...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, СтандартнаяОбработка)
	...
	Если КлючТекущегоВарианта = "Основной"
	   ...
	   И ЗначениеЗаполнено(Сценарий.Значение) Тогда
		...
		Если Тип(КомпоновщикНастроек.Настройки.Структура.Получить("1")) = Тип("ДиаграммаКомпоновкиДанных")
		   ...
		   И КомпоновщикНастроек.Настройки.Структура.Получить("2").Структура.Получить("0").Использование = Истина Тогда
			...
			ЗаголовокДиаграммыТД.Значение = НСтр("ru='Диаграмма требуемой доступности видов РЦ';uk='Діаграма необхідної доступності видів РЦ'");
			...
			ЗаголовокДиаграммТМ.Значение = НСтр("ru='Диаграммы анализа мощностей видов РЦ';uk='Діаграми аналізу потужностей видів РЦ'");
			...
			ДобавлениеИнформационнойЛинииДиаграммеТД.Подсказка = НСтр("ru='100% введённой доступности';uk='100% введеної доступності'");
			...
			ДобавлениеИнформационнойЛинииДиаграммамТМ.Подсказка = НСтр("ru='Максимальная мощность, ч';uk='Максимальна потужність, ч'");
