...
Процедура ПослеЗаполненияПанелиБыстрыхНастроек(ЭтаФорма, ПараметрыЗаполнения) Экспорт
	...
	Если ЭлементыФормы.Найти("Периоды") <> Неопределено
		...
		СтруктураИстечениеСрокаГодности = НайтиЭлементФормыПоПредставлениюОтбора(ЭтаФорма, НСтр("ru='С истекающим сроком годности';uk='Зі строком придатності, що закінчується'"), Истина);
