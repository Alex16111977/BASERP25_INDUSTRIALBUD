...
Процедура ЗаполнитьСведенияОбОрганизации(Форма)
	...
	ЗаполнитьПоказательНаСервере("REP_NYEAR", Формат(Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета, "ДФ=yyyy"), Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	...
	КонецЕсли;
	ЗаполнитьПоказательНаСервере("FIRM_ZIP",    Индекс,    Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	ЗаполнитьПоказательНаСервере("FIRM_CITY",   Город,     Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	ЗаполнитьПоказательНаСервере("FIRM_OBL",    Область,   Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	ЗаполнитьПоказательНаСервере("FIRM_STREET", Улица,     Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	ЗаполнитьПоказательНаСервере("FIRM_DOM1",   НомерДома, Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	ЗаполнитьПоказательНаСервере("FIRM_KORPUS", Корпус,    Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	ЗаполнитьПоказательНаСервере("FIRM_KVART",  Офис,      Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	ЗаполнитьПоказательНаСервере("FIRM_RAYON",  Район,     Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	ЗаполнитьПоказательНаСервере("FIRM_TERGROM", "",       Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	ЗаполнитьПоказательНаСервере("FIRM_RAYGOR",  "",       Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	...
	ЗаполнитьПоказательНаСервере("ZIP_FACT",    Индекс,  Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	ЗаполнитьПоказательНаСервере("CITY_FACT",   Город,   Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	ЗаполнитьПоказательНаСервере("OBL_FACT",    Область, Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	ЗаполнитьПоказательНаСервере("STREET_FACT", Улица,   Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	ЗаполнитьПоказательНаСервере("DOM1_FACT",   НомерДома, Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	ЗаполнитьПоказательНаСервере("KORPUS_FACT", Корпус,  Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	ЗаполнитьПоказательНаСервере("KVART_FACT",  Офис,    Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	ЗаполнитьПоказательНаСервере("RAYON_FACT",  Район,   Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	ЗаполнитьПоказательНаСервере("TERGROM_FACT", "",       Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	ЗаполнитьПоказательНаСервере("RAYGOR_FACT",  "",       Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
...
Функция ПолучитьДанныеФормыНаСервере();
	...
	//2024
	КодКАТОТТГ = ПолучитьПоказательНаСервере("KATOTTG", ЭтаФорма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	РайонКАТ = "0"+Сред(КодКАТОТТГ,5,2);
	Если Сред(КодКАТОТТГ,3,1) = "8" и РайонКАТ = "000" Тогда
		//Киев 
		РайонКАТ = "0"+Сред(КодКАТОТТГ,13,2);
	КонецЕсли;	
