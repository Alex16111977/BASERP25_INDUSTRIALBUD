...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ПараметрыРасшифровки") Тогда
		...
		Показатель = ПараметрыРасшифровки.Показатель; // СправочникСсылка.ЭлементыФинансовыхОтчетов -  
		ПроизводныйПоказатель = Показатель.Ссылка;
...
Процедура ВычислитьСуммуВыделенныхЯчеекТабличногоДокументаВКонтекстеНаСервере()
	...
	ПолеСумма = МеждународнаяОтчетностьВызовСервера.ВычислитьСуммуВыделенныхЯчеекТабличногоДокумента(
...
Процедура Подключаемый_РезультатПриАктивизацииОбластиПодключаемый()
	...
	МеждународнаяОтчетностьКлиент.ВычислитьСуммуВыделенныхЯчеекТабличногоДокумента(
