...
Процедура ОткрытьРасшифровку(ВыбранныйОтчет)
	...
	ЭлементУсловногоОформления.Представление = НСтр("ru='Выделять отрицательные';uk='Виділяти від''ємні'");
	...
	Если ИмяОтчета = "ОборотыСчета" Тогда
		...
		ЭлементУсловногоОформления.Представление = НСтр("ru='Уменьшенный автоотступ';uk='Зменшений автовідступ'");
	КонецЕсли;
