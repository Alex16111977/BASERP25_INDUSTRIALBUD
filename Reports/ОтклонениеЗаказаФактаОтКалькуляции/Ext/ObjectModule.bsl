...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если СкрытьОтборПоТипуЗатрат Тогда
		...
		ПредставлениеОтбора = НСтр("ru='Статья калькуляции.Тип затрат В списке ""Материальные; Оплата труда; Возвратные отходы""';uk='Стаття калькуляціі.Тіп витрат У списку ""Матеріальні; Оплата праці; Зворотні відходи""'");
