...
Процедура НастроитьПараметрыОтборыПоФункциональнымОпциям(КомпоновщикНастроекФормы)
	...
	Если Не ПолучитьФункциональнуюОпцию("ИспользоватьУправлениеПроизводством")
		...
		КомпоновкаДанныхСервер.УдалитьЭлементОтбораИзВсехНастроекОтчета(КомпоновщикНастроекФормы, "ЗаказНаПроизводство21");
		УдалитьУсловноеОформлениеПоля(КомпоновщикНастроекФормы, "ЗаказНаПроизводство21");
	КонецЕсли;
	...
	Если Не ПолучитьФункциональнуюОпцию("ИспользоватьУправлениеПроизводством2_2")
		...
		УдалитьУсловноеОформлениеПоля(КомпоновщикНастроекФормы, "ЗаказНаПроизводство");
	КонецЕсли;
	
	Если ПолучитьФункциональнуюОпцию("КомплекснаяАвтоматизация") Тогда
		КомпоновкаДанныхСервер.УдалитьЭлементОтбораИзВсехНастроекОтчета(КомпоновщикНастроекФормы, "ТипЗапасов");
		УдалитьУсловноеОформлениеПоля(КомпоновщикНастроекФормы, "ТипЗапасов");
	КонецЕсли;
...
Процедура УдалитьУсловноеОформлениеПоля(КомпоновщикНастроекФормы, ИмяПоля)
	
	ОформлениеКУдалению = Новый Массив;
	Для Каждого ТекОформление Из КомпоновщикНастроекФормы.Настройки.УсловноеОформление.Элементы Цикл
	...
	Для Каждого ТекОформление Из ОформлениеКУдалению Цикл
		КомпоновщикНастроекФормы.Настройки.УсловноеОформление.Элементы.Удалить(ТекОформление);
	КонецЦикла;
