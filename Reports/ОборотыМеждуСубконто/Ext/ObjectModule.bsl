...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если СписокВидовКорСубконто.Количество() > МаксКоличествоСубконто Тогда
		ТекстСообщения = НСтр("ru='Выбрано слишком много видов кор. субконто, максимально допустимо %1';uk='Обрано занадто багато видів кор. субконто, максимально допустиме %1'");
