...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета) Экспорт 
	...
	ЗаголовокОтчета = СтрШаблон(НСтр("ru='Обороты между субконто %1%2';uk='Обороти між субконто %1%2'"),
...
Процедура ПослеКомпоновкиМакета(ПараметрыОтчета, МакетКомпоновки) Экспорт
	...
	МакетШапкиОтчета = БухгалтерскиеОтчеты.ПолучитьМакетШапки(МакетКомпоновки, , ?(МакетКомпоновки.Тело.Количество() > 1, "Подвал", "Заголовок"));
...
Процедура ЗаполнитьПравилаРасшифровки(Правила) Экспорт
	...
	Правило.ШаблонПредставления = НСтр("ru='Отчет по проводкам';uk='Звіт по проводках'");
