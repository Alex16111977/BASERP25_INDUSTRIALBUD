...
|;uk='Деякі позиції матеріалів залежать від властивостей продукції. Рекомендується 
|сформувати звіт за замовленням на виробництво за вибраною специфікацією з вказаною продукцією та характеристикою.'");
	КонецЕсли;
