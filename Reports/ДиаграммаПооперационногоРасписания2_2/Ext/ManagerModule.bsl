	...
	Если ЗначенияЗаполнения.Состояние = ТекстРабота()
		...
		Если НЕ ЗначенияЗаполнения.ПараллельнаяЗагрузка Тогда
			...
			Результат = Результат
				...
				+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Партия: %1';uk='Партія: %1'"), ЗначенияЗаполнения.НомерПартии), "")
				+ Символы.ПС
...
Функция ПредставлениеЭтапаПроизводства(Номер, Дата)
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Этап №%1 от %2';uk='Етап №%1 від %2'"),
...
Функция ПредставлениеПартииОперации(Операция, НомерПартии)
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Операция ""%1"", партия %2';uk='Операція ""%1"", партія %2'"), Операция, НомерПартии);
