...
Процедура УстановитьЗаголовок()
	...
	Если ЗначениеЗаполнено(ЭтапПроизводства) Тогда
		...
		Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Диагностика графика этапа ""%1""';uk='Діагностика графіка етапу ""%1""'"),
			ПредставлениеЭтапа);
		
	Иначе
		
		Заголовок = НСтр("ru='Диагностика графика этапа производства';uk='Діагностика графіка етапу виробництва'");
...
Процедура СформироватьОтчетНаСервере()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания =
		НСтр("ru='Формирование отчета ""Диагностика этапа производства""';uk='Формування звіту ""Діагностика етапу виробництва""'");
...
Процедура ЗаменитьИспользуемыйВидРЦКлиент(Расшифровка)
	...
	ТекстВопроса = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Заменить используемый вид РЦ на ""%1""?';uk='Замінити використовуваний вид РЦ на ""%1""?'"),
...
Процедура ПланироватьГрафикЭтапа()
	...
	ПараметрыВыполнения = ДлительныеОперации.ПараметрыВыполненияВФоне(УникальныйИдентификатор);
	ПараметрыВыполнения.НаименованиеФоновогоЗадания =
		НСтр("ru='Планирование графика этапов производства""';uk='Планування графіка етапів виробництва""'");
