...
Процедура СформироватьОтчетВФоне()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru='Формирование отчета ""Диаграмма графика производства заказа""';uk='Формування звіту ""Діаграма графіка виробництва замовлення""'");
...
Процедура УстановитьЗаголовок()
	...
	Если СтатусГрафика = СтатусРабочийГрафик() Тогда
		...
		Заголовок = НСтр("ru='График производства заказа';uk='Графік виробництва замовлення'");
		
	ИначеЕсли СтатусГрафика = СтатусПредварительныйГрафик() Тогда
		
		Заголовок = НСтр("ru='График производства заказа (планирование)';uk='Графік виробництва замовлення (планування)'");
		
	ИначеЕсли СтатусГрафика = СтатусМодельГрафика() Тогда
		
		Заголовок = НСтр("ru='График производства заказа (модель)';uk='Графік виробництва замовлення (модель)'");
