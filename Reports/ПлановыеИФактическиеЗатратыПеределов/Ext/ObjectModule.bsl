...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если НаборДанныхРазузловки = Неопределено Тогда
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ru='Изменилась схема разузлования продукции. Разузлование невозможно.';uk='Змінилася схема розвузлування продукції. Розвузловання неможливо.'"));
		Возврат;
	...
	Запрос.УстановитьПараметр("ПредставлениеФакта", НСтр("ru='ФКП = %1';uk='ФКП = %1'"));
	Запрос.УстановитьПараметр("ПредставлениеПлана", НСтр("ru='ПКП = %1';uk='ПКП = %1'"));
	Запрос.УстановитьПараметр("Трудозатраты", НСтр("ru='Трудозатраты';uk='Трудовитрати'"));
	Запрос.УстановитьПараметр("Постатейные", НСтр("ru='Постатейные';uk='Постатейні'"));
	Запрос.УстановитьПараметр("Полуфабрикат", НСтр("ru='Полуфабрикат';uk='Напівфабрикат'"));
	Запрос.УстановитьПараметр("Материальные", НСтр("ru='Материальные';uk='Матеріальні'"));
...
#Область ТекстЗапроса
	Запрос.Текст =
		...
		|			И ВТПродукция.ПартияПродукции = Выпуски.Распоряжение
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
