...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если НЕ ПолучитьФункциональнуюОпцию("ИспользоватьМеждународныйФинансовыйУчет") Тогда
		ОтключенныйУчет.Добавить(НСтр("ru='международный учет';uk='міжнародний облік'"));
	КонецЕсли;
	
	Если НЕ ПолучитьФункциональнуюОпцию("ИспользоватьРеглУчет") Тогда
		ОтключенныйУчет.Добавить(НСтр("ru='регламентированный учет';uk='регламентований облік'"));
	КонецЕсли;
	
	Если ОтключенныйУчет.Количество() > 0 Тогда
		Шаблон = НСтр("ru='Невозможно построить отчет если отключен';uk='Неможливо побудувати звіт якщо відключений'") + " %1.";
		Учет = СтрСоединить(ОтключенныйУчет, " "+НСтр("ru='и';uk='і'")+" ");
...
Процедура ПостОбработка(ДокументРезультат)
	...
	Область = ДокументРезультат.НайтиТекст(НСтр("ru='Обычная';uk='Звичайна'"));
...
Процедура УстановитьГруппировкуКолонок(ДокументРезультат, ИмяГруппы, НачальнаяОбласть = Неопределено)
	...
	Область = ДокументРезультат.НайтиТекст(НСтр("ru='Обычная';uk='Звичайна'"),НачальнаяОбласть);
