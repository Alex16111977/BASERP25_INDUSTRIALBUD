...
Функция МассивИменОбъектовИсключаемыхИзТекстаЗапросаПрочиеЗадачиИсполнителя()
	...
	//++ НЕ УТ
	//++ Локализация
	МассивИменОбъектов.Добавить("Документ.ПередачаМатериаловВПроизводство");
	//-- Локализация
	МассивИменОбъектов.Добавить("Документ.ЗаказМатериаловВПроизводство");
	МассивИменОбъектов.Добавить("Документ.ДвижениеПродукцииИМатериалов");
	//-- НЕ УТ
