...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ТекстСообщения = НСтр("ru='Отчет не поддерживает получение данных до даты начала учета необоротных активов версии 2.5 - %1.
|Необходимо воспользоваться аналогичным отчетом в разделе ""Регламентированный учет"".'
|;uk='Звіт не підтримує отримання даних до дати початку обліку необоротних активів версії 2.5 – %1.
|Необхідно скористатися аналогічним звітом у розділі ""Регламентований облік"".'");
