...
Функция ТекстЗапросаУчетнаяПолитикаБухУчета()
	...
	|		ИНАЧЕ ЛОЖЬ
	|	КОНЕЦ КАК ОсновнаяОрганизация,
    |	УчетнаяПолитикаБухУчетаСрезПоследних.ИспользуемыеКлассыСчетовРасходов КАК ИспользуемыеКлассыСчетовРасходов,
	|	УчетнаяПолитикаБухУчетаСрезПоследних.СборкаТоваровЧерезСчет23 КАК СборкаТоваровЧерезСчет23,
    |	УчетнаяПолитикаБухУчетаСрезПоследних.ВключатьСуммуДооценокОСВСоставНераспределеннойПрибыли КАК ВключатьСуммуДооценокОСВСоставНераспределеннойПрибыли,
...
Функция ТекстЗапросаНастройкиУчетаНалогаНаПрибыль()
	...
	|		ИНАЧЕ ЛОЖЬ
	|	КОНЕЦ КАК ОсновнаяОрганизация,
	|	НастройкиУчетаНалогаНаПрибыльСрезПоследних.Ставка КАК Ставка,
	|	НастройкиУчетаНалогаНаПрибыльСрезПоследних.НалогНаПрибыльБезКорректировокФинансовогоРезультата КАК НалогНаПрибыльБезКорректировокФинансовогоРезультата
	|ИЗ
