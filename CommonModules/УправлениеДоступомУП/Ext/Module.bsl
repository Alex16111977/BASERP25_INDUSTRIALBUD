...
Процедура ДобавитьПрофильАналитикМеждународногоУчета(ОписанияПрофилей)
	...
	ОписаниеПрофиля.Наименование  = НСтр("ru='Аналитик международного учета (дополнительный)';uk='Аналітик міжнародного обліку (додатковий)'",ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура ДобавитьПрофильБухгалтерМеждународногоУчета(ОписанияПрофилей)
	...
	ОписаниеПрофиля.Наименование  = НСтр("ru='Бухгалтер международного учета';uk='Бухгалтер міжнародного обліку'",ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура ДобавитьПрофильПользовательОтчетностиМеждународногоУчета(ОписанияПрофилей)
	...
	ОписаниеПрофиля.Наименование  = НСтр("ru='Пользователь отчетности международного учета (дополнительный)';uk='Користувач звітності міжнародного обліку (додатковий)'",ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура ДобавитьПрофильГлавногоДиспетчера(ОписанияПрофилей)
	...
	ОписаниеПрофиля.Наименование  = НСтр("ru='Главный диспетчер производства';uk='Головний диспетчер виробництва'",ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура ДобавитьПрофильМенеджераПроизводства(ОписанияПрофилей)
	...
	ОписаниеПрофиля.Наименование  = НСтр("ru='Менеджер производства';uk='Менеджер виробництва'",ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура ДобавитьПрофильМенеджераПоПереработкеДавальческогоСырья(ОписанияПрофилей)
	...
	ОписаниеПрофиля.Наименование  = НСтр("ru='Менеджер по переработке давальческого сырья';uk='Менеджер з переробки давальницької сировини'",ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура ДобавитьПрофильОтветственныйЗаВедениеНСИУР(ОписанияПрофилей)
	...
	ОписаниеПрофиля.Наименование  = НСтр("ru='Ответственный за ведение НСИ управления ремонтами';uk='Відповідальний за ведення НДІ управління ремонтами'",ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура ДобавитьПрофильЭксплуатационник(ОписанияПрофилей)
	...
	ОписаниеПрофиля.Наименование  = НСтр("ru='Эксплуатационник';uk='Експлуатаційник'",ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура ДобавитьПрофильРемонтник(ОписанияПрофилей)
	...
	ОписаниеПрофиля.Наименование  = НСтр("ru='Ремонтник';uk='Ремонтник'",ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура ДобавитьПрофильПланировщикРемонтов(ОписанияПрофилей)
	...
	ОписаниеПрофиля.Наименование  = НСтр("ru='Планировщик ремонтов';uk='Планувальник ремонтів'",ОбщегоНазначения.КодОсновногоЯзыка());
