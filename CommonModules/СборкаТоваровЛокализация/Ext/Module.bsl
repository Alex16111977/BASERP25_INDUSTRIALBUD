...
#КонецОбласти
	...
	#Область ТекстСборкаТоваровНаСкладах // (Дт 28 :: Кт 28)
	ТекстЗапроса =    
	"ВЫБРАТЬ //// Комплектация товаров через 28 счет (Дт 28 :: Кт 28)
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
	|	НЕОПРЕДЕЛЕНО КАК ИдентификаторСтроки,
...
#КонецОбласти
	...
	#Область ТекстРазборкаТоваровТоваровНаСкладах // (Дт 28 :: Кт 28)
	ТекстЗапроса =                                         
	"ВЫБРАТЬ //// Комплектация товаров через 28 счет (Дт 28 :: Кт 28)
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
