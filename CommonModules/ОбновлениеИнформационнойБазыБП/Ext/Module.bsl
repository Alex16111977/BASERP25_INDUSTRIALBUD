...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "1.0.21.6";
	Обработчик.Процедура           = "ОбновлениеИнформационнойБазыБП.ЗаполнитьПредопределенные_1_0_21_6";
	Обработчик.НачальноеЗаполнение = Ложь;
...
Процедура ЗаполнитьПредопределенные_1_0_21_6() Экспорт
