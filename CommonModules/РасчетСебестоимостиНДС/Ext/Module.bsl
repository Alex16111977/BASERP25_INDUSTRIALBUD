...
Функция ТекстИнициализацияПартийНДС2_4ПоПартиямПрочихРасходов()
	Возврат
        ...
        //++ НЕ УТКА
		|					КОГДА Т.ЗаказНаПроизводство ССЫЛКА Документ.ЗаказНаПроизводство И Т.ЗаказНаПроизводство <> ЗНАЧЕНИЕ(Документ.ЗаказНаПроизводство.ПустаяСсылка)
		|                   	ТОГДА Т.ЗаказНаПроизводство
        //-- НЕ УТКА
        ...
        |			ТОГДА ВЫРАЗИТЬ(Т.ЗаказНаПроизводство КАК Документ.ЗаказНаПроизводство).НалоговоеНазначение
        //-- НЕ УТКА
...
Функция ТекстСписаниеНаВыпускПостатейныеРасходы()
	Возврат
        ...
        //++ НЕ УТКА
		|					КОГДА ДД.ЗаказНаПроизводство ССЫЛКА Документ.ЗаказНаПроизводство И ДД.ЗаказНаПроизводство <> ЗНАЧЕНИЕ(Документ.ЗаказНаПроизводство.ПустаяСсылка)
		|                   	ТОГДА ДД.ЗаказНаПроизводство
        //-- НЕ УТКА
        ...
        |			ТОГДА ВЫРАЗИТЬ(ДД.ЗаказНаПроизводство КАК Документ.ЗаказНаПроизводство).НалоговоеНазначение
        //-- НЕ УТКА
		//-- Устарело_Производство21  
        |		ИНАЧЕ ЗНАЧЕНИЕ(Справочник.НалоговыеНазначенияАктивовИЗатрат.ПустаяСсылка)
        |	КОНЕЦ 								КАК НалоговоеНазначение,
