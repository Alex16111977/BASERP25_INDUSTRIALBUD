...
Процедура ОповеститьПользователяОФормированииПроизводственныхОпераций(КоличествоОбработанных, КоличествоВсего, Источник = Неопределено) Экспорт
	...
	Если КоличествоОбработанных > 0 Тогда
		...
		ТекстЗаголовка = НСтр("ru='Производственные операции сформированы';uk='Виробничі операції сформовані'");
		ПоказатьОповещениеПользователя(ТекстЗаголовка,, ТекстСообщения, БиблиотекаКартинок.Информация32);
		
	Иначе
		
		ТекстСообщения = НСтр("ru='Не сформирован ни один документ';uk='Не сформовано жодний документ'");
		ТекстЗаголовка = НСтр("ru='Производственные операции не сформированы';uk='Виробничі операції не сформовані'");
		ПоказатьОповещениеПользователя(ТекстЗаголовка,, ТекстСообщения, БиблиотекаКартинок.Информация32);
