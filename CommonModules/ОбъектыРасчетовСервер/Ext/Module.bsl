...
Функция ЭкземплярыТиповОбъектовРасчетов()
	...
	//++ НЕ УТКА
	ЭкземплярыОбъектов.Добавить(Документы.ЗаказДавальца.ПустаяСсылка());
	ЭкземплярыОбъектов.Добавить(Документы.ОтчетДавальцу.ПустаяСсылка());
	//-- НЕ УТКА
	//-- НЕ УТ
...
Функция ВсеОбъектыРасчетовСгенерированы(Очередь) Экспорт
		...
		//-- НЕ УТ
		//++ НЕ УТКА
		ОбработчикиГенерации.Добавить("Документ.ЗаказДавальца");
		ОбработчикиГенерации.Добавить("Документ.ОтчетДавальцу");
		//-- НЕ УТКА     
...
Функция ПараметрыВзаиморасчетовОбъектаРасчетов(Объект) Экспорт
	...
	//++ НЕ УТКА
	ДокументыБезДопПараметров.Добавить("ЗаказДавальца");
	ДокументыБезДопПараметров.Добавить("ОтчетДавальцу");
	//-- НЕ УТКА
	//++ НЕ УТ
