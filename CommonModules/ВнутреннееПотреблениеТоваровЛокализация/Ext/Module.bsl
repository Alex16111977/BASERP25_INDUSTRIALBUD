...
#Область ТекстСписаниеТоваровДавальца // (Дт  :: Кт 0221/023)
	...
	ТекстСписаниеТоваровДавальца = СтрШаблон(ТекстСписаниеТоваровДавальца, 
...
#Область СписаниеТоваровДавальцаСкладПроизводства // (Дт  :: Кт 022)
	ТекстСписаниеТоваровДавальцаСкладПроизводства = "
	|ВЫБРАТЬ //// Списание материалов давальца со склада производства (Дт  :: Кт 022)
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
	|	НЕОПРЕДЕЛЕНО КАК ИдентификаторСтроки,
	...
	ТекстСписаниеТоваровДавальцаСкладПроизводства = СтрШаблон(ТекстСписаниеТоваровДавальцаСкладПроизводства, 
		НСтр("ru='Списание материалов давальца';uk='Списання матеріалів давальця'",ЯзыкСодержания));
 
	ТекстыОтражения.Добавить(ТекстСписаниеТоваровДавальцаСкладПроизводства);
...
#Область ТекстСписаниеПродукцииДавальца // (Дт  :: Кт 023)
	...
	ТекстСписаниеПродукцииДавальца = СтрШаблон(ТекстСписаниеПродукцииДавальца, 
