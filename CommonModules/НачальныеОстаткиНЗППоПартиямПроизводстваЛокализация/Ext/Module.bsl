...
Функция ТекстОтраженияВРеглУчетеУКР() Экспорт
	...
	//++ Локализация
#Область ТекстНачальныеОстаткиМатериаловПартийПроизводства // (Дт 23 :: Кт 00)

	ЯзыкСодержания = МультиязычностьУкр.КодЯзыкаИнформационнойБазы();
 
	ТекстНачальныеОстаткиМатериаловПартийПроизводства =
	// Начальные остатки партий производства (Дт 23 :: Кт 00).
	"ВЫБРАТЬ
	...
	ТекстНачальныеОстаткиМатериаловПартийПроизводства = СтрШаблон(ТекстНачальныеОстаткиМатериаловПартийПроизводства, 
		НСтр("ru='Ввод остатков материальных затрат партий производства';uk='Введення залишків матеріальних витрат партій виробництва'",ЯзыкСодержания));
...
#Область ТекстНачальныеОстаткиНематериальныхЗатратПартийПроизводства // (Дт 2Х :: Кт 000)
	...
	ТекстНачальныеОстаткиНематериальныхЗатратПартийПроизводства = СтрШаблон(ТекстНачальныеОстаткиНематериальныхЗатратПартийПроизводства, 
		НСтр("ru='Ввод остатков нематериальных затрат партий производства';uk='Введення залишків нематеріальних витрат партій виробництва'",ЯзыкСодержания));
