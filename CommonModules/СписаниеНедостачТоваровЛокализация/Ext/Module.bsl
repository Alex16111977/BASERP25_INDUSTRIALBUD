...
#Область ТекстСписаниеТоваровНаРасходы // (Дт 23, 9X :: Кт 28, 68ОК)
	ТекстЗапроса = "
	|ВЫБРАТЬ   //// Списание на расходы собственных товаров (Дт 23, 9X :: Кт 28, 68ОК)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
...
#Область ТекстСписаниеТоваровНаСтатьиАктивовПассивов // (Дт ХХ :: Кт 28, 68ОК)
	ТекстЗапроса = "
	|ВЫБРАТЬ   //// Списание на прочие активы собственных товаров (Дт ХХ :: Кт 28, 68ОК)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
