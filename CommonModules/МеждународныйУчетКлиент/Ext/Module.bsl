...
Функция ВозможныеРасшифровки(ПолноеИмяОтчета, КлючТекущегоВарианта, ЗначенияСчета)
	...
	Если ПолноеИмяОтчета = "БухгалтерскийОтчетМеждународный" Тогда
		...
		Если КлючТекущегоВарианта = "АнализСчетаМеждународный" Тогда
			...
			Представление						= СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
													НСтр("ru='Отчет по проводкам %1';uk='Звіт по проводках %1'"), ЗначенияСчета.Счет);
			ВозможныеРасшифровки.Добавить(Новый ФиксированнаяСтруктура(СтруктураРасшифровки), Представление);
			
			СтруктураРасшифровки.ИмяОтчета 		= "БухгалтерскийОтчетМеждународный";
			СтруктураРасшифровки.ИмяВарианта 	= "ОСВПоСчетуСКорреспонденциейМеждународный";
			Представление						= СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
													НСтр("ru='ОСВ по счету %1 с корреспонденцией';uk='ОСВ за рахунком %1 з кореспонденцією'"), ЗначенияСчета.Счет);
			ВозможныеРасшифровки.Добавить(Новый ФиксированнаяСтруктура(СтруктураРасшифровки), Представление);
		...
		ИначеЕсли КлючТекущегоВарианта = "ОСВ_ПоСчетуМеждународный" Тогда
		...
		ИначеЕсли КлючТекущегоВарианта = "ОСВ_Международный" Тогда
			...
			Представление						= СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
													НСтр("ru='ОСВ по счету %1';uk='ОСВ за рахунком %1'"), ЗначенияСчета.Счет);
			ВозможныеРасшифровки.Добавить(Новый ФиксированнаяСтруктура(СтруктураРасшифровки), Представление);
			
			СтруктураРасшифровки.ИмяОтчета 		= "КарточкаСчетаМеждународный";
			СтруктураРасшифровки.ИмяВарианта 	= "КарточкаСчетаМеждународный";
			Представление						= СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
													НСтр("ru='Карточка счета %1';uk='Картка рахунку %1'"), ЗначенияСчета.Счет);
			ВозможныеРасшифровки.Добавить(Новый ФиксированнаяСтруктура(СтруктураРасшифровки), Представление);
					
			СтруктураРасшифровки.ИмяОтчета 		= "БухгалтерскийОтчетМеждународный";
			СтруктураРасшифровки.ИмяВарианта 	= "АнализСчетаМеждународный";
			Представление						= СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
													НСтр("ru='Анализ счета %1';uk='Аналіз рахунку %1'"), ЗначенияСчета.Счет);
			ВозможныеРасшифровки.Добавить(Новый ФиксированнаяСтруктура(СтруктураРасшифровки), Представление);
	...
	ИначеЕсли ПолноеИмяОтчета = "ШахматнаяВедомостьМеждународный" Тогда
		
		СтруктураРасшифровки.ИмяОтчета 		= "БухгалтерскийОтчетМеждународный";
		СтруктураРасшифровки.ИмяВарианта 	= "ОСВПоСчетуСКорреспонденциейМеждународный";
		СтруктураРасшифровки.ДополнительныеПараметры = Новый Структура("ДтКт", "Дт");
		Представление						= СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
													НСтр("ru='ОСВ по счету %1 с корреспонденцией';uk='ОСВ за рахунком %1 з кореспонденцією'"), ЗначенияСчета.СчетДт);
		ВозможныеРасшифровки.Добавить(Новый ФиксированнаяСтруктура(СтруктураРасшифровки), Представление);
		...
		Представление						= СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
													НСтр("ru='ОСВ по счету %1 с корреспонденцией';uk='ОСВ за рахунком %1 з кореспонденцією'"), ЗначенияСчета.СчетКт);
		ВозможныеРасшифровки.Добавить(Новый ФиксированнаяСтруктура(СтруктураРасшифровки), Представление);
		
	ИначеЕсли ПолноеИмяОтчета = "КарточкаСчетаМеждународный" Тогда
	...
	ИначеЕсли ПолноеИмяОтчета = "МеждународныйОтчет" Тогда
...
Функция ПолучитьРасшифровкуОтчета(ФормаОтчета, ИдентификаторРасшифровки)
	...
	ПараметрыФормыРасшифровки = МеждународныйУчетВызовСервера.ПараметрыСтандартногоОтчета(
...
Функция ЭтоСтандартныйОтчет(ИмяОтчета) Экспорт
	...
	СписокОтчетов.Добавить("БухгалтерскийОтчетМеждународный");
