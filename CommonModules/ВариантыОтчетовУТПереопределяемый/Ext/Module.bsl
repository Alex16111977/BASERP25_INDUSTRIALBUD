...
|Яке поточне сальдо розрахунків?'");
	...
	ВариантыОтчетов.УстановитьРежимВыводаВПанеляхОтчетов(Настройки, ОписаниеОтчета, ВыводитьВариантыОтчетов);
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Анализ исполнительской дисциплины бюджетного процесса.';uk='Аналіз виконавської дисципліни бюджетного процесу.'");
...
|Наприклад, 0-7 днів, 7-15 днів, 15-30 днів, більше 30 днів.'");
	...
	ОписаниеОтчета.Описание = НСтр("ru='Просмотр графика производства заказа в виде диаграммы Ганта.';uk='Перегляд графіка виробництва замовлення у вигляді діаграми Ганта.'");
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
...
|Напівфабрикат 
|Етап виробництва'");
	ОписаниеВарианта.НастройкиДляПоиска.НаименованияПараметровИОтборов = НСтр("ru='Заказ на производство';uk='Замовлення на виробництво'");
	#КонецОбласти
	...
	ОписаниеВарианта.Описание = НСтр("ru='Показывает загрузку видов рабочих центров в каждом подразделении.';uk='Показує завантаження видів робочих центрів в кожному підрозділі.'");
	...
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Значения параметров производственных операций с отклонениями от нормативов.';uk='Значення параметрів виробничих операцій з відхиленнями від нормативів.'");
...
|По яких об''єктах відбулися відхилення?'");
	ОписаниеВарианта.ФункциональныеОпции.Добавить("ИспользоватьУправлениеПроизводством2_2");
	#КонецОбласти
	...
	ОписаниеВарианта.Описание = НСтр("ru='Каковы плановые и фактические затраты по выпущенной продукции в разрезе видов затрат?';uk='Які планові і фактичні витрати по випущеній продукції в розрізі видів витрат?'");
	ОписаниеВарианта.ФункциональныеОпции.Добавить("ИспользоватьУправлениеПроизводством2_2");
	#КонецОбласти
	//-- НЕ УТКА
	...
	ОписаниеВарианта.Описание = НСтр("ru='Каковы плановые затраты по выпускаемой продукции?';uk='Які планові витрати по продукції, що випускається?'");
	ОписаниеВарианта.ФункциональныеОпции.Добавить("ИспользоватьУправлениеПроизводством2_2");	
	...
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Плановые и фактические нормативы производственных расходов.';uk='Планові і фактичні нормативи виробничих витрат.'");
...
|;uk='По яких партіях запущено виробництво? 
|В якому підрозділі і на якому етапі (операції) перебуває виконання? 
|Які планові строки виробництва, чи є затримка?'");
	#КонецОбласти
	//-- НЕ УТКА	
