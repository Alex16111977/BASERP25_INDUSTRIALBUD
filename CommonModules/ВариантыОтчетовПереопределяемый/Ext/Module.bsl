...
Процедура ОпределитьОбъектыСКомандамиОтчетов(Объекты) Экспорт
	...
	//***  
	Объекты.Добавить(Метаданные.Документы.А_БюджетМесяц);
	Объекты.Добавить(Метаданные.Документы.А_ОтгрузкаПродукции);
	Объекты.Добавить(Метаданные.Документы.А_АрендаТехники);
	Объекты.Добавить(Метаданные.Документы.А_РаспределениеЗаработнойПлаты);
	Объекты.Добавить(Метаданные.Документы.РаспределениеФ2);

	
	Объекты.Добавить(Метаданные.Документы.А_ПередачаНачисленийМеждуПодразделениями);
	Объекты.Добавить(Метаданные.Документы.А_ФинРез_Баланс);          
	Объекты.Добавить(Метаданные.Документы.А_ОказаниеУслугМеждуПодразделениями);
	
	Объекты.Добавить(Метаданные.Документы.А_ПриходДенегОтФинАгента);
	Объекты.Добавить(Метаданные.Документы.А_ОтражениеЗПпоКазне);
	Объекты.Добавить(Метаданные.Документы.А_ОтчетPL);
	Объекты.Добавить(Метаданные.Документы.А_ФинРез_PL);
	Объекты.Добавить(Метаданные.Документы.А_ФинРез_DDS);
	Объекты.Добавить(Метаданные.Документы.А_ПереносДвиженийИзКазны);
