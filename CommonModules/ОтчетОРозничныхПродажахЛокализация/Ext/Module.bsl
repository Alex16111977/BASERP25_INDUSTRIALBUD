...
#Область ТекстВычетИзДоходовОтВозвратаСобственногоТовара
	...
	ТекстЗапроса = СтрШаблон(ТекстЗапроса, 
		НСтр("ru='Вычет из доходов от продаж в рознице (возврат)';uk='Вирахування з доходів від продажів у роздробі (повернення)'",ЯзыкСодержания));
	ТекстыОтражения.Добавить(ТекстЗапроса);
...
#Область ТекстВычетыИзДоходовОтВозвратаКомиссионногоТовара
	...
	ТекстЗапроса = СтрШаблон(ТекстЗапроса, 
		НСтр("ru='Вычет из доходов от реализации комиссионного товара в рознице (возврат)';uk='Вирахування з доходів від реалізації комісійного товару в роздробі (повернення)'",ЯзыкСодержания));
	ТекстыОтражения.Добавить(ТекстЗапроса);
