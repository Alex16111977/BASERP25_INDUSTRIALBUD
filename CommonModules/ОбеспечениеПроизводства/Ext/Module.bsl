...
Функция ПараметрыОбеспеченияМатериаловЭтапа(ТаблицаМатериалов, ЗаказНаПроизводство) Экспорт
	...
	ВыполнитьПодстановкуПараметровОбеспеченияМатериалов(
		ТекстЗапроса, "МатериалыИУслуги",,, Перечисления.ВариантыЗаполненияОбеспеченияПроизводства.ПоСхемамОбеспечения);
