...
Функция КоличествоПериодов(Периодичность, ПериодичностьПодПериодов) Экспорт
	...
	Если КоличествоПериодов = 0 Тогда
		ТекстОшибки = НСтр("ru='В нефинансовом показателе указаны некорректные значения периодичностей основного и вложенного периодов';uk='У нефінансовому показнику вказані некоректні значення періодичностей основного і вкладеного періодів'");
