...
Процедура ПроверитьВывестиИнформационноеСообщение()
	...
	Если СпособРаспределенияЗатратНаВыходныеИзделия = Перечисления.СпособыРаспределенияЗатратНаВыходныеИзделия.ПоПлановойСтоимости Тогда
		...
		Если Не ЗначениеЗаполнено(ВидЦены) Тогда
			ТекстСтроки = НСтр("ru='В настройках раздела ""Производство"" не задан вид цены плановой стоимости выходных изделий';uk='В настройках розділу ""Виробництво"" не заданий вид ціни планової вартості вихідних виробів'");
			МассивСтрок.Добавить(Новый ФорматированнаяСтрока(ТекстСтроки));
			МассивСтрок.Добавить(" ");
			МассивСтрок.Добавить(Новый ФорматированнаяСтрока(НСтр("ru='(открыть)';uk='(відкрити)'"),,,, "ПерейтиРазделПроизводство"));
		КонецЕсли;
