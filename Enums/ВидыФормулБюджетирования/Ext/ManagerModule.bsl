...
Функция ТекстФункции(ИмяЗначения) Экспорт
	...
	Если Значение = Менеджер.Максимум
		...
		Возврат ИмяФункции(Значение)
			+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				"(%1, %2, , %3)",
				НСтр("ru='<Значение 1>';uk='<Значення 1>'"),
				НСтр("ru='<Значение 2>';uk='<Значення 2>'"),
				НСтр("ru='<Значение N>';uk='<Значення N>'"));
	...
	ИначеЕсли Значение = Менеджер.Отклонение 
		...
		Возврат ИмяФункции(Значение)
			+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				"(%1, %2, , %3)",
				НСтр("ru='<Ведущая колонка>';uk='<Ведуча колонка>'"),
				НСтр("ru='<Сравниваемая колонка 1>';uk='<Порівнювати колонка 1>'"),
				НСтр("ru='<Сравниваемая колонка N>';uk='<Порівнювати колонка N>'"));
	...
	ИначеЕсли Значение = Менеджер.Округлить Тогда
		...
		Возврат ИмяФункции(Значение)
			+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				"(%1, %2)",
				НСтр("ru='<Значение>';uk='<Значення>'"),
				НСтр("ru='<Число знаков>';uk='<Число знаків>'"));
	...
	Иначе 
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Неизвестная функция: %1';uk='Невідома функція: %1'"),
			ИмяЗначения);
	КонецЕсли;
