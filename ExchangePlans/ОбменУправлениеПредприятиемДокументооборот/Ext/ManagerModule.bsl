...
|""BAS ERP"", и ""BAS Документооборот КОРП, редакция 2.1"".'
|;uk='Дана настройка дозволить синхронізувати дані між програмами
|""BAS ERP"" та ""BAS Документообіг КОРП, редакція 2.1"".'");
	...
	ОписаниеВарианта.НаименованиеКонфигурацииКорреспондента    = НСтр("ru='BAS Документооборот КОРП, редакция 2.1';uk='BAS Документообіг КОРП, редакція 2.1'");
...
Функция ЗаголовокКомандыДляСозданияНовогоОбменаДанными() Экспорт
	...
	Возврат НСтр("ru='Создать обмен с конфигурацией ""BAS Документооборот КОРП, ред. 1.4""';uk='Створити обмін з конфігурацією ""BAS Документообіг КОРП, ред. 1.4""'");
