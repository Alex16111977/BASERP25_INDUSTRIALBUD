...
Функция СформироватьОписаниеПравилОтправкиУТ()
	...
	ТекстОписанияУТ = НСтр("ru='Правила отправки данных из информационной базы ""BAS ERP"" :';uk='Правила надсилання даних з інформаційної бази ""BAS ERP"" :'") + Символы.ПС;
	...
	ИначеЕсли ПравилаОтправкиСправочниковУТ = "НеСинхронизировать" Тогда
		...
		ТекстОписанияУТ = ТекстОписанияУТ + 
		НСтр("ru='Данные из информационной базы ""BAS ERP"" отправляться не будут.';uk='Дані з інформаційної бази ""BAS ERP"" відправлятися не будуть.'");
	...
	ИначеЕсли ПравилаОтправкиДокументовУТ = "НеСинхронизировать"
		...
		ТекстОписанияУТ = ТекстОписанияУТ 
			+ Символы.ПС 
			+ НСтр("ru='Документы из информационной базы ""BAS ERP"" отправляться не будут;';uk='Документи з інформаційної бази ""BAS ERP"" відправлятися не будуть;'");
