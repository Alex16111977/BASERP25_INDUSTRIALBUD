...
|;uk='Коригувати проводки документа ""Операція (міжнародний облік)"" в закритому періоді за міжнародним обліком
|допускається тільки з включеним прапором ""Вводити дату в рядках"" на закладці ""Основне"".'");
