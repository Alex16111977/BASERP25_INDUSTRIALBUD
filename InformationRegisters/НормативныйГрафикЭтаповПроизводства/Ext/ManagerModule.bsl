...
Процедура РассчитатьГрафикВФоне(Распоряжение) Экспорт
	...
	НаименованиеЗадания = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Расчет нормативного графика этапов распоряжения ""%1""';uk='Розрахунок нормативного графіка етапів розпорядження ""%1""'"),
...
Процедура ОтменитьАктивныйРасчетГрафика(Распоряжение)
	...
	Для каждого Задание Из Задания Цикл
		...
		Исключение
			...
			СобытиеЖурналаРегистрации = НСтр("ru='Нормативный график этапов производства.Отмена фонового задания';uk='Нормативний графік етапів виробництва. Відміна фонового завдання'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
...
// Возвращает этапы производства с зависимостями
// 
// Параметры:
//  Распоряжение - 
//
...
Процедура ОжидатьЗавершениеТранзакцийЗаписиЭтапов(Распоряжение)
	...
	Исключение
		...
		СобытиеЖурналаРегистрации = НСтр("ru='Нормативный график этапов производства.Ожидание завершения записи этапов';uk='Нормативний графік етапів виробництва. Очікування завершення запису етапів'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
		...
		Если Длительность > Этап[ИмяКолонки] Тогда
			...
			Иначе
				...
				ВызватьИсключение СтрШаблон(
					НСтр("ru='В процессе расчета нормативного графика обнаружено зацикливание на этапе ""%1"".';uk='У процесі розрахунку нормативного графіка виявлено зациклення на етапі ""%1"".'"),
...
Процедура ЗаписатьРезультатыРасчетаГрафика(Распоряжение, Этапы) Экспорт
	...
	Исключение
		...
		СобытиеЖурналаРегистрации = НСтр("ru='Нормативный график этапов производства.Запись результатов расчета';uk='Нормативний графік етапів виробництва. Запис результатів розрахунку'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
