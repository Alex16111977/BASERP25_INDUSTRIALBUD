...
Функция СобытиеЖурналаРегистрации()
	...
	Возврат НСтр("ru='Межцеховое управление.Ошибка отражения состояния заказов в очереди';uk='Міжцехове управління. Помилка відображення стану замовлень в черзі'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
