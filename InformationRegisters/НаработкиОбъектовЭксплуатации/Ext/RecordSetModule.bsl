...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Если ОбменДанными.Загрузка Или Не ПроведениеДокументов.РассчитыватьИзменения(ДополнительныеСвойства)
		Или ВнеоборотныеАктивы.ИспользуетсяУправлениеВНА() Тогда
		Возврат;
	КонецЕсли;
...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	Если ТекстЗапроса = Неопределено Тогда
		...
		|
		|////////////////////////////////////////////////////////////////////////////////
		|УНИЧТОЖИТЬ ПоНаработкеУУ_Последнее";
		
	КонецЕсли; 
	СписокЗапросов.Добавить(ТекстЗапроса);

	СписокЗапросов.Добавить("УНИЧТОЖИТЬ НаработкиОбъектовЭксплуатацииИзменениеБезОрганизации");
	СписокЗапросов.Добавить("УНИЧТОЖИТЬ НаработкиОбъектовЭксплуатацииПередЗаписью");
