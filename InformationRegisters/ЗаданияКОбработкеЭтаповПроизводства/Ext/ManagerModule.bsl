...
Процедура ДобавитьЗадание(ЭтапПроизводства, Действия) Экспорт
	...
	Если Действия.ОбновитьСостояние ИЛИ Действия.ЗаполнитьПоОперациям Тогда
		...
		Идентификаторы = ПроизводствоСервер.ДобавитьЗаданиеВОчередь("ЗаданияКОбработкеЭтаповПроизводства", Задание);
		
		Отбор = Новый Структура("ЭтапПроизводства", ЭтапПроизводства);
		ПроизводствоСервер.ЗапуститьЗаданиеОбработкиОчереди("ЗаданияКОбработкеЭтаповПроизводства", Отбор, Идентификаторы);
...
Процедура ЗапуститьЗадание() Экспорт
	...
	ПроизводствоСервер.ЗапуститьЗаданиеОбработкиОчереди("ЗаданияКОбработкеЭтаповПроизводства");
...
Функция ПараметрыОбработки() Экспорт
	...
	ПараметрыОбработки.Вставить("Обработчик", "Документы.ЭтапПроизводства2_2.ОбработатьДокументОтложенно");
...
Функция ОчередьЗаданий(Отбор = Неопределено) Экспорт
	...
	ЗаданияКОбработке = ПроизводствоСервер.ОчередьЗаданий("ЗаданияКОбработкеЭтаповПроизводства", Отбор);
...
Процедура ЗаписатьОшибку(Задание, ПропуститьЗадание, ИнформацияОбОшибке) Экспорт
	...
	ПроизводствоСервер.ЗаписатьОшибкуОбработкиОчередиЗаданий("ЗаданияКОбработкеЭтаповПроизводства", ТекстОшибки, Задание);
