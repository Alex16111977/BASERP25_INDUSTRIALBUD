...
Процедура ЗаписатьРасписание(Знач МодельРасписания, Знач МодельПланирования, ЗаписьВыполнена) Экспорт
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Запись пооперационного расписания';uk='Запис поопераційного розкладу'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
Процедура ЗаблокироватьРасписаниеДляЗаписиПоКлючу(КлючОперации, НомерПартии, Отказ = Ложь) Экспорт
	...
	Исключение
		...
		ТекстСообщения = НСтр("ru='Не удалось заблокировать пооперационное расписание: %Причина%';uk='Не вдалося заблокувати поопераційний розклад: %Причина%'");
...
Процедура СообщитьПользователюОбОшибкеРасчета(Отказ)
	...
	ТекстСообщения = НСтр("ru='Не удалось рассчитать выполнение производственных операций.';uk='Не вдалося розрахувати виконання виробничих операцій.'");
