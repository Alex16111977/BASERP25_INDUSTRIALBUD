...
Процедура ОписаниеОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru='Очистка статусов проверки у документов ""ПрочееОприходованиеТоваров"" с хозяйственной операцией ""ВозвратИзЭксплуатации"".';uk='Очищення статусів перевірки у документів ""Інше оприбуткування товарів"" з господарською операцією ""Повернення з експлуатації"".'");
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Пока ДанныеКОбработке.Следующий() Цикл
		...
		Исключение
			ОтменитьТранзакцию();
			ТекстСообщения = НСтр("ru='Не удалось очистить статус проверки для документа возврат ТМЦ из эксплуатации по причине: %Причина%';uk='Не вдалося очистити статус перевірки для документа повернення ТМЦ з експлуатації по причині: %Причина%'");
