...
Функция Рассчитать(Спецификация) Экспорт
	...
	Исключение
		...
		ТекстСообщения = СтрШаблон(НСтр("ru='Не удалось рассчитать длительность этапов производства по спецификации: %1 по причине: %2';uk='Не вдалося розрахувати тривалість етапів провадження у специфікації: %1 з причини: %2'"),
							Спецификация,
...
Процедура ОписаниеОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru='Заполняет служебный регистр ""Нормативная длительность этапов производства""';uk='Заповнює службовий регістр ""Нормативна тривалість етапів виробництва""'");
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			ТекстСообщения = НСтр("ru='Не удалось рассчитать нормативную длительность этапов производства спецификации: %Ссылка% по причине: %Причина%';uk='Не вдалося розрахувати нормативну тривалість етапів виробництва специфікації: %Ссылка% по причині: %Причина%'");
