...
Процедура УстановитьПараметрыОтчета()
	...
	////НайденныйПараметр.Значение = ДатаНачала;
	//ДатаКонец = КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("ДатаКонец"));
	////НайденныйПараметр.Использование = Истина;
	//НайденныйПараметр.Значение = ДатаКонец;
...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	//Рассчет времени выполнения формирования отчета
	Попытка
	...
	Если НЕ ЗначениеПараметра = Неопределено Тогда
		...
		//ЗначениеПараметра2 = КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("НачалоПредПериода"));
		//ЗначениеПараметра2.Использование = Истина;
		//ЗначениеПараметра2.Значение = ДобавитьМесяц(ДатаНачала, -12);
	...
	//	
	//	//ЗначениеПараметра2 = КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("КонецПредПериода"));
	//	//ЗначениеПараметра2.Использование = Истина;
	//	//ЗначениеПараметра2.Значение = НачалоДня(ДобавитьМесяц(ДатаКонец, -12));
	...
	//Вывод времени затраченного на формирование
	//Попытка
	//ТочкаФиниш=Скрипт.eval("new Date().getTime()");
	//ЭтотОбъект.ПолучитьФорму("ФормаОтчета").ЭлементыФормы.НадписьВремяФормирования.Заголовок=" Время формирования отчета: "+ПолучитьПредставлениеВремени(ТочкаФиниш-ТочкаСтарт)+" мс"; 
	//Исключение
	//ЭтотОбъект.ПолучитьФорму("ФормаОтчета").ЭлементыФормы.НадписьВремяФормирования.Заголовок=" Время формирования отчета: Ошибка :( ";
	//КонецПопытки;
КонецПроцедуры
