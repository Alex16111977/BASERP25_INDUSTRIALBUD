...
Функция СписокПлановОбменаБСП() Экспорт
	...
	//++ Бахтишаев А.Э. , 25/05/16 01:15, глюки платформы. Произвольно меняет тип значения.
	СписокПлановОбмена.ТипЗначения = Новый ОписаниеТипов("Строка");
	//-- Бахтишаев А.Э. , 25/05/16 01:15
