...
Процедура ДополнитьПолучателей(Объект, Узлы) Экспорт
	...
	Для Каждого Элемент Из Узлы Цикл
		...
		Исключение
			...
			//++ Бахтишаев А.Э. , 03/06/16 04:06,только запись в журнале, без исключения.
			//ВызватьИсключение СтрокаСообщения;
			//ЗаписьЖурналаРегистрации("Обмен данными.Правила регистрации объектов", УровеньЖурналаРегистрации.Ошибка, ОбъектМетаданных, , СтрокаСообщения);
			//-- Бахтишаев А.Э. , 03/06/16 04:07
		КонецПопытки;
