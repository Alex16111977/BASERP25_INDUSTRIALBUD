...
Процедура ПолучитьПланыОбмена(ПланыОбменаПодсистемы) Экспорт
	...
	ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.КазначействоПродажиНедвижимости);

	ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.КазначействоБухгалтерияУкраины); 
	
	ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.КазначействоBASБухгалтерияУкраины);//Тютюн 26.10.22; 05.09.2026: был дубль КазначействоБухгалтерияУкраины, из-за него обновление ИБ стирало правила этого плана

	ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.КазначействоУправлениеТорговлейДляУкраины);
	
	ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.ОбменСМобильнымиУстройствами);
	
	//***
	ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.КазначействоBASERP);
	//***
КонецПроцедуры
