...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокУзловОбмена = ОбменДаннымиПовтИсп.СписокПлановОбменаБСП();
	Для Каждого Элемент Из СписокУзловОбмена Цикл
		Элемент.Значение = Тип("ПланОбменаСсылка." + Элемент.Значение);
	КонецЦикла;
