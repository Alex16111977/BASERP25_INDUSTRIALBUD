...
Процедура ПередЗаписью(Отказ, РежимЗаписи)
	...
	Текст = НСтр("ru = 'Установлена дата запрета формирования проводок по международному учету.
						...
						|en = 'Closing date of international accounting posting generation is set.
						|It is prohibited to change international accounting postings for the document.'");
	...
	Если ТипЗнч(Регистратор) = Тип("ДокументСсылка.ОперацияМеждународный") Тогда
		...
		Если ФормироватьКорректировочныеПроводки И НЕ ВводитьПериодПоСтрокам Тогда
			Текст = Текст + Символы.ПС + Символы.ПС
				...
				|en = 'You can correct the ""Transaction (international accounting)"" document postings in the closed period of international accounting
