...
Функция СоставРеквизитовОбъектаЭксплуатации() Экспорт
	...
	//<{УСО 2.4}:{Управление строительным предприятием}{Горский М.Е.}
	СтопЛист.Вставить("УСОERP_ПризнакОбъектаСтроительства");
	СтопЛист.Вставить("УСОERP_СпособСтроительства");
	СтопЛист.Вставить("УСОERP_ДолевоеСтроительство");
	//<{УСО 2.4}:{Управление строительным предприятием}{Горский М.Е.}
