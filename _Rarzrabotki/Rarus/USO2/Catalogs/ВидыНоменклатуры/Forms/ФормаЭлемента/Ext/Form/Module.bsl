...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	ТекстСообщенияНеЗаполненаПолитика = НСтр("ru = 'Не заполнена колонка ""Политика учета серий"" для склада ""%1"" списка ""Политики учета серий"".';
											|en = 'The ""Series accounting policy"" column for the ""%1"" warehouse of the ""Series accounting policies"" is not filled in.'");
	ТекстСообщенияНеЗаполненСклад = НСтр("ru = 'Не заполнена колонка ""Склад"" в списке ""Политики учета серий"".';
										|en = 'The Warehouse column is not filled in the ""Series accounting policies"" list.'");
	...
	Если Объект.ПолитикиУчетаСерий.Количество() > 0
		...
		Если ВТЧУказываютсяСкладыИПодразделения Тогда 
			ТекстВопроса = Нстр("ru = 'Для всех складов и производственных подразделений будет установлена общая политика учета серий.';
								|en = 'Common series accounting policy will be set for all warehouses and production departments.'");
		ИначеЕсли ИспользоватьНесколькоСкладов Тогда
			ТекстВопроса = Нстр("ru = 'Для всех складов будет установлена общая политика учета серий.';
								|en = 'Common series accounting policy will be set for all warehouses.'");
		Иначе
			ТекстВопроса = Нстр("ru = 'Для всех производственных подразделений будет установлена общая политика учета серий.';
								|en = 'Common series accounting policy will be set for all production departments.'");
		КонецЕсли;
...
Процедура ДобавитьДопРеквизитСведение(ТипЭлемента, ТипВладельцаНабораЭлементов, Вид = "")
	...
	Если Не ЗначениеЗаполнено(Объект.Ссылка) Тогда
		...
		|You can add additional properties only after the item is written.
		|Write the item?'");
...
Процедура ЗаписатьДопРеквизитыСведенияНабора(Отказ, ТекущийОбъект, ТипЭлемента, ТипВладельцаНабораЭлементов)
	...
	Исключение
		...
		ИмяСобытия = НСтр("ru = 'Дополнительные %1 %2. Не удалось обновить состав дополнительных %3 набора.';
							|en = 'Additional %1 %2. Cannot update the content of additional set %3.'");
		...
		КомментарийЖурнала  = НСтр("ru = 'При обновлении табличной части дополнительных реквизитов набора свойств ""%1"" произошла ошибка: ""%2""';
									|en = 'An error occurred when updating the tabular section of the additional attributes of property set ""%1"": ""%2"" '");
		...
		ВыражениеИсключения = НСтр("ru = 'При записи дополнительных %1 %2 произошла ошибка (см. журнал регистрации).';
									|en = 'An error occurred when writing additional %1 %2 (see event log).'");
...
Процедура ИзменениеВРедактореШаблона(ЗначащаяЧастьИмениШаблона)
	...
	Если Модифицированность Тогда
		...
		ТекстВопроса = НСтр("ru = 'Изменение шаблона наименования с помощью редактора формул 
		                          ...
		                          |editor only after writing the item, write the item?'");
...
Процедура ПостроитьДеревоОператоров()
	...
	РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, НСтр("ru = 'Строка';
																	|en = 'String'"), НСтр("ru = 'Строка()';
																							|en = 'String()'"));
	РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, НСтр("ru = 'ВРег';
																	|en = 'Upper'"), НСтр("ru = 'ВРег()';
																						|en = 'Upper()'"));
	РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, НСтр("ru = 'Лев';
																	|en = 'Left'"), НСтр("ru = 'Лев()';
																						|en = 'Left()'"));
	РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, НСтр("ru = 'НРег';
																	|en = 'Lower'"), НСтр("ru = 'НРег()';
																						|en = 'Lower()'"));
	РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, НСтр("ru = 'Прав';
																	|en = 'Rights'"), НСтр("ru = 'Прав()';
																						|en = 'Right()'"));
	РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, НСтр("ru = 'СокрЛ';
																	|en = 'TrimL'"), НСтр("ru = 'СокрЛ()';
																						|en = 'TrimL()'"));
	РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, НСтр("ru = 'СокрЛП';
																	|en = 'TrimAll'"), НСтр("ru = 'СокрЛП()';
																							|en = 'TrimAll()'"));
	РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, НСтр("ru = 'СокрП';
																	|en = 'TrimR'"), НСтр("ru = 'СокрП()';
																						|en = 'TrimR()'"));
	РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, НСтр("ru = 'ТРег';
																	|en = 'Title'"), НСтр("ru = 'ТРег()';
																						|en = 'Title()'"));
	РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, НСтр("ru = 'СтрЗаменить';
																	|en = 'StrReplace'"), НСтр("ru = 'СтрЗаменить(,,)';
																								|en = 'StrReplace(,,)'"));
	РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, НСтр("ru = 'СтрДлина';
	...
	РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, НСтр("ru = 'Условие';
																	|en = 'Condition'"), "?(,,)", 3);
	РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, НСтр("ru = 'Предопределенное значение';
																	|en = 'Predefined value'"), НСтр("ru = 'ПредопределенноеЗначение()';
																											|en = 'PredefinedValue()'"));
	РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, НСтр("ru = 'Значение заполнено';
																	|en = 'Value is filled in'"), НСтр("ru = 'ЗначениеЗаполнено()';
																										|en = 'ValueIsFilled()'"));
	РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, НСтр("ru = 'Формат';
...
Процедура НастроитьФорму()
	...
	ОписанияСправочныхСерий.Добавить(Новый ФорматированнаяСтрока(
									НСтр("ru = 'Для серий, идентифицирующих экземпляры товаров, возможно';
										|en = 'For series that identify instances of goods, it is possible'") + Символы.НПП,
									,
	...
	Если ИспользоватьПередачуНаХранение Тогда
		ОписанияОпераций.Добавить(НСтр("ru = '""Учет серий в переданных на хранение товарах""';
										|en = '""Series accounting in the deposited goods""'"));
	КонецЕсли;
	...
	Если ИспользоватьТоварыВПутиОтПоставщиков Тогда
		ОписанияОпераций.Добавить(НСтр("ru = '""Учет товаров в пути от поставщика по сериям""';
										|en = '""Series accounting of goods on the way from supplier""'"));
	КонецЕсли;
	...
	Если ИспользоватьНеотфактурованныеПоставки Тогда
		ОписанияОпераций.Добавить(НСтр("ru = '""Учет серий в неотфактурованных поставках товаров""';
										|en = '""Series accounting in uninvoiced goods deliveries""'"));
	КонецЕсли;
	...
	Если ВТЧУказываютсяСкладыИПодразделения Тогда
		...
		ПолитикаУчетаСерийПодсказка
			= НСтр("ru = 'Будет использована как общая политика для всех складов и производственных подразделений; будет устанавливаться по умолчанию для новых складов и производственных подразделений.';
					|en = 'It will be used as a general policy for all warehouses and production departments; it will be set by default for new warehouses and production departments.'");
	ИначеЕсли ИспользоватьНесколькоСкладов Тогда
		...
		ПолитикиУчетаСерийСкладПодсказка       = НСтр("ru = 'Склад, в котором ведется учет по сериям';
														|en = 'Warehouse where accounting is performed by series'");
		...
		ПолитикаУчетаСерийПодсказка
			= НСтр("ru = 'Будет использована как общая политика для всех складов; будет устанавливаться по умолчанию для новых складов.';
					|en = 'It will be used as a general policy for all warehouses; it will be set by default for new warehouses.'");
	Иначе
		...
		ПолитикиУчетаСерийСкладПодсказка       = НСтр("ru = 'Подразделение, в котором ведется учет по сериям';
														|en = 'Department where accounting is executed by series'");
		...
		ПолитикаУчетаСерийПодсказка
			= НСтр("ru = 'Будет использована как общая политика для всех производственных подразделений; будет устанавливаться по умолчанию для новых производственных подразделений.';
					|en = 'It will be used as a general policy for all production departments; it will be set by default for new production departments.'");
	КонецЕсли;
	...
	Если Элементы.НадписьНастройкаИспользованияСерий.Видимость Тогда
		...
		Если Объект.ИспользоватьСрокГодностиСерии Тогда
			...
			Если Объект.ТочностьУказанияСрокаГодностиСерии = Перечисления.ТочностиУказанияСрокаГодности.СТочностьюДоМесяцев Тогда
				МассивОписанияРеквизитов.Добавить(НСтр("ru = 'Срок годности с точностью до месяцев';
														|en = 'Shelf life with precision of months'"));
		...
		Если Объект.ИспользоватьЗаписьСкладскогоЖурналаВЕТИССерии Тогда
			МассивОписанияРеквизитов.Добавить(НСтр("ru = 'Запись складского журнала (ВетИС)';
													|en = 'Warehouse book record (VetIS)'"));
		КонецЕсли;
...
Процедура ТипНоменклатурыПриИзмененииСервер()
	...
	ОсобенностиУчета.Добавить("ТабачнаяПродукция");
...
Процедура УстановитьНастройкуИспользованияСерий()
	...
	Если Объект.ТабачнаяПродукция Тогда
	//	Объект.ИспользоватьСерии                  = Истина;
		Объект.ИспользоватьНомерСерии             = Ложь;
		Объект.ИспользоватьСрокГодностиСерии      = Ложь;
		Объект.ТочностьУказанияСрокаГодностиСерии = Неопределено;
...
Процедура ВключитьПроверкуЗаполненияДляРеквизитовНаСервере()
	...
	Если ПустаяСтрока(Объект.ШаблонНаименованияДляПечатиНоменклатуры)
		...
		ТекстПредупреждения = НСтр("ru = 'Настройки проверки заполнения реквизитов номенклатуры не изменены: не заданы ни шаблоны наименований номенклатуры, ни реквизиты, отображаемые в панели быстрого отбора.';
									|en = 'Settings of attribute population check for products are not changed: product name templates and attributes displayed in the quick filter bar are not set.'");
	...
	Если Объект.ИспользоватьХарактеристики Тогда
		Если ПустаяСтрока(Объект.ШаблонНаименованияДляПечатиХарактеристики)
			...
			ТекстПредупреждения = НСтр("ru = 'Настройки проверки заполнения реквизитов характеристик не изменены: не заданы ни шаблоны наименований характеристик, ни реквизиты, отображаемые в панели быстрого отбора.';
										|en = 'Settings of attribute population check for characteristics are not changed: characteristic name templates and attributes displayed in the quick filter bar are not set.'");
	...
	Если Объект.ИспользоватьСерии Тогда
		Если ПустаяСтрока(Объект.ШаблонРабочегоНаименованияСерии) Тогда
			ТекстПредупреждения = НСтр("ru = 'Настройки проверки заполнения серий не изменены: не задан шаблон наименования серий.';
										|en = 'Settings of series population check are not changed: series name template is not set.'");
...
Процедура ЗаписатьПередИзменениемПанелиБыстрогоОтбораНоменклатуры()
	...
	ТекстВопроса = НСтр("ru = 'Редактирование состава панели быстрого отбора
		|возможно только после записи элемента, записать элемент?';
		|en = 'You can edit quick filter bar items only
		|after the item is written. Write the item?'");
...
Процедура ИзменитьПанельБыстрогоОтбораХарактеристики()
	...
	Если КоличествоДоступных = 0 Тогда
		...
		|en = 'Cannot edit items of the characteristic quick filter bar.
		|Additional characteristic attributes were not specified.
		|Before editing quick filter bar items, customize the set
		|of additional characteristic attributes.'");
		...
		Если Особенности.ЭтотВидСамЯвляетсяВладельцем Тогда
			...
			Если ЗначащаяЧастьИмениНадписи <> "Серий" Тогда
				МассивСтрок.Добавить(Новый ФорматированнаяСтрока(НСтр("ru = 'Список';
																		|en = 'List'"),,,,"ОткрытьСписок"+ЗначащаяЧастьИмениНадписи));
		...
		Иначе
			...
			Если Не ЗначениеЗаполнено(ВидВладелец) Тогда
				...
				МассивСтрок.Добавить(Новый ФорматированнаяСтрока(НСтр("ru = 'Выбрать';
																		|en = 'Select'"),,,,"ИзменитьВладельца"+ЗначащаяЧастьИмениНадписи));
			Иначе	
				...
				Если Особенности.МожноРедактироватьВладельца Тогда
					...
					МассивСтрок.Добавить(Новый ФорматированнаяСтрока(НСтр("ru = 'изменить';
																			|en = 'change'"),,,,"ИзменитьВладельца"+ЗначащаяЧастьИмениНадписи));
					МассивСтрок.Добавить(")");
				КонецЕсли;	
...
Процедура ОбработкаНавигационнойСсылкиНадписиПоВидуВладельцу(НавигационнаяСсылка, ЗначащаяЧастьИмениНадписи, СтандартнаяОбработка);
	...
	ИначеЕсли НавигационнаяСсылкаПриведенная = "ОткрытьСписок" Тогда
		Если Не ЗначениеЗаполнено(Объект.Ссылка) Тогда
			...
			|You can go to the list only after the data is written.'");
		...
		Попытка
			...
			Если ТекущийНаборОбъект.ВерсияДанных <> ВерсияДанныхТекущегоНабора Тогда
				Если ЭтоНаборыДополнительныхСведений Тогда
					...
					|en = 'The action is not executed as additional information 
					|was changed by another user.
					|New additional information is read.
					|
					|Repeat the action if it is required.'");
				Иначе
					ВызватьИсключение
					...
					|
					|Повторите действие, если требуется.';
					|en = 'The action is not executed as additional attributes 
...
Процедура НастройкаИспользованияСерийПриИзменении(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат.НастройкаИспользованияСерий = ПредопределенноеЗначение("Перечисление.НастройкиИспользованияСерийНоменклатуры.ЭкземплярТовара")
		...
		Если Объект.ПродукцияМаркируемаяДляГИСМ Тогда
			...
			|en = 'You can set only a corresponding type of series accounting policy for products marked for SPMS.
			|Policies of other types will be cleared. Continue?'");
		Иначе
			...
			|en = 'For the series used for goods instances accounting only series accounting policies of type ""%СправочноеУказаниеСерий%"" can be assigned in warehouses. Policies of other types will be cleared.
			|Continue?'");
	...
	ИначеЕсли Не Результат.ИспользоватьСрокГодностиСерии
		...
		|en = 'Setting of operations with series does not involve the indication of shelf lives in the series. 
		|Lines with indication of series accounting policies of policy types ""%СерииПоFEFO%"" and ""%СрокиГодностиПоПоступлению%"" 
		|will be deleted from the list of series accounting settings. Continue?'");
