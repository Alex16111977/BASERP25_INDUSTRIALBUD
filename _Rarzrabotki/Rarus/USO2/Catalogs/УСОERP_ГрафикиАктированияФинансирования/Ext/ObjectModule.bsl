...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ВидГрафика = Перечисления.УСОERP_ВидыГрафиковАктированияФинансирования.ГрафикФинансирования Тогда
		...
		Для Каждого ЭтапОплаты Из Этапы Цикл
			...
			Если Не ЗначениеЗаполнено(ЭтапОплаты.ПроцентПлатежа) И Не ЗначениеЗаполнено(ЭтапОплаты.ПроцентЗалогаЗаТару) Тогда
				...
				ТекстОшибки = НСтр("ru='В строке для этапа должен быть указан процент платежа'");
		...
		КонецЦикла;
	Иначе
		Если Не ЗначениеЗаполнено(ВариантАктирования) Тогда
			 ТекстОшибки = НСтр("ru='Вариант актирования должен быть заполнен'");
