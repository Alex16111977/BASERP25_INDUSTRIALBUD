...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	ИначеЕсли ВариантОбластиДействия = НСтр("ru = 'список товаров';
											|en = 'goods list'") Тогда
...
Процедура ВариантОбластиДействияПриИзменении(Элемент)
	...
	Если ТекущаяОбластьДействия.ВариантОбластиДействия = НСтр("ru = 'список товаров';
																|en = 'goods list'") Тогда
...
Процедура ПросмотретьИзображение()
	...
	Если ЗначениеЗаполнено(Объект.Ссылка) Тогда
		...
		Если ЗначениеЗаполнено(ПрисоединенныйФайл) Тогда
			...
			УникальныйИдентификатор));
		Иначе
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Отсутствует изображение для просмотра';
																	|en = 'No preview image'"),, "АдресКартинки");
		КонецЕсли;
...
Процедура УстановитьТекущуюОбластьДействия()
	...
	Если ВариантОбластиДействия = НСтр("ru = 'конкретный товар';
										|en = 'specific goods'")
		Или ВариантОбластиДействия = НСтр("ru = 'вид номенклатуры';
											|en = 'product kind'") Тогда
