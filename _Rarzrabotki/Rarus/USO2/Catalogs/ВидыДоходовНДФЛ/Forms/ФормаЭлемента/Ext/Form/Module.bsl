...
Процедура ЗаписатьНаКлиенте(ЗакрытьПослеЗаписи, ОповещениеЗавершения = Неопределено) Экспорт 
	...
	ТекстВопроса = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		...
		|en = 'When editing, you have changed information about correspondence between income kind and labor compensation. 
		|If you have changed previous information about labor compensation correspondence (it was incorrect), click ""%1"".'"), 
		ТекстКнопкиДа);
