		...
		Если Выборка.Количество() > 1 Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
				НСтр("ru = 'В составе набора присутствуют позиции номенклатуры с разными ставками НДС.
				           ...
				           |en = 'Product items with different VAT rates are in the set.
				           |You can display only components for such sets in print forms.'"),,
...
Процедура ПриКопировании(ОбъектКопирования)
	...
	Если ТипНоменклатуры = Перечисления.ТипыНоменклатуры.Набор Тогда
		ВызватьИсключение НСтр("ru = 'Копирование состава набора не требуется';
								|en = 'Set content copying is not required'");
	КонецЕсли;
