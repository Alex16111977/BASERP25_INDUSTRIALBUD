...
Процедура СформироватьНаименованиеСервер()
	...
	СпрОб.ЗначенияПолейАдреса = Новый ХранилищеЗначения(ЗначенияПолей, Новый СжатиеДанных(9));
	
	Объект.Наименование = уатНастройкиШаблонов.СформироватьНаименованиеПоШаблону("Справочник_уатПунктыНазначения", СпрОб);
