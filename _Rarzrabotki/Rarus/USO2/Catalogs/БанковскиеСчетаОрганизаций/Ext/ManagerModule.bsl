...
Процедура ЗаполнитьРегистрТребующихНастройкиНаОснованииАнализаНеотраженныхОпераций(ПараметрыАнализатора) Экспорт
	...
	ИмяСобытия = НСтр("ru = 'Анализ отражения безналичных денежных средств, требующих настройки';
						|en = 'Analysis of recording non-cash which require setting'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
