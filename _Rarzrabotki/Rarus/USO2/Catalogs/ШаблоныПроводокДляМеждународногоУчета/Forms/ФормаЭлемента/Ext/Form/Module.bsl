...
Процедура ПроверитьИспользованиеВПравилахОтраженияВМеждународномУчете()
	...
	Если Выборка.Следующий() Тогда
		СостояниеИспользованияВУчетнойПолитике = СтрШаблон(" "+НСтр("ru = 'Используется';
																	|en = 'Used'")+" (%1)", Выборка.УчетнаяПолитика);
