...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// При вставке дополнительных реквизитов в подгруппу страницы данные не отображаются.
...
Процедура ПриОткрытии(Отказ)
	...
	Если ЗначениеЗаполнено(Объект.Владелец) Тогда
		...
		ТекстВопроса = НСтр(
			...
			|en = 'Facility ""%Объект%"" is not being edited.
			|To change the node content, unlock the object for changing.'");
