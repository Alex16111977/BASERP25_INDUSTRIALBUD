...
// Возвращает таблицу с кодами из классификатора.
//
...
//		* НаименованиеПолное - Строка - Подробное описание операции;
//		* ОперацияНеПодлежитНалогообложению - Булево - Истина, если операции соответствует ст. 149 НК РФ.
//
