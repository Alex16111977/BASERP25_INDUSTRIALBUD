...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	ИначеЕсли ЭтоЗагрузкаСканаНапрямуюИзОписи Тогда
		...
		Если НЕ ПрограммноеЗакрытие И ЗначениеЗаполнено(Объект.Ссылка) Тогда
			...
			Закрыть(МассивСвойствВыбранныхДокументов);
...
Процедура Пропустить(Команда)
	...
	|en = 'Пропустить подготовку текущего документа и перейти к следующему?
	|Изменения в текущем документе не сохранятся.'");
