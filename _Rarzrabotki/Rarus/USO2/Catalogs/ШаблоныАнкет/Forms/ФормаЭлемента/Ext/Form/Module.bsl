	...
	Если Модифицированность Тогда
		...
		ПоказатьВопрос(ОбработчикОповещенияОЗакрытии,
		               НСтр("ru = 'Шаблон анкеты был модифицирован. 
		                   ...
		                   |Записать?';
		                   |en = 'Questionnaire template was modified.  
		                   |To display all changes correctly, save the template. 
		                   |Save it? '"),
...
Процедура ДобавитьВопрос(ТекущиеДанные,ТипВопроса)
	...
	Если Родитель.ТипСтроки = "Корень" Тогда
		ПоказатьПредупреждение(,НСтр("ru = 'Вопросы нельзя добавлять в корень анкеты.';
									|en = 'Cannot add questions to the questionnaire root.'"),15,НСтр("ru = 'Ошибка добавления';
																								|en = 'Addition error'"));
		Возврат;
	КонецЕсли;
...
Процедура ВыборТипаДобавляемогоЭлементаПриЗавершении(ВыбранныйЭлемент, ДополнительныеПараметры) Экспорт
	...
	Если НЕ ВыбранныйЭлемент = Неопределено Тогда
		...
		Если ВыбранныйЭлемент.Значение = НСтр("ru = 'Раздел';
												|en = 'Section'") Тогда
			
			ДобавитьРаздел(Команды.ДобавитьРаздел);
			
		ИначеЕсли ВыбранныйЭлемент.Значение = НСтр("ru = 'Простой вопрос';
													|en = 'Simple question'") Тогда
			
			ДобавитьПростойВопрос(Команды.ДобавитьПростойВопрос)
			
		ИначеЕсли ВыбранныйЭлемент.Значение = НСтр("ru = 'Комплексный вопрос';
													|en = 'Complex question'") Тогда
			
			ДобавитьКомплексныйВопрос(Команды.ДобавитьПростойВопрос)
			
		ИначеЕсли ВыбранныйЭлемент.Значение = НСтр("ru = 'Условный вопрос';
													|en = 'Conditional question'") Тогда
			
			ДобавитьВопросСУсловием(Команды.ДобавитьВопросСУсловием)
			
		ИначеЕсли ВыбранныйЭлемент.Значение = НСтр("ru = 'Табличный вопрос';
													|en = 'Table question'") Тогда
