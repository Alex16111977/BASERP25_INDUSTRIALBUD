...
Функция ПолучитьРеквизитыОбъектаДокументооборота(ТипОбъектаДокументооборота, Параметры = Неопределено) Экспорт 
	...
	Если ТипОбъектаДокументооборота = "DMIncomingDocument" Тогда 
		...
		Если НастройкиТипа.documentTypeEnabled = Истина Тогда 
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "documentType", НСтр("ru = 'Вид документа';
																				|en = 'Document kind'"), "DMIncomingDocumentType", Истина);
		КонецЕсли;
			
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "correspondent", НСтр("ru = 'Отправитель';
																			|en = 'From'"), "DMCorrespondent", Истина);
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "externalNumber", НСтр("ru = '№ отправителя';
																				|en = 'Sender No.'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "externalDate", НСтр("ru = 'Дата отправителя';
																			|en = 'Sender date'"), "Дата");
		
		Если НастройкиТипа.organizationEnabled = Истина Тогда 
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "organization", НСтр("ru = 'Организация';
																				|en = 'Company'"), "DMOrganization", Истина);
		КонецЕсли;
		
		Если НастройкиВида = Неопределено Или НастройкиВида.sumEnabled = Истина Тогда 
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "sum", НСтр("ru = 'Сумма';
																		|en = 'Amount'"), "Число");
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "currency", НСтр("ru = 'Валюта';
																			|en = 'Currency'"), "DMCurrency");
		КонецЕсли;
		
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "title", НСтр("ru = 'Наименование';
																	|en = 'Name'"), "Строка", Истина);
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "summary", НСтр("ru = 'Содержание';
																		|en = 'Content'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "regNumber", НСтр("ru = 'Регистрационный номер';
																		|en = 'Registration number'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "regDate", НСтр("ru = 'Дата регистрации';
																		|en = 'Registration date'"), "Дата");
		
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "signer", НСтр("ru = 'Подписал';
																		|en = 'Signed by'"), "DMContactPerson");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "addressee", НСтр("ru = 'Адресат';
																		|en = 'Addressee'"), "DMUser");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "subdivision", НСтр("ru = 'Подразделение';
																			|en = 'Department'"), "DMSubdivision");
		
		Если НастройкиВида = Неопределено Или НастройкиВида.performanceDateEnabled = Истина Тогда 
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "performanceDate", НСтр("ru = 'Срок исполнения';
																					|en = 'Deadline'"), "Дата");
		КонецЕсли;
		
		Если НастройкиТипа.accessLevelEnabled  = Истина Тогда 
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "accessLevel", НСтр("ru = 'Гриф доступа';
																				|en = 'Access label '"), "DMAccessLevel", Истина);
		КонецЕсли;
		
		Если НастройкиТипа.activityMatterEnabled = Истина Тогда 
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "activityMatter", НСтр("ru = 'Вопрос деятельности';
		...
		Если ИнтеграцияС1СДокументооборотПовтИсп.ДоступенФункционалВерсииСервиса("1.3.2.3.CORP") Тогда
			Если НастройкиТипа.projectsEnabled = Истина Тогда
				ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "project", НСтр("ru = 'Проект';
																				|en = 'Project'"), "DMProject");
			КонецЕсли;
		КонецЕсли;
		
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "deliveryMethod",  НСтр("ru = 'Способ получения';
																				|en = 'Receipt method'"), "DMDeliveryMethod");
		
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "comment", НСтр("ru = 'Комментарий';
																		|en = 'Comment'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "responsible", НСтр("ru = 'Ответственный';
	...
	ИначеЕсли ТипОбъектаДокументооборота = "DMOutgoingDocument" Тогда 
		...
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "correspondent", НСтр("ru = 'Получатель';
																			|en = 'Beneficiary'"), "DMCorrespondent", Истина);
		
		Если НастройкиВида = Неопределено Или НастройкиВида.externalNumberEnabled = Истина Тогда 
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "externalNumber", НСтр("ru = '№ получателя';
																					|en = 'Recipient No.'"), "Строка");
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "externalDate", НСтр("ru = 'Дата получателя';
		...
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "title", НСтр("ru = 'Заголовок';
		...
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "sent", НСтр("ru = 'Отправлен';
																	|en = 'Sent'"), "Булево");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "sendDate", НСтр("ru = 'Дата отправки';
																		|en = 'Sending date'"), "Дата");
		
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "signer", НСтр("ru = 'Подписал';
																		|en = 'Signed by'"), "DMUser");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "author", НСтр("ru = 'Подготовил';
																		|en = 'Prepared'"), "DMUser");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "subdivision", НСтр("ru = 'Подразделение';
																			|en = 'Department'"), "DMSubdivision");
		...
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "deliveryMethod", НСтр("ru = 'Способ отправки';
	...
	ИначеЕсли ТипОбъектаДокументооборота = "DMInternalDocument" Тогда 
		...
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "folder", НСтр("ru = 'Папка';
		...
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "signer", НСтр("ru = 'Утвердил';
																		|en = 'Approved'"), "DMUser");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "author", НСтр("ru = 'Подготовил';
																		|en = 'Prepared'"), "DMUser");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "subdivision", НСтр("ru = 'Подразделение';
		...
		Если НастройкиВида = Неопределено Или НастройкиВида.correspondentEnabled = Истина Тогда 
			Если ИнтеграцияС1СДокументооборотПовтИсп.ИспользоватьТерминКорреспонденты() Тогда
				ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "correspondent", НСтр("ru = 'Корреспондент';
																					|en = 'Correspondent'"), "DMCorrespondent", Истина);
			Иначе
				ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "correspondent", НСтр("ru = 'Контрагент';
																					|en = 'Counterparty'"), "DMCorrespondent", Истина);
			КонецЕсли;
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "contactPerson", НСтр("ru = 'Контактное лицо';
																				|en = 'Contact person'"), "DMContactPerson");
		КонецЕсли;
		
		Если НастройкиВида = Неопределено Или НастройкиВида.durationEnabled = Истина Тогда 
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "beginDate", НСтр("ru = 'Дата начала действия';
																			|en = 'Effective date'"), "Дата");
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "endDate", НСтр("ru = 'Дата окончания действия';
																			|en = 'Expiration date'"), "Дата");
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "openEnded", НСтр("ru = 'Бессрочный';
																			|en = 'Indefinite'"), "Булево");
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "prolongationProcedure", НСтр("ru = 'Порядок продления';
	...
	ИначеЕсли ТипОбъектаДокументооборота = "DMCorrespondent" Тогда 
		...
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "name", НСтр("ru = 'Наименование';
																	|en = 'Name'"), "Строка", Истина);
		Если ИнтеграцияС1СДокументооборотПовтИсп.ИспользоватьТерминКорреспонденты() Тогда
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "legalPrivatePerson", НСтр("ru = 'Вид корреспондента';
																						|en = 'Correspondent kind'"), "DMLegalPrivatePerson", Истина);
		Иначе
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "legalPrivatePerson", НСтр("ru = 'Вид контрагента';
																						|en = 'Counterparty type'"), "DMLegalPrivatePerson", Истина);
		КонецЕсли;
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "inn", НСтр("ru = 'ИНН';
																	|en = 'TIN'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "kpp", НСтр("ru = 'КПП';
																	|en = 'CRTR'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "okpo", НСтр("ru = 'Код по ОКПО';
																	|en = 'RNCBO code'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "comment", НСтр("ru = 'Комментарий';
																		|en = 'Comment'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "fullName", НСтр("ru = 'Полное наименование';
																		|en = 'Full name'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "privatePerson", НСтр("ru = 'Физическое лицо';
																			|en = 'Individual'"), "DMPrivatePerson");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "responsible", НСтр("ru = 'Ответственный';
																			|en = 'Responsible person'"), "DMUser");
	...
	Если ТипОбъектаДокументооборота = "DMIncomingDocument"
		...
		Если НастройкиТипа.statusEnabled = Истина
			...
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "statusApproval", НСтр("ru = 'Состояние согласования';
																					|en = 'Approval state '"), "DMDocumentStatus");
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "statusConfirmation", НСтр("ru = 'Состояние утверждения';
																						|en = 'Confirmation state'"), "DMDocumentStatus");
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "statusConsideration", НСтр("ru = 'Состояние рассмотрения';
																						|en = 'Review state'"), "DMDocumentStatus");
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "statusPerformance", НСтр("ru = 'Состояние исполнения';
																					|en = 'Execution state'"), "DMDocumentStatus");
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "statusRegistration", НСтр("ru = 'Состояние регистрации';
