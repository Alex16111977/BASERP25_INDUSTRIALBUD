...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипВыражения = "ПравилоВыгрузки"
		...
		Инструкция = Инструкция + "<p>" + 
			...
			|en = 'Result of calculation of expression in 1C:Enterprise
			|script should be assigned to property <b>Result</b> variable <b>Parameters</b>'");
	...
	ИначеЕсли ТипВыражения = "УсловиеПрименимостиПриВыгрузке" Тогда
		...
		Инструкция = Инструкция + "<p>" + 
			...
			|en = 'Expression in 1C:Enterprise script determines
			|a rule applicability when creating the 1C:Document Management object based on
			|an object of this configuration. Calculation result must be assigned to the property
			|<b>Result</b>. <b>True</b> means rule applicability, <b>False</b> – inapplicability.
			|Expression is checked only for rules eligible  by values of key attributes.
			|</p><p>Default value: <b>True</b>.'") + "<p>";
	...
	ИначеЕсли ТипВыражения = "УсловиеПрименимостиПриЗагрузке" Тогда
		...
		Инструкция = Инструкция + "<p>" + 
			...
			|</p><p>Значение по умолчанию: <b>Истина</b>.';
			|en = 'Expression in 1C:Enterprise script determines
			|rule applicability when creating an object of this configuration based on
			|the 1C:Document Management object. Calculation result must be assigned to variable
			|<b>Result</b>. <b>True</b> means rule applicability, <b>False</b> – inapplicability.
			|The expression is checked only for rules eligible by values of key attributes.
			|</p><p>Default value: <b>True</b>.'") + "<p>";
		
	КонецЕсли;
	
	Инструкция = Инструкция + " " + НСтр("ru = 'К реквизитам объекта';
										|en = 'To object attributes'") + " ";
	...
	Инструкция = Инструкция + " " + 
		...
		|Реквизиты источника:';
		|en = 'you can access it using the <b>Источник</b> property of the <b>Параметры</b> variable.
		|Attribute source:'") 
		+ "</p><table>";
	...
	Для Каждого СтруктураРеквизита из СоставРеквизитов Цикл
		...
		Если ЭтоДопРеквизит
			...
			Инструкция = Инструкция + "<b>" + НСтр("ru = 'Дополнительные реквизиты:';
													|en = 'Additional attributes:'") + "</b>";
			Инструкция = Инструкция + "</tr></td>";
...
Процедура КомандаОчистить(Команда)
	...
	ТекстВопроса = НСтр("ru = 'Вы действительно хотите очистить введенное выражение?';
						|en = 'Are you sure you want to clear the entered expression?'");
