	...
	Если ЗначениеЗаполнено(Объект.ДокументРегистрацииНаименование)
		...
		Если НЕ Форма.ТолькоПросмотр Тогда
			СтрокаСТегами = НСтр("ru = '%1 №%2 от %3 <a href = ""#Изменить"">изменить</a>';
								|en = '%1 No.%2 dated %3 <a href = ""#Изменить"">изменить</a>'");
		Иначе
...
Процедура СохранитьЗначенияРеквизитовДоИзменения(Форма)
	...
	НовыеЗначенияРеквизитовДоИзменения.Вставить("Наименование", Форма.Объект.Наименование);
	НовыеЗначенияРеквизитовДоИзменения.Вставить("НаименованиеПолное", Форма.Объект.НаименованиеПолное);
