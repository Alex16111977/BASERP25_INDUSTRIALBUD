...
Процедура ЗаполнитьРеквизитыТСПоТипуТСЗавершение(РезультатВопроса, ДополнительныеПараметры) Экспорт
	...
	СтруктураРеквизитов.Вставить("Грузоподъемность",     "ГрузоподъемностьВТоннах");
	СтруктураРеквизитов.Вставить("ОбъемКузова",          "ВместимостьВКубическихМетрах");
	СтруктураРеквизитов.Вставить("ПолезныйРазмерДлина",  "уатПолезныйРазмерДлина");
	СтруктураРеквизитов.Вставить("ПолезныйРазмерВысота", "уатПолезныйРазмерВысота");
	СтруктураРеквизитов.Вставить("ПолезныйРазмерШирина", "уатПолезныйРазмерШирина");
