...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если ЕстьБазовыйКалендарь И Не ЗначениеЗаполнено(Объект.БазовыйКалендарь) Тогда
		ТекстСообщения = НСтр("ru = 'Федеральный календарь не заполнен.';
								|en = 'Federal calendar is not filled in.'");
	...
	Если Объект.Ссылка.Пустая() Тогда
		...
		ПоказатьВопрос(
			...
			НСтр("ru = 'Данные производственного календаря еще не записаны.
                  ...
                  |
                  |Записать?';
                  |en = 'Business calendar data is not recorded. 
                  |You can print only after data record.
                  |
                  |Record?'"),
...
Функция ПредставлениеПереноса(ДатаИсточник, ДатаПриемник, ВидДняИсточник, ВидДняПриемник)
	...
	ДниЖР.Вставить(НСтр("ru = 'среда';
						|en = 'Wednesday'"), НСтр("ru = 'среду';
												|en = 'Wednesday'"));
	ДниЖР.Вставить(НСтр("ru = 'пятница';
						|en = 'Friday'"), НСтр("ru = 'пятницу';
												|en = 'Friday'"));
	ДниЖР.Вставить(НСтр("ru = 'суббота';
						|en = 'Saturday'"), НСтр("ru = 'субботу';
												|en = 'Saturday'"));
	
	ДниСР = Новый Соответствие;
	ДниСР.Вставить(НСтр("ru = 'воскресенье';
						|en = 'Sunday'"), Истина);
