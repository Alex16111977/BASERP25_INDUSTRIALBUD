...
Функция ИмяСобытияВЖурналеРегистрации()
	...
	Возврат НСтр("ru = 'Правила заполнения форм статистики';
				|en = 'Statistics forms filling rules'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru = 'Обновление поставляемых данных статистики';
				|en = 'Updating supplied statistics data'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
