...
Функция ТекстЗапросаСравненияНаборовСтруктурныхЕдиниц(ИмяРегистра, ИмяРеквизита) Экспорт
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ЕСТЬNULL(ОсновнойНабор.Период, НЕОПРЕДЕЛЕНО) КАК Период,
	|	НаборПроверки.СтруктурнаяЕдиница КАК СтруктурнаяЕдиница,
	|	ЕСТЬNULL(ОсновнойНабор.ИмяРеквизита, НЕОПРЕДЕЛЕНО) КАК ИмяРеквизита
	|ПОМЕСТИТЬ ВТНовыеЗначенияРеквизитов
	|ИЗ
	...
	|ИЗ
	|	ВТНаборПроверки КАК НаборПроверки
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТНовыеЗначенияРеквизитов КАК НовыеЗначенияРеквизитов
	|		ПО НаборПроверки.Период = НовыеЗначенияРеквизитов.Период
	|			И НаборПроверки.ИмяРеквизита = НовыеЗначенияРеквизитов.ИмяРеквизита
	|ГДЕ
	|	НовыеЗначенияРеквизитов.СтруктурнаяЕдиница ЕСТЬ NULL
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	НовыеЗначенияРеквизитов.СтруктурнаяЕдиница
	|ИЗ
	|	ВТНовыеЗначенияРеквизитов КАК НовыеЗначенияРеквизитов
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТНаборПроверки КАК НаборПроверки
	|		ПО НовыеЗначенияРеквизитов.Период = НаборПроверки.Период
	|			И НовыеЗначенияРеквизитов.ИмяРеквизита = НаборПроверки.ИмяРеквизита
	|ГДЕ
	|	НаборПроверки.СтруктурнаяЕдиница ЕСТЬ NULL
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|		ПО НаборПроверки.СтруктурнаяЕдиница = НаборИзменений.СтруктурнаяЕдиница
	|ГДЕ
	|	НаборИзменений.СтруктурнаяЕдиница ЕСТЬ NULL
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ВсеСтруктурныеЕдиницы.СтруктурнаяЕдиница КАК СтруктурнаяЕдиница
	|ИЗ
