...
Процедура ПередЗакрытием(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(АдресЭлементаВХранилище) Тогда
		...
		Если Модифицированность И Не ЗакрытиеФормы = Истина Тогда
			...
			ПоказатьВопрос(ОписаниеОповещения, НСтр("ru = 'Все внесенные изменения будут потеряны. Закрыть форму?';
													|en = 'All changes you have made will be lost. Close the form?'"), РежимДиалогаВопрос.ДаНет);
			Отказ = Истина;
		КонецЕсли;
	КонецЕсли;
