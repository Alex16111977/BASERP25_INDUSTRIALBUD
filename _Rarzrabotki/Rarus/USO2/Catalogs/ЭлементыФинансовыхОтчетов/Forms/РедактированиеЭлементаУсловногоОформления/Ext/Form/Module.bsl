...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СоответствиеПараметров.Вставить(НСтр("ru = 'Цвет фона';
										|en = 'Background color'"),                ЦветФона);
	СоответствиеПараметров.Вставить(НСтр("ru = 'Цвет текста';
										|en = 'Text color'"),              ЦветТекста);
	СоответствиеПараметров.Вставить(НСтр("ru = 'Цвет границы';
										|en = 'Border color '"),             ЦветГраницы);
	СоответствиеПараметров.Вставить(НСтр("ru = 'Шрифт';
										|en = 'Font'"),                    Шрифт);
	СоответствиеПараметров.Вставить(НСтр("ru = 'Горизонтальное положение';
										|en = 'Horizontal position'"), СвойстваГоризонтальногоПоложения);
	СоответствиеПараметров.Вставить(НСтр("ru = 'Вертикальное положение';
										|en = 'Vertical position'"),   СвойстваВертикальногоПоложения);
	СоответствиеПараметров.Вставить(НСтр("ru = 'Ориентация текста';
										|en = 'Text orientation'"),        ОриентацияТекста);
	СоответствиеПараметров.Вставить(НСтр("ru = 'Формат';
										|en = 'Format'"),                   СвойстваФорматаСтроки);
