...
Процедура Подключаемый_РазрешитьРедактированиеРеквизитовОбъекта(Команда) 
	...
	Если ЗаблокированныеРеквизиты.Количество() > 0 Тогда
		...
		ТекстВопроса = НСтр("ru = 'Внимание!
			...
			|en = 'Warning!
			|If you change company, department or position occupation in the staff list, 
			|HR data compliance with the staff list and correctness of HR documents can be violated. 
			|
			|Orders refilling for this staff list item can be required.'");
