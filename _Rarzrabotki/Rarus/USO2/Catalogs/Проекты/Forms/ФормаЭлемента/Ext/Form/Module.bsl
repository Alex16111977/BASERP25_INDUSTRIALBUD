...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//<{УСО 2.0}[:{УИД}] {1С-Рарус, Rodant}
	НовыйЭлемент = Элементы.Вставить("ПортфельПроектов",Тип("ПолеФормы"),Этаформа,ЭтаФорма.Элементы.ГруппаСтраницы);
	НовыйЭлемент.ПутьКДанным = "Объект.УСОERP_ПортфельПроектов";
