...
Функция ПредставлениеАналитик(ИсточникЗаданнойИерархии) Экспорт
	...
	ПредставлениеОрганизации   = НСтр("ru = 'Организация';
										|en = 'Company'", КодОсновногоЯзыка);
	ПредставлениеПодразделения = НСтр("ru = 'Подразделение';
										|en = 'Department'", КодОсновногоЯзыка);
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Не удалось записать справочник: %1 по причине: %2';
					|en = 'Cannot record the %1 catalog due to: %2'", КодЯзыка),
				Выборка.Ссылка);
