...
Процедура ПроверитьВозможностьВводаНаОснованииПартнера(Партнер)
	...
	Если Не ПрочиеОтношения Тогда
		...
		|en = 'Other relations are not allowed with the ""%Партнер%"" partner. 
		|The ""input on the basis"" method is available only for partners with whom other relations are allowed.'");
