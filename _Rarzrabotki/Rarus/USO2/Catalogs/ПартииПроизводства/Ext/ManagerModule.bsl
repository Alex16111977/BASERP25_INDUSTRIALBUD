...
Функция ПолучитьПартиюПроизводства(ПоляПартии = Неопределено,
	...
	Исключение
		...
		ТекстСообщения = НСтр("ru = 'Не удалось создать партию производства с параметрами: %ПартияПроизводства% по причине: %Причина%';
								|en = 'Cannot create a production batch with parameters: %ПартияПроизводства% due to:%Причина%'");
		ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ПартияПроизводства%", НаименованиеПартии);
		ТекстСообщения = СтрЗаменить(ТекстСообщения, "%Причина%", ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Справочник.ПартииПроизводства.ПолучитьПартиюПроизводства';
										|en = 'Справочник.ПартииПроизводства.ПолучитьПартиюПроизводства'", КодОсновногоЯзыка),
...
Функция ТекстЗапросаНомераСтрокОсновныхИзделий() Экспорт
...
Функция ТекстЗапросаКорректныеПоляПартийПроизводства() Экспорт
