...
Функция СохранитьПараметрыПодписок(РасшифрованныйМаркер, ПараметрыУведомления)
	...
	Исключение
		...
		ВидОперации = НСтр("ru = 'Изменение свойств подписки ЭДО';
							|en = 'Change EDI subscription properties'");
