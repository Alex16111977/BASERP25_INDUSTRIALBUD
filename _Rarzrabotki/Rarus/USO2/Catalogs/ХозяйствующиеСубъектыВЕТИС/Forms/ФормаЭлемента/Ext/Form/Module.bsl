...
Процедура СоответствуетОрганизацииПриИзмененииСервер()
	...
	Если Объект.СоответствуетОрганизации Тогда
		...
		Если ИнтеграцияВЕТИС.ИспользуетсяПереработкаНаСтороне() Тогда
	...
	Элементы.ПредприятияТорговыйОбъект.Видимость = (СтороннийТорговыйОбъектЗначениеПоУмолчанию <> Неопределено);
