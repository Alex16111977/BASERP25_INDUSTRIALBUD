...
Процедура ПриКопировании(ОбъектКопирования)
	...
	Наименование = ?(ПустаяСтрока(Строка(Код)), НСтр("ru = 'Рабочее место';
													|en = 'Workplace'"), Строка(Код))
	             + ?(ПустаяСтрока(Строка(Код)), ": ", "/")
	             + ?(ПустаяСтрока(Строка(ТекущийПользователь)), НСтр("ru = 'Пользователь';
																	|en = 'User'"), Строка(ТекущийПользователь));
