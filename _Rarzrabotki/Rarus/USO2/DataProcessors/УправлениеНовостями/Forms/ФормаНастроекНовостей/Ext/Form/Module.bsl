					...
					РезультатШага = РезультатШага
						+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
							НСтр("ru = '%1Успешное получение файла новостей.
								...
								|%6';
								|en = '%1News file is received.
								|%1HTTP response code: %2
								|%1HTTP response title:
								|%3
		...
		ИначеЕсли ТипЗнч(ТекущаяИнформация.Значение) = ТипСтруктура Тогда // Новости
				...
				Иначе
					СписокПервыхНовостей = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru = 'В реквизите Новости ключ массива контекстных новостей Новостей неправильного типа: %1.';
							|en = 'Array key of the News context news has an incorrect type in the News attribute: %1.'"),
			...
			Иначе
				СписокПервыхНовостей = НСтр("ru = 'В реквизите Новости отсутствует ключ массива контекстных новостей Новостей.';
											|en = 'Array key of the News context news is missing in the News attribute.'");
			КонецЕсли;
			Результат = Результат
				+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'Имя формы: %1
