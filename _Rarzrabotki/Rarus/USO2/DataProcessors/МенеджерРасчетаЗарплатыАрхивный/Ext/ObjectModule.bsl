...
Процедура ДобавитьПлановыеНачисления(ОписаниеВТСотрудникиПериоды, Начисления)
	...
	Запрос.Текст = 
		...
		|				ИНАЧЕ &ПерерассчитыватьПособия
		|						ИЛИ НЕ СотрудникиПериоды.ПериодПерерасчета
		|			КОНЕЦ)
...
Процедура СоздатьВТПоказателиРасчетаНачисления(ОписаниеВТНачисления)
	...
	Запрос.УстановитьПараметр("КалендарныеДниМесяцаБезПраздников", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ПоказателиРасчетаЗарплаты.КалендарныеДниМесяцаБезПраздников"));
...
Процедура РассчитатьЗначенияПоказателейКалендарныеДниМесяцаБезУчетаПраздников(СтрокиПоИдентификатору, ТребованияНачислений)
	...
	КалендарныеДниМесяцаБезПраздников = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ПоказателиРасчетаЗарплаты.КалендарныеДниМесяцаБезПраздников");
...
Процедура ЗаполнитьОплаченнымВременемКоличествоДней(Строка)
	...
	ПоказателиДней.Добавить(ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ПоказателиРасчетаЗарплаты.КалендарныеДниМесяцаБезПраздников"));
	ПоказателиДней.Добавить(ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ПоказателиРасчетаЗарплаты.КоличествоДнейКомпенсации"));
	ПоказателиДней.Добавить(ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ПоказателиРасчетаЗарплаты.КоличествоДнейОтпуска"));
...
Процедура ЗаполнитьОплаченнымВременемНормуДнейЧасов(Строка)
	...
	Показатель = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ПоказателиРасчетаЗарплаты.НормаДнейЧасов");
