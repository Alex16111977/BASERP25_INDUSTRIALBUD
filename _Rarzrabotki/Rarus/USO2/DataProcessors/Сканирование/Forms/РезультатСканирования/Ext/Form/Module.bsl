...
Процедура Сохранить(Команда)
	...
	Результат.ТекстОшибки = НСтр("ru = 'Не удалось сохранить отсканированный файл.';
								|en = 'Cannot save the scanned file.'");
	ПринятьЗавершение(Результат, ПараметрыВыполнения);
КонецПроцедуры
...
Функция ТекстСообщенияОшибкиПреобразованияВPDF(ФайлРезультата)
	...
	ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Не найден файл ""%1"".
		           ...
		           |Make sure that the ImageMagick application is installed,
		           |and the correct path to the
		           |PDF conversion application is specified in the form of scan settings.'"),
		ФайлРезультата);
