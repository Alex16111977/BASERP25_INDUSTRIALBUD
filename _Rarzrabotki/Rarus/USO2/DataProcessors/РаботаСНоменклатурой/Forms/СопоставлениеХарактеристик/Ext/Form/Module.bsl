		...
		= СтроковыеФункцииКлиентСервер.ФорматированнаяСтрока(
			СтрШаблон(
				НСтр("ru = 'Сопоставьте характеристики номенклатуры <b>%1</b> с характеристиками 1С:Номенклатуры <a href = ""Ссылка"">%2</a>';
					|en = 'Map the <b>%1</b> product characteristics with the 1C:Products characteristics <a href = ""Link"">%2</a>'"), 
...
Процедура ЗаписатьСоответствие(Характеристика, ИдентификаторХарактеристики, ПредставлениеХарактеристики)
	...
	Если Отказ Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Не удалось выполнить привязку характеристики';
