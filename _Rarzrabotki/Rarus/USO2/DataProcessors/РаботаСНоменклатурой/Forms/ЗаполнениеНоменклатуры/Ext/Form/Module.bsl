	...
	Иначе
		...
		Если КатегорииОтличаются Тогда
			...
			МассивПодстрок.Добавить(НСтр("ru = 'Вид текущей номенклатуры сопоставлен с категорий, отличной от категории выбранной номенклатуры';
										|en = 'The current products kind is mapped with the category different from the selected products category'") + ". ");
			...
			= СтроковыеФункцииКлиентСервер.ФорматированнаяСтрока(
				СтрШаблон(
					НСтр("ru = 'Не обнаружен вид номенклатуры, сопоставленный с категорией <b>%1</b>';
						|en = 'Cannot find product kind mapped to category <b>%1</b>'"), НаименованиеКатегории));
			...
			= СтроковыеФункцииКлиентСервер.ФорматированнаяСтрока(
				СтрШаблон(
					НСтр("ru = 'Обнаружено несколько видов номенклатуры, сопоставленных с категорией <b>%1</b>. 
						...
						|If you want to use additional attributes and characteristics, select a product kind.'"), НаименованиеКатегории));	
