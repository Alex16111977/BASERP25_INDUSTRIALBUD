	...
	Для Каждого ТекущийРеквизит Из ДополнительныеРеквизиты Цикл
		...
		ИначеЕсли СтрСравнить(ТекущийРеквизит.Тип, "Число") = 0 Тогда
			...
			Если ЗначениеЗаполнено(ТекущийРеквизит.МинимальноеЗначение) Тогда 
				ПодсказкаВвода.Добавить(СтрШаблон(НСтр("ru = 'от %1';
														|en = 'from %1'"), Формат(ТекущийРеквизит.МинимальноеЗначение, "ЧН=0; ЧГ=3,0; ЧО=1")))
			КонецЕсли;
			Если ЗначениеЗаполнено(ТекущийРеквизит.МаксимальноеЗначение) Тогда
				ПодсказкаВвода.Добавить(СтрШаблон(НСтр("ru = 'до %1';
														|en = 'until %1'"), Формат(ТекущийРеквизит.МаксимальноеЗначение, "ЧН=0; ЧГ=3,0; ЧО=1")))
			КонецЕсли;
