...
Процедура ИнициализироватьРасчетБазыНачислений() 
	...
	Если ОписаниеНеобходмыхДанных.НеобходимоПолучатьФПДБазовыхЗаписей 
		...
		СоздатьВТБазовыеЗаписиПериоды(ОписаниеНеобходмыхДанных,
			ОписаниеРасчитываемогоНабораНачислений.ОписаниеТекущегоНабораРегистраНачисления,
			ОписаниеВТБазовыеЗаписиРезультат.ИмяВТРезультат, ИмяВТБазовыеЗаписиНачисленийПериоды);
		
		УдерживаеимыеТаблицыРасчетаНачислений.Добавить(ИмяВТБазовыеЗаписиНачисленийПериоды);
	Иначе
...
Процедура СоздатьВТФПДБазовыхЗаписей(ОписаниеНеобходмыхДанных, ОписаниеНабораТеукщегоРегистратора = Неопределено, ИмяВТБазовыеЗаписи = "ВТБазовыеЗаписи", ИмяВТРезультат = "ВТФПДБазовыхЗаписей")
	ОбщегоНазначенияКлиентСервер.Проверить(
		...
		НСтр("ru = 'Расчет базы начислений (удержаний) – не задано описание текущего набора регистра';
			|en = 'Calculation of accrual (deduction) base - description of the current register set is not specified'"));
