	...
	Для Каждого Выборка Из ВыборкаРодитель.Строки Цикл
		...
		Иначе
			...
			Иначе // Умудрились создать элемент с несколькими типами или вовсе без них
				...
				Если Строка.ПравоНастройка = ПланыВидовХарактеристик.уатПраваИНастройки.ВыдалДиспетчер 
					ИЛИ Строка.ПравоНастройка = ПланыВидовХарактеристик.уатПраваИНастройки.ПринялДиспетчер
					ИЛИ Строка.ПравоНастройка = ПланыВидовХарактеристик.уатПраваИНастройки.ОсновнойВрач
					ИЛИ Строка.ПравоНастройка = ПланыВидовХарактеристик.уатПраваИНастройки.ВыпустилМеханик
					ИЛИ Строка.ПравоНастройка = ПланыВидовХарактеристик.уатПраваИНастройки.ПринялМеханик Тогда
