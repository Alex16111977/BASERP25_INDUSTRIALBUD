...
Функция ТекстОтложите(Форма)
	...
	Иначе
		...
		Если ШтрихкодированиеИСКлиентСервер.ЭтоУпаковка(Форма.ТипУпаковкиНайденного) Тогда
...
Процедура СформироватьИнформациюОРезультатахПоиска()
	...
	ПредставлениеШтрихкода = ШтрихкодированиеИСКлиентСервер.ПредставлениеШтрихкода(ЗначениеШтрихкода);
	...
	Если ШтрихкодНайден Тогда
		...
		Иначе
			...
			Префикс = НСтр("ru = 'Алкогольная продукция со акцизной маркой';
							|en = 'Алкогольная продукция со акцизной маркой'");
		...
		Если ИнтеграцияИСКлиентСервер.ЭтоУпаковка(ТипУпаковкиГдеДолжноНаходиться) Тогда
			...
			Если ШтрихкодированиеИСКлиентСервер.ЭтоУпаковка(ТипУпаковкиГдеНашли) Тогда 
	...
	Иначе
		...
		ТекстШтрихкодНеНайден = Новый ФорматированнаяСтрока(НСтр("ru = 'Штрихкод';
																|en = 'Штрихкод'"), " """, СтрокаШтрихкод,
