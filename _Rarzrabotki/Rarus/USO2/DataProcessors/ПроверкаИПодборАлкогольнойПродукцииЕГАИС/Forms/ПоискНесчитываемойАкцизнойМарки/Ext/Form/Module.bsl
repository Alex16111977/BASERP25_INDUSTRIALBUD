...
Процедура НайденныеАкцизныеМаркиПриАктивизацииСтроки(Элемент)
	...
	ИначеЕсли ТекущаяСтрока<>Элементы.НайденныеАкцизныеМарки.ТекущиеДанные.ЗначениеШтрихкода Тогда
		ТекущаяСтрока = Элементы.НайденныеАкцизныеМарки.ТекущиеДанные.ЗначениеШтрихкода;
		Если СтрДлина(ТекущаяСтрока) = 150 Тогда
			Элементы.НайденныеАкцизныеМаркиЗначениеШтрихкода.Заголовок = НСтр("ru = 'Серия';
																				|en = 'Серия'");
		Иначе 
			Элементы.НайденныеАкцизныеМаркиЗначениеШтрихкода.Заголовок = НСтр("ru = 'Номер заявки';
																				|en = 'Номер заявки'");
		КонецЕсли;
	КонецЕсли;
