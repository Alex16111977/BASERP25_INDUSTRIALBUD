...
Процедура ОбновитьЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли Результат.Статус = "Ошибка" Тогда
		...
		Сообщение.Текст = НСтр("ru = 'Не удалось выполнить проверку. Информация для технической поддержки: ';
								|en = 'Не удалось выполнить проверку. Информация для технической поддержки: '")
...
&НаКлиенте
Процедура ПолеТабличногоДокументаКСПриАктивизацииОбласти(Элемент)
	...
	Если Элементы.Группа2.Видимость
		...
		ПодключитьОбработчикОжидания("Подключаемый_ОбновитьРасшифровкуПриАктивизацииОбласти", ИнтервалОжидания, Истина);
	КонецЕсли;
	
КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_ОбновитьРасшифровкуПриАктивизацииОбласти()
