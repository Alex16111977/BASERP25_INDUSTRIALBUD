...
Процедура ОбработатьВыборВСпискеКалендарей(СтандартнаяОбработка = Неопределено)
	...
	ПоказатьОповещениеПользователя(НСтр("ru = 'Календари добавлены.';
										|en = 'Calendars are added.'"), , , БиблиотекаКартинок.Информация32);
	Закрыть();
	...
	Если НайденныеСтроки.Количество() = 0 Тогда
		ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Календарь с кодом %1, указанный в качестве базового, отсутствует в списке поставляемых.';
				|en = 'Calendar with code %1 specified as a base calendar is missing in the list of supplied calendars.'"),
