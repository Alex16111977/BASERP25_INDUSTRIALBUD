...
Функция СформироватьНаименованиеПриложенияВСервисе()
	...
	Возврат СтрШаблон(НСтр("ru = '%1 (приложение в Интернете)';
							|en = '%1 (online application)'"), НаименованиеПриложения);
...
Функция ЗаголовокСистемы()
	...
	Возврат ?(ПустаяСтрока(Результат), НСтр("ru = 'Автономное рабочее место';
											|en = 'Offline workplace'"), Результат);
КонецФункции
