	...
	Если ПолучитьФункциональнуюОпцию("УправлениеПредприятием") Тогда
		...
		Элементы.ДекорацияОписаниеВерсииУчета.Заголовок =
			НСтр("ru = 'Новые возможности и изменения версии:
                  ...
                  |- Documents support recording in compliance and management accounting simultaneously or only in one of them
                  |- Asset accounting in international accounting is kept by management or compliance accounting data (separate documents are not used)
		...
		Элементы.ДекорацияЧтоДелаетПомощник.Заголовок = 
			НСтр("ru = 'Помощник создает и отражает в учете следующие документы:
	          ...
	          |- Enter start balance of assets and liabilities (if you use the ""Accounting of capital assets in international accounting"" and ""Record the accrued depreciation of compliance accounting in management accounting"" functional options).'");
	...
	Иначе	
		...
		Элементы.ДекорацияОписаниеВерсииУчета.Заголовок =
			НСтр("ru = 'Новые возможности и изменения версии:
                  ...
                  |en = 'New features and changes of the version:
                  |- Full accounting of capital assets in management accounting;
                  |- Documents can be recorded in compliance and management accounting simultaneously or only in one of them;
		...
		Элементы.ДекорацияЧтоДелаетПомощник.Заголовок = 
			НСтр("ru = 'Помощник создает и отражает в учете следующие документы:
	          ...
	          |- Parameter change (if there is a document in the month before the migration) 
	          |- Enter start balance of assets and liabilities (if you use the ""Record the accrued depreciation of compliance accounting in management accounting"" functional option.'");
