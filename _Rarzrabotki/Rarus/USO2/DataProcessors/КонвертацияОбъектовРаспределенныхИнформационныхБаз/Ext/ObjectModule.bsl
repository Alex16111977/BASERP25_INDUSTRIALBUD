			...
			Если ЗначениеЗаполнено(ДублиПредопределенных) Тогда
				ЗаписьЖурналаРегистрации(
					НСтр("ru = 'Предопределенные элементы.Найдены не уникальные записи.';
						|en = 'Predefined items.Non-unique entries found.'",
	...
	Если ЗаписатьВЖурнал Тогда
		Если КоличествоДублей = 1 Тогда
			Шаблон = НСтр("ru = '(загружаемая ссылка: %1, ссылка дубля: %2)';
							|en = '(imported reference: %1, duplicate reference: %2)'");
		Иначе
			Шаблон = НСтр("ru = '(загружаемая ссылка: %1, ссылки дублей: %2)';
							|en = '(imported reference: %1, duplicate references %2)'");
		КонецЕсли;
...
Функция ОшибкаОткрытияФайлаСообщенияОбмена()
	...
	Возврат НСтр("ru = 'Ошибка открытия файла сообщения обмена';
				|en = 'An error occurred when opening the exchange message file'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Функция ОшибкаНачалаЧтенияФайлаСообщенияОбмена()
	...
	Возврат НСтр("ru = 'Ошибка при начале чтения файла сообщения обмена';
				|en = 'An error occurred when starting reading the exchange message file'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Функция ОшибкаНачалаЗаписиФайлаСообщенияОбмена()
	...
	Возврат НСтр("ru = 'Ошибка при начале записи файла сообщения обмена';
				|en = 'An error occurred when starting writing the exchange message file'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Функция ОшибкаЧтенияФайлаСообщенияОбмена()
	...
	Возврат НСтр("ru = 'Ошибка чтения файла сообщения обмена';
				|en = 'An error occurred when reading an exchange message file'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Функция ОшибкаЗаписиФайлаСообщенияОбмена()
	...
	Возврат НСтр("ru = 'Ошибка записи данных в файл сообщения обмена';
				|en = 'An error occurred when writing data to the exchange message file'");
...
Функция ОшибкаВидаОбменаДанными()
	...
	Возврат НСтр("ru = 'Обмен не по правилам конвертации не поддерживается';
				|en = 'Exchange not according to conversion rules is not supported'", ОбщегоНазначения.КодОсновногоЯзыка());
