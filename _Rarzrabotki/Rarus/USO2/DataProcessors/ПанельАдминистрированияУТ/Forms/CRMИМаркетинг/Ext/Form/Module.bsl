...
Процедура НазваниеГеографическойСхемыДляОтчетовНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СписокВыбора.Добавить("ГеографическаяСхемаРоссияРегионыИСтолицы", НСтр("ru = 'Регионы России';
																			|en = 'Regions of Russia'"),, ГеоКартинка);
	СписокВыбора.Добавить("ГеографическаяСхемаРоссияРегионыИВсеГорода", НСтр("ru = 'Регионы России и города';
																			|en = 'Regions of Russia and cities'"),, ГеоКартинка);
	СписокВыбора.Добавить("ГеографическаяСхемаКартаМира", НСтр("ru = 'Карта мира';
																|en = 'World map'"),, ГеоКартинка);
	...
	Если ВыбранноеЗначение <> Неопределено Тогда
		...
		Если ВыбранноеЗначение.Значение = "Загрузить из файла..." Тогда
			...
			ВыборФайла.Фильтр = НСтр("ru = 'Географические схемы';
									|en = 'Geographic diagrams'") + " (*.geo)|*.geo";
