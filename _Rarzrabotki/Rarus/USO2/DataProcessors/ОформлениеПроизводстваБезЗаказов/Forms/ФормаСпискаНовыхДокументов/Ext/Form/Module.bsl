			...
			Попытка
				...
				Иначе
					ПредставлениеОшибки = НСтр("ru = 'Документ %1 недоступен для обработки. Обратитесь к администратору.';
												|en = 'Cannot process the %1 document. Contact your administrator.'");
					ПредставлениеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ПредставлениеОшибки, Строка(ТекСтрока));
					ЗаписьЖурналаРегистрации(НСтр("ru = 'Оформление производства без заказа.Проведение документов.';
													|en = 'Register production without order. Post documents.'", КодОсновногоЯзыка),
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			Иначе
				...
				ЗаписьЖурналаРегистрации(НСтр("ru = 'Оформление производства без заказа.Удаление документов.';
												|en = 'Register production without order. Remove documents.'", КодОсновногоЯзыка),
										УровеньЖурналаРегистрации.Ошибка,
										,
										Выборка.Ссылка,
										ПредставлениеОшибки);
		...
		Попытка
			...
			Иначе
				ПредставлениеОшибки = НСтр("ru = 'Документ %1 недоступен для обработки. Обратитесь к администратору.';
											|en = 'Cannot process the %1 document. Contact your administrator.'");
				ПредставлениеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ПредставлениеОшибки, Строка(ТекСтрока));
				ЗаписьЖурналаРегистрации(НСтр("ru = 'Оформление производства без заказа.Установка пометки на удаление.';
												|en = 'Register production without order. Select deletion mark.'", КодОсновногоЯзыка),
										УровеньЖурналаРегистрации.Ошибка,
										,
										ТекСтрока,
										ПредставлениеОшибки);
