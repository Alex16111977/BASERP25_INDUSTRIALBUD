	...
	Если Модифицированность
		...
		ПоказатьВопрос(
			...
			НСтр("ru = 'Данные были изменены. Сохранить изменения?';
				|en = 'Data has been changed. Save the changes?'"), РежимДиалогаВопрос.ДаНетОтмена);
...
Процедура ПостроитьДеревоОператоров()
	...
	ДобавитьОператор(Дерево, НСтр("ru = 'Максимум';
									|en = 'Maximum'"),    ГруппаОператоров, НСтр("ru = 'Макс(,)';
																				|en = 'Max(,)'"), 2);
	ДобавитьОператор(Дерево, НСтр("ru = 'Минимум';
									|en = 'Minimum'"),     ГруппаОператоров, НСтр("ru = 'Мин(,)';
																				|en = 'Min(,)'"),  2);
	...
	ДобавитьОператор(Дерево, НСтр("ru = 'Целая часть';
									|en = 'Integer part'"), ГруппаОператоров, НСтр("ru = 'Цел()';
																				|en = 'Int()'"),   1);
	...
	ДобавитьОператор(Дерево, НСтр("ru = 'Строка';
									|en = 'String'"),      ГруппаОператоров, НСтр("ru = 'Строка()';
																				|en = 'String()'"));
	...
	ДобавитьОператор(Дерево, НСтр("ru = 'Прав';
									|en = 'Rights'"),        ГруппаОператоров, НСтр("ru = 'Прав()';
																				|en = 'Right()'"));
	...
	ДобавитьОператор(Дерево, НСтр("ru = 'Значение заполнено';
									|en = 'Value is filled in'"),        ГруппаОператоров, НСтр("ru = 'ЗначениеЗаполнено()';
																							|en = 'ValueIsFilled()'"));
...
Функция ПроверитьФормулу(Формула)
	...
	Если ЗначениеЗаполнено(ТекстОшибки) Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстОшибки,, "Формула");
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(Формула) Тогда
		Если ПроверитьФормулу(Формула) Тогда
			ПоказатьОповещениеПользователя(НСтр("ru = 'В формуле ошибок не обнаружено';
												|en = 'Errors were not detected in the formula'"),,,БиблиотекаКартинок.Информация32);
		КонецЕсли;
	КонецЕсли;
