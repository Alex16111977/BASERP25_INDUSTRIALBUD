	...
	Для Каждого ОбъектМетаданных Из ВыгружаемыеТипы Цикл
		...
		Если ИсключаемыеТипы.Найти(ОбъектМетаданных) <> Неопределено Тогда
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'ВыгрузкаЗагрузкаДанных.ВыгрузкаОбъектаПропущена';
					|en = 'ВыгрузкаЗагрузкаДанных.ВыгрузкаОбъектаПропущена'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
				...
				СтрШаблон(НСтр("ru = 'Выгрузка данных объекта метаданных %1 пропущена, т.к. он включен в
                          ...
                          |en = 'Export of metadata object data %1 is skipped as it is included
                          |in the list of metadata objects excluded from data export and import '", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
