...
Процедура Отложить(Команда)
	...
	Если НапомнитьЧерез = "-1" Тогда
		...
		Текст = НСтр("ru = 'Вы всегда можете посмотреть и при необходимости продлить срок действия лицензии и сертификата по гиперссылке 
                      ...
                      |en = 'You can always view and, if necessary, extend validity period of the license and certificate by clicking the
                      |Settings of exchange with regulatory authorities hyperlink in the Settings section of the 1C Reporting form.'");
