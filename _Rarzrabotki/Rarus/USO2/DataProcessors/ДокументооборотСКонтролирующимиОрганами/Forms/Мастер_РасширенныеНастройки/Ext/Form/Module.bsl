...
Процедура СпроситьПроИзменениеТелефона()
	...
	ТекстВопроса = НСтр("ru = 'Вы изменили номер мобильного телефона для SMS-уведомлений о статусе отправки отчетов и входящих сообщениях.
                         ...
                         |en = 'You have changed the phone number for SMS notifications of send report status and incoming messages.
                         |Would you also like to change the phone number to receive passwords for sending reports?'");
