...
Функция ВывестиОтчет(
	...
	Для каждого ДанныеЭтапа Из ДанныеСравнения.СписокЭтапов Цикл
		...
		ВывестиГруппуСвойств(НСтр("ru = 'Разбираемые изделия';
									|en = 'Products being disassembled'"),
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьУправлениеПроизводством2_2") Тогда
		...
		Если Реквизиты.ВыпускПроизвольнымиПорциями Тогда
			ДобавитьРеквизит(НСтр("ru = 'Выпуск';
									|en = 'Release'"), НСтр("ru = 'произвольными порциями';
														|en = 'in custom portions'"), ТаблицаРеквизитов, ПолеЗначения);
		Иначе
			ДобавитьРеквизит(НСтр("ru = 'Выпуск';
									|en = 'Release'"), НСтр("ru = 'кратными партиями';
														|en = 'multiple batches'"), ТаблицаРеквизитов, ПолеЗначения);
		КонецЕсли;
		
		ДобавитьРеквизит(НСтр("ru = 'Оптимальная партия';
								|en = 'Optimal batch'"), Реквизиты.ОптимальнаяПартияВыпуска, ТаблицаРеквизитов, ПолеЗначения);
		ДобавитьРеквизит(НСтр("ru = 'Минимальная партия';
								|en = 'Minimum batch'"), Реквизиты.МинимальнаяПартияВыпуска, ТаблицаРеквизитов, ПолеЗначения);
...
Процедура ДобавитьСвойстваЭтапа(ДанныеЭтапа, ТаблицаСвойств, ПолеЗначения)
	...
	ДобавитьСвойство(НСтр("ru = 'Подразделение';
							|en = 'Department'"), ДанныеЭтапа.ПодразделениеПредставление, ТаблицаСвойств, ПолеЗначения);
	
//++ НЕ УТКА
	ДобавитьСвойство(НСтр("ru = 'Одновременно производимое количество единиц/партий изделий';
							|en = 'Quantity of product units/batches produced simultaneously'"), ДанныеЭтапа.ОдновременноПроизводимоеКоличествоЕдиницПартийИзделий, ТаблицаСвойств, ПолеЗначения);
	
	ДобавитьСвойство(НСтр("ru = 'Маршрутная карта';
							|en = 'Operations sheet'"), ДанныеЭтапа.МаршрутнаяКартаПредставление, ТаблицаСвойств, ПолеЗначения);
	
	ДобавитьСвойство(НСтр("ru = 'Планировать работу видов рабочих центров';
							|en = 'Plan operations of the work center kinds'"), ДанныеЭтапа.ПланироватьРаботуВидовРабочихЦентров, ТаблицаСвойств, ПолеЗначения);
//-- НЕ УТКА
