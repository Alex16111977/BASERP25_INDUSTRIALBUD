...
Процедура СформироватьОтчет()
	...
	Если ТабличныйДокумент.ВысотаТаблицы <= 2 Тогда
		...
		ОбластьОшибка.Параметры.ТекстОшибки = НСтр("ru = 'Вам недоступно для оформления ни одного документа. Возможно нет необходимых прав.';
													|en = 'You cannot create any documents. You may not have the required rights.'");
		...
		Если Описание.ИмяКоманды = "Изменить" Тогда
			...
			ИначеЕсли Результат.СостояниеДокумента = "ОснованиеНеСоответствуетАкту" Тогда
				...
				ТекстГиперссылки = НСтр("ru = 'Основание не соответствует акту';
										|en = 'Basis does not correspond to the certificate'");
			КонецЕсли;
...
Функция ТекстШапки(ТипДокумента, Описание , ХозяйственнаяОперация = Неопределено)
	...
	Если ТипДокумента = "КорректировкаРеализации" Тогда
		Если ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ИсправлениеОшибок Тогда
			ТекстШапки = НСтр("ru = 'Документ ""Корректировка реализации (исправление ошибок)""';
								|en = 'Document ""Sale adjustment (error correction)""'");
		ИначеЕсли ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.РеализацияПерепоставленногоТовара Тогда
			ТекстШапки = НСтр("ru = 'Документ ""Корректировка реализации (реализация перепоставленного товара)""';
								|en = 'Document ""Sale adjustment (overdelivered goods sales)""'");
	...
	ИначеЕсли ТипДокумента = "ИсправлениеРеализации" Тогда
		ТекстШапки = НСтр("ru = 'Отразить расхождения в документе ""Реализация товаров и услуг""';
							|en = 'Record discrepancies in document ""Sales of goods and services"" '");
	ИначеЕсли ТипДокумента = "ИсправлениеВозвратаТоваровПоставщику" Тогда
		ТекстШапки = НСтр("ru = 'Отразить расхождения в документе ""Возврат товаров поставщику""';
							|en = 'Record discrepancies in document ""Goods return to supplier"" '");
	//++ НЕ УТ
	ИначеЕсли ТипДокумента = "ОтгрузкаТоваровСХранения" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Отгрузка товаров с хранения"" для довозврата недовозращенного товара';
							|en = 'The ""Goods shipment from storage"" document for additional return of unreturned goods'");
	ИначеЕсли ТипДокумента = "ОтгрузкаТоваровСХраненияПоПриемке" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Отгрузка товаров с хранения"" для возврата перепоставленного товара';
							|en = 'The ""Goods shipment from storage"" document for return of overdelivered goods'");
	ИначеЕсли ТипДокумента = "ИсправлениеОтгрузкаТоваровСХранения" Тогда
		ТекстШапки = НСтр("ru = 'Отразить расхождения в документе ""Отгрузка товаров с хранения""';
							|en = 'Record discrepancies in the ""Goods shipment from storage"" document'");
	ИначеЕсли ТипДокумента = "ИсправлениеПередачи" Тогда
		ТекстШапки = НСтр("ru = 'Отразить расхождения в документе ""Передача товаров хранителю""';
							|en = 'Record discrepancies in the ""Goods transfer to the custodian"" document'");
	ИначеЕсли ТипДокумента = "ПередачаТоваровХранителю" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Передача товаров хранителю"" для передачи недопоставленного товара';
							|en = 'The ""Goods transfer to the custodian"" document for underdelivered goods transfer'");
	ИначеЕсли ТипДокумента = "ПриемкаТоваровНаХранениеДопоставкаПоПриемке" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Приемка товаров на хранение"" для поступления недопоставленного товара';
							|en = 'The ""Goods receiving for storage"" document for underdelivered goods receipt'");
	ИначеЕсли ТипДокумента = "ПриемкаТоваровНаХранение" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Приемка товаров на хранение"" для поступления перепоставленного товара';
							|en = 'The ""Goods receiving for storage"" document for overdelivered goods receipt'");
	ИначеЕсли ТипДокумента = "ИсправлениеВозвратаТоваровОтХранителя" Тогда
		ТекстШапки = НСтр("ru = 'Отразить расхождения в документе ""Поступление товаров от хранителя""';
							|en = 'Record discrepancies in the ""Goods receipt from the custodian"" document'");
	ИначеЕсли ТипДокумента = "ВозвратТоваровОтХранителяДовозврат" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Поступление товаров от хранителя"" по недовозвращенным товарам';
							|en = 'The ""Goods receipt from the custodian"" document for unreturned goods'");
	//-- НЕ УТ
	ИначеЕсли ТипДокумента = "ИсправлениеВозвратаТоваровОтКлиента" Тогда
		ТекстШапки = НСтр("ru = 'Отразить расхождения в документе ""Возврат товаров от клиента""';
							|en = 'Record discrepancies in document ""Return of goods from customer""'");
	...
	ИначеЕсли ТипДокумента = "ДокументВозврата" Тогда
		Если ИспользоватьЗаявкиНаВозврат Тогда
			ТекстШапки = НСтр("ru = 'Документ ""Заявка на возврат товаров от клиента"" по перепоставленным товарам к возврату';
								|en = 'Document ""Request for goods return from customer"" for overdelivered goods for return'");
		Иначе
			ТекстШапки = НСтр("ru = 'Документ ""Возврат товаров от клиента"" по перепоставленным товарам к возврату';
								|en = 'Document ""Return of goods from customer"" for overdelivered goods for return'");
		КонецЕсли;
	ИначеЕсли ТипДокумента = "ВозвратТоваровОтКлиентаДовозврат" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Возврат товаров от клиента"" по недовозвращенным товарам';
							|en = 'Document ""Return of goods from customer"" for unreturned goods'");
	...
	ИначеЕсли ТипДокумента = "ИсправлениеЗаявкаНаВозвратТоваров" Тогда
		ТекстШапки = НСтр("ru = 'Отменить строки документов ""Заявка на возврат товаров от клиента"" по недостачам при возврате';
							|en = 'Cancel lines of documents ""Request for goods return from customer"" by the shortages on return'");
	ИначеЕсли ТипДокумента = "РеализацияТоваровИУслуг" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Реализация товаров и услуг"" для реализации недопоставленного товара';
							|en = 'Document ""Sales of goods and services"" for sales of underdelivered goods'");
	ИначеЕсли ТипДокумента = "РеализацияТоваровИУслугПоВозвратуОтКлиента" Тогда 
		ТекстШапки = НСтр("ru = 'Документ ""Реализация товаров и услуг"" для реализации излишков возврата от клиента';
							|en = 'Document ""Sales of goods and services"" for sales of surplus of return from customer'");
	ИначеЕсли ТипДокумента = "ВозвратТоваровПоставщику" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Возврат товаров поставщику"" для довозврата недовозращенного товара';
							|en = 'Document ""Goods return to supplier"" for additional return of unreturned goods'");
	ИначеЕсли ТипДокумента = "ПриобретениеТоваровУслуг" Тогда 
		ТекстШапки = НСтр("ru = 'Документ ""Приобретение товаров и услуг"" для поступления перепоставленного товара';
							|en = 'The ""Purchase of goods and services"" document for overdelivered goods receipt'");
	ИначеЕсли ТипДокумента = "ПриобретениеТоваровУслугДопоставкаПоПоступлению" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Приобретение товаров и услуг"" для поступления недопоставленного товара';
							|en = 'The ""Purchase of goods and services"" document for underdelivered goods receipt'");
	...
	ИначеЕсли ТипДокумента = "ПеремещениеТоваровВозврат" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Перемещение товаров"" на возврат перепоставленного товара';
							|en = 'Document ""Goods transfer"" for overdelivered goods return'");
	ИначеЕсли ТипДокумента = "СписаниеНедостачТоваров" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Списание недостач товаров"" для списания непризнанных недостач';
							|en = 'The ""Write off goods shortages"" document to write off unrecognized shortage'");
	ИначеЕсли ТипДокумента = "СписаниеЗадолженности" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Списание задолженности"" для отражения задолженности сторонней компании';
							|en = 'Document ""Debt relief"" for recording a third party debt'");
	ИначеЕсли ТипДокумента = "ОприходованиеИзлишковТоваров" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Оприходование излишков товаров"" для оприходования излишков поставленных товаров';
							|en = 'Document ""Goods surplus recording as received for recording as received of delivered goods surplus'");
	ИначеЕсли ТипДокумента = "ИсправлениеПоступления" Тогда
		ТекстШапки = НСтр("ru = 'Отразить расхождения в документе ""Приобретение товаров и услуг""';
							|en = 'Record discrepancies in the ""Purchase of goods and services"" document'");
	ИначеЕсли ТипДокумента = "ИсправлениеПриемкиТоваровНаХранение" Тогда
		ТекстШапки = НСтр("ru = 'Отразить расхождения в документе ""Приемка товаров на хранение""';
							|en = 'Record discrepancies in the ""Goods receiving for storage"" document'");
	ИначеЕсли ТипДокумента = "ВозвратТоваровПоставщикуПоПоступлению" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Возврат товаров поставщику"" для возврата перепоставленного товара';
							|en = 'Document ""Goods return to supplier"" for return of overdelivered goods'");
	КонецЕсли;
...
Функция ТекстЛегенды(ТипДокумента, ХозяйственнаяОперация = Неопределено)
	...
	Если ТипДокумента = "КорректировкаРеализации" Тогда
		Если ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ИсправлениеОшибок Тогда
			Возврат НСтр("ru = 'Необходимо оформить документ ""Корректировка реализации (исправление ошибок)"" для отражения излишков и недостач. Документ является основанием для выставления исправленных первичных документов и исправительного счета-фактуры.';
						|en = 'Register document ""Sale adjustment (underdelivered goods return)"" for recording surplus and shortages. The document is a basis for issuing corrected source documents and a replacement tax invoice.'");
		ИначеЕсли ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.РеализацияПерепоставленногоТовара Тогда
			Возврат НСтр("ru = 'Необходимо оформить документ ""Корректировка реализации (реализация перепоставленного товара)"" для отражения в учете факта продажи излишне доставленных товаров. Документ является основанием для выставления первичных документов и счета-фактуры. Оформляется на строки акта приемки с вариантами отработки: ""Оформить"" и ""Оформить и вернуть"".';
						|en = 'Register document ""Sale adjustment (underdelivered goods return)"" for recording overdelivered goods sale in accounting. The document is a basis for issuing source documents and tax invoice. It is registered for receiving note lines with processing options: ""Register"" and ""Register and return"".'");
		ИначеЕсли ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВозвратНедопоставленногоТовара Тогда
			Возврат НСтр("ru = 'Необходимо зарегистрировать документ ""Корректировка реализации (возврат недопоставленного товара)"". Выполняется сторнирование в учете факта продажи товаров, которые были отражены при реализации, но не были доставлены. Документ регистрируется на основании первичных документов и счета-фактуры, полученных от клиента. Оформляется на строки акта о расхождениях с вариантами отработки: ""Оформить"" и ""Оформить и допоставить"".';
						|en = 'Register the ""Sale adjustment (underdelivered goods return)"" document. Reversal is carried out in accounting of sale of goods which were recorded on sale, but were not delivered. The document is registered on the basis of source documents and the tax invoice received from the customer. It is registered for discrepancy certificate lines with processing options: ""Register"" and ""Register and supply additionally"".'");
		КонецЕсли;
	ИначеЕсли ТипДокумента = "КорректировкаПриобретения" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Корректировка поступления"" для отражения излишков и недостач. Документ является основанием для регистрации исправленных первичных документов и исправительного счета-фактуры.';
					|en = 'Register document ""Receipt adjustment"" to record surplus and shortage. The document is a basis for registration of corrected source documents and a replacement tax invoice.  '");
	ИначеЕсли ТипДокумента = "ИсправлениеРеализации" Тогда
		Возврат НСтр("ru = 'Необходимо скорректировать документ ""Реализация товаров и услуг"", отразив в нем количество по факту. Следует выполнить для строк акта о расхождениях с вариантами отработки: ""Оформить и вернуть"", ""Оформить"", ""Оформить и допоставить"".';
					|en = 'Correct document ""Sales of goods and services"" by recording an actual quantity in it. Make the changes to discrepancy certificate lines with processing options: ""Register and return"", ""Register"", ""Register and supply additionally"".'");
	ИначеЕсли ТипДокумента = "ИсправлениеВозвратаТоваровПоставщику" Тогда
		Возврат НСтр("ru = 'Необходимо скорректировать документ ""Возврат товаров поставщику"", отразив в нем количество по факту. Следует выполнить для строк акта о расхождениях с вариантами отработки: ""Оформить и вернуть"", ""Оформить"", ""Оформить и допоставить"".';
					|en = 'Correct document ""Goods return to supplier"" recording an actual quantity in it. Execute for discrepancy certificate lines with processing options: ""Register and return"", ""Register"", ""Register and supply additionally"".'");
	ИначеЕсли ТипДокумента = "ИсправлениеВозвратаТоваровОтКлиента" Тогда
		Возврат НСтр("ru = 'Необходимо скорректировать документ ""Возврат товаров поставщику"", отразив в нем количество по факту. Следует выполнить для строк акта о расхождениях с вариантами отработки: ""Оформить и вернуть"", ""Оформить"", ""Оформить и допоставить"".';
					|en = 'Correct document ""Goods return to supplier"" recording an actual quantity in it. Execute for discrepancy certificate lines with processing options: ""Register and return"", ""Register"", ""Register and supply additionally"".'");
	ИначеЕсли ТипДокумента = "ИсправлениеПеремещенияТоваров" Тогда
		Возврат НСтр("ru = 'Необходимо скорректировать документ ""Перемещение товаров"", отразив в нем количество по факту. Следует выполнить для строк акта о расхождениях с вариантами отработки: ""Оформить и вернуть"", ""Оформить"", ""Оформить и допоставить"".';
					|en = 'Correct document ""Goods transfer"" by recording an actual quantity in it. Make the changes to the discrepancy certificate lines with tolling options: ""Register and return"", ""Register"", ""Register and supply additionally"".'");
	ИначеЕсли ТипДокумента = "ДокументВозврата" Тогда
		Если ИспользоватьЗаявкиНаВозврат Тогда
			Возврат НСтр("ru = 'Необходимо оформить документ ""Заявка на возврат товаров от клиента"" по излишкам, отмеченным к возврату клиентом. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и вернуть"".';
						|en = 'Register document ""Request for goods return from customer"" for surplus marked for return by the customer. It is registered in discrepancy certificate lines with processing option ""Register and return"".  '");
		Иначе
			Возврат НСтр("ru = 'Необходимо оформить документ ""Возврат товаров от клиента"" по излишкам, отмеченным к возврату клиентом. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и вернуть"".';
						|en = 'Register document ""Return of goods from customer"" for surplus marked for return by the customer. It is registered in discrepancy certificate lines with processing option ""Register and return"". '");
		КонецЕсли;
	ИначеЕсли ТипДокумента = "ВозвратТоваровОтКлиентаДовозврат" Тогда
			Возврат НСтр("ru = 'Необходимо оформить документ ""Возврат товаров от клиента"" по недостачам, отмеченным к довозврату клиентом. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и ожидать допоставку"".';
						|en = 'Register document ""Return of goods from customer"" by shortages selected by a customer for additional return. It is registered for discrepancy certificate lines with processing option ""Register and wait for subsequent delivery"".'");
	ИначеЕсли ТипДокумента = "ЗаказКлиента" Тогда
		Возврат НСтр("ru = 'Необходимо скорректировать документы ""Заказ клиента"", отменив строки с товарами, которые были отражены при реализации, но не были доставлены. Следует выполнить для строк акта о расхождениях с вариантом отработки ""Оформить"".';
					|en = 'Correct documents ""Sales order"" by canceling lines with goods which were recorded on sale, but were not delivered. Make the changes to discrepancy certificate lines with processing option ""Register"".'");
	ИначеЕсли ТипДокумента = "ЗаказПоставщику" Тогда
		Возврат НСтр("ru = 'Необходимо скорректировать документы ""Заказ поставщику"", отменив строки с товарами, которые были отражены при поступлении, но не были доставлены. Следует выполнить для строк акта о расхождениях с вариантом отработки ""Оформить"".';
					|en = 'Correct documents ""Purchase order"" by canceling lines with goods which were recorded on receipt, but were not delivered. Make these changes to the discrepancy certificate lines with processing option ""Register"".'");
	ИначеЕсли ТипДокумента = "ЗаказНаПеремещение" Тогда
		Возврат НСтр("ru = 'Необходимо скорректировать документы ""Заказ на перемещение"", отменив строки с товарами, которые были отражены при перемещении, но не были перемещены. Следует выполнить для строк акта о расхождениях с вариантом отработки ""Оформить"".';
					|en = 'Correct documents ""Transfer order"" canceling lines with goods which were recorded when moving, but were not transferred. Make the changes to discrepancy certificate lines with tolling option: ""Register"".'");
	ИначеЕсли ТипДокумента = "ИсправлениеЗаявкаНаВозвратТоваров" Тогда
		Возврат НСтр("ru = 'Необходимо скорректировать документы ""Заявка на возврат товаров от клиента"", отменив строки с товарами, по которым были выявлены недостачи при возврате. Следует выполнить для строк акта о расхождениях с вариантом отработки ""Оформить"".';
					|en = 'Correct the Request for goods return from the customer documents by canceling lines with goods for which shortages on return were detected. This is relevant to lines of discrepancy certificate with the Register processing option.'");
	ИначеЕсли ТипДокумента = "РеализацияТоваровИУслуг" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Реализация товаров и услуг"" по недостачам, отмеченным к допоставке клиенту. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и допоставить"".';
					|en = 'Register document ""Sales of goods and services"" for shortages marked for subsequent delivery to the customer. It is registered in discrepancy certificate lines with processing option ""Register and supply additionally"".'");
	ИначеЕсли ТипДокумента = "РеализацияТоваровИУслугПоВозвратуОтКлиента" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Реализация товаров и услуг"" по излишкам, отмеченным к возврату клиенту. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и вернуть"".';
					|en = 'Register document ""Sales of goods and services"" for surplus marked for return to the customer. It is registered in discrepancy certificate lines with processing option ""Register and return"".'");
	ИначеЕсли ТипДокумента = "ВозвратТоваровПоставщику" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Возврат товаров поставщику"" по недостачам, отмеченным к допоставке поставщику. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и допоставить"".';
					|en = 'Register document ""Goods return to supplier"" for shortages marked for additional delivery to the supplier. It is registered in discrepancy certificate lines with processing option ""Register and supply additionally"". '");
	ИначеЕсли ТипДокумента = "ПриобретениеТоваровУслуг" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Приобретение товаров и услуг"" по излишкам, отмеченным к возврату поставщиком. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и вернуть"".';
					|en = 'Register the ""Purchase of goods and services"" document for surplus marked for return by the supplier. It is registered for discrepancy certificate lines with the ""Register and return"" processing option.'");
	//++ НЕ УТ
	ИначеЕсли ТипДокумента = "ОтгрузкаТоваровСХранения" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Отгрузка товаров с хранения"" по недостачам, отмеченным к допоставке поставщику. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и допоставить"".';
					|en = 'Register the ""Goods shipment from storage"" document for shortages marked for additional delivery to the supplier. It is registered for discrepancy certificate lines with the ""Register and supply additionally"" processing option.'");
	ИначеЕсли ТипДокумента = "ИсправлениеОтгрузкаТоваровСХранения" Тогда
		Возврат НСтр("ru = 'Необходимо скорректировать документ ""Отгрузка товаров с хранения"", отразив в нем количество по факту. Следует выполнить для строк акта о расхождениях с вариантами отработки: ""Оформить и вернуть"", ""Оформить"", ""Оформить и допоставить"".';
					|en = 'Correct the ""Goods shipment from storage"" document by recording an actual quantity in it. Make the changes to discrepancy certificate lines with processing options: ""Register and return"", ""Register"", ""Register and supply additionally"".  '");
	ИначеЕсли ТипДокумента = "ОтгрузкаТоваровСХраненияПоПриемке" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Отгрузка товаров с хранения"" по перепоставленному товару, отмеченному к возврату поставщику. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и вернуть"".';
					|en = 'Register the ""Goods shipment from storage"" document for overdelivered goods marked for return to the supplier. It is registered for discrepancy certificate lines with the ""Register and return"" processing option.'");
	ИначеЕсли ТипДокумента = "ИсправлениеПередачи" Тогда
		Возврат НСтр("ru = 'Необходимо скорректировать документ ""Передача товаров хранителю"", отразив в нем количество по факту. Следует выполнить для строк акта о расхождениях с вариантами отработки: ""Оформить и вернуть"", ""Оформить"", ""Оформить и допоставить"".';
					|en = 'Correct the ""Goods transfer to the custodian"" document by recording an actual quantity in it. Make these changes to the discrepancy certificate lines with the ""Register and return"", the ""Register"", the ""Register and deliver"" processing options.'");
	ИначеЕсли ТипДокумента = "ПередачаТоваровХранителю" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Передача товаров хранителю"" по недостачам, отмеченным к допоставке клиенту. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и допоставить"".';
					|en = 'Register the ""Goods transfer to the custodian"" document by shortages marked for additional delivery to the client. It is registered in discrepancy certificate lines with the ""Register and supply additionally"" processing option.'");
	ИначеЕсли ТипДокумента = "ПриемкаТоваровНаХранение" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Приемка товаров на хранение"" по излишкам, отмеченным к возврату поставщиком. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и вернуть"".';
					|en = 'Register the ""Goods receiving for storage"" document for surplus marked for return by the supplier. It is registered for discrepancy certificate lines with the ""Register and return"" processing option.'");
	ИначеЕсли ТипДокумента = "ПриемкаТоваровНаХранениеДопоставкаПоПриемке" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Приемка товаров на хранение"" по недостачам, для которых требуется допоставка. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и ожидать допоставку"".';
					|en = 'Register the ""Goods receiving for storage"" document for shortages that require additional delivery. It is registered for discrepancy certificate lines with the ""Register and wait for subsequent delivery"" processing option.'");
	ИначеЕсли ТипДокумента = "ИсправлениеВозвратаТоваровОтХранителя" Тогда
		Возврат НСтр("ru = 'Необходимо скорректировать документ ""Поступление товаров от хранителя"", отразив в нем количество по факту. Следует выполнить для строк акта о расхождениях с вариантами отработки: ""Оформить и вернуть"", ""Оформить"", ""Оформить и допоставить"".';
					|en = 'Correct the ""Goods receipt from the custodian"" document by recording an actual quantity in it. Make these changes to discrepancy certificate lines with the processing options: ""Register and return"", ""Register"", ""Register and supply additionally"".'");
	ИначеЕсли ТипДокумента = "ВозвратТоваровОтХранителяДовозврат" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Поступление товаров от хранителя"" по недостачам, отмеченным к довозврату клиентом. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и ожидать допоставку"".';
					|en = 'Register the ""Goods receipt from the custodian"" document by shortages marked by a client for additional return. It is registered for discrepancy certificate lines with the ""Register and wait for additional delivery"" processing option.'");
	//-- НЕ УТ
	ИначеЕсли ТипДокумента = "ПриобретениеТоваровУслугДопоставкаПоПоступлению" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Приобретение товаров и услуг"" по недостачам, для которых требуется допоставка. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и ожидать допоставку"".';
					|en = 'Register the ""Purchase of goods and services"" document for shortages that require additional delivery. It is registered for discrepancy certificate lines with the ""Register and wait for subsequent delivery"" processing option.'");
	ИначеЕсли ТипДокумента = "ПеремещениеТоваров" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Перемещение товаров"" на допоставку недопоставленного товара на склад-получатель. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и вернуть"", ""Оформить"".';
					|en = 'Register document ""Goods transfer"" for subsequent delivery of underdelivered products to receiving warehouse. It is registered for discrepancy certificate lines with tolling option ""Register and return"", ""Register"".'");
	ИначеЕсли ТипДокумента = "ПеремещениеТоваровВозврат" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Перемещение товаров"" на возврат излишков со склада-получателя на склад-отправитель. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и вернуть"".';
					|en = 'Register document ""Goods transfer"" for surplus return from a receiving warehouse to a shipping warehouse. It is registered for discrepancy certificate lines with tolling option ""Register and return"".'");
	ИначеЕсли ТипДокумента = "СписаниеНедостачТоваров" Тогда
		Если ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПриемНаХранениеСПравомПродажи Тогда
			Возврат НСтр("ru = 'Необходимо оформить документ ""Списание недостач товаров"" для списания  непризнанных недостач. Оформляется на строки акта о расхождениях с вариантом отработки ""Списать недостачи"".';
						|en = 'Register the ""Write off goods shortages"" document to write-off unrecognized shortages. It is registered in discrepancy certificate lines with the ""Write-off shortages"" processing option.'");
		Иначе
			Возврат НСтр("ru = 'Необходимо оформить документ ""Списание недостач товаров"" для списания на прочие расходы непризнанных недостач. Оформляется на строки акта о расхождениях с вариантом отработки ""По вине сторонней компании"" или ""За наш счет"".';
						|en = 'Register ""Write off goods shortages"" to write off unrecognized shortages as other expenses. It is registered for discrepancy certificate lines with processing option ""Due to the fault of the third party"" or ""At our expense"".'");
		КонецЕсли;
	ИначеЕсли ТипДокумента = "СписаниеЗадолженности" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Списание задолженности"" для отражения задолженности сторонней компании по недостачам, произошедшим по ее вине. Оформляется на строки акта о расхождениях с вариантом отработки ""По вине сторонней компании"" в случае, если установлен флаг ""По вине сторонней компании"".';
					|en = 'Register the ""Debt relief"" document for recording the third party debt for shortages incurred due to its fault. It is registered for discrepancy certificate lines with processing option: ""Due to the fault of the third party"" when the ""Due to the fault of the third party"" check box is selected.'");
	ИначеЕсли ТипДокумента = "ОприходованиеИзлишковТоваров" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Оприходование излишков товаров"" для оприходования излишков товаров. Оформляется на строки акта о расхождениях с вариантом отработки ""На прочие доходы"".';
					|en = 'Register document ""Goods surplus recording as received"" to record as received goods surplus. It is registered in discrepancy certificate lines with processing option ""For other income"".'");
	ИначеЕсли ТипДокумента = "ИсправлениеПоступления" Тогда
		Возврат НСтр("ru = 'Необходимо скорректировать документ ""Приобретение товаров и услуг"", отразив в нем количество по факту. Следует выполнить для строк акта о расхождениях с вариантами отработки: ""Оформить и вернуть"", ""Оформить"", ""Оформить и ожидать допоставку"".';
					|en = 'Correct the ""Purchase of goods and services"" document by recording an actual quantity in it. Make the changes to discrepancy certificate lines with processing options: ""Register and return"", ""Register"", ""Register and wait for subsequent delivery"".'");
	ИначеЕсли ТипДокумента = "ИсправлениеПриемкиТоваровНаХранение" Тогда
		Возврат НСтр("ru = 'Необходимо скорректировать документ ""Приемка товаров на хранение"", отразив в нем количество по факту. Следует выполнить для строк акта о расхождениях с вариантами отработки: ""Оформить и вернуть"", ""Оформить"", ""Оформить и ожидать допоставку"".';
					|en = 'Correct the ""Goods receiving for storage"" document recording an actual quantity in it. Make the changes to discrepancy certificate lines with processing options: ""Register and return"", ""Register"", ""Register and wait for subsequent delivery"".'");
	ИначеЕсли ТипДокумента = "ВозвратТоваровПоставщикуПоПоступлению" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Возврат товаров поставщику"" по перепоставленному товару, отмеченному к возврату поставщику. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и вернуть"".';
					|en = 'Register document ""Goods return to supplier"" for overdelivered goods marked for return to the supplier. It is registered in discrepancy certificate lines with processing option ""Register and return"". '");
	ИначеЕсли ТипДокумента = "ЭлектронныйДокументПодтверждение" Тогда
		Возврат НСтр("ru = 'Необходимо подтвердить полученный электронный документ, так как для отражения расхождения оформляется документ ""Корректировка поступления"".';
					|en = 'Confirm the received electronic document, as the ""Inpayment adjustment"" document is registered to record a discrepancy.'");
	ИначеЕсли ТипДокумента = "ЭлектронныйДокументОтклонение" Тогда
		Возврат НСтр("ru = 'Необходимо подтвердить полученный электронный документ, так как для отражения расхождения изменяется исходный документ поступления.';
					|en = 'Confirm the received electronic document, as the original inpayment document changes to record a discrepancy.'");
	КонецЕсли;
