...
Процедура ЗаполнитьДанныеШапкиФормы(ОписательСервиса)
	...
	ЧастиОписания.Добавить(Новый ФорматированнаяСтрока(НСтр("ru = 'Возможности сервиса:';
															|en = 'Service features:'"), Новый Шрифт(,,Истина)));
...
Процедура ДобавитьЭлементыТестовыхПериодов(ОписательПодключения, ОписательСервиса)
	...
	ЧастиОписания.Добавить(НСтр("ru = ':';
								|en = ':'"));
	...
	НовыйЭлемент = Элементы.Добавить(НСтр("ru = 'ЗаголовокТестовыеПериоды';
											|en = 'ЗаголовокТестовыеПериоды'"), Тип("ДекорацияФормы"), ГруппаФормы);
