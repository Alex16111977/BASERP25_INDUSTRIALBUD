...
Процедура ОчиститьИдентификаторы(Команда)
	...
	ПоказатьВопрос(Оповещение, НСтр("ru = 'В программе будут очищены служебный идентификаторы публикуемых торговых предложений.
		...
		|Продолжить?';
		|en = 'Service IDs of selling propositions being published will be cleared in the application.
		|New IDs will be created in the service for the goods being published upon synchronization.
		|The operation will be performed for the current line.
