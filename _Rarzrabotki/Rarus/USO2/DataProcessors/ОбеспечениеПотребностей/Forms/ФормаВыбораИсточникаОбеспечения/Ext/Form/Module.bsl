		...
		Иначе
			...
			Если ЗначениеЗаполнено(Параметры.Характеристика) Тогда
				...
				ШаблонТекста = НСтр("ru = 'Выбор поставщика (Номенклатура: %1, Характеристика: %2, Склад: %3)';
									|en = 'Select supplier (Products: %1, Characteristics: %2, Warehouse: %3)'");
			...
			Иначе
				...
				ШаблонТекста = НСтр("ru = 'Выбор поставщика (Номенклатура: %1, Склад: %2)';
									|en = 'Select supplier (Products: %1, Warehouse: %2)'");
		...
		Иначе
			...
			Если ЗначениеЗаполнено(Параметры.Характеристика) Тогда
				...
				ШаблонТекста = НСтр("ru = 'Выбор склада (Номенклатура: %1, Характеристика: %2)';
									|en = 'Select warehouse (Products: %1, Characteristic: %2)'");
			...
			Иначе
				...
				Заголовок = СтрШаблон(НСтр("ru = 'Выбор склада (Номенклатура: %1)';
											|en = 'Select warehouse (Products: %1)'"), Параметры.Номенклатура);
		...
		Иначе
			...
			Если ЗначениеЗаполнено(Параметры.Характеристика) Тогда
				...
				ШаблонТекста = НСтр("ru = 'Выбор подразделения (Номенклатура: %1, Характеристика: %2)';
									|en = 'Select department (Products: %1, Characteristic: %2)'");
				Заголовок = СтрШаблон(ШаблонТекста, Параметры.Номенклатура, Параметры.Характеристика);
				
			Иначе
				
				ШаблонТекста = НСтр("ru = 'Выбор подразделения (Номенклатура: %1)';
									|en = 'Select department (Products: %1)'");
