		...
		Для Каждого ЭлементВыгрузки Из СодержаниеВыгрузки Цикл
			...
			Исключение
				ЗаписьЖурналаРегистрации(
					НСтр("ru = 'Отчеты по НДС в электронном виде.Доп лист книги покупок';
						|en = 'Digital VAT reports.Add. purchase ledger sheets'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
