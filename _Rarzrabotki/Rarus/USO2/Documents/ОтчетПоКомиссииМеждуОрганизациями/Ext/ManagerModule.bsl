...
Процедура ДобавитьКомандыСозданияНаОсновании(КомандыСозданияНаОсновании, Параметры) Экспорт
	...
	Если НоваяКоманда <> Неопределено Тогда
		НоваяКоманда.Представление = НСтр("ru = 'Поступление безналичных ДС комитенту (оплата от комиссионера)';
											|en = 'Non-cash receipt to consignor (payment from consignee)'");
	КонецЕсли;
	...
	Если НоваяКоманда <> Неопределено Тогда
		НоваяКоманда.Представление = НСтр("ru = 'Заявка на расходование ДС комиссионера (оплата комитенту)';
											|en = 'Consignee expenditure request (payment to consignor)'");
	КонецЕсли;
	...
	Если НоваяКоманда <> Неопределено Тогда
		НоваяКоманда.Представление = НСтр("ru = 'Списание безналичных ДС комиссионера (оплата комитенту)';
											|en = 'Consignee non-cash debiting (payment to consignor)'");
	КонецЕсли;
...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка)
	...
	ИнформацияПоКомитенту = НСтр("ru = 'Отчет от ""%Комитент%""';
								|en = 'Report from ""%Комитент%""'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	...
	ИнформацияПоКомиссионеру = НСтр("ru = 'Отчет перед ""%Комиссионер%""';
									|en = 'Report for ""%Комиссионер%""'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
