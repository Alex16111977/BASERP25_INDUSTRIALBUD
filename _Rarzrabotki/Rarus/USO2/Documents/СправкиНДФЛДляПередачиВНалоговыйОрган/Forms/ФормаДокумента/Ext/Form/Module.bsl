...
Процедура Заполнить(Команда)
	...
	Если Объект.РегистрацияВНалоговомОргане.Пустая() Тогда
		ПоказатьПредупреждение(, СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Не указаны %1.';
																								|en = '%1 are not specified.'"), Элементы.РегистрацияВНалоговомОргане.Заголовок));
		Возврат;
	КонецЕсли;	
