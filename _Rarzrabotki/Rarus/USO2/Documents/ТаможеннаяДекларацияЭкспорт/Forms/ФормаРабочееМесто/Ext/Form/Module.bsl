...
Процедура СформироватьДокументыНаОсновании();
	...
	ОснованияПоОрганизациям = ПолучитьОрганизациииПоРеализациям(МассивОснований);
	Для каждого Элемент Из ОснованияПоОрганизациям Цикл
		ОткрытьФорму("Документ.ТаможеннаяДекларацияЭкспорт.ФормаОбъекта", Новый Структура("ДокументОснование", Элемент.Значение), , Истина);
	КонецЦикла; 
