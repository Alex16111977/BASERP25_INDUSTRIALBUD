...
Функция СоздатьДокументыБлокировкиНормативовНаСервере(ДатаНачалаДействия)
	...
	Для каждого ВыбраннаяСтрока Из Элементы.Нормативы.ВыделенныеСтроки Цикл
		...
		Исключение
			ЗаписьЖурналаРегистрации(НСтр("ru = 'Данные.Проведение';
											|en = 'Data.Posting'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),УровеньЖурналаРегистрации.Ошибка, Документы.НормативРаспределенияПлановПродажПоКатегориям,, ОписаниеОшибки());
		КонецПопытки; 
