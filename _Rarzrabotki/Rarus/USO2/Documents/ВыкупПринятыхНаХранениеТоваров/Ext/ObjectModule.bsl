...
Процедура ЗаполнитьАналитикиУчетаНоменклатуры() Экспорт
	...
	Для Каждого Строка Из ДанныеДляРасчетаАналитик Цикл
		...
		Для Каждого НайденнаяСтрока Из ТаблицаДляОбработки Цикл
			НайденнаяСтрока.НомерСтроки = НомерСтроки;
...
Процедура ИнициализироватьДокумент()
	...
	Если ЗначениеЗаполнено(Договор) Тогда
		...
		ЗаполнитьЗначенияСвойств(ЭтотОбъект, РеквизитыДоговора, , "НаправлениеДеятельности, ГруппаФинансовогоУчета, ПорядокОплаты, БанковскийСчетКонтрагента");
