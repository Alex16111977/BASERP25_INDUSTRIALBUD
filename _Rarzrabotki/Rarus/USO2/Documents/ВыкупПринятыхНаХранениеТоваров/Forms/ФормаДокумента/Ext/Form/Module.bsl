...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ЕстьПродукцияВЕТИС
		...
		|en = 'There are products of the ""Products under VETIS control"" type and different storage locations are specified.
		|When using products of this type, the same storage location must be specified for all lines of the ""Goods"" tabular section.'");
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Выкуп товаров, хранящихся на складе';
																|en = 'Redemption of goods stored in the warehouse'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Выкуп товаров, переданных в производство';
																|en = 'Redemption of goods transferred to production'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Выкуп товаров, переданных на хранение';
																|en = 'Redemption of goods transfered to storage'"));
