...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	ВнеоборотныеАктивыКлиентСервер.ОчиститьНеиспользуемыеРеквизиты(ЭтотОбъект, ЗначенияСвойствЗависимыхРеквизитов);
...
Процедура ЗаблокироватьДанные()
	...
	ПеремещениеНМАЛокализация.ДополнитьБлокировкуДанныхПриПроведении(ЭтотОбъект, Блокировка);
...
Процедура ЗаполнитьНаОснованииНематериальногоАктива(Основание)
	...
	Если РеквизитыОснования.ЭтоГруппа Тогда
		...
		ТекстСообщения = НСтр("ru = 'Перемещение на основании группы НМА невозможно.
			...
			|en = 'Cannot transfer based on IA group. 
			|Select IA. To expand the group, press Ctrl + down arrow.'");
