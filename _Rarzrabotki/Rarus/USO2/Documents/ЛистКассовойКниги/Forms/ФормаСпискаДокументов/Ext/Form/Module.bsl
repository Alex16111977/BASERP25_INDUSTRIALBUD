...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.СуммаПоступления.Заголовок = НСтр("ru = 'Приход (';
												|en = 'Receipt ('") + НаименованиеВалютыРеглУчета +")";
	Элементы.СуммаВыдачи.Заголовок = НСтр("ru = 'Расход (';
											|en = 'Expense ('") + НаименованиеВалютыРеглУчета +")";
	Элементы.СуммаКонечныйОстаток.Заголовок = НСтр("ru = 'Конечный остаток (';
													|en = 'Closing balance ('") + НаименованиеВалютыРеглУчета +")";
