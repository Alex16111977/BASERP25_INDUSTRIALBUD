...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Для Каждого СтрокаТаблицы Из Таблица2 Цикл
		Текст = СтрШаблон(НСтр("ru = 'Документ ""%1"" уже выбран в строке %2.';
								|en = 'Document ""%1"" is already selected in line %2.'"), СтрокаТаблицы.Заявление, СтрокаТаблицы.НомерСтроки1);
