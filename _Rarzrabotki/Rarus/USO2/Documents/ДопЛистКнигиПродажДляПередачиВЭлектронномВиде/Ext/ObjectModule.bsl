		...
		Для Каждого ЭлементВыгрузки Из СодержаниеВыгрузки Цикл
			...
			Исключение
				ЗаписьЖурналаРегистрации(
					НСтр("ru = 'Отчеты по НДС в электронном виде.Доп лист книги продаж';
						|en = 'Digital VAT reports.Add. sales ledger sheets'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
