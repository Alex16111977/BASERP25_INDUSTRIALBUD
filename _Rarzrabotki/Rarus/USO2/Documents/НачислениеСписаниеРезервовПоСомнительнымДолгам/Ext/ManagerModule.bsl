...
Функция ТекстЗапросаТаблицаРасчетРезервовПоСомнительнымДолгам(Запрос, ТекстыЗапроса, Регистры)
	...
	|	вт_Резервы.ВстречнаяЗадолженность КАК ВстречнаяЗадолженность,
	|	вт_Резервы.СуммаОбеспечения КАК СуммаОбеспечения,
	...
	|	вт_Резервы.ТипСуммы,
	|	вт_Резервы.ВстречнаяЗадолженность,
	|	вт_Резервы.СуммаОбеспечения,
