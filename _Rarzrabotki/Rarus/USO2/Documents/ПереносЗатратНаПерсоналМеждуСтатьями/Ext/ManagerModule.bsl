...
Процедура ПровестиПоУчетам(ДокументСсылка, РежимПроведения, Отказ, ВидыУчетов = Неопределено, Движения = Неопределено, Объект = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если СтруктураВидовУчета.ОстальныеВидыУчета Тогда
		...
		Если ДанныеДляПроведения.НДФЛ <> Неопределено И ДанныеДляПроведения.НДФЛ.Количество() > 0 Тогда
			УчетНачисленнойЗарплатыРасширенный.ЗарегистрироватьНДФЛИКорректировкиВыплаты(ДанныеДляПроведенияУчетЗарплаты, Отказ, ДанныеДляПроведения.НДФЛ, Неопределено);
		КонецЕсли;
...
Функция СведенияОДоходахНДФЛ(НачисленияСотрудников)
	...
	НовыеСведенияОДоходах = ОтражениеЗарплатыВУчетеРасширенный.НовыеСведенияОДоходахДополненныеСтатьейФинансирования(СведенияОДоходах, БухучетНачислений);
...
Функция НДФЛПоСотрудникам(РеквизитыДляПроведения, Сотрудники, НачисленияСотрудников)
	...
	ИсходныеДанные.НДФЛКЗачету		 		= ОтражениеЗарплатыВУчетеРасширенный.НоваяТаблицаКорректировкиВыплаты();
	ИсходныеДанные.НДФЛЗачтено		 		= ОтражениеЗарплатыВУчетеРасширенный.НоваяТаблицаКорректировкиВыплаты();
