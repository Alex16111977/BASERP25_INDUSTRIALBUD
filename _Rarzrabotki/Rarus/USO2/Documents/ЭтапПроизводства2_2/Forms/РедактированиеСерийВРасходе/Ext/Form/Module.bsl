...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокРеквизитов = "Ссылка, ДатаРасхода, Назначение, Подразделение, РасходОднойДатой";
	СтруктураОбъекта = Новый Структура(СписокРеквизитов);
	
	Если Параметры.Свойство("Ссылка") Тогда
		СтруктураОбъекта.Ссылка = Параметры.Ссылка;
	КонецЕсли;
	...
	Если Параметры.Свойство("ПараметрыУказанияСерий") Тогда
		ПараметрыУказанияСерий = ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(Параметры.ПараметрыУказанияСерий);
...
Процедура РазбитьСтроку(Команда)
	...
	Если Элементы.РасходМатериаловИРабот.ТекущиеДанные = Неопределено Тогда
		Возврат;
	КонецЕсли;
	...
	ОбщегоНазначенияУТКлиент.РазбитьСтрокуТЧ(РасходМатериаловИРабот, Элементы.РасходМатериаловИРабот, Оповещение, ПараметрыРазбиенияСтроки);
