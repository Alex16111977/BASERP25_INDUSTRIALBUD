...
Процедура ПроверитьДанныеДокумента(Отказ) Экспорт
	...
	НачалоСообщенияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Справка 2-НДФЛ по %1:';
																							|en = '2-NDFL statement of %1:'"), ДанныеСотрудникаДляПроверки.СотрудникНаименование);
