		...
		Пока Выборка.Следующий() Цикл
			...
			Иначе
				ТекстСообщения = НСтр("ru = 'В периоде %2 г. право на вычеты отменено в связи с увольнением. Внесите изменение в документ %1 перед проведением заявления на вычеты.';
										|en = 'The deduction entitlement is canceled in the %2 period due to termination of employment. Change the %1 document before posting the deduction application.'");
			КонецЕсли;
