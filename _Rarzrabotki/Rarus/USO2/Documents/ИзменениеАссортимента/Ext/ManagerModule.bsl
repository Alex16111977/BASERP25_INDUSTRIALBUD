...
Функция ДобавитьКомандуСоздатьНаОснованииСоздатьЗаказНаВнутреннееПотребление(КомандыСозданияНаОсновании) Экспорт
	Если ПравоДоступа("Добавление", Метаданные.Документы.ЗаказНаВнутреннееПотребление) И ПолучитьФункциональнуюОпцию("ИспользоватьАссортимент") Тогда
		...
		КомандаСоздатьНаОсновании.Представление = НСтр("ru = 'Заказ на внутреннее потребление';
														|en = 'Order for internal consumption'");
...
Процедура СопоставитьЗагружаемыеДанные(АдресЗагружаемыхДанных, АдресТаблицыСопоставления, СписокНеоднозначностей, ПолноеИмяТабличнойЧасти, ДополнительныеПараметры) Экспорт
	...
	РолиАссортимента.Вставить(НСтр("ru = 'Постоянный ассортимент';
									|en = 'Regular assortment'"), Перечисления.РолиАссортимента.ПостоянныйАссортимент);
	...
	РолиАссортимента.Вставить(НСтр("ru = 'Дополнительный ассортимент';
									|en = 'Additional assortment'"), Перечисления.РолиАссортимента.ДополнительныйАссортимент);
	...
	РолиАссортимента.Вставить(НСтр("ru = 'Пробный ассортимент';
									|en = 'Trial assortment'"), Перечисления.РолиАссортимента.ПробныйАссортимент);
