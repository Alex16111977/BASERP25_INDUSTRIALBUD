...
Процедура УстановитьСтатусНеСогласована(Команда)
	...
	ТекстВопроса = НСтр("ru = 'У выделенных в списке заявок будет установлен статус ""Не согласована"". Продолжить?';
						|en = 'Status of the requests selected in the list will be set to Not approved. Continue?'");
	Ответ = Неопределено;
...
Процедура УстановитьСтатусКОплате(Команда)
	...
	ТекстВопроса = НСтр("ru = 'У выделенных в списке заявок будет установлен статус ""К оплате"". Продолжить?';
						|en = 'Status of the requests selected in the list will be set to ""For payment"". Continue?'");
	Ответ = Неопределено;
