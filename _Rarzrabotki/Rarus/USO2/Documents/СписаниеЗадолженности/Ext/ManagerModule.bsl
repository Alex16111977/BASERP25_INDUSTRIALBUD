...
Функция ТекстЗапросаВтОстаткиРезервовПоСомнительнымДолгам(Запрос, ТекстыЗапроса)
	...
	|	СУММА(Расчеты.Долг) КАК Сумма,
	|	СУММА(Расчеты.ДолгРегл) КАК СуммаРегл,
	|	СУММА(Расчеты.ДолгУпр) КАК СуммаУпр
	...
	|	СУММА(Расчеты.ПредоплатаРегл) КАК СуммаРегл,
	|	СУММА(Расчеты.ПредоплатаУпр) КАК СуммаУпр
	|ИЗ
