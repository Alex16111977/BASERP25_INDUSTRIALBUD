...
Процедура СформироватьТаблицаГСМ(ДокументСсылка, СтруктураДополнительныеСвойства)
	...
	ВсеОК =	уатГСМ.ПодготовитьТаблицуСписанияГСМ(ДокументСсылка, мТаблицаПоСписаниюГСМ, Истина);
	...
	Если ДокументСсылка.ВидОперации = Перечисления.уатВидыОперацийСливГСМ.НаТС Тогда 
		...
		МестонахождениеТС = уатОбщегоНазначения.МестонахождениеТС(ДокументСсылка.АЗС, ПериодРегистра);
...
Процедура ВыполнитьКонтроль(ДокументСсылка, ДополнительныеСвойства, Отказ, УдалениеПроведения = Ложь) Экспорт
	...
	Если КоличествоОстаток < 0 Тогда
		ТекстСообщения = "ГСМ """ + ДокументСсылка.ГСМ + """, ТС """ + Строка(ДокументСсылка.ТС) + """ ";
