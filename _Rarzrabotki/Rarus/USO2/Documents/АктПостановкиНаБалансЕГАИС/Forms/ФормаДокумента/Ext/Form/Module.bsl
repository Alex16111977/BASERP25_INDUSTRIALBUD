...
Процедура СканированиеАлкогольнойПродукцииПослеЗакрытияНаСервере(АдресВременногоХранилища)
	...
	ЗаполнитьТипШтрихкодаВДеревеУпаковок(ДеревоУпаковок);
	
	//ШтрихкодированиеИС
	ШтрихкодыУпаковок = ШтрихкодированиеИС.ШтрихкодыУпаковок(
		ШтрихкодированиеИС.ЗначенияШтрихкодовИзДереваУпаковок(ДеревоУпаковок));
...
Процедура ЗаполнитьТипыШтрихкодовВСтрокахДерева(СтрокиДерева, ДанныеШтрихкодовУпаковок)
	...
	Для Каждого СтрокаДерева Из СтрокиДерева Цикл
		...
		НайденнаяСтрока = ДанныеШтрихкодовУпаковок.Найти(СтрокаДерева.ЗначениеШтрихкода, "ЗначениеШтрихкода");
...
Процедура ЗаполнитьШтрихкодыАкцизныхМарокПоСтрокамДерева(СтрокиДерева, ЗначенияШтрихкодов)
	...
	Для Каждого СтрокаДерева Из СтрокиДерева Цикл
		...
		ЗначенияШтрихкодов.Добавить(СтрокаДерева.ЗначениеШтрихкода);
...
Процедура ОбработатьДанныеТСДНаСервере(ДанныеПартионнойПродукции, КэшированныеЗначения)
	...
	Для Каждого МаркируемаяПродукция Из ЗагрузкаДанныхТСД.МаркируемаяПродукция Цикл
		...
		РезультатОбработкиШтрихкода = Документы.АктПостановкиНаБалансЕГАИС.ОбработатьДанныеШтрихкода(ЭтотОбъект, 
