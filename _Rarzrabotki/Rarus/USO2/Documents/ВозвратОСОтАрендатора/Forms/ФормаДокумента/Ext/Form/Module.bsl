...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	Оповестить("Запись_ВозвратОСОтАрендатора", ПараметрыЗаписи, Объект.Ссылка);
...
Процедура ДокументНаОснованииПриИзменении(Элемент)
	...
	Если Объект.ДокументНаОсновании Тогда
		ОткрытьФорму("Документ.ПередачаОСАрендатору.ФормаВыбора", , ЭтаФорма, ЭтаФорма,,, Новый ОписаниеОповещения("ВыборДокументаОснования", ЭтаФорма));
	Иначе
