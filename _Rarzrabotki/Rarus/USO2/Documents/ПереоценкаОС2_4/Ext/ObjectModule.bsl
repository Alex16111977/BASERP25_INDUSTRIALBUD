...
Процедура ЗаполнитьНаОснованииОбъектаЭксплуатации(Основание)
	...
	Если РеквизитыОснования.ЭтоГруппа Тогда
		...
		ТекстСообщения = НСтр("ru = 'Переоценка на основании группы ОС невозможно.
			...
			|en = 'Cannot revaluate based on FA group. select FA.
			|To open the group, press Ctrl and the down arrow.'");
...
Процедура ЗаполнитьНаОснованииИнвентаризацииОС(Знач ДанныеЗаполнения)
	...
	Документы.ПереоценкаОС2_4.ЗаполнитьНаОснованииИнвентаризацииОС(ЭтотОбъект, СообщатьОбОшибках, МассивНомеровСтрок);
