	...
	Если ИспользоватьПравилоНачисления = 1 И Не ЗначениеЗаполнено(Объект.ПравилоНачисления) Тогда
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ru = 'Поле ""Правило начисления"" не заполнено.';
				|en = 'The ""Accrual rule"" field is not filled in.'"),,"Объект.ПравилоНачисления",, Отказ);
	...
	Если ИспользоватьПериодДействия = 2 И Не ЗначениеЗаполнено(Объект.ДатаОкончанияСрокаДействия) Тогда
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ru = 'Поле ""Дата окончания срока действия"" не заполнено.';
				|en = 'The ""Validity period expiration date"" field is not filled in.'"),,"Объект.ДатаОкончанияСрокаДействия",, Отказ);
