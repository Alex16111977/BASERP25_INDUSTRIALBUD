...
Процедура ПриИзмененииПараметровНДСиКурса()
	...
	Если Объект.КурсВзаиморасчетов <> ПредКурсДокумента Тогда
		уатОбщегоНазначенияКлиент.ПересчитатьЦеныТабличнойЧастиПоВалюте(ЭтаФорма, Объект.ВалютаДокумента, "Услуги");
	КонецЕсли;
...
Процедура УстановитьВидимость()
	...
	// Данные по НДС показываем только тогда, когда его учитываем.
	...
	Элементы.Соглашение.Видимость = флЗаказОтКонтрагента И ИспользоватьСоглашения;
