...
Процедура ЗаполнитьВсеТипыОпераций()
	...
	УстановитьВидимостьЗначенияСпискаВыбора(
		...
		Перечисления.ТипыРегламентныхОпераций.ПризнаниеВНУЛизинговыхПлатежей);
	...
	//
	ИспользоватьВНА = ПолучитьФункциональнуюОпцию("ИспользоватьВнеоборотныеАктивы2_2")
						ИЛИ ПолучитьФункциональнуюОпцию("ИспользоватьВнеоборотныеАктивы2_4");
