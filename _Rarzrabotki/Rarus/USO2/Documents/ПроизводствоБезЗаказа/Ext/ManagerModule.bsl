...
Функция ТекстЗапросаВтТовары(Запрос, ТекстыЗапроса)
	...
	|		И КлючиАналитикиПолучателя.МестоХранения = ВЫРАЗИТЬ(ТаблицаТовары.АналитикаУчетаНоменклатуры.Назначение.Заказ КАК Документ.ЗаказДавальца).Подразделение
...
Функция ТекстЗапросаТаблицаТоварыНаСкладах(Запрос, ТекстыЗапроса, Регистры)
	...
	|	И НЕ (ВЫРАЗИТЬ(МатериалыИРаботы.Склад КАК Справочник.Склады).ИспользоватьОрдернуюСхемуПриОтгрузке
...
#Область ГенерацияАналитикУчетаНоменклатуры
