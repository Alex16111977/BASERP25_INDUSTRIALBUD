...
Процедура ОбработатьВидВыплатыПриИзмененииНаСервере()
	...
	ОтражениеЗарплатыВБухучетеРасширенный.УстановитьПодсказкуВводаСтатьиРасходовВыплатыБывшимСотрудникам(ЭтаФорма,Объект.ВидВыплаты,Объект.ПериодРегистрации);
