...
Процедура ПереименоватьРасчетПлатыВДекларациюНВОС(Параметры = Неопределено) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ru = 'Обновление декларация по оплате за негативное воздействие завершено с ошибкой';
				|en = 'Обновление декларация по оплате за негативное воздействие завершено с ошибкой'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
