...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ТаблицаВыданныеАвансыСуммаАвансаРегл.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Сумма (%1)';
																															|en = 'Amount (%1)'"), ВалютаРеглУчета);
...
Процедура АктуализироватьРасчеты(Команда)
	...
	ПоказатьВопрос(
		...
		НСтр("ru = 'Актуализировать расчеты с поставщиками?';
			|en = 'Update settlements with suppliers?'"), 
	...
	Если КодОтвета = КодВозвратаДиалога.Да Тогда
		...
		ПоказатьОповещениеПользователя(
			...
			НСтр("ru = 'Расчеты с поставщиками актуализированы';
				|en = 'Settlements with suppliers are updated'"));
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = НСтр("ru = 'Учет НДС с выплаченных авансов';
							|en = 'Accounting of VAT on paid advances'")
