...
Процедура ОбработатьСтрокиТЧ(ДобавленныеСтроки, ИзмененныеСтроки, КэшированныеЗначения = Неопределено)
	...
	СтруктураДействийСДобавленнымиСтроками.Вставить("ЗаполнитьНоменклатуруЕГАИС", ПараметрыЗаполнения);
	СтруктураДействийСДобавленнымиСтроками.Вставить("ЗаполнитьПризнакМаркируемаяАлкогольнаяПродукция", Новый Структура("Номенклатура", "МаркируемаяПродукция"));
...
Функция ДанныеДляПробитияЧека()
	...
	ДанныеПоТоварам = Документы.ЧекККМВозврат.ДанныеПоТоварам(Объект, МенеджерВременныхТаблиц);
	
	ДанныеДляЕГАИС = Документы.ЧекККМВозврат.ДанныеДляЕГАИС(Объект, МенеджерВременныхТаблиц);
	
	ДанныеДляМОТП = Документы.ЧекККМВозврат.ДанныеДляМОТП(Объект, МенеджерВременныхТаблиц);
