...
Процедура уатИспользоватьМониторингПриИзменении(Элемент)
	...
	Элементы.НастройкиМониторинга.Доступность = НаборКонстант.уатИспользоватьМониторинг;
	Если НаборКонстант.уатИспользоватьМониторинг = Ложь Тогда
		НаборКонстант.уатИспользоватьDynafleet   = Ложь;
		НаборКонстант.уатИспользоватьOmnicomm    = Ложь;
		НаборКонстант.уатИспользоватьWialon      = Ложь;
		НаборКонстант.уатИспользоватьАвтоГРАФ    = Ложь;
		НаборКонстант.уатИспользоватьАвтотрекер  = Ложь;
		НаборКонстант.уатИспользоватьСКАУТ       = Ложь;
	КонецЕсли;
