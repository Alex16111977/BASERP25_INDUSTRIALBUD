...
Процедура ОтразитьВКадровомУчете(Команда)
	...
	Если Модифицированность Тогда 
		...
		ТекстВопроса = НСтр("ru = 'Для продолжения необходимо записать позиции.';
							|en = 'Write positions to continue.'") + Символы.ПС + НСтр("ru = 'Продолжить?';
																										|en = 'Continue?'"); 
	...
	Для каждого СтрокаПозиции Из Позиции Цикл
		...
		Исключение
			...
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				...
				|en = 'Cannot change the ""%1"" staff list position.
		...
		Исключение
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Не удалось сохранить изменения в позиции';
...
Функция ДополнитьПоТекущейКадровойРасстановкеНаСервере()
	...
	НаименованиеЗадания = НСтр("ru = 'Формирование позиций штатного расписания""';
								|en = 'Generate staff list positions""'");
