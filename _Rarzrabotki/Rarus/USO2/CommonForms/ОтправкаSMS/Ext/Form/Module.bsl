...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = НСтр("ru = 'Отправка SMS на телефон';
					|en = 'Send SMS message to phone'") + НомераПолучателей;
КонецПроцедуры
...
Процедура ПроверитьСтатусДоставки()
	...
	ШаблонСостояния = НСтр("ru = 'Отправка сообщения выполнена. Состояние доставки:
		|%1.';
		|en = 'Message is sent. Delivery state:
		|%1'");
