...
Процедура УправлениеФормой(Форма)
	...
	Элементы.Информация.Заголовок = СтрШаблон(НСтр("ru = 'Заявление принято к рассмотрению.
                                                    ...
                                                    |en = 'The application is submitted for review.
                                                    |You will receive an SMS with the application review results to number %1'"), Форма.НовыйТелефон);
