...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++ НЕ УТ
	ПлатежиПо275ФЗ = ?(Параметры.Свойство("ПлатежиПо275ФЗ"), Параметры.ПлатежиПо275ФЗ, Ложь);
	ДоговорСУчастникомГОЗ = ?(Параметры.Свойство("ДоговорСУчастникомГОЗ"), Параметры.ДоговорСУчастникомГОЗ, Ложь);
	//-- НЕ УТ
...
Процедура УстановитьВидимость()
	...
	Если ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ОплатаДенежныхСредствВДругуюОрганизацию
		...
		Заголовок = НСтр("ru = 'Подбор по расчетам между организациями';
						|en = 'Select by settlements between companies'");
...
Процедура ЗаполнитьТаблицуПоРасчетамСПартнерами()
	...
	//++ НЕ УТ
	Реквизиты.Вставить("ПлатежиПо275ФЗ", ПлатежиПо275ФЗ);
	Реквизиты.Вставить("ДоговорСУчастникомГОЗ", ДоговорСУчастникомГОЗ);
	//-- НЕ УТ
