	...
	Иначе
		...
		Если ПараметрВводаПоля <> Неопределено И ПараметрВводаПоля.ТаблицаЗначений <> Неопределено Тогда
			...
			Состояние(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = '%1. Открывается форма для выбора значения, подождите...';
																					|en = '%1. Открывается форма для выбора значения, подождите...'"), ЭтаФорма.Заголовок), , , БиблиотекаКартинок.Таблица);
...
Функция ЗагрузитьСпискиВыбораНаСервере()
	...
	РезультатВыполнения = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
		...
		НСтр("ru = 'Выполняется формирование списков выбора. Пожалуйста, подождите...';
			|en = 'Выполняется формирование списков выбора. Пожалуйста, подождите...'"));
