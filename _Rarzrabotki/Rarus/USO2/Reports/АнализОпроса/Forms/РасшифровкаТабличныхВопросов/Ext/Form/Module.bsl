...
Функция ОбработатьВходящиеПараметры(ФормулировкиЭлементарныхВопросов)
	...
	Заголовок = НСтр("ru = 'Ответы на вопрос №';
					|en = 'Responses to question No.'") + " " + ПолныйКод + " " + НСтр("ru = 'опроса';
																				|en = 'survey'") + " " + НаименованиеОпроса + " " + НСтр("ru = 'от';
																																		|en = 'dated'") + " " + Формат(ДатаОпроса,"ДЛФ=D");
