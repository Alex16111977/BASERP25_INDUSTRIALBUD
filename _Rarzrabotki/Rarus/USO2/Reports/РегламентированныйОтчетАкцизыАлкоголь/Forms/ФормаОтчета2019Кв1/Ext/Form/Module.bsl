...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	//ПроверкаКС_5_09(СтруктураРезультата);
	//ПроверкаКС_5_10(СтруктураРезультата);
...
Процедура ПроверкаКС_4_06(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.6)';
													|en = 'Проверка Приложения 1 (КС 4.6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru=''") +
...
Процедура ПроверкаКС_4_07(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.7)';
													|en = 'Проверка Приложения 1 (КС 4.7)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru=''") +
...
Процедура ПроверкаКС_4_08(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.8)';
													|en = 'Проверка Приложения 1 (КС 4.8)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru=''") +
...
Процедура ПроверкаКС_4_09(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.9)';
													|en = 'Проверка Приложения 1 (КС 4.9)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru=''") +
...
Процедура ПроверкаКС_4_10(СтруктураРезультата)
	...
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 1 (КС 4.10)';
													|en = 'Проверка Приложения 1 (КС 4.10)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru=''") +
...
&НаСервере
Процедура ПроверкаКС_5_09(СтруктураРезультата)
	...
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Реализация ожидается';
													|en = 'Реализация ожидается'"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 2 (КС 5.9)';
													|en = 'Проверка Приложения 2 (КС 5.9)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru=''") +
...
&НаСервере
Процедура ПроверкаКС_5_10(СтруктураРезультата)
	...
	Заголовки.Вставить("Комментарий"		, НСтр("ru = 'Реализация ожидается';
													|en = 'Реализация ожидается'"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru = 'Проверка Приложения 2 (КС 5.10)';
													|en = 'Проверка Приложения 2 (КС 5.10)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru = 'ст.80 НК РФ';
													|en = 'ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru=''") +
...
Процедура СформироватьДанныеОтчета()
	...
	СтруктураДанныхОтчета = ПолучитьДанныеОтчета(СтруктураРеквизитовФормы.мСохраненныйДок);
	...
	ДанныеКС.Вставить("Раздел2"			, ПолучитьДанныеМногостраничныхРазделов(СтруктураДанныхОтчета, "Раздел2"));
	ДанныеКС.Вставить("Приложение1"		, ПолучитьДанныеМногостраничныхРазделов(СтруктураДанныхОтчета, "Приложение1"));
	ДанныеКС.Вставить("Приложение2"		, ПолучитьДанныеМногостраничныхРазделов(СтруктураДанныхОтчета, "Приложение2"));
	ДанныеКС.Вставить("Приложение3"		, ПолучитьДанныеМногостраничныхРазделов(СтруктураДанныхОтчета, "Приложение3"));
	ДанныеКС.Вставить("Приложение4"		, ПолучитьДанныеМногостраничныхРазделов(СтруктураДанныхОтчета, "Приложение4"));
	ДанныеКС.Вставить("Приложение5"		, ПолучитьДанныеМногостраничныхРазделов(СтруктураДанныхОтчета, "Приложение5"));
	ДанныеКС.Вставить("Приложение6"		, ПолучитьДанныеМногостраничныхРазделов(СтруктураДанныхОтчета, "Приложение6"));
...
Процедура СформироватьДанныеОтчетаПРП()
	...
	|ГДЕ
	|	ДокументРО.ИсточникОтчета = ""РегламентированныйОтчетАкцизыАлкогольУ""
