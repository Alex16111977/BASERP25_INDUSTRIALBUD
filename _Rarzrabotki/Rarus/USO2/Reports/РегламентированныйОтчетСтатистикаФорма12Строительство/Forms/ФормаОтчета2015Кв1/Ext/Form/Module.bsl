...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	Нарушение = "Приказ Росстата 17.07.2015 № 327";
	
	Для Стр = 1 По 45 Цикл
	...
	СоответствиеСтрок[18] = Новый Массив;
	СоответствиеСтрок[18].Добавить(19);
	СоответствиеСтрок[18].Добавить(20);
	
	СоответствиеСтрок[21] = Новый Массив;
	СоответствиеСтрок[21].Добавить(22);
	СоответствиеСтрок[21].Добавить(23);
	
	СоответствиеСтрок[24] = Новый Массив;
	СоответствиеСтрок[24].Добавить(25);
	
	СоответствиеСтрок[26] = Новый Массив;
	СоответствиеСтрок[26].Добавить(27);
	
	СоответствиеСтрок[30] = Новый Массив;
	СоответствиеСтрок[30].Добавить(31);
	
	СоответствиеСтрок[39] = Новый Массив;
	СоответствиеСтрок[39].Добавить(40);
	...
	СоответствиеСтрок[12] = Новый Массив;
	СоответствиеСтрок[12].Добавить(16);
	Для Каждого КЗ Из СоответствиеСтрок Цикл
		Для Гр = 3 По 7 Цикл 
			Если Не Показатели.Свойство("П010"+Формат(КЗ.Ключ, "ЧЦ=2; ЧВН=; ЧГ=;")+"0"+Гр) Тогда 
				Продолжить;
