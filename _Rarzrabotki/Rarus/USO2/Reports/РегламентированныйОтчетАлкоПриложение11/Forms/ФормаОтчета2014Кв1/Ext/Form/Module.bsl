...
Функция ЗагрузкаОтчетаИзФайлаНаСервере(ДанныеДляЗагрузки)
	...
	ДеревоДляЗагрузки = РегламентированнаяОтчетность.ИзвлечьСтруктуруXML(ЭтотОбъект, "СхемаВыгрузки431_2015Кв4");
...
Процедура УстановитьВидимостьРазделов(НаименованиеРаздела, ИндексСтраницы,
	...
	РегламентированнаяОтчетностьАЛКО.УстановитьВидимостьРазделовАЛКО(ЭтаФорма, НаименованиеРаздела, ИндексСтраницы, ЗаголовокОП_ИП, ЗаголовокОП_ЮЛ);
