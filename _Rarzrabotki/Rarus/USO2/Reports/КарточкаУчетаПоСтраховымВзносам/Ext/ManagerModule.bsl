...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.Описание =
		НСтр("ru = 'Рекомендованная ПФ РФ и ФСС РФ Карточка учета страховых взносов.';
			|en = 'Record card of insurance contributions recommended by PF of the Russian Federation and SSF of the Russian Federation'");
	...
	НастройкиВарианта.Описание =
		НСтр("ru = 'Рекомендованная ПФ РФ и ФСС РФ Карточка учета страховых взносов отдельно по головной организации и ее филиалам.';
			|en = 'Record card of insurance contributions recommended by PF of the Russian Federation and SSF of the Russian Federation separately for the parent company and its branches'");
