...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ВызываемыйМодуль.ДобавитьВыбранноеПоле(Группировка.Выбор, "ГоловнаяОрганизация");
	ВызываемыйМодуль.ДобавитьВыбранноеПоле(Группировка.Выбор, "Организация");
	ВызываемыйМодуль.ДобавитьВыбранноеПоле(Группировка.Выбор, "ГОД");
	ВызываемыйМодуль.ДобавитьВыбранноеПоле(Группировка.Выбор, "ФизическоеЛицо");
