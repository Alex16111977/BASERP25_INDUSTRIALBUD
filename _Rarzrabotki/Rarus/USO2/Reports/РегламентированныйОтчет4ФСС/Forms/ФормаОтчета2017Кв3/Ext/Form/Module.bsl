...
Процедура ПроверитьКС_Т2_Ст20Гр01_4а_2м(СтруктураРезультата)
	...
	Если УсловиеВыполнено Тогда
		КС = ПоказателиКС(Т2_Ст22Гр01.Значение, (Т1_Ст3Гр05.Значение - Т1_Ст4Гр05.Значение + 0.6 * Т1_Ст4Гр05.Значение) * Т1_Ст9.Значение / 100, , Истина);
...
Процедура ПроверитьКС_Т2_Ст20Гр01_4а_3м(СтруктураРезультата)
	...
	УсловиеВыполнено = НЕ РазделЗаполнен(ЭтаФорма, "Таблица1_1") И (Льгота60Процентов = 0);
	Если УсловиеВыполнено Тогда
		КС = ПоказателиКС(Т2_Ст23Гр01.Значение, (Т1_Ст3Гр06.Значение - Т1_Ст4Гр06.Значение + 0.6 * Т1_Ст4Гр06.Значение) * Т1_Ст9.Значение / 100, , Истина);
...
Процедура ПроверитьКС_Т2_Ст20Гр01_4б_2м(СтруктураРезультата)
	...
	Если УсловиеВыполнено Тогда
		КС = ПоказателиКС(Т2_Ст22Гр01.Значение, Т1_Ст3Гр05.Значение * Т1_Ст9.Значение / 100, , Истина);
...
Процедура ПроверитьКС_Т2_Ст20Гр01_4б_3м(СтруктураРезультата)
	...
	УсловиеВыполнено = НЕ РазделЗаполнен(ЭтаФорма, "Таблица1_1") И (Льгота60Процентов = 1);
	Если УсловиеВыполнено Тогда
		КС = ПоказателиКС(Т2_Ст23Гр01.Значение, Т1_Ст3Гр06.Значение * Т1_Ст9.Значение / 100, , Истина);
...
Процедура ПроверитьКС_Т2_Ст20Гр01_4г_2м(СтруктураРезультата)
	...
	Если УсловиеВыполнено Тогда
		КС = ПоказателиКС(Т2_Ст22Гр01.Значение, (Т1_Ст3Гр05.Значение - Т1_Ст4Гр05.Значение - СуммаГр10 + СуммаГр11 + 0.6 * Т1_Ст4Гр05.Значение - СуммаГр11) * Т1_Ст9.Значение / 100, , Истина);
...
Процедура ПроверитьКС_Т2_Ст20Гр01_4г_3м(СтруктураРезультата)
	...
	УсловиеВыполнено = РазделЗаполнен(ЭтаФорма, "Таблица1_1") И (Льгота60Процентов = 0);
	Если УсловиеВыполнено Тогда
		КС = ПоказателиКС(Т2_Ст23Гр01.Значение, (Т1_Ст3Гр06.Значение - Т1_Ст4Гр06.Значение - СуммаГр12 + СуммаГр13 + 0.6 * Т1_Ст4Гр06.Значение - СуммаГр13) * Т1_Ст9.Значение / 100, , Истина);
...
Процедура ПроверитьКС_Т2_Ст20Гр01_4д_2м(СтруктураРезультата)
	...
	Если УсловиеВыполнено Тогда
		КС = ПоказателиКС(Т2_Ст22Гр01.Значение, 0.6 * (Т1_Ст3Гр05.Значение - СуммаГр10) * Т1_Ст9.Значение / 100 + СуммаГр10, , Истина);
...
Процедура ПроверитьКС_Т2_Ст20Гр01_4д_3м(СтруктураРезультата)
	...
	УсловиеВыполнено = РазделЗаполнен(ЭтаФорма, "Таблица1_1") И (Льгота60Процентов = 1);
	Если УсловиеВыполнено Тогда
		КС = ПоказателиКС(Т2_Ст23Гр01.Значение, 0.6 * (Т1_Ст3Гр06.Значение - СуммаГр11) * Т1_Ст9.Значение / 100 + СуммаГр11, , Истина);
...
Процедура ПроверитьКС_Т2_Ст20Гр03_5а(СтруктураРезультата)
	...
	УсловиеВыполнено = НЕ РазделЗаполнен(ЭтаФорма, "Таблица1_1") И (Льгота60Процентов = 0);
	Если УсловиеВыполнено Тогда
		КС = ПоказателиКС(Т2_Ст20Гр03.Значение, (Т1_Ст3Гр03.Значение - Т1_Ст4Гр03.Значение + 0.6 * Т1_Ст4Гр03.Значение) * Т1_Ст9.Значение / 100, , Истина);
...
Процедура ПроверитьКС_Т2_Ст20Гр03_5б(СтруктураРезультата)
	...
	УсловиеВыполнено = НЕ РазделЗаполнен(ЭтаФорма, "Таблица1_1") И (Льгота60Процентов = 1);
	Если УсловиеВыполнено Тогда
		КС = ПоказателиКС(Т2_Ст20Гр03.Значение, 0.6 * Т1_Ст3Гр03.Значение * Т1_Ст9.Значение / 100, , Истина);
...
Процедура ПроверитьКС_Т2_Ст20Гр03_5г(СтруктураРезультата)
	...
	УсловиеВыполнено = РазделЗаполнен(ЭтаФорма, "Таблица1_1") И (Льгота60Процентов = 0);
	Если УсловиеВыполнено Тогда
		КС = ПоказателиКС(Т2_Ст20Гр03.Значение, ((Т1_Ст3Гр03.Значение - Т1_Ст4Гр03.Значение - СуммаГр06 + СуммаГр07 + 0.6 * (Т1_Ст4Гр03.Значение - СуммаГр07)) * Т1_Ст9.Значение / 100) + СуммаГр06, , Истина);
...
Процедура ПроверитьКС_Т2_Ст20Гр03_5д(СтруктураРезультата)
	...
	УсловиеВыполнено = РазделЗаполнен(ЭтаФорма, "Таблица1_1") И (Льгота60Процентов = 1);
	Если УсловиеВыполнено Тогда
		КС = ПоказателиКС(Т2_Ст20Гр03.Значение, (0.6 * (Т1_Ст3Гр03.Значение - СуммаГр06)) * Т1_Ст9.Значение / 100 + СуммаГр06, , Истина);
...
Процедура ПроверитьКС_Т2_Ст80Гр03(СтруктураРезультата)
	...
	Т2_Ст10Гр03 = ПоказательПоСтроке("Т2_Ст10Гр03");
	Т2_Ст11Гр03 = ПоказательПоСтроке("Т2_Ст11Гр03");
	Т2_Ст20Гр03 = ПоказательПоСтроке("Т2_Ст20Гр03");
	...
	ВставитьЗначениеПоказателя(Таблица2, Т2_Ст10Гр03);
	ВставитьЗначениеПоказателя(Таблица2, Т2_Ст11Гр03);
	ВставитьЗначениеПоказателя(Таблица2, Т2_Ст20Гр03);
	...
	ВнестиПоказательВРасшифровку(Т2_Ст10Гр03, "Таблица2");
	ВнестиПоказательВРасшифровку(Т2_Ст11Гр03, "Таблица2");
	ВнестиПоказательВРасшифровку(Т2_Ст20Гр03, "Таблица2");
	...
	КС = ПоказателиКС(Т2_Ст80Гр03.Значение, Т2_Ст10Гр03.Значение + Т2_Ст11Гр03.Значение + Т2_Ст20Гр03.Значение
		+ Т2_Ст30Гр03.Значение + Т2_Ст40Гр03.Значение + Т2_Ст50Гр03.Значение + Т2_Ст60Гр03.Значение + Т2_Ст70Гр03.Значение);
	Расшифровка = КС.ЛеваяЧастьСтр + " = " + Т2_Ст10Гр03.ЗначениеСтр + " + " + Т2_Ст11Гр03.ЗначениеСтр + " + "
		+ Т2_Ст20Гр03.ЗначениеСтр + " + " + Т2_Ст30Гр03.ЗначениеСтр + " + " + Т2_Ст40Гр03.ЗначениеСтр + " + "
		+ Т2_Ст50Гр03.ЗначениеСтр + " + " + Т2_Ст60Гр03.ЗначениеСтр + " + " + Т2_Ст70Гр03.ЗначениеСтр + " Итог [" + КС.ПраваяЧастьСтр + "]";
...
Процедура ПроверитьКС_Т2_Ст100Гр03(СтруктураРезультата)
	...
	ОписаниеКС      = НСтр("ru = 'Значение строки 10 графы 3 равно 0, если значения строк 13, 14.1 и 15 по графе 3 равны 0';
							|en = 'Значение строки 10 графы 3 равно 0, если значения строк 13, 14.1 и 15 по графе 3 равны 0'");
	
	ОписаниеОшибки  = НСтр("ru=''");
	
	Т2_Ст100Гр03 = ПоказательПоСтроке("Т2_Ст100Гр03");
	Т2_Ст130Гр03 = ПоказательПоСтроке("Т2_Ст130Гр03");
	Т2_Ст141Гр03 = ПоказательПоСтроке("Т2_Ст141Гр03");
	Т2_Ст150Гр03 = ПоказательПоСтроке("Т2_Ст150Гр03");
	Таблица2 = мДанныеОтчета.ПолеТабличногоДокументаТаблица2;
	ВставитьЗначениеПоказателя(Таблица2, Т2_Ст100Гр03);
	ВставитьЗначениеПоказателя(Таблица2, Т2_Ст130Гр03);
	ВставитьЗначениеПоказателя(Таблица2, Т2_Ст141Гр03);
	...
	ВнестиПоказательВРасшифровку(Т2_Ст141Гр03, "Таблица2");
	...
	Расшифровка = КС.ЛеваяЧастьСтр + " = " + КС.ПраваяЧастьСтр + ", когда " + Т2_Ст130Гр03.ЗначениеСтр + " = 0 и "
		+ Т2_Ст141Гр03.ЗначениеСтр + " = 0 и " + Т2_Ст150Гр03.ЗначениеСтр + " = 0";
	
	УсловиеВыполнено = Т2_Ст130Гр03.Значение = 0 И Т2_Ст141Гр03.Значение = 0 И Т2_Ст150Гр03.Значение = 0;
	Если НЕ УсловиеВыполнено ИЛИ (УсловиеВыполнено И КС.ЛеваяЧасть = КС.ПраваяЧасть) Тогда
		ЭтоОшибка = Ложь;
		ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
...
Процедура ПроверитьКС_Т2_Ст180Гр03(СтруктураРезультата)
	...
	ОписаниеКС      = НСтр("ru = 'Значение строки 18 графы 3 равно сумме строк 12, 14.1, 15, 16, 17 графы 3';
							|en = 'Значение строки 18 графы 3 равно сумме строк 12, 14.1, 15, 16, 17 графы 3'");
	...
	КС = ПоказателиКС(Т2_Ст180Гр03.Значение, Т2_Ст120Гр03.Значение + Т2_Ст141Гр03.Значение + Т2_Ст150Гр03.Значение
		+ Т2_Ст160Гр03.Значение + Т2_Ст170Гр03.Значение);
	Расшифровка = КС.ЛеваяЧастьСтр + " = " + Т2_Ст120Гр03.ЗначениеСтр + " + " + Т2_Ст141Гр03.ЗначениеСтр + " + "
		+ Т2_Ст150Гр03.ЗначениеСтр + " + " + Т2_Ст160Гр03.ЗначениеСтр + " + " + Т2_Ст170Гр03.ЗначениеСтр
...
Функция ПоказательПоСтроке(УсловныйКодПоказателя)
	...
	ИначеЕсли УсловныйКодПоказателя = "Т2_Ст80Гр03" Тогда
		...
		Результат.Вставить("Представление", Нстр("ru = 'Всего (сумма строк 1+1.1+2+3+4+5+6+7)';
												|en = 'Всего (сумма строк 1+1.1+2+3+4+5+6+7)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Т2_Ст11Гр03" Тогда
		Результат.Вставить("Имя", "П000020001103");
		Результат.Вставить("Представление", Нстр("ru = 'Задолженность за реорганизованным страхователем и (или) снятым с учета обособленным подразделением юридического лица';
												|en = 'Задолженность за реорганизованным страхователем и (или) снятым с учета обособленным подразделением юридического лица'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Т2_Ст141Гр03" Тогда
		Результат.Вставить("Имя", "П000020014103");
		Результат.Вставить("Представление", Нстр("ru = 'Задолженность за территориальным органом Фонда страхователю и (или) снятому с учета обособленному подразделению юридического лица';
												|en = 'Задолженность за территориальным органом Фонда страхователю и (или) снятому с учета обособленному подразделению юридического лица'"));
