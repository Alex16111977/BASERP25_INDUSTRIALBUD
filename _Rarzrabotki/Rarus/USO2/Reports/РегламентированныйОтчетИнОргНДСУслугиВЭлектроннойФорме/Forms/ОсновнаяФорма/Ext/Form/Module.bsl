...
Процедура ВыбратьФорму(Команда)
	...
	"ru = 'Налоговую декларацию по налогу на добавленную стоимость при оказании иностранными организациями услуг в электронной форме представляют организации.';
	|en = 'Налоговую декларацию по налогу на добавленную стоимость при оказании иностранными организациями услуг в электронной форме представляют организации.'");
...
Функция ДоступныеОрганизацииОтсутствуютТекст()
	...
	Возврат НСтр(
	"ru = 'Налоговую декларацию по налогу на добавленную стоимость при оказании иностранными организациями услуг в электронной форме представляют только организации.
	|В справочнике ""Организации"" сведения об организациях отсутствуют.';
	|en = 'Налоговую декларацию по налогу на добавленную стоимость при оказании иностранными организациями услуг в электронной форме представляют только организации.
	|В справочнике ""Организации"" сведения об организациях отсутствуют.'");
