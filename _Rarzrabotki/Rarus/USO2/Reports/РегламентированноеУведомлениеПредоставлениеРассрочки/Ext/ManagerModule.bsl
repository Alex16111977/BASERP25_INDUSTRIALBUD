...
Процедура СоздатьСконвертированныйРассрочкаФСС(Выборка) Экспорт 
	...
	Исключение
		...
		СтрОш = НСтр("ru = 'Создание уведомления о предоставлении рассрочки ФСС';
					|en = 'Создание уведомления о предоставлении рассрочки ФСС'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
