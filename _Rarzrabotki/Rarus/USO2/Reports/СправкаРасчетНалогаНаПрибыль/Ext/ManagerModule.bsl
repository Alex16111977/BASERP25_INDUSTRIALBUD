...
Функция ВариантыНастроек() Экспорт
	...
	Вариант.Вставить("Представление", НСтр("ru = 'Расчет налога на прибыль';
											|en = 'Corporate profit tax calculation'"));
...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета, ОрганизацияВНачале = Истина) Экспорт 
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Справка-расчет налога на прибыль %1';
			|en = 'Detailed calculation of corporate profit tax %1'"),
...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	Для Каждого ИмяТаблицы Из МассивТаблицОтчета Цикл
		...
		ГруппаДоходыМесяц.Заголовок	 = НСтр("ru = 'Доходы без НДС, акцизов и пошлин';
												|en = 'Income VAT exempt, excises and duties'");
		...
		ГруппаРасходыМесяц.Заголовок	 = НСтр("ru = 'Расходы без НДС, акцизов и пошлин';
												|en = 'Expenses VAT exempt, excises and duties'");
