...
Процедура ПриСозданииНаСервере(ЭтаФорма, Отказ, СтандартнаяОбработка) Экспорт
	...
	Если Параметры.Свойство("ПараметрКоманды")
		...
		Если Не ИспользуетсяОрдернаяСхема Тогда
			...
			|en = 'The report is designed to display information on warehouses which use advanced warehousing while recording surplus, shortages, misgrading, and damage.
			|The corresponding advanced warehousing is not used in the %Склад% warehouse as of %Дата%.'");
