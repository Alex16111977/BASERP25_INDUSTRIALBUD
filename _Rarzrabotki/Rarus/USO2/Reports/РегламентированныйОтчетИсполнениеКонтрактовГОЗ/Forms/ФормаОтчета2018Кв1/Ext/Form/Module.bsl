...
Процедура ПроверитьКС_02(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		Настройки.ЭтоОшибка = НЕ Показатели.С001Г2.Значение = РасчетнаяСумма;
...
Процедура ПроверитьКС_05(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		Настройки.ЭтоОшибка = НЕ Показатели.С011Г2.Значение = РасчетнаяСумма;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_44(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		Настройки.ЭтоОшибка = НЕ Показатели.С231Г2.Значение = РасчетнаяСумма;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_46(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		Настройки.ЭтоОшибка = НЕ Показатели.С232Г2.Значение = РасчетнаяСумма;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_48(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		Настройки.ЭтоОшибка = НЕ Показатели.С233Г2.Значение = РасчетнаяСумма;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_50(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		Настройки.ЭтоОшибка = НЕ Показатели.С234Г2.Значение = РасчетнаяСумма;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_52(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		Настройки.ЭтоОшибка = НЕ Показатели.С235Г2.Значение = РасчетнаяСумма;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_60(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		Настройки.ЭтоОшибка = НЕ Показатели.С003Г2.Значение = РасчетнаяСумма;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_62(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		Настройки.ЭтоОшибка = НЕ Показатели.С031Г2.Значение = РасчетнаяСумма;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_64(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		Настройки.ЭтоОшибка = НЕ Показатели.С032Г2.Значение = РасчетнаяСумма;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_66(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		Настройки.ЭтоОшибка = НЕ Показатели.С033Г2.Значение = РасчетнаяСумма;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_68(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		Настройки.ЭтоОшибка = НЕ Показатели.С034Г2.Значение = РасчетнаяСумма;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_71(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		Настройки.ЭтоОшибка = НЕ Показатели.С036Г2.Значение = РасчетнаяСумма;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_78(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		Настройки.ЭтоОшибка = НЕ Показатели.С005Г2.Значение = РасчетнаяСумма;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_79(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		Настройки.ЭтоОшибка = НЕ Показатели.С012Г2.Значение = РасчетнаяСумма;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
