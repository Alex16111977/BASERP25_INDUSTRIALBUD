...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаОсновныеПараметры.Заголовок = СтрШаблон(НСтр("ru = 'Основные параметры контракта (%1)';
																|en = 'Main contract parameters (%1)'"), ВалютаРеглУчета);
	Элементы.ГруппаЗатраты.Заголовок = СтрШаблон(НСтр("ru = 'Целевые затраты (%1)';
														|en = 'Target costs (%1)'"), ВалютаРеглУчета);
