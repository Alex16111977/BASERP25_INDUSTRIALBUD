...
Процедура УстановитьШрифты(ЭтаФорма)
	...
	Для Инд = 1 По 6 Цикл 
		ШрифтНовый = Новый Шрифт(ШрифтСтарый.Имя, ШрифтСтарый.Размер, ШрифтСтарый.Жирный, ШрифтСтарый.Наклонный, ШрифтСтарый.Подчеркивание, ЭтаФорма["ВТ"+Инд], ШрифтСтарый.Масштаб);
...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Лев(Область.Имя, 2) = "ВТ" Тогда 
		...
		ШрифтНовый = Новый Шрифт(ШрифтСтарый.Имя, ШрифтСтарый.Размер, ШрифтСтарый.Жирный, ШрифтСтарый.Наклонный, ШрифтСтарый.Подчеркивание, Зачеркивание, ШрифтСтарый.Масштаб);
...
Функция ПолучитьПараметрыИнициализацииУниверсальногоОтчета()
	Возврат УниверсальныйОтчетСтатистики.ПолучитьПараметрыИнициализацииУниверсальногоОтчета(ЭтаФорма, "АтрибВыгрузкиXML2014Кв1", "ШаблонРосстата2014Кв1", "СхемаВыгрузкиXML2014Кв1", Ложь, Ложь);
КонецФункции
