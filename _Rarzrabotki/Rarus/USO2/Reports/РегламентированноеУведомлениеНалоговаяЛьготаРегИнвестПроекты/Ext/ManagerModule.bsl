...
Процедура СоздатьСконвертированныйОтчетЛьготаНДПИ(Выборка) Экспорт 
	...
	Исключение
		...
		СтрОш = НСтр("ru = 'ошибка при преобразовании: Заявление о применении налоговой льготы участниками региональных инвестиционных проектов';
					|en = 'ошибка при преобразовании: Заявление о применении налоговой льготы участниками региональных инвестиционных проектов'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
