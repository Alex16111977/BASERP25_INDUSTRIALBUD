...
Функция ПолучитьВнешниеНаборыДанных(ПараметрыОтчета, МакетКомпоновки) Экспорт
	...
	|				ИНАЧЕ 0
	|			КОНЕЦ + ВЫБОР
	|				КОГДА КонтролируемыеСделки.СделкаМорскогоМесторождения
	|					ТОГДА 1
	|				ИНАЧЕ 0
	|			КОНЕЦ + ВЫБОР
	|				КОГДА КонтролируемыеСделки.СделкаКонтролируетсяПоИнвестиционнымПроектам
	|					ТОГДА 1
	|				ИНАЧЕ 0
	|			КОНЕЦ + ВЫБОР
	|				КОГДА КонтролируемыеСделки.СделкаКонтролируетсяПоОсвобождениюНДС
	|					ТОГДА 1
	|				ИНАЧЕ 0
	|			КОНЕЦ + ВЫБОР
	|				КОГДА КонтролируемыеСделки.СделкаКонтролируетсяПоИнвестиционномуВычету
	|					ТОГДА 1
	|				ИНАЧЕ 0
	|			КОНЕЦ + ВЫБОР
