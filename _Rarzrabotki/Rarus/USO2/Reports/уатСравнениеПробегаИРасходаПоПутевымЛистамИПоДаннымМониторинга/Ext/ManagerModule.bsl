...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Сравнение пробега и расхода по путевым листам и по данным мониторинга");
	НастройкиВарианта.Описание = НСтр("en='Report provides comparative information on fuels consumption and vehicle mileage according to routing lists and monitoring system.';ru='Отчет позволяет получить сравнительную информацию о расходе ГСМ и пробеге ТС по данным путевых листов и системы мониторинга.'");
