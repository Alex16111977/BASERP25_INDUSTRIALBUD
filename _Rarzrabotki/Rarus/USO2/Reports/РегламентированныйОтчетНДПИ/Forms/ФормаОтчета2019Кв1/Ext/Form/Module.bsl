...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	мСтруктураКолвоКолонокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы51,  5);
...
Процедура ВывестиНаПечатьДанныеМногоуровневогоРаздела(СтруктураПараметров, ОбщиеРеквизитыРазделов, СтрПоля)
	...
	Если ИмяТекРаздела = "Раздел2" Тогда
		...
		Для НомСтрокиВДереве = 1 По ДеревоДанныхРаздела.Строки.Количество() Цикл
			...
			Для НомСтрокиВВетке2 = 1 По Ветка2.Строки.Количество() Цикл
				...
				// Вывод листа с кодом "01010039".
				ВывестиНаПечатьЛист(СтруктураПараметров, ОбщиеРеквизитыРазделов, СтрПоля);
				
				// Определение количества листов с кодом "01010046",
				// относящихся к выведенному листу с кодом "01010039".
				//
				НомерСтроки211 = 0;
				...
				КолЛистов01010046ПоКолСтрок211 = ?(ДробКол = ЦелКол, ЦелКол, ЦелКол + 1);
				КолЛистов01010046ПоКолСтрок212 = 0;
				Для НомСтрокиВВетке21 = 1 По Ветка21.Строки.Количество() Цикл
					...
					КолЛистов01010046ПоКолСтрок212 = КолЛистов01010046ПоКолСтрок212 + ?(ДробКол = ЦелКол, ЦелКол, ЦелКол + 1);
				КонецЦикла;
				// Необходимое количество листов с кодом "01010046".
				КолЛистов01010046 = Макс(КолЛистов01010046ПоКолСтрок211, КолЛистов01010046ПоКолСтрок212);
				
				// Формирование данных для заполнения листов с кодом "01010046".
				//
				МассивДанных211 = Новый Массив;
				Для НомЛиста = 1 По КолЛистов01010046 Цикл
				...
				НомСтрокиВВетке21 = 1;
				НомЛиста = 1;
				Пока НомЛиста <= КолЛистов01010046 Цикл
		...
		Для НомСтрокиВДереве = 1 По ДеревоДанныхРаздела.Строки.Количество() Цикл
			...
			Для НомСтрокиВВетке3 = 1 По Ветка3.Строки.Количество() Цикл
				...
				Для НомСтрокиВВетке31 = 1 По Ветка31.Строки.Количество() Цикл
					...
					// Определение текущего количества листов с кодом "01010060".
					//
					НомерСтроки311 = 0;
					...
					КолТекЛистов01010060ПоКолСтрок311 = ?(ДробКол = ЦелКол, ЦелКол, ЦелКол + 1);
					
					// Формирование данных многосторочной части 3.1.1 для заполнения листов с кодом "01010060".
					//
					МассивДанных311 = Новый Массив;
					Для НомЛиста = 1 По КолТекЛистов01010060ПоКолСтрок311 Цикл
						ПриращениеКНомеру = (НомЛиста - 1) * 3;
					...
					Для НомЛиста = 1 По КолТекЛистов01010060ПоКолСтрок311 Цикл
						...
						СтруктураПараметров31 = ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(СтруктураПараметров);
						СтруктураПараметров31.Вставить("ИмяСтраницы", "Раздел31");
						
						// Вывод листа с кодом "01010060".
	...
	ИначеЕсли ИмяТекРаздела = "Раздел5" Тогда
		...
		// Вывод листов с кодом "01010084".
		//
		Для НомСтрокиВДереве = 1 По ДеревоДанныхРаздела.Строки.Количество() Цикл
			
			Ветка5 = ДеревоДанныхРаздела.Строки[НомСтрокиВДереве - 1];
			
			// Формирование данных многосторочной части 5.1 для заполнения листов с кодом "01010084".
			//
			...
			Для НомСтрокиВВетке5 = 1 По Ветка5.Строки.Количество() Цикл
				...
				Для НомГруппыСтрок01_03 = 1 По КолГруппСтрок01_03ВТекВетке51 Цикл
					...
					Для НомСтрВЭлементеМассива = 1 По 3 Цикл
						...
						НовИмяП000510000105 = Префикс51 + "05_" + Формат(НомСтрВЭлементеМассива, "ЧГ=");
						...
						Если Ветка51.Данные.Свойство(ИмяП000510000101) Тогда
							...
							СтруктДанных51[НовИмяП000510000105] = Ветка51.Данные[ИмяП000510000105];
						КонецЕсли;
					КонецЦикла;
	...
	ИначеЕсли ИмяТекРаздела = "Раздел8" Тогда
		...
		Для НомСтрокиВДереве = 1 По ДеревоДанныхРаздела.Строки.Количество() Цикл
			...
			Для НомСтрокиВВетке8 = 1 По Ветка8.Строки.Количество() Цикл
				...
				// Определение текущего количества листов с кодом "01010138".
				//
				НомерСтрокиМнЧ = 0;
				...
				КолТекЛистов01010138ПоКолСтрокМнЧ = ?(ДробКол = ЦелКол, ЦелКол, ЦелКол + 1);
				
				// Формирование данных многосторочной части 8.1 для заполнения листов с кодом "01010138".
				//
				МассивДанныхМнЧ = Новый Массив;
				Для НомЛиста = 1 По КолТекЛистов01010138ПоКолСтрокМнЧ Цикл
					ПриращениеКНомеру = (НомЛиста - 1) * 3;
						...
						Пока СтрокаТЗ_5.Данные.Свойство("П000055110000_" + Формат(НомСтрТЗ_51 + 1, "ЧГ=")) Цикл
							...
							Если СтрокаТЗ_5.ДополнительныеДанные <> Неопределено
								...
								Для каждого СтрокаТЗ_51 Из ТЗ_51 Цикл
									...
									ВеткаРаздел51.Данные.Вставить("П000510000105_" + Формат(НомСтр51, "ЧГ="), СтрокаТЗ_51["ПризнакКтд"]);
								КонецЦикла;
							Иначе
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	// Раздел 3.
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000300004003", "П000300001003;П000300021003;П000300022003;П000300021503;П000300031003");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000300005003", "П000300001003;П000300004003;П000300004503;П000300021003;П000300022003;П000300021503;П000300031003");
	
	// Раздел 3.1.
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000300021003", "П000300031003");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000300022003", "П000300001003;П000300021003;П000300021503;П000300031003");
...
Процедура СформироватьСпискиВыбора()
	...
	"Выбор кода бюджетной классификации", КоллекцияСписковВыбора["КБК_Раздел2_Раздел8"]);
	...
	"Выбор кода бюджетной классификации", КоллекцияСписковВыбора["КБК_Раздел5"]);
	...
	"Выбор кода бюджетной классификации", КоллекцияСписковВыбора["КБК_Раздел7"]);
		...
		Для каждого СтраницаРаздела3 Из ДанныеРаздела3.Строки Цикл
			...
			Для каждого СтраницаРаздела31 Из СтраницаРаздела3.Строки Цикл
				...
				Если СерЛицРаздел31Длина <> 3 Тогда
					...
					+ " задана серия лицензии на пользование недрами",
					"Раздел31", "П000300020003", КоординатыСтраницы31);
					СтатусПроверки = Ложь;
				КонецЕсли;
				...
				Если НомЛицРаздел31Длина <> 5 Тогда
					...
					+ " задан номер лицензии на пользование недрами",
					"Раздел31", "П000300020004", КоординатыСтраницы31);
					СтатусПроверки = Ложь;
				КонецЕсли;
				...
				Если ВидЛицРаздел31Длина <> 2 Тогда
					...
					+ " задан вид лицензии на пользование недрами",
					"Раздел31", "П000300020005", КоординатыСтраницы31);
					СтатусПроверки = Ложь;
				КонецЕсли;
		...
		Для каждого СтраницаРаздела5 Из ДанныеРаздела5.Строки Цикл
			...
			Для каждого СтраницаРаздела51 Из СтраницаРаздела5.Строки Цикл
				...
				Пока СтраницаРаздела51.Данные.Свойство("П000510000101_" + НомерСтроки51Стр) Цикл
					...
					ПризнКтд51  = СокрЛП(СтраницаРаздела51.Данные["П000510000105_" + НомерСтроки51Стр]);
					...
					Если НЕ ЗначениеЗаполнено(ПризнКтд51) Тогда
						...
						"П000510000105_" + НомерСтроки51Стр, КоординатыСтраницы51);
						СтатусПроверки = Ложь;
...
Процедура Расчет(Форма, ИмяРаздела = "", ОбластьИмя = "") Экспорт
	...
	ИначеЕсли ИмяРаздела = "Раздел3" ИЛИ ИмяРаздела = "Раздел31" ИЛИ ИмяРаздела = "Раздел311" Тогда
		...
		// Стр. 040 равна сумме стр. 220.
		// Стр. 050 = стр. 040 - стр. 045.
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ (ЗначениеЗаполнено(ОбластьИмя)
			И (СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000300004003, ОбластьИмя) > 0
			ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000300005003, ОбластьИмя) > 0
			ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000300021003, ОбластьИмя) > 0
			ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000300022003, ОбластьИмя) > 0)) Тогда
			РасчетВДеревеЗначений(Форма, ИмяРаздела);
		КонецЕсли;
...
Процедура РасчетВДеревеЗначений(Форма, ИмяРаздела)
		...
		Для каждого ВеткаРаздел2 Из ДеревоДанныхРаздел2.Строки Цикл
			Для каждого ВеткаРаздел21 Из ВеткаРаздел2.Строки Цикл
				...
				Если ВеткаРаздел21 = АктивнаяВеткаДереваЗначений Тогда
					ВеткаРаздел21.Данные.Вставить("П000200013003", Форма.ТабличныйДокумент.Области["П000200013003"].Значение);
					ВеткаРаздел21.Данные.Вставить("П000200014003", Форма.ТабличныйДокумент.Области["П000200014003"].Значение);
				КонецЕсли;
				
				ВеткаРаздел21.Данные.Вставить("П000200015003",
				РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ВеткаРаздел21.Данные.П000200013003)
				- РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ВеткаРаздел21.Данные.П000200014003));
	...
	ИначеЕсли ИмяРаздела = "Раздел3" ИЛИ ИмяРаздела = "Раздел31" ИЛИ ИмяРаздела = "Раздел311" Тогда
		...
		Для каждого Ветка3 Из ДеревоДанныхРаздел3.Строки Цикл
			...
			Если Ветка3 = АктивнаяВетка Тогда
				Ветка3.Данные.Вставить("П000300004503", Форма.ТабличныйДокумент.Области["П000300004503"].Значение);
			КонецЕсли;
			...
			Для каждого Ветка31 Из Ветка3.Строки Цикл
				...
				Если Ветка31 = АктивнаяВетка Тогда
					Ветка31.Данные.Вставить("П000300021503", Форма.ТабличныйДокумент.Области["П000300021503"].Значение);
				КонецЕсли;
				...
				Для каждого Ветка311 Из Ветка31.Строки Цикл
					...
					Если Ветка311 = АктивнаяВетка Тогда
						Ветка311.Данные.Вставить("П000300031003", Форма.ТабличныйДокумент.Области["П000300031003"].Значение);
					КонецЕсли;
					Стр210 = Стр210 + РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
					Форма, Ветка311.Данные["П000300031003"]);
					
				КонецЦикла;
				
				Стр220 = Стр210 - РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
				Форма, Ветка31.Данные["П000300021503"]);
				
				Ветка31.Данные.Вставить("П000300021003", Стр210);
				Ветка31.Данные.Вставить("П000300022003", Стр220);
				Если Ветка31 = АктивнаяВетка Тогда
					Форма.ТабличныйДокумент.Области["П000300021003"].Значение = Стр210;
					Форма.ТабличныйДокумент.Области["П000300022003"].Значение = Стр220;
				КонецЕсли;
				
				Стр040 = Стр040 + Стр220;
				
			КонецЦикла;
			
			Стр050 = Стр040 - РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
			Форма, Ветка3.Данные["П000300004503"]);
			
			Ветка3.Данные["П000300004003"] = Стр040;
			Ветка3.Данные["П000300005003"] = Стр050;
			Если Ветка3 = АктивнаяВетка Тогда
				Форма.ТабличныйДокумент.Области["П000300004003"].Значение = Стр040;
				Форма.ТабличныйДокумент.Области["П000300005003"].Значение = Стр050;
			КонецЕсли;
	...
	ИначеЕсли ИмяРаздела = "Раздел5" ИЛИ ИмяРаздела = "Раздел51" Тогда
		...
		ВозможныеКодыОснованияДляРасчетаСтр140 = СтрРазделить("2000,4000", ",", Ложь);
		...
		Для каждого ВеткаРаздел5 Из ДеревоДанныхРаздел5.Строки Цикл
			...
			Если ВеткаРаздел5 = АктивнаяВетка5 Тогда
				ВеткаРаздел5.Данные.Вставить("П000500007003", Форма.ТабличныйДокумент.Области["П000500007003"].Значение);
			КонецЕсли;
			...
			Для каждого ВеткаРаздел51 Из ВеткаРаздел5.Строки Цикл
				...
				Пока ВеткаРаздел51.Данные.Свойство("П000510000101_" + НомСтрСтр) Цикл
					...
					Если ЗначениеЗаполнено(ТекКодОсн) И ВозможныеКодыОснованияДляРасчетаСтр140.Найти(ТекКодОсн) <> Неопределено Тогда
			...
			ВеткаРаздел5.Данные.Вставить("П000500014003", ВеткаРаздел5.Данные["П000500007003"] * СуммаПоГрафе2Раздела51);
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяСтраницыПанели)
	...
	ИначеЕсли ИмяСтраницыПанели = "Раздел3" Тогда
		...
		Если СокрЛП(ОпределяющаяОбласть.Значение) = "03300" Тогда
			ЗапретитьВводДанныхВОбласть(Форма, ОбрабатываемаяОбласть);
			ОбрабатываемаяОбласть.Формат = "ЧН=0";
		Иначе
			РазрешитьВводДанныхВОбласть(Форма, ОбрабатываемаяОбласть);
...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	ПроверитьКС_3_15а(СтруктураРезультата);
	ПроверитьКС_3_15б(СтруктураРезультата);
	...
	Для Инд = 1 По КолвоСтрокВМногострочнойЧасти Цикл
		...
		Для Каждого СтраницаРаздела Из Раздел8 Цикл
			...
			Если ДанныеСтраницы.Свойство("НомерСтраницы") Тогда
				НомерСтраницыСтр = ДанныеСтраницы.НомерСтраницы;
			Иначе
				НомерСтраницыСтр = СтрокаЧГ0(Раздел8.Индекс(СтраницаРаздела) + 1);
			КонецЕсли;
...
Процедура ПроверитьКС_1_2(СтруктураРезультата)
	...
	ОписаниеКС      = НСтр("ru = 'Код по ОКТМО в строке 020 Раздела 1 должен соответствовать коду по ОКТМО, указанному в ';
		...
		+ НСтр("ru = 'строке 040 Раздела 2.1 или в строке 190 Раздела 3.1 или в строке 040 Раздела 4 или в строке 050 раздел';
				|en = 'строке 040 Раздела 2.1 или в строке 190 Раздела 3.1 или в строке 040 Раздела 4 или в строке 050 раздел'")
	...
	Для Инд = 1 По КолвоСтрокВМногострочнойЧасти Цикл
		...
		Для Каждого Страница Из Раздел3 Цикл
			...
			Если Р1Ст1Гр02.Значение = Р3Ст190Гр03.Значение Тогда
				ВнестиПоказательВРасшифровку(Р3Ст190Гр03, Р3Ст190Гр03.Раздел, НомерСтраницыМнУ(Страница.Представление, Р3Ст190Гр03.ПорядокСтраницы));
				МассивРасшифровки.Добавить(Р1Ст1Гр02.ЗначениеСтр + " = " + Р3Ст190Гр03.ЗначениеСтр);
				Прервать;
			КонецЕсли;
		...
		Для Каждого Страница Из Раздел8 Цикл
			...
			Если ДанныеСтраницы.Свойство("НомерСтраницы") Тогда
				НомерСтраницыСтр = ДанныеСтраницы.НомерСтраницы;
			Иначе
				НомерСтраницыСтр = СтрокаЧГ0(Раздел8.Индекс(Страница) + 1);
			КонецЕсли;
		...
		Если Р1Ст1Гр02.Значение = Р2Ст40Гр03.Значение
			ИЛИ Р1Ст1Гр02.Значение = Р3Ст190Гр03.Значение
...
Процедура ПроверитьКС_2_1(СтруктураРезультата)
	...
	Раздел2 = ДанныеИзДереваРаздела("Раздел2", 1);
...
Процедура ПроверитьКС_2_5(СтруктураРезультата)
	...
	Р2Ст40Гр03 = ПоказательПоСтроке("Р2Ст40Гр03");
	Р1Ст1Гр02 = ПоказательПоСтроке("Р1Ст1Гр02");
	Раздел2 = ДанныеИзДереваРаздела("Раздел2", 2);
	Раздел1 = мДанныеОтчета.Раздел1;
...
Процедура ПроверитьКС_2_7(СтруктураРезультата)
	...
	СоответствиеКк.Вставить(2021, 428);
	...
	ОписаниеКС			= НСтр("ru='Показатель, характеризующий особенности добычи нефти Дм в строке 060 Раздела 2.1 " 
		+ "должен быть равен произведению: строка 070 х строка 080 х (1 - строка 090 х строка 110 х 1 х строка 115 х строка "
		+ "120) - Кк - строка 123 - строка 125 х строка 126'");
	...
	ШаблонРасшифровки	= НСтр("ru = '%1 = %2 х %3 х (1 - %4 х %5 х 1 х %6 х %7) - %8 - %9';
								|en = '%1 = %2 х %3 х (1 - %4 х %5 х 1 х %6 х %7) - %8 - %9'");
	ШаблонРасшифровки2	= НСтр("ru = '%1 - %2 х %3 Итог [%4]';
								|en = '%1 - %2 х %3 Итог [%4]'");
	Нарушение			= НСтр("ru = 'ст.342.5 НК РФ';
								|en = 'ст.342.5 НК РФ'");
	...
	Р2Ст123Гр03 = ПоказательПоСтроке("Р2Ст123Гр03");
	Р2Ст125Гр03 = ПоказательПоСтроке("Р2Ст125Гр03");
	Р2Ст126Гр03 = ПоказательПоСтроке("Р2Ст126Гр03");
	...
	Для Каждого СтраницаРаздела Из Раздел2 Цикл
		...
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Ст123Гр03);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Ст125Гр03);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Ст126Гр03);
		
		ПоказателиНеЗаполнены = Р2Ст60Гр03.Значение + Р2Ст70Гр03.Значение + Р2Ст80Гр03.Значение + Р2Ст90Гр03.Значение 
			+ Р2Ст110Гр03.Значение + Р2Ст115Гр03.Значение + Р2Ст120Гр03.Значение + Р2Ст123Гр03.Значение 
			+ Р2Ст125Гр03.Значение + Р2Ст126Гр03.Значение = 0;
		...
		ВнестиПоказательВРасшифровку(Р2Ст123Гр03, Р2Ст123Гр03.Раздел, НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р2Ст125Гр03, Р2Ст125Гр03.Раздел, НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р2Ст126Гр03, Р2Ст126Гр03.Раздел, НомерСтраницыСтр);
		
		РасчетнаяСумма = Р2Ст70Гр03.Значение * Р2Ст80Гр03.Значение * (1 - Р2Ст90Гр03.Значение * Р2Ст110Гр03.Значение * 
			Р2Ст115Гр03.Значение * Р2Ст120Гр03.Значение) - КоэффициентКк - Р2Ст123Гр03.Значение 
			- Р2Ст125Гр03.Значение * Р2Ст126Гр03.Значение;
		...
		Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонРасшифровки, КС.ЛеваяЧасть, 
			...
			Р2Ст120Гр03.Значение, КоэффициентКк, Р2Ст123Гр03.Значение);
		Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонРасшифровки2, Расшифровка, 
			Р2Ст125Гр03.Значение, Р2Ст126Гр03.Значение, КС.ПраваяЧасть);
...
Процедура ПроверитьКС_3_1(СтруктураРезультата)
	...
	Раздел3 = ДанныеИзДереваРаздела("Раздел3", 1);
...
Процедура ПроверитьКС_3_3(СтруктураРезультата)
	...
	ТекстФормулы    = НСтр("ru = 'Раздел 3 (КС 3.3)';
							|en = 'Раздел 3 (КС 3.3)'");
	ОписаниеКС      = НСтр("ru = 'КБК по строке 020 Раздела 3 должен быть равен ""18210701012011000110"" или ""18210701013011000110""';
							|en = 'КБК по строке 020 Раздела 3 должен быть равен ""18210701012011000110"" или ""18210701013011000110""'");
	...
	Для Каждого СтраницаРаздела Из Раздел3 Цикл
		...
		КодыКБК = СтроковыеФункцииКлиентСервер.РазложитьСтрокуВМассивПодстрок("18210701012011000110,18210701013011000110");
		КСВыполнено = (КодыКБК.Найти(Р3Ст20Гр03.Значение) <> Неопределено);
		Расшифровка = ПредставлениеДляРасшифровки(Р3Ст20Гр03.ЗначениеСтр) + " = ""18210701012011000110"" или ""18210701013011000110""";
...
Процедура ПроверитьКС_3_5(СтруктураРезультата)
	...
	ТекстФормулы    = НСтр("ru = 'Раздел 3 (КС 3.5)';
							|en = 'Раздел 3 (КС 3.5)'");
	ОписаниеКС      = НСтр("ru = 'Код по ОКТМО по строке 190 Раздела 3.1 должен быть равен ОКТМО в строке 020 Раздела 1';
							|en = 'Код по ОКТМО по строке 190 Раздела 3.1 должен быть равен ОКТМО в строке 020 Раздела 1'");
	...
	Р3Ст190Гр03 = ПоказательПоСтроке("Р3Ст190Гр03");
	Р1Ст1Гр02 = ПоказательПоСтроке("Р1Ст1Гр02");
	Раздел3 = ДанныеИзДереваРаздела("Раздел3", 2);
	Раздел1 = мДанныеОтчета.Раздел1;
	...
	Для Каждого СтраницаРаздела Из Раздел3 Цикл
		...
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р3Ст190Гр03);
		Если НЕ ЗначениеЗаполнено(Р3Ст190Гр03.Значение) Тогда
			Продолжить;
		КонецЕсли;
		...
		Расшифровка = ПредставлениеДляРасшифровки(Р1Ст1Гр02.ЗначениеСтр) + " = "
			+ ПредставлениеДляРасшифровки(Р3Ст190Гр03.ЗначениеСтр);
...
Процедура ПроверитьКС_3_6(СтруктураРезультата)
	...
	ТекстФормулы    = НСтр("ru = 'Раздел 3 (КС 3.6)';
							|en = 'Раздел 3 (КС 3.6)'");
	ОписаниеКС      = НСтр("ru = 'Сумма исчисленного налога по строке 040 Раздела 3 должна быть равна сумме всех значений строки 220 Раздела 3.1';
							|en = 'Сумма исчисленного налога по строке 040 Раздела 3 должна быть равна сумме всех значений строки 220 Раздела 3.1'");
	...
	Р3Ст220Гр03 = ПоказательПоСтроке("Р3Ст220Гр03");
	...
	Для Каждого СтраницаРаздела Из Раздел3 Цикл
		...
		СуммаР3Ст220Гр03 = СуммаПодУровня(УровеньСтраницы, Раздел3, Р3Ст220Гр03);
		//ВставитьЗначениеПоказателя(ДанныеСтраницы, Р3Ст190Гр03);
		//ВнестиПоказательВРасшифровку(Р3Ст190Гр03, Р3Ст190Гр03.Раздел, НомерСтраницыМнУ(СтраницаРаздела.Представление, Р3Ст190Гр03.ПорядокСтраницы));
		
		КС = ПоказателиКС(Р3Ст40Гр03.Значение, СуммаР3Ст220Гр03.Значение);
		Расшифровка = КС.ЛеваяЧастьСтр + " = " + РасшифровкаВСтр(СуммаР3Ст220Гр03.ЗначениеСтр) + " Итог [" + КС.ПраваяЧастьСтр + "]";
...
Процедура ПроверитьКС_3_7(СтруктураРезультата)
	...
	ТекстФормулы    = НСтр("ru = 'Раздел 3 (КС 3.7)';
							|en = 'Раздел 3 (КС 3.7)'");
	ОписаниеКС      = НСтр("ru = 'Коэффициент, характеризующий долю реализации газа Ов по строке 110 Раздела 3 должен быть равен ""0,64"" или ""1""';
							|en = 'Коэффициент, характеризующий долю реализации газа Ов по строке 110 Раздела 3 должен быть равен ""0,64"" или ""1""'");
	...
	Для Каждого СтраницаРаздела Из Раздел3 Цикл
		...
		Если УровеньСтраницы = НомерСтраницыМнУ(СтраницаРаздела.Представление, Р3Ст110Гр03.ПорядокСтраницы) Тогда
			Продолжить;
		КонецЕсли;
		УровеньСтраницы = НомерСтраницыМнУ(СтраницаРаздела.Представление, Р3Ст110Гр03.ПорядокСтраницы);
		
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р3Ст110Гр03);
		Если НЕ ЗначениеЗаполнено(Р3Ст110Гр03.Значение) Тогда
			Продолжить;
		КонецЕсли;
		...
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р3Ст110Гр03);
		ВнестиПоказательВРасшифровку(Р3Ст110Гр03, Р3Ст110Гр03.Раздел, НомерСтраницыМнУ(СтраницаРаздела.Представление, Р3Ст110Гр03.ПорядокСтраницы));
		
		КСВыполнено = ((Р3Ст110Гр03.Значение = 0.64) ИЛИ (Р3Ст110Гр03.Значение = 1));
		Расшифровка = Р3Ст110Гр03.ЗначениеСтр + " = ""0,64"" или ""1""";
...
Процедура ПроверитьКС_3_8(СтруктураРезультата)
	...
	ТекстФормулы    = НСтр("ru = 'Раздел 3 (КС 3.8)';
							|en = 'Раздел 3 (КС 3.8)'");
	ОписаниеКС      = НСтр("ru='Коэффициент Кгпн по строке 120 Раздела 3 должен быть равен "
		+ "(35 х Гг)/(35 х (Гг + Гп) + 42 х (Но + Кг)), где Гг - газ горючий (сумма всех значений графы 2 Раздела 3.1.1 "
		+ "для Кода ПИ (стр. 010 Раздела 3) = ""03300"" и Кода ЕИ (стр. 030 Раздела 3) = ""114""), Гп - газ попутный "
		+ "(сумма всех значений графы 2 Раздела 5.1 для Кода ПИ = ""03400"" Кода ЕИ = ""114""), Но - нефть обезвоженная "
		+ "(сумма всех значений графы 2 Раздела 2.1.1 и графы 2 Раздела 2.1.2 для Кода ПИ = ""03100"" и Кода ЕИ = ""168""), "
		+ "Кг - газовый конденсат (сумма всех значений графы 2 Раздела 3.1.1 для Кода ПИ = ""03200"" и Код ЕИ = ""168""'");
	...
	Р3Ст120Гр03		= ПоказательПоСтроке("Р3Ст120Гр03");
	...
	Раздел3_		= ДанныеМногоуровнегоРаздела("Раздел3", 1, 1);
	Раздел2а		= ДанныеМногоуровнегоРаздела("Раздел2", 3, 3);
	Раздел2б		= ДанныеМногоуровнегоРаздела("Раздел2", 1, 2);
	Раздел5			= ДанныеМногоуровнегоРаздела("Раздел5");
	
	Для Каждого СтраницаРаздела Из Раздел3_ Цикл
		
		ВставитьЗначениеПоказателя(СтраницаРаздела, Р3Ст10Гр03);
		ВставитьЗначениеПоказателя(СтраницаРаздела, Р3Ст30Гр03);
		
		Если НЕ (Р3Ст10Гр03.Значение = "03300" И Р3Ст30Гр03.Значение = "114") Тогда
			Продолжить;
		КонецЕсли; 
		...
		ВставитьЗначениеПоказателя(СтраницаРаздела, Р3Ст120Гр03);
		ВнестиПоказательВРасшифровку(Р3Ст120Гр03, Р3Ст120Гр03.Раздел, НомерСтраницыМнС(СтраницаРаздела, Р3Ст120Гр03));
		...
		СуммироватьМнЧ(Раздел2б, Р211Ст1Гр02, Новый Структура(Р2Ст10Гр03.Имя + "," + Р2Ст30Гр03.Имя, "03100", "168"));
		СуммироватьМнЧ(Раздел2а, Р212Ст1Гр02, Новый Структура(Р2Ст10Гр03.Имя + "," + Р2Ст30Гр03.Имя, "03100", "168"));
		...
		ЗначениеДелителяПравойЧасти = 35 * (Р311Ст1Гр02.Значение + Р5Ст1Гр02.Значение) 
			+ 42 * (Р211Ст1Гр02.Значение + Р212Ст1Гр02.Значение + Р311Ст1Гр02_2.Значение);
		
		КС = ПоказателиКС(Р3Ст120Гр03.Значение, ?(ЗначениеДелителяПравойЧасти = 0, 0, ЗначениеДелимогоПравойЧасти / ЗначениеДелителяПравойЧасти), 2, 2);
		
		Расшифровка = КС.ЛеваяЧастьСтр + " = (35 х " + Р311Ст1Гр02.ЗначениеСтр + ") / (35 х (" + Р311Ст1Гр02.ЗначениеСтр + " + "
			+ Р5Ст1Гр02.ЗначениеСтр + ") + 42 х (" + Р211Ст1Гр02.ЗначениеСтр + " + " + Р212Ст1Гр02.ЗначениеСтр + " + " 
			+ Р311Ст1Гр02_2.ЗначениеСтр + ")) Итог [" + КС.ПраваяЧастьСтр + "]";
...
Процедура ПроверитьКС_3_9(СтруктураРезультата)
	...
	ТекстФормулы    = НСтр("ru = 'Раздел 3 (КС 3.9)';
							|en = 'Раздел 3 (КС 3.9)'");
	ОписаниеКС      = НСтр("ru='Коэффициент Дг по строке 250 Раздела 3.1 должен быть равен "
		+ "(35 х Гг) / (35 х Гг + 42 х Кг), где Гг - газ горючий (сумма всех значений графы 2 Раздела 3.1.1 для Кода ПИ "
		+ "(стр. 010 Раздела 3) = ""03300"" и Кода ЕИ (стр. 030 Раздела 3) = ""114""), Кг - газовый конденсат (сумма всех "
		+ "значений графы 2 Раздела 3.1.1 для Кода ПИ = ""03200"" и Код ЕИ = ""168""'");
	...
	Р3Ст250Гр03		= ПоказательПоСтроке("Р3Ст250Гр03");
	Р311Ст1Гр02		= ПоказательПоСтроке("Р311Ст1Гр02");
	Р311Ст1Гр02_2	= ПоказательПоСтроке("Р311Ст1Гр02");
	Р3Ст10Гр03		= ПоказательПоСтроке("Р3Ст10Гр03");
	Р3Ст30Гр03		= ПоказательПоСтроке("Р3Ст30Гр03");
	...
	Раздел3			= ДанныеМногоуровнегоРаздела("Раздел3");
	Раздел3_		= ДанныеМногоуровнегоРаздела("Раздел3", 1, 2);
	...
	Для Каждого СтраницаРаздела Из Раздел3_ Цикл
		...
		ВставитьЗначениеПоказателя(СтраницаРаздела, Р3Ст250Гр03);
		ВнестиПоказательВРасшифровку(Р3Ст250Гр03, Р3Ст250Гр03.Раздел, НомерСтраницыМнС(СтраницаРаздела, Р3Ст250Гр03));
		...
		КС = ПоказателиКС(Р3Ст250Гр03.Значение, ?(ЗначениеДелителяПравойЧасти = 0, 0, ЗначениеДелимогоПравойЧасти / ЗначениеДелителяПравойЧасти), 2, 2);
			
		Расшифровка = КС.ЛеваяЧастьСтр + " = (35 х " + Р311Ст1Гр02.ЗначениеСтр + ") / (35 х " + Р311Ст1Гр02.ЗначениеСтр + " + "
			+ " 42 х " + Р311Ст1Гр02_2.ЗначениеСтр + ") Итог [" + КС.ПраваяЧастьСтр + "]";
...
Процедура ПроверитьКС_3_10(СтруктураРезультата)
	...
	ТекстФормулы    = НСтр("ru = 'Раздел 3 (КС 3.10)';
							|en = 'Раздел 3 (КС 3.10)'");
	ОписаниеКС      = НСтр("ru='Значение коэффициента Квг (строка 290 Раздела 3.1.1) должно быть равно "
		+ "2,75 - 2,5 х строка 230 Раздела 3.1, если значение строки 230 Раздела 3.1 > 0,7 и <= 0,9'");
	...
	Р3Ст290Гр03 = ПоказательПоСтроке("Р3Ст290Гр03");
	Р3Ст230Гр03 = ПоказательПоСтроке("Р3Ст230Гр03");
	Раздел3 = ДанныеМногоуровнегоРаздела("Раздел3");
	
	//Определяем уровень обхода по "младшему" показателю
	УровеньОбхода = Макс(?(Р3Ст290Гр03.Свойство("ПорядокСтраницы"), Р3Ст290Гр03.ПорядокСтраницы, 0), 
		?(Р3Ст230Гр03.Свойство("ПорядокСтраницы"), Р3Ст230Гр03.ПорядокСтраницы, 0));
	
	ДанныеРаздела = Раздел3.Скопировать();
	ДанныеРаздела.Свернуть("НомерСтраницы," + КолонкиДляСворачивания(УровеньОбхода) + Р3Ст230Гр03.Имя + "," + Р3Ст290Гр03.Имя);
	
	Для Каждого СтрокаДанных Из ДанныеРаздела Цикл
		
		ВставитьЗначениеПоказателя(СтрокаДанных, Р3Ст230Гр03);
		Если НЕ ЗначениеЗаполнено(Р3Ст230Гр03.Значение) Тогда
			Продолжить;
		КонецЕсли;
		...
		ВнестиПоказательВРасшифровку(Р3Ст230Гр03, Р3Ст230Гр03.Раздел, СтрокаДанных.НомерСтраницы);
		
		ВставитьЗначениеПоказателя(СтрокаДанных, Р3Ст290Гр03);
		ВнестиПоказательВРасшифровку(Р3Ст290Гр03, Р3Ст290Гр03.Раздел, СтрокаДанных.НомерСтраницы);
	
		КС = ПоказателиКС(Р3Ст290Гр03.Значение, 2.75 - 2.5 * Р3Ст230Гр03.Значение, 4, 4);
			
		Расшифровка = КС.ЛеваяЧастьСтр + " = 2.75 - 2.5 * " + Р3Ст230Гр03.ЗначениеСтр + " Итог [" + КС.ПраваяЧастьСтр + "], когда 0.7 < "
			+ Р3Ст230Гр03.ЗначениеСтр + " <= 0.9";
		
		УсловиеВыполнено = (Р3Ст230Гр03.Значение > 0.7) И (Р3Ст230Гр03.Значение <= 0.9);
		Если НЕ УсловиеВыполнено ИЛИ (УсловиеВыполнено И КС.ЛеваяЧасть = КС.ПраваяЧасть) Тогда
			ЭтоОшибка = Ложь;
			ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
...
Процедура ПроверитьКС_3_11(СтруктураРезультата)
	...
	ТекстФормулы    = НСтр("ru = 'Раздел 3 (КС 3.11)';
							|en = 'Раздел 3 (КС 3.11)'");
	ОписаниеКС      = НСтр("ru='Значение коэффициента Квг (строка 290 Раздела 3.1.1) должно быть равно ""0,5"", "
		+ "если значение строки 230 Раздела 3.1 > 0,9'");
	ОписаниеОшибки  = НСтр("ru = 'Допущена ошибка при определении коэффициента Квг (возможна арифметическая ошибка)';
							|en = 'Допущена ошибка при определении коэффициента Квг (возможна арифметическая ошибка)'");
	Нарушение       = НСтр("ru = 'ст.342.4 НК РФ';
							|en = 'ст.342.4 НК РФ'");
	...
	Для Каждого СтрокаДанных Из ДанныеРаздела Цикл
		...
		КС = ПоказателиКС(Р3Ст290Гр03.Значение, 0.5, 4, 4);
			
		Расшифровка = КС.ЛеваяЧастьСтр + " = " + КС.ПраваяЧастьСтр + ", когда " + Р3Ст230Гр03.ЗначениеСтр + " > 0.9";
		
		УсловиеВыполнено = (Р3Ст230Гр03.Значение > 0.9);
		Если НЕ УсловиеВыполнено ИЛИ (УсловиеВыполнено И КС.ЛеваяЧасть = КС.ПраваяЧасть) Тогда
			ЭтоОшибка = Ложь;
			ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
...
Процедура ПроверитьКС_3_12(СтруктураРезультата)
	...
	ТекстФормулы    = НСтр("ru = 'Раздел 3 (КС 3.12)';
							|en = 'Раздел 3 (КС 3.12)'");
	ОписаниеКС      = НСтр("ru='Значение коэффициента Квг (строка 290 Раздела 3.1.1) должно быть равно ""1"", "
		+ "если значение строки 230 Раздела 3.1 <= 0,7'");
	ОписаниеОшибки  = НСтр("ru = 'Допущена ошибка при определении коэффициента Квг (возможна арифметическая ошибка)';
							|en = 'Допущена ошибка при определении коэффициента Квг (возможна арифметическая ошибка)'");
	Нарушение       = НСтр("ru = 'ст.342.4 НК РФ';
							|en = 'ст.342.4 НК РФ'");
	...
	Для Каждого СтрокаДанных Из ДанныеРаздела Цикл
		...
		КС = ПоказателиКС(Р3Ст290Гр03.Значение, 1, 4, 4);
			
		Расшифровка = КС.ЛеваяЧастьСтр + " = " + КС.ПраваяЧастьСтр + ", когда " + Р3Ст230Гр03.ЗначениеСтр + " <= 0.7";
		
		УсловиеВыполнено = (Р3Ст230Гр03.Значение <= 0.7);
		Если НЕ УсловиеВыполнено ИЛИ (УсловиеВыполнено И КС.ЛеваяЧасть = КС.ПраваяЧасть) Тогда
			ЭтоОшибка = Ложь;
			ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
...
Процедура ПроверитьКС_3_13(СтруктураРезультата)
	...
	ТекстФормулы    = НСтр("ru = 'Раздел 3 (КС 3.13)';
							|en = 'Раздел 3 (КС 3.13)'");
	ОписаниеКС      = НСтр("ru = 'Значение коэффициента Кгз (строка 290 Раздела 3.1.1) должно быть равно ""1"", если значение строки 270 Раздела 3.1.1 <= 1700';
							|en = 'Значение коэффициента Кгз (строка 290 Раздела 3.1.1) должно быть равно ""1"", если значение строки 270 Раздела 3.1.1 <= 1700'");
	...
	Р3Ст290Гр05 = ПоказательПоСтроке("Р3Ст290Гр05");
	Р3Ст270Гр03 = ПоказательПоСтроке("Р3Ст270Гр03");
	Раздел3 = ДанныеМногоуровнегоРаздела("Раздел3");
	
	//Определяем уровень обхода по "младшему" показателю
	УровеньОбхода = Макс(?(Р3Ст290Гр05.Свойство("ПорядокСтраницы"), Р3Ст290Гр05.ПорядокСтраницы, 0), 
		?(Р3Ст270Гр03.Свойство("ПорядокСтраницы"), Р3Ст270Гр03.ПорядокСтраницы, 0));
	
	ДанныеРаздела = Раздел3.Скопировать();
	ДанныеРаздела.Свернуть("НомерСтраницы," + КолонкиДляСворачивания(УровеньОбхода) + Р3Ст270Гр03.Имя + "," + Р3Ст290Гр05.Имя);
	
	Для Каждого СтрокаДанных Из ДанныеРаздела Цикл
		
		ВставитьЗначениеПоказателя(СтрокаДанных, Р3Ст270Гр03);
		Если НЕ ЗначениеЗаполнено(Р3Ст270Гр03.Значение) Тогда
			Продолжить;
		КонецЕсли;
		...
		ВнестиПоказательВРасшифровку(Р3Ст270Гр03, Р3Ст270Гр03.Раздел, СтрокаДанных.НомерСтраницы);
		
		ВставитьЗначениеПоказателя(СтрокаДанных, Р3Ст290Гр05);
		ВнестиПоказательВРасшифровку(Р3Ст290Гр05, Р3Ст290Гр05.Раздел, СтрокаДанных.НомерСтраницы);
	
		КС = ПоказателиКС(Р3Ст290Гр05.Значение, 1);
			
		Расшифровка = КС.ЛеваяЧастьСтр + " = " + КС.ПраваяЧастьСтр + ", когда " + Р3Ст270Гр03.ЗначениеСтр + " <= 1700";
		
		УсловиеВыполнено = (Р3Ст270Гр03.Значение <= 1700);
		Если НЕ УсловиеВыполнено ИЛИ (УсловиеВыполнено И КС.ЛеваяЧасть = КС.ПраваяЧасть) Тогда
			ЭтоОшибка = Ложь;
			ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
...
Процедура ПроверитьКС_3_14(СтруктураРезультата)
	...
	ТекстФормулы    = НСтр("ru = 'Раздел 3 (КС 3.14)';
							|en = 'Раздел 3 (КС 3.14)'");
	ОписаниеКС      = НСтр("ru = 'Значение коэффициента Кгз (строка 290 Раздела 3.1.1) должно быть равно ""0,64"", если значение строки 270 Раздела 3.1.1 > 1700 и <= 3300';
							|en = 'Значение коэффициента Кгз (строка 290 Раздела 3.1.1) должно быть равно ""0,64"", если значение строки 270 Раздела 3.1.1 > 1700 и <= 3300'");
	ОписаниеОшибки  = НСтр("ru = 'Допущена ошибка при определении коэффициента Кгз (возможна арифметическая ошибка)';
							|en = 'Допущена ошибка при определении коэффициента Кгз (возможна арифметическая ошибка)'");
	Нарушение       = НСтр("ru = 'ст.342.4 НК РФ';
							|en = 'ст.342.4 НК РФ'");
	...
	Для Каждого СтрокаДанных Из ДанныеРаздела Цикл
		...
		КС = ПоказателиКС(Р3Ст290Гр05.Значение, 0.64);
			
		Расшифровка = КС.ЛеваяЧастьСтр + " = " + КС.ПраваяЧастьСтр + ", когда 1700 < " + Р3Ст270Гр03.ЗначениеСтр + " <= 3300";
		
		УсловиеВыполнено = (Р3Ст270Гр03.Значение  > 1700) И (Р3Ст270Гр03.Значение <= 3300);
		Если НЕ УсловиеВыполнено ИЛИ (УсловиеВыполнено И КС.ЛеваяЧасть = КС.ПраваяЧасть) Тогда
			ЭтоОшибка = Ложь;
			ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
...
&НаСервере
Процедура ПроверитьКС_3_15а(СтруктураРезультата)
	
	ОбщееЧислоОшибок    = СтруктураРезультата.КоличествоНайденныхОшибок;
	ОбщееЧислоБезОшибок = СтруктураРезультата.КоличествоНайденныхБезОшибок;
	СтруктураОшибок     = СтруктураРезультата.СтруктураОшибок;
	
	ТекстФормулы    = НСтр("ru = 'Раздел 3 (КС 3.15а)';
							|en = 'Раздел 3 (КС 3.15а)'");
	ОписаниеКС      = НСтр("ru='Значение коэффициента Кгз (строка 290 Раздела 3.1.1) для газового конденсата (Код ПИ "
		+ "по стр. 010 Раздела 3 = ""03200"" и Код ЕИ по строке 030 Раздела 3 = ""168"") должно быть равно ""0,5"", если "
		+ "значение строки 270 Раздела 3.1.1 > 3300'");
	ОписаниеОшибки  = НСтр("ru = 'Допущена ошибка при определении коэффициента Кгз (возможна арифметическая ошибка)';
							|en = 'Допущена ошибка при определении коэффициента Кгз (возможна арифметическая ошибка)'");
	Нарушение       = НСтр("ru = 'ст.342.4 НК РФ';
							|en = 'ст.342.4 НК РФ'");
	...
	ДанныеРаздела = Раздел3.Скопировать();
	ДанныеРаздела.Свернуть("НомерСтраницы," + КолонкиДляСворачивания(УровеньОбхода) + Р3Ст270Гр03.Имя 
		+ "," + Р3Ст290Гр05.Имя + "," + Р3Ст10Гр03.Имя + "," + Р3Ст30Гр03.Имя);
	
	Для Каждого СтрокаДанных Из ДанныеРаздела Цикл
		
		ВставитьЗначениеПоказателя(СтрокаДанных, Р3Ст10Гр03);
		ВставитьЗначениеПоказателя(СтрокаДанных, Р3Ст30Гр03);
		
		Если НЕ (Р3Ст10Гр03.Значение = "03200" И Р3Ст30Гр03.Значение = "168") Тогда
			Продолжить;
		КонецЕсли; 
		...
		КС = ПоказателиКС(Р3Ст290Гр05.Значение, 0.5);
			
		Расшифровка = КС.ЛеваяЧастьСтр + " = " + КС.ПраваяЧастьСтр + ", когда " + Р3Ст270Гр03.ЗначениеСтр + "  > 3300";
		
		УсловиеВыполнено = (Р3Ст270Гр03.Значение  > 3300);
		Если НЕ УсловиеВыполнено ИЛИ (УсловиеВыполнено И КС.ЛеваяЧасть = КС.ПраваяЧасть) Тогда
			ЭтоОшибка = Ложь;
			ОбщееЧислоБезОшибок = ОбщееЧислоБезОшибок + 1;
...
&НаСервере
Процедура ПроверитьКС_3_15б(СтруктураРезультата)
	
	ОбщееЧислоОшибок    = СтруктураРезультата.КоличествоНайденныхОшибок;
	ОбщееЧислоБезОшибок = СтруктураРезультата.КоличествоНайденныхБезОшибок;
	СтруктураОшибок     = СтруктураРезультата.СтруктураОшибок;
	
	ТекстФормулы    = НСтр("ru = 'Раздел 3 (КС 3.15б)';
							|en = 'Раздел 3 (КС 3.15б)'");
	ОписаниеКС      = НСтр("ru='Значение коэффициента Кгз (строка 290 Раздела 3.1.1) для газа горючего (Код ПИ по строке "
		+ "010 Раздела 3 = ""03300"" и Код ЕИ по строке 030 Раздела 3 = ""114"") должно быть равно результату деления "
		+ "числа ""0,5"" на коэффициент Кгп по строке 170 Раздела 3, если значение строки 270 Раздела 3.1.1 > 3300'");
	ОписаниеОшибки  = НСтр("ru = 'Допущена ошибка при определении коэффициента Кгз (возможна арифметическая ошибка)';
							|en = 'Допущена ошибка при определении коэффициента Кгз (возможна арифметическая ошибка)'");
	Нарушение       = НСтр("ru = 'ст.342.4 НК РФ';
							|en = 'ст.342.4 НК РФ'");
	...
	ДанныеРаздела = Раздел3.Скопировать();
	ДанныеРаздела.Свернуть("НомерСтраницы," + КолонкиДляСворачивания(УровеньОбхода) + Р3Ст270Гр03.Имя 
		+ "," + Р3Ст290Гр05.Имя + "," + Р3Ст10Гр03.Имя + "," + Р3Ст30Гр03.Имя + "," + Р3Ст170Гр03.Имя);
	...
	Для Каждого СтрокаДанных Из ДанныеРаздела Цикл
		...
		ВнестиПоказательВРасшифровку(Р3Ст170Гр03, Р3Ст170Гр03.Раздел, НомерСтраницыМнУ(СтрокаДанных.НомерСтраницы, Р3Ст170Гр03.ПорядокСтраницы));
	
		ВставитьЗначениеПоказателя(СтрокаДанных, Р3Ст290Гр05);
		ВнестиПоказательВРасшифровку(Р3Ст290Гр05, Р3Ст290Гр05.Раздел, СтрокаДанных.НомерСтраницы);
		
		Р3Ст170Гр03.Значение = ?(Р3Ст170Гр03.Значение = 0, 1, Р3Ст170Гр03.Значение);
		КС = ПоказателиКС(Р3Ст290Гр05.Значение, Окр(0.5/Р3Ст170Гр03.Значение, 4));
			
		Расшифровка = КС.ЛеваяЧастьСтр + " = 0,5/" + Р3Ст170Гр03.ЗначениеСтр + " Итог [" + КС.ПраваяЧастьСтр + "], когда " + Р3Ст270Гр03.ЗначениеСтр + "  > 3300";
...
Процедура ПроверитьКС_3_16(СтруктураРезультата)
	...
	ТекстФормулы    = НСтр("ru = 'Раздел 3 (КС 3.16)';
							|en = 'Раздел 3 (КС 3.16)'");
	ОписаниеКС      = НСтр("ru = 'Коэффициент, характеризующий сложность добычи газа горючего природного и(или) газового конденсата Кс по строке 300 Раздела 3.1.1 должен быть равен минимальному значению строки 290 Раздела 3.1.1 (min из Квг, Кр, Кгз, Кас, Корз)';
							|en = 'Коэффициент, характеризующий сложность добычи газа горючего природного и(или) газового конденсата Кс по строке 300 Раздела 3.1.1 должен быть равен минимальному значению строки 290 Раздела 3.1.1 (min из Квг, Кр, Кгз, Кас, Корз)'");
	...
	Р3Ст300Гр03 = ПоказательПоСтроке("Р3Ст300Гр03");
	Р3Ст290Гр03 = ПоказательПоСтроке("Р3Ст290Гр03");
	Р3Ст290Гр04 = ПоказательПоСтроке("Р3Ст290Гр04");
	Р3Ст290Гр05 = ПоказательПоСтроке("Р3Ст290Гр05");
	Р3Ст290Гр06 = ПоказательПоСтроке("Р3Ст290Гр06");
	Р3Ст290Гр07 = ПоказательПоСтроке("Р3Ст290Гр07");
	Раздел3 = ДанныеМногоуровнегоРаздела("Раздел3");
	
	//Определяем уровень обхода по "младшему" показателю
	УровеньОбхода = Макс(?(Р3Ст300Гр03.Свойство("ПорядокСтраницы"), Р3Ст300Гр03.ПорядокСтраницы, 0), 
		?(Р3Ст290Гр03.Свойство("ПорядокСтраницы"), Р3Ст290Гр03.ПорядокСтраницы, 0));
	
	ДанныеРаздела = Раздел3.Скопировать();
	ДанныеРаздела.Свернуть("НомерСтраницы," + КолонкиДляСворачивания(УровеньОбхода) + Р3Ст290Гр03.Имя + "," + Р3Ст290Гр04.Имя + ","
		+ Р3Ст290Гр05.Имя + "," + Р3Ст290Гр06.Имя + "," + Р3Ст290Гр07.Имя + "," + Р3Ст300Гр03.Имя);
	
	Для Каждого СтрокаДанных Из ДанныеРаздела Цикл
		ВставитьЗначениеПоказателя(СтрокаДанных, Р3Ст290Гр03);		
		ВставитьЗначениеПоказателя(СтрокаДанных, Р3Ст290Гр04);
		ВставитьЗначениеПоказателя(СтрокаДанных, Р3Ст290Гр05);
		ВставитьЗначениеПоказателя(СтрокаДанных, Р3Ст290Гр06);
		ВставитьЗначениеПоказателя(СтрокаДанных, Р3Ст290Гр07);
		
		Если НЕ (ЗначениеЗаполнено(Р3Ст290Гр03.Значение) ИЛИ ЗначениеЗаполнено(Р3Ст290Гр04.Значение) ИЛИ ЗначениеЗаполнено(Р3Ст290Гр05.Значение)
			ИЛИ ЗначениеЗаполнено(Р3Ст290Гр06.Значение) ИЛИ ЗначениеЗаполнено(Р3Ст290Гр07.Значение)) Тогда
			Продолжить;
		КонецЕсли;
		...
		ВставитьЗначениеПоказателя(СтрокаДанных, Р3Ст300Гр03);
		ВнестиПоказательВРасшифровку(Р3Ст300Гр03, Р3Ст300Гр03.Раздел, СтрокаДанных.НомерСтраницы);
		ВнестиПоказательВРасшифровку(Р3Ст290Гр03, Р3Ст290Гр03.Раздел, СтрокаДанных.НомерСтраницы);
		ВнестиПоказательВРасшифровку(Р3Ст290Гр04, Р3Ст290Гр04.Раздел, СтрокаДанных.НомерСтраницы);
		ВнестиПоказательВРасшифровку(Р3Ст290Гр05, Р3Ст290Гр05.Раздел, СтрокаДанных.НомерСтраницы);
		ВнестиПоказательВРасшифровку(Р3Ст290Гр06, Р3Ст290Гр06.Раздел, СтрокаДанных.НомерСтраницы);
		ВнестиПоказательВРасшифровку(Р3Ст290Гр07, Р3Ст290Гр07.Раздел, СтрокаДанных.НомерСтраницы);

		ПраваяЧасть = Мин(Р3Ст290Гр03.Значение, Р3Ст290Гр04.Значение, Р3Ст290Гр05.Значение, Р3Ст290Гр06.Значение, Р3Ст290Гр07.Значение);
		
		КС = ПоказателиКС(Р3Ст300Гр03.Значение, ПраваяЧасть, 4, 4);
...
Процедура ПроверитьКС_4_2(СтруктураРезультата)
	...
	Для Каждого СтраницаРаздела Из Раздел4 Цикл
		...
		Для Инд = 1 По КолвоСтрокВМногострочнойЧасти Цикл
			...
			Если Р4Ст20Гр03.Значение = Р1Ст1Гр01.Значение Тогда
				КСВыполнено = Истина;
				Прервать;
...
Процедура ПроверитьКС_4_5(СтруктураРезультата)
	...
	Для Каждого СтраницаРаздела Из Раздел4 Цикл
		...
		Для Инд = 1 По КолвоСтрокВМногострочнойЧасти Цикл
			...
			Если Р4Ст40Гр03.Значение = Р1Ст2Гр01.Значение Тогда
				КСВыполнено = Истина;
				Прервать;
...
Процедура ПроверитьКС_6_2(СтруктураРезультата)
	...
	ТекстФормулы    = НСтр("ru = 'Раздел 6 (КС 6.2)';
							|en = 'Раздел 6 (КС 6.2)'");
	ОписаниеКС      = НСтр("ru='Сумма косвенных и иных расходов по строке 090 раздела 6.1 должна быть равна сумме "
		+ "Внереализационных расходов по строке 050 Раздела 6.1, Косвенных расходов по строке 060 Раздела 6.1, Косвенных "
		+ "расходов по строке 070 раздела 6.1 * Прямые расходы по добыче по строке 010 Раздела 6.1 / Общую сумму прямых "
		+ "расходов по строке 080 Раздела 6.1'");
...
Процедура ПроверитьКС_8_1(СтруктураРезультата)
	...
	Раздел8 = ДанныеИзДереваРаздела("Раздел8", 1);
...
&НаСервере
Процедура ДобавитьСтрокуВТаблицу(Таблица, Ветка2, Ветка21 = Неопределено, Ветка211 = Неопределено, НомерСтраницы)
	...
	Если Ветка21 <> Неопределено Тогда
...
&НаСервере
Функция ДанныеИзДереваРаздела(ИмяРаздела, КоличествоУровней = 3) Экспорт
	...
	Для НомСтрокиВДереве = 1 По ДеревоДанныхРаздела.Строки.Количество() Цикл
		...
		Если КоличествоУровней = 1 Тогда
			Представление = НомерСтраницы(НомСтрокиВДереве);
			ДобавитьСтрокуВТаблицу(Таблица, Ветка2, , , Представление);
			Продолжить;
		КонецЕсли;
		...
		Для НомСтрокиВВетке2 = 1 По Ветка2.Строки.Количество() Цикл
			...
			Если Ветка21.Строки.Количество() = 0 ИЛИ КоличествоУровней = 2 Тогда
...
&НаСервере
Процедура РазвернутьСтрокуВТаблицу(Таблица, Ветка2 = Неопределено, 
											Ветка21 = Неопределено, 
											Ветка211 = Неопределено, 
											НомерСтраницы)
	...
	Если Ветка2 <> Неопределено Тогда
		Для Каждого ЭлементСтруктуры Из Ветка2.Данные Цикл
			ОбъединеннаяСтруктура.Вставить(ЭлементСтруктуры.Ключ, ЭлементСтруктуры.Значение);
		КонецЦикла;
	КонецЕсли;
...
&НаСервере
Функция ДанныеМногоуровнегоРаздела(ИмяРаздела, СУровня = 1, ДоУровня = 3) Экспорт
	...
	Для НомСтрокиВДереве = 1 По ДеревоДанныхРаздела.Строки.Количество() Цикл
		...
		Если ДоУровня = 1 Тогда
			ПараметрыНумерации = ДанныеНумерации(НомСтрокиВДереве);
			РазвернутьСтрокуВТаблицу(Таблица, Ветка2, , , ПараметрыНумерации);
			Продолжить;
		КонецЕсли;
		...
		Для НомСтрокиВВетке2 = 1 По Ветка2.Строки.Количество() Цикл
			...
			Если Ветка21.Строки.Количество() = 0 ИЛИ ДоУровня = 2 Тогда
			...
			Иначе
				Для НомСтрокиВВетке21 = 1 По Ветка21.Строки.Количество() Цикл
					...
					Если СУровня = 3 Тогда
						РазвернутьСтрокуВТаблицу(Таблица, Ветка2, Неопределено, Ветка211, ПараметрыНумерации);
					Иначе
...
Функция ПоказательПоСтроке(УсловныйКодПоказателя)
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Ст123Гр03" Тогда
		Результат.Вставить("Имя", "П000200012303");
		Результат.Вставить("Представление", Нстр("ru=''"));
	
	ИначеЕсли УсловныйКодПоказателя = "Р2Ст125Гр03" Тогда
		Результат.Вставить("Имя", "П000200012503");
		Результат.Вставить("Представление", Нстр("ru=''"));
	
	ИначеЕсли УсловныйКодПоказателя = "Р2Ст126Гр03" Тогда
		Результат.Вставить("Имя", "П000200012603");
		Результат.Вставить("Представление", Нстр("ru=''"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р3Ст110Гр03" Тогда
		Результат.Вставить("Имя", "П000300011003");
		Результат.Вставить("Представление", Нстр("ru=''"));
	
	ИначеЕсли УсловныйКодПоказателя = "Р3Ст120Гр03" Тогда
		Результат.Вставить("Имя", "П000300012003");
		Результат.Вставить("Представление", Нстр("ru=''"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р3Ст200Гр03" Тогда
		Результат.Вставить("Имя", "П000300020003");
		Результат.Вставить("Представление", Нстр("ru=''"));
	
	ИначеЕсли УсловныйКодПоказателя = "Р3Ст200Гр04" Тогда
		Результат.Вставить("Имя", "П000300020004");
		Результат.Вставить("Представление", Нстр("ru=''"));
	
	ИначеЕсли УсловныйКодПоказателя = "Р3Ст200Гр05" Тогда
		Результат.Вставить("Имя", "П000300020005");
		Результат.Вставить("Представление", Нстр("ru=''"));
	
	ИначеЕсли УсловныйКодПоказателя = "Р3Ст210Гр03" Тогда
		Результат.Вставить("Имя", "П000300021003");
		Результат.Вставить("Представление", Нстр("ru=''"));
	
	ИначеЕсли УсловныйКодПоказателя = "Р3Ст215Гр03" Тогда
		Результат.Вставить("Имя", "П000300021503");
		Результат.Вставить("Представление", Нстр("ru=''"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р3Ст220Гр03" Тогда
		Результат.Вставить("Имя", "П000300022003");
		Результат.Вставить("Представление", Нстр("ru=''"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р3Ст230Гр03" Тогда
		Результат.Вставить("Имя", "П000300023003");
		Результат.Вставить("Представление", Нстр("ru=''"));
	
	ИначеЕсли УсловныйКодПоказателя = "Р3Ст250Гр03" Тогда
		Результат.Вставить("Имя", "П000300025003");
		Результат.Вставить("Представление", Нстр("ru=''"));
	
	ИначеЕсли УсловныйКодПоказателя = "Р3Ст270Гр03" Тогда
		Результат.Вставить("Имя", "П000300027003");
		Результат.Вставить("Представление", Нстр("ru=''"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р3Ст290Гр03" Тогда
		Результат.Вставить("Имя", "П000300029003");
		Результат.Вставить("Представление", Нстр("ru=''"));
	
	ИначеЕсли УсловныйКодПоказателя = "Р3Ст290Гр04" Тогда
		Результат.Вставить("Имя", "П000300029004");
		Результат.Вставить("Представление", Нстр("ru=''"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р3Ст290Гр05" Тогда
		Результат.Вставить("Имя", "П000300029005");
		Результат.Вставить("Представление", Нстр("ru=''"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р3Ст290Гр06" Тогда
		Результат.Вставить("Имя", "П000300029006");
		Результат.Вставить("Представление", Нстр("ru=''"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р3Ст290Гр07" Тогда
		Результат.Вставить("Имя", "П000300029007");
		Результат.Вставить("Представление", Нстр("ru=''"));
	
	ИначеЕсли УсловныйКодПоказателя = "Р3Ст300Гр03" Тогда
		Результат.Вставить("Имя", "П000300030003");
		Результат.Вставить("Представление", Нстр("ru=''"));
...
Процедура ДобавитьКординаты(Результат)
	...
	ИначеЕсли СтрНайти("П000200004003|П000200005003|П000200005004|П000200005005|П000200006003|П000200007003|П000200008003
						|П000200009003|П000200010003|П000200011003|П000200011503|П000200012003|П000200012303|П000200012503
						|П000200012603|П000200013003|П000200014003|П000200015003|П000200004003|П000211000101|П000211000102", 
						ИмяПоказателя) <> 0 Тогда
	...
	ИначеЕсли СтрНайти("П000300001003|П000300002003|П000300003003|П000300004003|П000300005003|П000300011003|П000300012003
						|П000300017003", ИмяПоказателя) <> 0 Тогда
		Результат.Вставить("Раздел", "Раздел3");
		Результат.Вставить("ПорядокСтраницы", 1);
	
	ИначеЕсли СтрНайти("П000300019003|П000300020003|П000300020004|П000300020005|П000300021003|П000300021503|П000300022003
						|П000300023003|П000300024003|П000300025003", ИмяПоказателя) <> 0 Тогда
		Результат.Вставить("Раздел", "Раздел31");
		Результат.Вставить("ПорядокСтраницы", 2);
	
	ИначеЕсли СтрНайти("П000300014003|П000300015003|П000300027003|П000300029003|П000300029004|П000300029005|П000300029006
						|П000300029007|П000300030003|П000300019003|П000311000101|П000311000102", ИмяПоказателя) <> 0 Тогда
