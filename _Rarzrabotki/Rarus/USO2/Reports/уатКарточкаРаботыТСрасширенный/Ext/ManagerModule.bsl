...
Функция ПрицепыПЛсписок(ПЛ) Экспорт
	...
	Для Каждого ТекПрицеп Из ПЛ.Прицепы Цикл
		Если ТекПрицеп.ТС.уатВидМоделиТС = Перечисления.уатВидыМоделейТС.Автотранспорт 
				Или ТекПрицеп.ТС.уатВидМоделиТС = Перечисления.уатВидыМоделейТС.Прицеп Тогда
