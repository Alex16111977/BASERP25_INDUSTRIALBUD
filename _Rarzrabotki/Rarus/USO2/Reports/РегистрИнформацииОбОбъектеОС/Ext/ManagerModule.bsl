...
Процедура СформироватьТабличныйДокумент(ПараметрыОтчета, АдресХранилища) Экспорт
	...
	Пока ВыборкаОбъектов.Следующий() Цикл
		...
		Запрос.Текст = 
		"ВЫБРАТЬ
		|	ЕСТЬNULL(СчетаБУ.ГруппаФинансовогоУчета.СчетУчета, СчетаБУ.СчетУчета) КАК СчетУчета,
		|	ЕСТЬNULL(СчетаБУ.ГруппаФинансовогоУчета.СчетУчетаАмортизации, СчетаБУ.СчетНачисленияАмортизации) КАК СчетНачисленияАмортизации,
		...
		|				И ОсновноеСредство = &ОсновноеСредство) КАК СчетаБУ
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		...
		|ИЗ
		|	РегистрСведений.СчетаБухгалтерскогоУчетаОС КАК СчетаБУ
		|ГДЕ
