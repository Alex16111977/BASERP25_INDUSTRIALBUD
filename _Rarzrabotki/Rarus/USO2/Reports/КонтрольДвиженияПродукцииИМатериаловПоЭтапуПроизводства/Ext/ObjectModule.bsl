...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ПараметрДетализитроватьПоПериоду = ПараметрыДанных.Найти("ДетализироватьПоПериоду"); 	
	...
	Если ПараметрДетализитроватьПоПериоду.Значение > 0 Тогда
		ДобавляемыеГруппы.Добавить(
			Новый ПолеКомпоновкиДанных(?(ПараметрДетализитроватьПоПериоду.Значение = 1, "ПериодДень", "ПериодМесяц")));
	КонецЕсли;	
	...
	МассивПолей = РесурсыБезДетализации.Получить(0);
	МассивПолей.Добавить(Новый ПолеКомпоновкиДанных("КПередачеНаСклад"));
	
	МассивПолей = РесурсыБезДетализации.Получить(1);
