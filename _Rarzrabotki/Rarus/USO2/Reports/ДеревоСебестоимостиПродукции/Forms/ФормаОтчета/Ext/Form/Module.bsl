...
Процедура УстановитьВидимостьЗаголовки()
	...
	Элементы.ПолноеДеревоСебестоимостиСумма.Заголовок			= СтрШаблон(ШаблонЗаголовка, НСтр("ru = 'Сумма';
																									|en = 'Amount'"), Валюта);
	Элементы.ПолноеДеревоСебестоимостиМатериальные.Заголовок	= СтрШаблон(ШаблонЗаголовка, НСтр("ru = 'Материальные';
																									|en = 'Material'"), Валюта);
	Элементы.ПолноеДеревоСебестоимостиТрудозатраты.Заголовок	= СтрШаблон(ШаблонЗаголовка, НСтр("ru = 'Трудозатраты';
																									|en = 'Labor costs'"), Валюта);;
	Элементы.ПолноеДеревоСебестоимостиДопРасходы.Заголовок		= СтрШаблон(ШаблонЗаголовка, НСтр("ru = 'Доп. расходы';
																									|en = 'Additional expenses'"), Валюта);;
	Элементы.ПолноеДеревоСебестоимостиСуммаЗабалансовая.Заголовок		= СтрШаблон(ШаблонЗаголовка, НСтр("ru = 'Забалансовая сумма';
																											|en = 'Off-balance amount '"), Валюта);;
	Элементы.ПолноеДеревоСебестоимостиПостатейныеПостоянные.Заголовок	= СтрШаблон(ШаблонЗаголовка, НСтр("ru = 'Постатейные (постоянные)';
																											|en = 'Itemized (constants)'"), Валюта);;
	Элементы.ПолноеДеревоСебестоимостиПостатейныеПеременные.Заголовок	= СтрШаблон(ШаблонЗаголовка, НСтр("ru = 'Постатейные (переменные)';
																											|en = 'Itemized (variables)'"), Валюта);;
