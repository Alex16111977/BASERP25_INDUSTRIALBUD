...
Процедура ПоказатьПериод()
	СтруктураРеквизитовФормы.СтрПериодОтчета = Нрег(Формат(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета, "ДФ='yyyy'") + " год");
...
Процедура Расчет(ПолеТабличногоДокументаФормаОтчета) 
	...
	Области["П012703"].Значение = Области["П010103"].Значение + Области["П010503"].Значение + Области["П010603"].Значение + Области["П011503"].Значение + Области["П011603"].Значение
								+ Области["П011803"].Значение + Области["П011903"].Значение + Области["П012003"].Значение + Области["П012103"].Значение + Области["П012203"].Значение
								+ Области["П012303"].Значение + Области["П012403"].Значение + Области["П012503"].Значение + Области["П012603"].Значение;
	...
	Области["П012803"].Значение = Области["П012903"].Значение + Области["П013403"].Значение + Области["П013703"].Значение + Области["П013803"].Значение + Области["П014103"].Значение
								+ Области["П014703"].Значение + Области["П014803"].Значение + Области["П014903"].Значение + Области["П015003"].Значение + Области["П015103"].Значение;
	Области["П017103"].Значение = Области["П012803"].Значение + Области["П016403"].Значение + Области["П016603"].Значение + Области["П016803"].Значение + Области["П016903"].Значение
								+ Области["П017003"].Значение;
КонецПроцедуры
...
Процедура ПолеТабличногоДокументаФормаОтчетаПриАктивизацииОбласти(Элемент)
	РегламентированнаяОтчетностьКлиент.ПриАктивизацииОбластиСтатистическогоОтчета(ЭтотОбъект);
КонецПроцедуры
