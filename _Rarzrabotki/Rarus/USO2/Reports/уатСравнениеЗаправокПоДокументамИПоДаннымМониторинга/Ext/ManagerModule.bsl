...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.Описание = НСтр("en='Report provides comparative information about quantity of fuelled according to fueling data and GPS data.';ru='Отчет позволяет получить сравнительную информацию о количестве заправленного топлива по данным заправок ГСМ и данным GPS.'");
