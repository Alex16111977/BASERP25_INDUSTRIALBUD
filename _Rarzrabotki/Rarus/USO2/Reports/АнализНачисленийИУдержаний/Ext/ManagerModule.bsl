...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.Описание = НСтр("ru = 'Расчетные листки могут выводиться с разбивкой по подразделениям';
										|en = 'Payslips can be displayed by departments'");
	...
	НастройкиВарианта.Описание = НСтр("ru = 'Регламентированная форма справка по ДСВ';
										|en = 'Compliance form DSV certificate'");
	...
	НастройкиВарианта.Описание = НСтр("ru = 'Расчетные листки с разбивкой по рабочим местам могут выводиться по подразделениям';
										|en = 'Payslips divided by workplaces can be displayed by departments'");
	...
	НастройкиВарианта.Описание = НСтр("ru = 'Расчетно-платежная ведомость (0504401) с 2015 года';
										|en = 'Pay statement (0504401) from 2015'");
