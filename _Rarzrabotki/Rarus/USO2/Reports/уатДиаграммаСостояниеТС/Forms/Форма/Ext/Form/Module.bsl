...
Процедура ПриОткрытии(Отказ)
	...
	#Если ВебКлиент Тогда
		ТекстОшибки = НСтр("en='Report in web client is not available.';ru='Работа данного отчета в веб-клиенте не предусмотрена.'");
...
&НаКлиенте
Процедура НастройкиКомпоновкиНастройкиОтборПриИзменении(Элемент)
	СохранитьНастройки();
КонецПроцедуры
