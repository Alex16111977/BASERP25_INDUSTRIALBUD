...
Процедура СформироватьРаздел1()
	...
	Иначе
		Если ТаблДанных.Количество() > 0 Тогда
			...
			Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Есть экземпляры раздела 2, заполненные отметкой 4 по строке ""код вида имущества"".%1Данные из раздела 3 не были перенесены!';
																							|en = 'Есть экземпляры раздела 2, заполненные отметкой 4 по строке ""код вида имущества"".%1Данные из раздела 3 не были перенесены!'"), Символы.ПС);
