...
Процедура ПолучениеФайловЗавершение(Результат, ДополнительныеПараметры) Экспорт 
	...
	ТекстПояснения = НСтр("ru = 'Законодательные зачения успешно выгружены';
							|en = 'Statutory values exported successfully'"); 
	...
	Если ТипЗнч(Результат) = Тип("Массив") И Результат.Количество() > 0 Тогда
		...
		|" + ИмяФайла; 
	КонецЕсли;
	ПоказатьОповещениеПользователя(НСтр("ru = 'Файл сформирован';
										|en = 'File is generated'"), , ТекстПояснения, БиблиотекаКартинок.Успешно32);	
