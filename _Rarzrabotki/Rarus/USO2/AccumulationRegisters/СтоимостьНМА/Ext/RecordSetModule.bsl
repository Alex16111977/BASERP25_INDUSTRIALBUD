...
Процедура ПодготовитьДанныеДляФормированияЗаданийПриЗаписи()
	...
	|	Таблица.Организация      КАК Организация
	|ПОМЕСТИТЬ ИзмененениеСтоимостиНМАПринятиеКУчету
	|ИЗ
	|	СтоимостьНМАИзменение КАК Таблица
	|ГДЕ
	|	ТИПЗНАЧЕНИЯ(Таблица.Документ) = ТИП(Документ.ПринятиеКУчетуНМА2_4)
	|;
	|////////////////////////////////////////////////////////////////////////////////
	...
	МассивЗапросовЗаданийПоОперациям.Добавить(
		УчетНДСУП.ТекстЗапросаФормированияЗаданийПриПринятииКУчетуИлиМодернизацииВНА("ИзмененениеСтоимостиНМАПринятиеКУчету"));
	ТекстЗапросаЗаданийКЗакрытиюМесяца = ЗакрытиеМесяцаСервер.ТекстЗапросЗаданийКЗакрытиюМесяца("СтоимостьНМА", МассивЗапросовЗаданийПоОперациям);
	...
	СтруктураВременныеТаблицы.Вставить("СтоимостьНМАИзменение", Выборка.Количество > 0);
	
	//
	Выборка = РезультатЗапроса[1].Выбрать();
	Выборка.Следующий();
	
	СтруктураВременныеТаблицы.Вставить("СтоимостьНМА_ЗаданияКРасчетуСтоимостиВНАИзменение", Выборка.Количество > 0);
