	...
	Пока ВыборкаПоРегистраторам.СледующийПоЗначениюПоля("Регистратор") Цикл 
		...
		Пока ВыборкаПоРегистраторам.Следующий() Цикл
			...
			Иначе 
				...
				ЗаписьЖурналаРегистрации(НСтр("ru = 'Обновление информационной базы.Битая ссылка на документ-регистратор';
												|en = 'Updating infobase.Dead link to recorder document'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
