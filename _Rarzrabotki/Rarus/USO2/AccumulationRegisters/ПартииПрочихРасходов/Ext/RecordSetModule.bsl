...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	МассивЗапросовЗаданийПоОперациям.Добавить(
		УчетНДСУП.ТекстЗапросаФормированияЗаданийПриЗаписиПартийПрочихРасходов("втПартийПрочихРасходовРазница"));
	ТекстЗапросаЗаданийКЗакрытиюМесяца = ЗакрытиеМесяцаСервер.ТекстЗапросЗаданийКЗакрытиюМесяца(
	                                         "ПартииПрочихРасходов", МассивЗапросовЗаданийПоОперациям);
