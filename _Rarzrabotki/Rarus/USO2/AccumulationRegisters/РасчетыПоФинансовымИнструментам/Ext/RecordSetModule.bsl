...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	ИмяТаблицыИзменений = НачислениеСписаниеРезервовПоСомнительнымДолгамСервер.ПодготовитьТаблицуИзмененийПоАналитикеУчетаПоПартнерам(
		Запрос, "ТаблицаИзмененийРасчетыПоФинансовымИнструментам");
	...
	УниверсальныеМеханизмыПартийИСебестоимости.УничтожитьВременныеТаблицы(Запрос, "ТаблицаИзмененийРасчетыПоФинансовымИнструментам");
