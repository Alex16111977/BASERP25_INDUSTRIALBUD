		...
		Для Каждого СтрокаТаблицы Из Таблица Цикл
			...
			Исключение
				...
				ИмяСобытияЖурнала = НСтр("ru = 'Заполнение способа обеспечения товаров';
										|en = 'Fill in goods supply method'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
