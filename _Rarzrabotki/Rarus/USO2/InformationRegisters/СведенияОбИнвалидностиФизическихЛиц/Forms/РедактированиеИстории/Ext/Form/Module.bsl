	...
	Если НЕ ОтменаРедактирования Тогда
		...
		Если Элемент.ТекущиеДанные <> Неопределено Тогда
			...
			Если НЕ ЗначениеЗаполнено(Элемент.ТекущиеДанные.Период) Тогда
				...
				ОбщегоНазначенияКлиентСервер.СообщитьПользователю(СообщениеОбОшибке,,"НаборЗаписей[" + Элемент.ТекущиеДанные.ИсходныйНомерСтроки + "].ПериодСтрокой", , Отказ);
			Иначе
			...
			Если НЕ ЗначениеЗаполнено(Элемент.ТекущиеДанные.ДатаРегистрацииИзменений) Тогда
				...
				ОбщегоНазначенияКлиентСервер.СообщитьПользователю(СообщениеОбОшибке,,"НаборЗаписей[" + Элемент.ТекущиеДанные.ИсходныйНомерСтроки + "].ДатаРегистрацииИзмененийСтрокой", , Отказ);
			КонецЕсли;
