	...
	Если НаборЗаписей <> Неопределено Тогда
		...
		Исключение
			...
			Если НаборЗаписей.Количество() = 0 Тогда // запись не создана из-за ошибки заполнения полей.
				...
				ЗаписьЖурналаРегистрации(НСтр("ru = 'Создание нового ключа аналитики учета партий производства';
												|en = 'Create new dimension key of production batch accounting '", КодОсновногоЯзыка),
