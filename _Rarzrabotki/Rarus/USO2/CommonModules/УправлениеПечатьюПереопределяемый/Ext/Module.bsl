...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	// СметнаяПодсистема
	СписокОбъектов.Добавить(Документы.СМ_АктВыполненныхРабот);
	СписокОбъектов.Добавить(Документы.СМ_ЛокальнаяСмета);
	СписокОбъектов.Добавить(Документы.СМ_ОбъектнаяСмета);
	СписокОбъектов.Добавить(Документы.СМ_СводнаяСмета);
	// СметнаяПодсистема
	// {УАТ}
	...
	УСОERP_МодификацияКонфигурации.ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов);
	// {УСО 2.4}:{Управление строительной организацией}{Горский М.Е.} }}
