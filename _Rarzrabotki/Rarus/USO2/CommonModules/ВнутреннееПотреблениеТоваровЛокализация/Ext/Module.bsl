...
Процедура ДополнитьТекстЗапросаДвиженияНоменклатураДоходыРасходы(ТекстЗапроса) Экспорт

	ХозяйственнаяОперация_Условие = "ЛОЖЬ";
	ХозяйственнаяОперация_Значение = "НЕОПРЕДЕЛЕНО";
	
	//++ Локализация
	
	ХозяйственнаяОперация_Условие = 
		"&ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ПередачаВЭксплуатацию)
	//++ НЕ УТ
		|	И Строки.КатегорияЭксплуатации.СпособПогашенияСтоимостиБУ = ЗНАЧЕНИЕ(Перечисление.СпособыПогашенияСтоимостиТМЦ.ПриПередаче)
	//-- НЕ УТ
	...
	ХозяйственнаяОперация_Значение = "ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.СписаниеТоваровПоТребованию)";
	
	//-- Локализация
	
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&ХозяйственнаяОперация_Условие", ХозяйственнаяОперация_Условие);
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&ХозяйственнаяОперация_Значение", ХозяйственнаяОперация_Значение);
...
Процедура ПроверитьЗаполнениеИнвентарныхНомеров(Объект, НепроверяемыеРеквизиты, Отказ)
	...
	Если Не Результат.Пустой() Тогда
		...
		ШаблонОшибкаПустойИнвентарныйНомер = НСтр("ru = 'Не заполнена колонка ""Инвентарный номер""
			...
			|in %НомерСтроки%line of the ""Goods"" list'");
		...
		ШаблонОшибкаДубль = НСтр("ru = 'Инвентарный номер ""%ИнвентарныйНомер%""
			...
			|in %НомерСтроки% line of the ""Goods"" list is repeated in other lines of the document'");
