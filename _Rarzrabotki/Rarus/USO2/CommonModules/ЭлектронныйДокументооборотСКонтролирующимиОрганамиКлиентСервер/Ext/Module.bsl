...
Процедура ОбработкаПроверкиЗаполненияЗаявленияОНазначенииПенсии(Форма, Отказ, ПроверяемыеРеквизиты) Экспорт
	...
	Если НЕ СведенияКорректны Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Заполните обязательные реквизиты раздела ""Вид пенсии""';
	...
	Если НЕ СведенияКорректны Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Заполните обязательные реквизиты раздела ""Паспорт, контакты""';
	...
	Если НЕ СведенияКорректны Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Заполните обязательные реквизиты раздела ""Начисление пенсии""';
	...
	Если НЕ СведенияКорректны Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Заполните обязательные реквизиты раздела ""Представитель""';
	...
	Если НЕ СведенияКорректны Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Заполните обязательные реквизиты раздела ""Cпособ получения""';
...
Функция НачислениеПенсииУказаноКорректно(Форма, МастерДалее = Истина, ВыводитьСообщения) Экспорт
	...
	ПроверитьНаПустое(РезультатПроверкиРеквизитов, Форма, "ОрганПФРПоМестуНазначенияПенсии", НСтр("ru = 'ПФР по месту назначения пенсии';
																									|en = 'ПФР по месту назначения пенсии'"));
