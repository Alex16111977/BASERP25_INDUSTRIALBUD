...
Функция ЗначенияБазовыхТарифовПоСотруднткам(ПозицииШтатногоРасписанияСотрудниковПериоды) Экспорт
	...
	Если ЗначениеЗаполнено(Сотрудник) И Форма.ПолучитьФункциональнуюОпциюФормы("ИспользоватьТарифныеСеткиПриРасчетеЗарплаты") Тогда
		...
		Если Не ЗначениеЗаполнено(РазрядПоУмолчанию) Тогда 
			...
			Если ДанныеДолжности <> Неопределено Тогда
				...
				Если ЗначениеЗаполнено(СвойстваДолжности) И Форма.ПолучитьФункциональнуюОпциюФормы("ИспользоватьКвалификационнуюНадбавку") Тогда
