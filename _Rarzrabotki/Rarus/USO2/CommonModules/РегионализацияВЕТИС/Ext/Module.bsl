...
//  ПараметрыОтбора         - Структура отборов регионов.
//   *ДанныеАдреса          - Структура отборов по адресу.
...
// Параметры:
//  GUIDЗаболеванияУсловийПеремещения - Строка - Глобальный идентификатор заболевания. Обязательный параметр.
//  ПараметрыОтбора         - Структура отборов.
...
Функция ЗапросСпискаУсловийПеремещенияГрузаПоПравиламРегионализации(GUIDЗаболеванияУсловийПеремещения, НомерСтраницы, КоличествоЭлементовНаСтранице)
...
Функция ЗапросСпискаСтатусовРегионовПоКонкретномуЗаболеванию(GUIDЗаболеванияУсловийПеремещения, ПараметрыОтбора, НомерСтраницы, КоличествоЭлементовНаСтранице)
...
Функция ЗапросСпискаПравилПеремещенияГрузаПоКонкретномуЗаболеванию(GUIDЗаболеванияУсловийПеремещения, ПараметрыОтбора, НомерСтраницы, КоличествоЭлементовНаСтранице)
