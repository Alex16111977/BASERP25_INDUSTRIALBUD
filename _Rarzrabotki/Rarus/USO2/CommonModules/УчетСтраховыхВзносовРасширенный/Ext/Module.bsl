...
Процедура ПередСкрытиемПерсональныхДанныхСубъектов(Субъекты, ТаблицаИсключений, Отказ) Экспорт
	...
	ПричинаОтменыСкрытия = НСтр("ru = 'субъект получал доходы, облагаемые страховыми взносами';
								|en = 'the subject earned income subject to insurance contributions'", Метаданные.ОсновнойЯзык.КодЯзыка);
