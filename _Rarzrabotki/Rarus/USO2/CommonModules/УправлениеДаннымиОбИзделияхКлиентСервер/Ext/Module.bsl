...
Функция СпецификациюМожноНазначитьОсновной(СвойстваСпецификации, СтруктураОшибки) Экспорт
	...
	Если СвойстваСпецификации.ТипПроизводственногоПроцесса <> ПредопределенноеЗначение("Перечисление.ТипыПроизводственныхПроцессов.Сборка") Тогда
		Шаблон = НСтр("ru = 'Назначить основной можно только спецификацию типа ""%1"".';
						|en = 'Only bill of materials of the ""%1"" type can be assigned as a main one.'");
...
Функция СписокУсловийОтбораПоСвойствамНоменклатуры() Экспорт
	...
	Результат.Добавить(Новый Структура(Реквизиты, "Равно",             НСтр("ru = 'Равно';
																			|en = 'Equal to'"),               Ложь));
	Результат.Добавить(Новый Структура(Реквизиты, "НеРавно",           НСтр("ru = 'Не равно';
																			|en = 'Not equal'"),            Ложь));
	
	Результат.Добавить(Новый Структура(Реквизиты, "Больше",            НСтр("ru = 'Больше';
																			|en = 'Greater than'"),              Истина));
	Результат.Добавить(Новый Структура(Реквизиты, "БольшеИлиРавно",    НСтр("ru = 'Больше или равно';
																			|en = 'Greater than or equal'"),    Истина));
	Результат.Добавить(Новый Структура(Реквизиты, "Меньше",            НСтр("ru = 'Меньше';
																			|en = 'Less'"),              Истина));
	Результат.Добавить(Новый Структура(Реквизиты, "МеньшеИлиРавно",    НСтр("ru = 'Меньше или равно';
																			|en = 'Less than or equal'"),    Истина));
	
	Результат.Добавить(Новый Структура(Реквизиты, "ВСписке",           НСтр("ru = 'В списке';
																			|en = 'In the list'"),            Ложь));
	Результат.Добавить(Новый Структура(Реквизиты, "НеВСписке",         НСтр("ru = 'Не в списке';
																			|en = 'Not in the list'"),         Ложь));
	
	Результат.Добавить(Новый Структура(Реквизиты, "ВИнтервале",        НСтр("ru = 'В интервале (>,<)';
																			|en = 'Within interval (>,<)'"),   Истина));
	Результат.Добавить(Новый Структура(Реквизиты, "ВИнтервалеВключая", НСтр("ru = 'В интервале (>=,<=)';
																			|en = 'Within interval (>=,<=)'"), Истина));
	
	Результат.Добавить(Новый Структура(Реквизиты, "Заполнено",         НСтр("ru = 'Заполнено';
																			|en = 'Filled'"),           Ложь));
	Результат.Добавить(Новый Структура(Реквизиты, "НеЗаполнено",       НСтр("ru = 'Не заполнено';
																			|en = 'Not filled in'"),        Ложь));
