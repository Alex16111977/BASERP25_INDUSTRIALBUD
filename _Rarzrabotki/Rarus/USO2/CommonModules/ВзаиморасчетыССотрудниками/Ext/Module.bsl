	...
	Для Каждого ОписаниеКолонки Из ОписаниеСоответствияКолонок Цикл
		Если КолонкиТаблицыВыплаченнойЗарплаты.Все.Найти(ОписаниеКолонки.Ключ) = Неопределено Тогда
			ВызватьИсключение НСтр("ru = 'НоваяТаблицаВыплаченнойЗарплатыПоТабличнойЧасти: недопустимое имя колонки таблицы выплаченной зарплаты в описании соответствия колонок';
									|en = 'НоваяТаблицаВыплаченнойЗарплатыПоТабличнойЧасти: invalid column name of the paid salary table in column correspondence description'")
		КонецЕсли;	
...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение регистра накопления Бухгалтерские взаиморасчеты с сотрудниками (по оплатам ведомостей).';
									|en = 'Fill in the ""Accounting mutual settlements with employees (of paysheet payment)"" accumulation register. '");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение регистра накопления Бухгалтерские взаиморасчеты с сотрудниками (кроме оплачиваемых ведомостей).';
									|en = 'Fill in the ""Accounting mutual settlements with employees (except for paid paysheets)"" accumulation register. '");
