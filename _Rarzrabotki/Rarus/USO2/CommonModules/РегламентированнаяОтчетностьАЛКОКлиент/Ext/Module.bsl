...
Функция ОбработкаДействияСАлкоОтчетом(ОписаниеОтчета, Действие,
	...
	Алко19.Вставить("ФормаОтчета2019Кв1", Новый Структура);
	Алко19.ФормаОтчета2019Кв1.Вставить("ТабличныйОтчет", Ложь);
	Алко19.ФормаОтчета2019Кв1.Вставить("Утверждена", "Постановлением Правительства РФ от 29.12.2018 № 1719");
	Алко19.ФормаОтчета2019Кв1.Вставить("НачалоДействия", "1 квартал 2019 года");
	УстановитьДляФормыДействие(СписокДействий, Алко19.ФормаОтчета2019Кв1, Неопределено, Истина);
	УстановитьДляФормыДействие(СписокДействий, Алко19.ФормаОтчета2019Кв1, "ЗагрузкаИзФайла", Ложь);
	
	// Формы Алко20.
	Алко20 = СтруктураАлкоОтчетов.РегламентированныйОтчетАлкоПриложение20;

	Алко20.Вставить("ФормаОтчета2019Кв1", Новый Структура);
	Алко20.ФормаОтчета2019Кв1.Вставить("ТабличныйОтчет", Ложь);
	Алко20.ФормаОтчета2019Кв1.Вставить("Утверждена", "Постановлением Правительства РФ от 29.12.2018 № 1719");
	Алко20.ФормаОтчета2019Кв1.Вставить("НачалоДействия", "1 квартал 2019 года");
	УстановитьДляФормыДействие(СписокДействий, Алко20.ФормаОтчета2019Кв1, Неопределено, Истина);
	УстановитьДляФормыДействие(СписокДействий, Алко20.ФормаОтчета2019Кв1, "ЗагрузкаИзФайла", Ложь);
	
	// Формы Алко21.
	Алко21 = СтруктураАлкоОтчетов.РегламентированныйОтчетАлкоПриложение21;

	Алко21.Вставить("ФормаОтчета2019Кв1", Новый Структура);
	Алко21.ФормаОтчета2019Кв1.Вставить("ТабличныйОтчет", Ложь);
	Алко21.ФормаОтчета2019Кв1.Вставить("Утверждена", "Постановлением Правительства РФ от 29.12.2018 № 1719");
	Алко21.ФормаОтчета2019Кв1.Вставить("НачалоДействия", "1 квартал 2019 года");
	УстановитьДляФормыДействие(СписокДействий, Алко21.ФормаОтчета2019Кв1, Неопределено, Истина);
	УстановитьДляФормыДействие(СписокДействий, Алко21.ФормаОтчета2019Кв1, "ЗагрузкаИзФайла", Ложь);
	
	// Формы Алко22.
	Алко22 = СтруктураАлкоОтчетов.РегламентированныйОтчетАлкоПриложение22;

	Алко22.Вставить("ФормаОтчета2019Кв1", Новый Структура);
	Алко22.ФормаОтчета2019Кв1.Вставить("ТабличныйОтчет", Ложь);
	Алко22.ФормаОтчета2019Кв1.Вставить("Утверждена", "Постановлением Правительства РФ от 29.12.2018 № 1719");
	Алко22.ФормаОтчета2019Кв1.Вставить("НачалоДействия", "1 квартал 2019 года");
	УстановитьДляФормыДействие(СписокДействий, Алко22.ФормаОтчета2019Кв1, Неопределено, Истина);
	УстановитьДляФормыДействие(СписокДействий, Алко22.ФормаОтчета2019Кв1, "ЗагрузкаИзФайла", Ложь);
	
	// Формы Алко23.
	Алко23 = СтруктураАлкоОтчетов.РегламентированныйОтчетАлкоПриложение23;

	Алко23.Вставить("ФормаОтчета2019Кв1", Новый Структура);
	Алко23.ФормаОтчета2019Кв1.Вставить("ТабличныйОтчет", Ложь);
	Алко23.ФормаОтчета2019Кв1.Вставить("Утверждена", "Постановлением Правительства РФ от 29.12.2018 № 1719");
	Алко23.ФормаОтчета2019Кв1.Вставить("НачалоДействия", "1 квартал 2019 года");
	УстановитьДляФормыДействие(СписокДействий, Алко23.ФормаОтчета2019Кв1, Неопределено, Истина);
	УстановитьДляФормыДействие(СписокДействий, Алко23.ФормаОтчета2019Кв1, "ЗагрузкаИзФайла", Ложь);
	
	// Формы Алко24.
	Алко24 = СтруктураАлкоОтчетов.РегламентированныйОтчетАлкоПриложение24;

	Алко24.Вставить("ФормаОтчета2019Кв1", Новый Структура);
	Алко24.ФормаОтчета2019Кв1.Вставить("ТабличныйОтчет", Ложь);
	Алко24.ФормаОтчета2019Кв1.Вставить("Утверждена", "Постановлением Правительства РФ от 29.12.2018 № 1719");
	Алко24.ФормаОтчета2019Кв1.Вставить("НачалоДействия", "1 квартал 2019 года");
	УстановитьДляФормыДействие(СписокДействий, Алко24.ФормаОтчета2019Кв1, Неопределено, Истина);
	УстановитьДляФормыДействие(СписокДействий, Алко24.ФормаОтчета2019Кв1, "ЗагрузкаИзФайла", Ложь);
	
	// Формы Алко25.
	Алко25 = СтруктураАлкоОтчетов.РегламентированныйОтчетАлкоПриложение25;

	Алко25.Вставить("ФормаОтчета2019Кв1", Новый Структура);
	Алко25.ФормаОтчета2019Кв1.Вставить("ТабличныйОтчет", Ложь);
	Алко25.ФормаОтчета2019Кв1.Вставить("Утверждена", "Постановлением Правительства РФ от 29.12.2018 № 1719");
	Алко25.ФормаОтчета2019Кв1.Вставить("НачалоДействия", "1 квартал 2019 года");
	УстановитьДляФормыДействие(СписокДействий, Алко25.ФормаОтчета2019Кв1, Неопределено, Истина);
		
	// Формы Алко26.
	Алко26 = СтруктураАлкоОтчетов.РегламентированныйОтчетАлкоПриложение26;

	Алко26.Вставить("ФормаОтчета2019Кв1", Новый Структура);
	Алко26.ФормаОтчета2019Кв1.Вставить("ТабличныйОтчет", Ложь);
	Алко26.ФормаОтчета2019Кв1.Вставить("Утверждена", "Постановлением Правительства РФ от 29.12.2018 № 1719");
	Алко26.ФормаОтчета2019Кв1.Вставить("НачалоДействия", "1 квартал 2019 года");
	УстановитьДляФормыДействие(СписокДействий, Алко26.ФормаОтчета2019Кв1, Неопределено, Истина);
	...
	Алко27.ФормаОтчета2019Кв1.Вставить("НачалоДействия", "1 квартал 2019 года");
	УстановитьДляФормыДействие(СписокДействий, Алко27.ФормаОтчета2019Кв1, Неопределено, Истина);
	УстановитьДляФормыДействие(СписокДействий, Алко27.ФормаОтчета2019Кв1, "ЗагрузкаИзФайла", Ложь);
	...
	Алко28.ФормаОтчета2019Кв1.Вставить("НачалоДействия", "1 квартал 2019 года");
	УстановитьДляФормыДействие(СписокДействий, Алко28.ФормаОтчета2019Кв1, Неопределено, Истина);
	УстановитьДляФормыДействие(СписокДействий, Алко28.ФормаОтчета2019Кв1, "ЗагрузкаИзФайла", Ложь);
	...
	Алко29.ФормаОтчета2019Кв1.Вставить("НачалоДействия", "1 квартал 2019 года");
	УстановитьДляФормыДействие(СписокДействий, Алко29.ФормаОтчета2019Кв1, Неопределено, Истина);
	УстановитьДляФормыДействие(СписокДействий, Алко29.ФормаОтчета2019Кв1, "ЗагрузкаИзФайла", Ложь);
...
Процедура ВызватьФормуВыбораЗначенийАЛКО(Форма, ФлажокОтклАвтоВыборКодов,
	...
	Если НЕ ФлажокОтклАвтоВыборКодов Тогда
		...
		Форма.Активизировать();
		Форма.ОткрытаяФормаПотомокСБлокировкойВладельца = ОткрытьФорму("Обработка.ОбщиеОбъектыРеглОтчетности.Форма.ФормаВыбораЗначенияИзТаблицы", ПараметрыФормы, Форма, КлючУникальности, , , ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
	...
	Иначе
		...
		Форма.Активизировать();
		Форма.ОткрытаяФормаПотомокСБлокировкойВладельца = ОткрытьФорму("ОбщаяФорма.АЛКОФормаВводаПарыСвязанныхЗначений", ПараметрыФормы, Форма, КлючУникальности, , , ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
	...
	// Это БРО 1.1.10.
		...
		ИначеЕсли (НЕ Подключение.ФСРАР) и (НЕ ТолькоОтчетность) Тогда
			ПоказатьПредупреждение(, НСтр("ru = 'По организации отчета не включена возможность электронного документооборота с Росалкогольрегулированием!';
											|en = 'По организации отчета не включена возможность электронного документооборота с Росалкогольрегулированием!'"));
		КонецЕсли;
...
Процедура КомандаОчиститьРегистрыОтМусораАЛКО(Форма)
	...
	ТекстВнимание = Новый ФорматированнаяСтрока(НСтр("ru = 'Внимание!';
													|en = 'Внимание!'"), ЖирныйНаклонныйШрифт, WebЦвета.Красный);
	ТекстПредупреждение = Новый ФорматированнаяСтрока(НСтр("ru = 'После применения данной процедуры восстановление удаленных страниц станет невозможным!';
															|en = 'После применения данной процедуры восстановление удаленных страниц станет невозможным!'"), ЖирныйНаклонныйШрифт);
	ТекстПредупреждение2 = Новый ФорматированнаяСтрока(НСтр("ru = 'Если Отчет изменен, перед очисткой изменения будут сохранены!';
															|en = 'Если Отчет изменен, перед очисткой изменения будут сохранены!'"), ЖирныйНаклонныйШрифт);
	...
	ТекстЧастичнаяОчистка = Новый ФорматированнаяСтрока(НСтр("ru = 'Частичная очистка';
															|en = 'Частичная очистка'"), ЖирныйШрифт);
...
Процедура ПечатьПослеСохраненияАЛКО(Отказ, Форма) Экспорт
	...
	Состояние(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = '%1. Формируется печатная форма...';
																			|en = '%1. Формируется печатная форма...'"), Форма.Заголовок), , , БиблиотекаКартинок.Печать);
...
Процедура ОткрытьФормуВыбораСтраницОтчетаАЛКО(Форма, ВариантВыбора)
	...
	Если Форма.НомерАлкоОтчета = 13 или Форма.НомерАлкоОтчета = 14
...
Функция ОпределитьОткрытуюВспомогательнуюФормуОтчета(ФормаИлиДокументОтчета,
	...
	Если НЕ (ТипЗнч(ФормаИлиДокументОтчета) = Тип("УправляемаяФорма")
	...
	Если ТипЗнч(ФормаИлиДокументОтчета) = Тип("УправляемаяФорма") Тогда
...
// Нужно зафиксировать данные текущего ОП.	
	ТекущиеСведенияОбОП = ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(Форма.АктивнаяСтраницаРаздела.ДополнительныеДанные[0].Значение.СведенияОбОП);
...
Процедура ЗакрытьФормуОшибокПриИзмененииОтчета(Форма)
	...
	Если (НЕ Форма.ФормаОшибок = Неопределено)
			и ТипЗнч(Форма.ФормаОшибок) = Тип("УправляемаяФорма") Тогда
