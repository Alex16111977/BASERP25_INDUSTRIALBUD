	...
	Если МассивНеНайденныхРеквизитов.Количество() = 1 Тогда
		ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'У %1 нет реквизита с именем %2';
				|en = '%1 does not have an attribute with the %2 name'"), ПолноеИмяОбъекта, МассивНеНайденныхРеквизитов[0]);
	Иначе
		ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'У %1 нет реквизитов с именами %2.';
				|en = '%1 does not have attributes with the %2 names.'"), ПолноеИмяОбъекта, СтрСоединить(МассивНеНайденныхРеквизитов, ", "));
	КонецЕсли;
