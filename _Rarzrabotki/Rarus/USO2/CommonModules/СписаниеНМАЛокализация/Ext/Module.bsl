...
Функция ТекстЗапросаТаблицаВтТаблицаНМА(ТекстыЗапроса) Экспорт
	...
	ВнеоборотныеАктивыСлужебный.ТекстЗапросаВтТаблицаПорядокУчетаНМА(ТекстыЗапроса, "Документ.СписаниеНМА2_4");
	ВнеоборотныеАктивыСлужебный.ТекстЗапросаВтТаблицаМестоУчетаНМА(ТекстыЗапроса, "Документ.СписаниеНМА2_4");
	ВнеоборотныеАктивыСлужебный.ТекстЗапросаВтТаблицаПараметрыАмортизацииНМАУУ(ТекстыЗапроса, "Документ.СписаниеНМА2_4");
	ВнеоборотныеАктивыЛокализация.ТекстЗапросаВтТаблицаПараметрыЦелевогоФинансированияНМА(ТекстыЗапроса, "Документ.СписаниеНМА2_4");
...
Процедура ПриЧтенииСозданииНаСервере(Форма) Экспорт
	...
	Элементы.ГруппаРеглУчет.Заголовок = СтрШаблон(НСтр("ru = 'Регламентированный учет (%1)';
														|en = 'Compliance accounting (%1)'"), ВалютаРегл);
