...
Функция ТекстЗапросаДанныеДокументаОбработкаДокументовОтражениеЗарплатыВБухучете(Знач ТекстЗапроса) Экспорт
	...
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"#НачисленнаяЗарплатаИВзносы", "Документ.ОтражениеЗарплатыВФинансовомУчете.НачисленнаяЗарплатаИВзносы");
...
Процедура ЗаполнитьИмяДокументаОтраженияВБухучете(ИмяДокументаОтраженияВБухучете) Экспорт
	ИмяДокументаОтраженияВБухучете = Метаданные.Документы.ОтражениеЗарплатыВФинансовомУчете.ПолноеИмя();
КонецПроцедуры
...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение статьи расходов в регистре ""Зарплата к выплате.""';
									|en = 'Fill in the expense item in the register ""Salary to pay.""'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение статьи расходов в регистре ""Зарплата к выплате авансом.""';
									|en = 'Fill in the expense item in the register ""Salary to pay as an advance.""'");
