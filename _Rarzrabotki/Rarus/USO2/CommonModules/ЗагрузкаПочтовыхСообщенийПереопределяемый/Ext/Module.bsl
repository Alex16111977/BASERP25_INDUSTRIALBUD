			    ...
			    Исключение
			    	...
			    	ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			    		НСтр("ru = 'Ошибка при загрузке вложения ""%1"" в ""%2"": %3';
							|en = 'An error occurred while importing attachment ""%1"" to ""%2"": %3'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
			    	...
			    	ЗаписьЖурналаРегистрации(
			    		НСтр("ru = 'СверкаДанныхУчетаНДС.ЗагрузкаИзПочты';
							|en = 'СверкаДанныхУчетаНДС.ЗагрузкаИзПочты'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
