...
Процедура ОбработкаРасшифровки(ЭтаФорма, Элемент, Расшифровка, СтандартнаяОбработка) Экспорт
	...
	ИначеЕсли ПолноеИмяОтчета = "Отчет.ВедомостьРасчетовСКлиентами" Тогда
		...
		ПараметрыОтчета.Вставить("Заголовок",        НСтр("ru = 'Карточка расчетов с клиентами';
															|en = 'Card of settlements with customers'"));
	...
	ИначеЕсли ПолноеИмяОтчета = "Отчет.ВедомостьРасчетовСПоставщиками" Тогда
		...
		ПараметрыОтчета.Вставить("Заголовок",        НСтр("ru = 'Карточка расчетов с поставщиками';
															|en = 'Card of settlements with suppliers'"));
...
Процедура ОткрытьОтчетКарточкаРасчетовСКлиентами(КлючВарианта, Документ) Экспорт
	...
	Если Не ЗначениеЗаполнено(Документ) Тогда
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Данные еще не записаны. Переход к отчету возможен только после записи данных.';
																|en = 'Data is not written yet. You can go to the report only after data writing.'"));
		Возврат;
	КонецЕсли;
...
Процедура ОбработатьРасшифровкуСтруктураСерииНоменклатуры(ЭтаФорма, Расшифровка, СтандартнаяОбработка)
	...
	СписокОтчетов.Добавить("ДвижениеСерииНоменклатуры", НСтр("ru = 'Движение серии номенклатуры';
															|en = 'Product series movement'"),, БиблиотекаКартинок.Отчет);
	СписокОтчетов.Добавить("ВедомостьПоСериямНоменклатуры", НСтр("ru = 'Ведомость по сериям номенклатуры';
																|en = 'Product series list'"),, БиблиотекаКартинок.Отчет);
	СписокОтчетов.Добавить("ПрименениеСерииНоменклатуры", НСтр("ru = 'Применение серии номенклатуры';
																|en = 'Application of product series'"),, БиблиотекаКартинок.Отчет);
...
Процедура ОбработатьРасшифровкуПрименениеСерииНоменклатуры(ЭтаФорма, Расшифровка, СтандартнаяОбработка)
	...
	СписокОтчетов.Добавить("ВедомостьПоСериямНоменклатуры", НСтр("ru = 'Ведомость по сериям номенклатуры';
																|en = 'Product series list'"),, БиблиотекаКартинок.Отчет);
	СписокОтчетов.Добавить("СтруктураСерииНоменклатуры", НСтр("ru = 'Структура серии номенклатуры';
																|en = 'Product series structure'"),, БиблиотекаКартинок.Отчет);
