...
Процедура ПолучитьПланыОбмена(ПланыОбменаПодсистемы) Экспорт
	...
	// СметнаяПодсистема
	// Если Не ПолучитьФункциональнуюОпцию("СМ_БазоваяВерсия") Тогда
		ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.СМ_ОбменСметаБухгалтерияСтроительнойОрганизации);
		ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.СМ_ОбменСметаПодрядчикСтроительстваУправлениеФинансами);
		ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.СМ_ОбменСметаУправлениеСтроительнымПроизводством);	
		ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.СМ_ОбменСметаУправлениеПроизводственнымПредприятием);	
		ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.СМ_ОбменСметаУправлениеПредприятием);	
	//  КонецЕсли;
	// Конец СметнаяПодсистема	
