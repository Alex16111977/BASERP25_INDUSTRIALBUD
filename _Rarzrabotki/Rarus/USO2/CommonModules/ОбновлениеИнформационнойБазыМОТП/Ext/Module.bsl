...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Имя    = "БиблиотекаИнтеграцииМОТП";
	Описание.Версия = "1.0.1.575";
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыМОТП.НачальноеЗаполнение";
...
Процедура ПередОбновлениемИнформационнойБазы() Экспорт
	...
	Если ВерсияКонфигурации <> "0.0.0.0" Тогда
		...
		ИдентификаторБиблиотекаИнтеграцииМОТП = "БиблиотекаИнтеграцииМОТП";
		ВерсияБиблиотекаИнтеграцииМОТП = ОбновлениеИнформационнойБазы.ВерсияИБ(ИдентификаторБиблиотекаИнтеграцииМОТП);
		Если ВерсияБиблиотекаИнтеграцииМОТП = "0.0.0.0" Тогда
			
			ОбновлениеИнформационнойБазы.УстановитьВерсиюИБ("ВерсияБиблиотекаИнтеграцииМОТП", "1.0.0.0", Ложь);
