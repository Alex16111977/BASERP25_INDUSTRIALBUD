...
Процедура ЕстьТабачнаяПродукцияВКоллекции(Коллекция, ЕстьТабачнаяПродукция) Экспорт
	...
	//++ НЕ ГОСИС
	ПроверкаИПодборПродукцииМОТПУТ.ЕстьТабачнаяПродукцияВКоллекции(Коллекция, ЕстьТабачнаяПродукция);
	//-- НЕ ГОСИС
...
Процедура ПриОпределенииТабачнойПродукцииДокумента(Контекст, ТаблицаТабачнойПродукции) Экспорт
	...
	//++ НЕ ГОСИС
	ТаблицаТабачнойПродукции = ПроверкаИПодборПродукцииМОТПУТ.ТаблицаТабачнойПродукцииДокумента(Контекст);
	//-- НЕ ГОСИС
...
Процедура ОтразитьРезультатыСканированияВДокументе(ПараметрыОкончанияСканирования) Экспорт
	...
	//++ НЕ ГОСИС
	ИнтеграцияМОТПУТ.ОтразитьРезультатыСканированияВДокументе(ПараметрыОкончанияСканирования);
	//-- НЕ ГОСИС
...
Процедура ПолучитьСформированныйАктОРасхождениях(Документ, АктОРасхождениях) Экспорт
	...
	//++ НЕ ГОСИС
	АктОРасхождениях = ИнтеграцияМОТПУТ.СформированныйАктОРасхождениях(Документ);
	//-- НЕ ГОСИС
...
Процедура ЗаполнитьСлужебныеРеквизитыВКоллекции(Форма, ТабличнаяЧасть) Экспорт
	...
	//++ НЕ ГОСИС
	ПроверкаИПодборПродукцииМОТПУТ.ЗаполнитьСлужебныеРеквизитыВКоллекции(Форма, ТабличнаяЧасть);
	//-- НЕ ГОСИС
...
Процедура ЗаполнитьПараметрыУказанияСерий(Форма, ПараметрыУказанияСерий) Экспорт
	...
	//++ НЕ ГОСИС
	ПроверкаИПодборПродукцииМОТПУТ.ЗаполнитьПараметрыУказанияСерий(Форма, ПараметрыУказанияСерий);
	//-- НЕ ГОСИС
...
Процедура СформироватьТекстЗапросаЗаполненияСтатусовУказанияСерий(ПараметрыУказанияСерий, ТекстЗапроса) Экспорт
	...
	//++ НЕ ГОСИС
	ПроверкаИПодборПродукцииМОТПУТ.СформироватьТекстЗапросаЗаполненияСтатусовУказанияСерий(ПараметрыУказанияСерий, ТекстЗапроса);
	//-- НЕ ГОСИС
...
Процедура ЗаполнитьСтатусыУказанияСерий(Форма, ПараметрыУказанияСерий) Экспорт
	...
	//++ НЕ ГОСИС
	ПроверкаИПодборПродукцииМОТПУТ.ЗаполнитьСтатусыУказанияСерий(Форма, ПараметрыУказанияСерий);
	//-- НЕ ГОСИС
...
Процедура ОпределитьПравоДобавлениеСерий(ПравоДобавлениеСерий) Экспорт
	...
	//++ НЕ ГОСИС
	ПроверкаИПодборПродукцииМОТПУТ.ОпределитьПравоДобавлениеСерий(ПравоДобавлениеСерий);
	//-- НЕ ГОСИС
