...
Функция ПолучитьТаблицуВидовАктивовИОбязательств() Экспорт
	...
	УСОERP_УправлениеСтроительнымПроизводством.ДополнитьТаблицаВидовАктивовИОбязательств(ТаблицаВидовАктивовИОбязательств);
	// {УСО 2.0}:{Управление строительной организацией}}}
...
Функция ДоляТранспортныхРасходовТекущегоМесяца(Период, Организация)
	...
	|		И ЕСТЬNULL(ВыручкаИСебестоимостьПродаж.ВидЗапасов.ТипЗапасов,ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.Товар)) = ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.Товар)
