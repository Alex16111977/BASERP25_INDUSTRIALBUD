...
Функция ОшибкаУдостоверяющийЦентрНеАвторизованФирмой1С(УдостоверяющийЦентр) Экспорт
	...
	Ошибка.Описание = СтрШаблон(НСтр("ru = 'Удостоверяющий центр ""%1"" не авторизован фирмой 1С';
									|en = 'Удостоверяющий центр ""%1"" не авторизован фирмой 1С'"), УдостоверяющийЦентр);
...
Функция АвторизованныеУдостоверяющиеЦентры() Экспорт
	...
	УдостоверяющиеЦентры.Добавить(
		УдостоверяющийЦентр(
			"ООО ""Такском""",
			"OOO Taxcom|ООО ""Такском""|Общество с ограниченной ответственностью ""Такском"""));
	...
	УдостоверяющиеЦентры.Добавить(
		УдостоверяющийЦентр(
			...
			"ЗАО Удостоверяющий центр|ЗАО 'Удостоверяющий Центр'"));
		
	УдостоверяющиеЦентры.Добавить(
		УдостоверяющийЦентр(
			"ООО ""Линк-сервис""",
			"Link Service Ltd|ООО Линк-сервис"));
		
	УдостоверяющиеЦентры.Добавить(
		УдостоверяющийЦентр(
			"ООО ""Компания Тензор""",
			"ООО Компания Тензор|Tensor"));
