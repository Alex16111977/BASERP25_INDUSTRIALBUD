...
#Область ЭлектронноеВзаимодействиеМОТП
...
//		ШтрихкодыУпаковок = ИнтеграцияМОТП.ШтрихкодыУпаковокИзСтрокиДереваЭДО(СведенияОТоваре);
//	КонецЦикла;
//
...
// 
// Параметры:
// 	ШтрихкодыУпаковок - ТаблицаЗначений - Таблица со свойствами.(См. ИнтеграцияМОТП.НоваяТаблицаШтрихкодыУпаковок)
