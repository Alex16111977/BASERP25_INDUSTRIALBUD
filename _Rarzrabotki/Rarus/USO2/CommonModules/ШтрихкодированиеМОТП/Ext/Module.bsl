...
Функция ВложенныеШтрихкоды(КодыМаркировок, ПараметрыСканирования) Экспорт
	...
	Иначе
		...
		ОбработанныеШтрихкоды = ДанныеНеизвестнойМаркируемойПродукцииБезЗапросаСтатусаМОТП(КодыМаркировок);
		...
		Для Каждого КлючЗначение Из ОбработанныеШтрихкоды Цикл
			...
			НоваяСтрокаДерева.ЗначениеШтрихкода = КлючЗначение.Значение.Штрихкод;
			...
			НоваяСтрокаТаблицы.ЗначениеШтрихкода = КлючЗначение.Значение.Штрихкод;
...
Функция ДанныеНеизвестнойМаркируемойПродукцииБезЗапросаСтатусаМОТП(Штрихкоды)
	...
	Для Каждого КлючЗначение Из СоответствиеШтрихкодов Цикл
		...
		Если НайденнаяСтрока <> Неопределено Тогда
			...
			ДанныеКодаМаркировки.КоличествоПачек           = 1;
			ДанныеКодаМаркировки.КоличествоБлоков          = 0;
			ДанныеСуществующейУпаковки = СуществующиеУпаковки.Найти(КлючЗначение.Ключ, "ЗначениеШтрихкода");
