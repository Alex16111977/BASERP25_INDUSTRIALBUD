...
//
// Возвращаемое значение:
//	Представление - Строка - представление периода.
//
...
Функция ПериодЦифрамиПериодичностьПрописью(ЧислоПериодов, Периодичность) Экспорт
	...
	Если Периодичность = ПредопределенноеЗначение("Перечисление.Периодичность.День") Тогда
		ОписаниеДлительности = НСтр("ru = 'день, дня, дней';
									|en = 'day, day, days'");
	ИначеЕсли Периодичность = ПредопределенноеЗначение("Перечисление.Периодичность.Неделя") Тогда
		ОписаниеДлительности = НСтр("ru = 'неделя, недели, недель';
									|en = 'week, week, weeks'");
	ИначеЕсли Периодичность = ПредопределенноеЗначение("Перечисление.Периодичность.Декада") Тогда
		ОписаниеДлительности = НСтр("ru = 'декада, декады, декад';
									|en = 'ten-day period, ten-day period, ten-day periods'");
	ИначеЕсли Периодичность = ПредопределенноеЗначение("Перечисление.Периодичность.Месяц") Тогда
		ОписаниеДлительности = НСтр("ru = 'месяц, месяца, месяцев';
									|en = 'month, month, months'");
	ИначеЕсли Периодичность = ПредопределенноеЗначение("Перечисление.Периодичность.Квартал") Тогда
		ОписаниеДлительности = НСтр("ru = 'квартал, квартала, кварталов';
									|en = 'quarter, quarter, quarters'");
	ИначеЕсли Периодичность = ПредопределенноеЗначение("Перечисление.Периодичность.Полугодие") Тогда
		ОписаниеДлительности = НСтр("ru = 'полугодие, полугодия, полугодий';
									|en = 'half-year,half-year,half-years'");
	ИначеЕсли Периодичность = ПредопределенноеЗначение("Перечисление.Периодичность.Год") Тогда
		ОписаниеДлительности = НСтр("ru = 'год, года, лет';
									|en = 'year,year,years'");
	КонецЕсли;
...
//
// Параметры:
// 	ЗначениеАналитики      - Любой тип     - Значение, которое необходимо привести к типу
...
//
// Возвращаемое значение:
// 	Значение аналитики - Значение аналитики, приведенное к типу. Если значение аналитики не заполнено, то вернется Неопределено,
