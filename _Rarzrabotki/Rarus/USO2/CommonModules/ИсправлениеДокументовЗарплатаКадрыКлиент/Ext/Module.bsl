...
Процедура ОповеститьОбИсправленииДокумента(Ссылка, ИсправленныйДокумент, РежимЗаписи, РежимИсправления = "РасчетЗарплаты", ПолеПериодРегистрации = "ПериодРегистрации") Экспорт
