		...
		ЗаписьЖурналаРегистрации(
			ИнтеграцияС1СДокументооборот.ИмяСобытияЖурналаРегистрации(
				НСтр("ru = 'Не удалось добавить связь';
					|en = 'Cannot add link'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка())),
	...
	Если Результат = Неопределено Тогда
		...
		Если Правила.Количество() = 0 Тогда
			Результат = НСтр("ru = 'Необходимо настроить
				...
				|en = 'Configure
				|integration rules. Contact your administrator.'");
	...
	Попытка
		...
		ДанныеСтроки.Статус = ?(ДанныеСтроки.Неверна,
			ДанныеСтроки.Статус = НСтр("ru = 'Не верна';
										|en = 'Incorrect'") + ": " + ОписаниеОшибки,
			НСтр("ru = 'Верна';
				|en = 'Correct'"));
	Исключение
		ДанныеСтроки.Статус = НСтр("ru = 'Не верна: не указан менеджер криптографии';
									|en = 'Incorrect: cryptography manager is not specified '");
