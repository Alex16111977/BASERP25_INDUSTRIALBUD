...
Процедура УдалитьСтраницу(Форма) Экспорт
	...
	ПоказатьВопрос(Оповещение, НСтр("ru = 'Операция удаления страницы не может быть отменена. Удалить страницу?';
									|en = 'Операция удаления страницы не может быть отменена. Удалить страницу?'"), РежимДиалогаВопрос.ДаНет, 0);
КонецПроцедуры
...
Процедура ОчиститьУведомление(Форма) Экспорт
	...
	ПоказатьВопрос(Оповещение, НСтр("ru = 'Операция очистки отчета не может быть отменена. Продолжить?';
									|en = 'Операция очистки отчета не может быть отменена. Продолжить?'"), РежимДиалогаВопрос.ДаНет, 0);
КонецПроцедуры
