		...
		Для Каждого Колонка Из ТаблицаДанных.Колонки Цикл
			...
			Иначе
				...
				Если СтрокаРеквизита <> Неопределено Тогда
					...
					ИначеЕсли СтрокаРеквизита.Признак = "Выбор" И НЕ СтрокаДанных[Колонка.Имя] = Неопределено Тогда
						ЗначениеВыбора = СтрокаДанных[Колонка.Имя];
						ПредставлениеВыбора = ЗначениеВыбора;
						ЗагрузитьСтруктуруВГруппуДерева(ТекСтрока, ЗначениеВыбора, ПолныйПуть);
						Если ТипЗнч(ЗначениеВыбора) = Тип("Структура") Тогда
							Для каждого КлючЗначение Из ЗначениеВыбора Цикл
								ПредставлениеВыбора = КлючЗначение.Ключ;
								Прервать;
							КонецЦикла;
						КонецЕсли;
						СтрокаРеквизита.Значение = ПредставлениеВыбора;
					Иначе
	...
	Для Каждого Элемент Из СтруктураДанных Цикл
		...
		Если СтрокаРеквизита <> Неопределено Тогда
			...
			ИначеЕсли СтрокаРеквизита.Признак = "Группа" И НЕ Элемент.Значение = Неопределено Тогда
				...
				СтрокаРеквизита.Значение = Истина;
			ИначеЕсли СтрокаРеквизита.Признак = "Выбор" И НЕ Элемент.Значение = Неопределено Тогда
				ЗагрузитьСтруктуруВГруппуДерева(СтрокаТаблицы, Элемент.Значение, ПолныйПуть);
				ЗначениеВыбора = Элемент.Значение;
				ПредставлениеВыбора = ЗначениеВыбора;
				Если ТипЗнч(ЗначениеВыбора) = Тип("Структура") Тогда
					Для каждого КлючЗначение Из ЗначениеВыбора Цикл
						ПредставлениеВыбора = КлючЗначение.Ключ;
