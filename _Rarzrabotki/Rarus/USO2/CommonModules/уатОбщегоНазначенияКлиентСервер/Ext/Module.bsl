...
Процедура УстановитьВидимостьПутевойЛист(Форма, СтруктураРеквизитов) Экспорт
	...
	Если СтруктураРеквизитов.ВидПЛ = ПредопределенноеЗначение("Перечисление.уатВидыПЛ._3") Тогда
		...
		Форма.Элементы.ЗаданиеКоличествоКмГруз.Подсказка = НСтр("en='Mileage with passengers';ru='Пробег с пассажирами'");
	...
	Иначе
		...
		Иначе	
			...
			Форма.Элементы.ЗаданиеКоличествоКмГруз.Подсказка = НСтр("en='Mileage with cargo';ru='Пробег с грузом'");
