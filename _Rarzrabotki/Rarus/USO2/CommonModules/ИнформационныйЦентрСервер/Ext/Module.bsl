...
Функция ПолучитьИмяСобытияДляЖурналаРегистрации() Экспорт
	...
	Возврат НСтр("ru = 'Информационный центр';
				|en = 'Info center'", ТехнологияСервисаИнтеграцияСБСП.КодОсновногоЯзыка());
...
Функция ПолучитьПроксиНовостейСлужбыПоддержки() Экспорт
	...
	Если Не ТехнологияСервисаИнтеграцияСБСП.ПодсистемаСуществует("СтандартныеПодсистемы.РаботаВМоделиСервиса") Тогда
		ВызватьИсключение(НСтр("ru = 'Сервис новостей доступен только в модели сервиса.';
								|en = 'The news service is available only in SaaS.'"));
	КонецЕсли;
...
Функция ТекстВыводаИнформацииОбОшибкеВЦентреИдей() Экспорт 
	...
	Возврат НСтр("ru = 'Центр идей временно не доступен.
                       ...
                       |en = 'Idea center is temporarily unavailable.
                       |Try again later.'")
...
Функция СформироватьЗаголовокКомментариев(Знач ПредставлениеИдеи) Экспорт
	...
	Возврат СтрШаблон(НСтр("ru = 'Комментарии: %1';
							|en = 'Comments: %1'"), ПредставлениеИдеи.CommentsCount);
...
Функция СформироватьЗаголовокДатыРеализации(Знач ПредставлениеИдеи) Экспорт
	...
	Возврат СтрШаблон(НСтр("ru = 'Плановая дата реализации: %1';
							|en = 'Planned sale date: %1 '"), ПредставлениеИдеи.PlanMadeDatePresentation);
...
Функция СформироватьДатуОтклонения(Знач ПредставлениеИдеи) Экспорт
	...
	Возврат СтрШаблон(НСтр("ru = 'Отклонено: %1';
							|en = 'Rejected: %1'"), Формат(ПредставлениеИдеи.ClosingDate, "ДЛФ=DD"));
...
Функция СформироватьДатуРеализации(Знач ПредставлениеИдеи) Экспорт
	...
	Возврат СтрШаблон(НСтр("ru = 'Реализовано: %1';
							|en = 'Sold: %1'"), Формат(ПредставлениеИдеи.ClosingDate, "ДЛФ=DD"));
...
Функция СформироватьXMLСТехническимиПараметрами(ДополнительныеПараметры = Неопределено) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Информационный центр.Отправка сообщения в техподдержку.Не удалось удалить временный файл технических параметров.';
										|en = 'Information center. Sending a message to the technical support. Cannot remove a temporary file of technical parameters.'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
