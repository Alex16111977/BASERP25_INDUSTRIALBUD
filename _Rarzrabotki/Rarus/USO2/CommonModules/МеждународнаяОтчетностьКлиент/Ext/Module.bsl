...
//
// Параметры:
//  Форма - УправляемаяФорма - форма на которой размещен элемент ДеревоЗначений.
...
// Вызывается из обработчика формы отчета ОбработкаРасшифровки при стандартной расшифровки отчета СКД 
// сформированного генератором финансовой отчетности.
//
// Параметры:
//
//  ФормаОтчета - УправляемаяФорма - форма отчета вызвавшего обработку расшифровки.
//  Элемент - ПолеФормы - элемент формы содержащий результат отчета.
//  Расшифровка - Структура, Расшифровка - стандартная расшифровка СКД.
//
...
Процедура ОткрытьОтчетАнализСчетаХозрасчетный(ПараметрыРасшифровки)
	...
	ЗаполняемыеНастройки.Вставить("Показатели, Группировка, Отбор, ВыводимыеДанные", Ложь, Истина, Ложь, Истина);
