...
// 	                   - ЗаписьРегистра   - запись любого регистра
...
// 	                   - Массив           - Массив строк-путей к полям замены, например "ИмяРеквизита" или "ИмяТабличнойЧасти.ИмяРеквизита"
// 	ЗаменяемыеЗначения - Массив           - Массив значений, на которые будет проверяться значение в поле перед заменой
// 	ЗначениеЗамены -   - ЛюбойТип         - Неопределено, ЛюбаяСсылка.
//
//
