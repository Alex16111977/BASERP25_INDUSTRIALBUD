...
Функция ШтрихкодыУпаковок(ЗначенияШтрихкодов) Экспорт
	...
	Если ТипЗнч(ЗначенияШтрихкодов) = Тип("Массив") Тогда
		...
		Таблица.Колонки.Добавить("ЗначениеШтрихкода", Новый ОписаниеТипов("Строка",,,,Новый КвалификаторыСтроки(200)));
		
		Для Каждого Элемент Из ЗначенияШтрихкодов Цикл
			НоваяСтрока = Таблица.Добавить();
			НоваяСтрока.ЗначениеШтрихкода = Элемент;
		КонецЦикла;
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ШтрихкодыУпаковокТоваров.ЗначениеШтрихкода КАК ЗначенияШтрихкодов,
	...
	|			И ШтрихкодыУпаковокТоваров.ЗначениеШтрихкода = МаксимальныеДатыУпаковок.ЗначенияШтрихкодов";
...
Функция ИнициализацияЗапросаШтрихкодыУпаковок(ТипыУпаковок = Неопределено)
	...
	|	&ОпределениеПризнакаМаркируемый            КАК МаркируемаяПродукция
	|ИЗ
	|	ШтрихкодыУпаковокТоваров КАК ШтрихкодыУпаковокТоваров
	...
	ШтрихкодированиеИСПереопределяемый.ОпределитьПризнакМаркируемаяПродукцияТекстаЗапроса(
		Запрос.Текст, "ШтрихкодыУпаковокТоваров.Номенклатура", "&ОпределениеПризнакаМаркируемый");
