...
Процедура ОпределитьСвойстваИсточниковДляЗаполненияСканированныхДокументовПоТребованиюФНС(СвойстваИсточников) Экспорт
	...
	ЭлектронныйДокументооборотСКонтролирующимиОрганамиУП.ОпределитьСвойстваИсточниковДляЗаполненияСканированныхДокументовПоТребованиюФНС(СвойстваИсточников);
...
Процедура ОпределитьСвойстваИсточниковДляРегистраДокументыПоТребованиюФНС(СвойстваИсточников) Экспорт
	...
	ЭлектронныйДокументооборотСКонтролирующимиОрганамиУП.ОпределитьСвойстваИсточниковДляРегистраДокументыПоТребованиюФНС(СвойстваИсточников);
...
// Заполняет вид документа ФНС для владельцев электронных документов, которые будут отражаться в едином списке
// документов, представляемых по требованию ФНС. Для владельца ЭД должны существовать электронные документы по
// завершенным обменам, не помеченые на удаление и принадлежащие следующим видам ЭД:
//СчетФактура
...
// Переопределяет строку, в которой перечислены направления, внешние сервисы которых следует разместить на закладке
// "Личные кабинеты". Перечисление производится через запятую без пробелов.
//
// Параметры:
...
//    * Организация - СправочникСсылка.Организации
//    * СчетФактураВыданный - Булево - "Истина" при проверке разделов 9, 9.1, 10 (кроме графы с реквизитами
//                                     счета-фактуры продавца), 12
...
Процедура ОпределитьПодключаемыеНаправленияСдачиОтчетности(Организация, Направления) Экспорт
	...
	ЭлектронныйДокументооборотСКонтролирующимиОрганамиУП.ОпределитьПодключаемыеНаправленияСдачиОтчетности(Организация, Направления);
...
// Скрывает элементы формы в зависимости от установки тех или иных флагов используемых ИП на УСН 6%.
//
// Параметры:
...
//		ФормаРО.Элементы.КнопкаСоздатьСправкаОСостоянииРасчетов.Видимость = Ложь;
//		
...
// Процедура удаляет из исходного дерева отчеты не используемые ИП на УСН 6%, если доступна упрощенная отчетность.
//
// Параметры:
...
// Процедура выполняет действия по упрощению интерфейса формы создания отчета, 
