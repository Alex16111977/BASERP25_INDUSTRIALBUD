		...
		Исключение
			...
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Ошибка при использовании Windows Script Host:
					|%1';
					|en = 'An error occurred while using Windows Script Host:
					|%1'"),
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке));
			ИнтернетПоддержкаПользователейВызовСервера.ЗаписатьСообщениеВЖурналРегистрации(
				НСтр("ru = 'БИП:ОблачныйАрхив.Отладка';
					|en = 'ISL:CloudArchive.Debugging'"), // ИмяСобытия
				НСтр("ru = 'Облачный архив. Отладка. Работа с Windows Script Host';
					|en = '1C:Cloud Archive. Debug. Work with Windows Script Host'"), // ИдентификаторШага
