...
Процедура ВыгрузитьДокументОтчетности(Ссылка) Экспорт 
	...
	ТекстСообщения = НСтр("ru = 'Для выгрузки файлов рекомендуется установить расширение для веб-клиента 1С:Предприятие.';
							|en = 'To export files, install 1C:Enterprise web client extension.'");
...
Процедура ВыгрузитьДокументОтчетностиПослеПодключенияРасширения(Подключено, ПараметрыВыгрузки) Экспорт 
	...
	ОписаниеФайла = ЗарплатаКадрыВызовСервера.ПолучитьОписаниеДокументаОтчетности(ПараметрыВыгрузки.Ссылка, Отказ);
...
Процедура ВыгрузитьДокументОтчетностиЗавершение(ПолученныеФайлы, ПараметрыВыгрузки) Экспорт 
	...
	ТекстОповещения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Файл-пачка записан под именем: %1';
			|en = 'File bundle is recorded as: %1'"), ПараметрыВыгрузки.ОписаниеФайла.Имя);
