...
Функция ПолучитьИзмененияВЯчейках(ВидБюджета,
	...
	ПараметрыРасчетаИзменений.Вставить("МассивКПересчету",              МассивКПересчету);
...
Функция РассчитатьИзмененияВОтчете(ПараметрыРасчетаИзменений)
	...
	МассивКПересчету              = ПараметрыРасчетаИзменений.МассивКПересчету;
	...
	Для Каждого СтрокаОформления Из ТаблицаОформления Цикл
		...
		Для Каждого ИмяОбласти Из Области Цикл
			...
			Для Каждого ЭлементОформления Из Оформление Цикл
				Если ЭлементОформления.Параметр = НСтр("ru = 'Цвет фона';
														|en = 'Background color'") Тогда
					ОбластьДокумента.ЦветФона = ЭлементОформления.Оформление;
				ИначеЕсли ЭлементОформления.Параметр = НСтр("ru = 'Цвет текста';
															|en = 'Text color'") Тогда
					ОбластьДокумента.ЦветТекста = ЭлементОформления.Оформление;
				ИначеЕсли ЭлементОформления.Параметр = НСтр("ru = 'Цвет границы';
															|en = 'Border color '") Тогда
					ОбластьДокумента.ЦветРамки = ЭлементОформления.Оформление;
				ИначеЕсли ЭлементОформления.Параметр = НСтр("ru = 'Шрифт';
															|en = 'Font'") Тогда
					ОбластьДокумента.Шрифт = ЭлементОформления.Оформление;
				ИначеЕсли ЭлементОформления.Параметр = НСтр("ru = 'Горизонтальное положение';
															|en = 'Horizontal position'") Тогда
					ОбластьДокумента.ГоризонтальноеПоложение = ЭлементОформления.Оформление;
				ИначеЕсли ЭлементОформления.Параметр = НСтр("ru = 'Вертикальное положение';
															|en = 'Vertical position'") Тогда
					ОбластьДокумента.ВертикальноеПоложение = ЭлементОформления.Оформление;
				ИначеЕсли ЭлементОформления.Параметр = НСтр("ru = 'Ориентация текста';
															|en = 'Text orientation'") Тогда
					ОбластьДокумента.ОриентацияТекста = ЭлементОформления.Оформление;
				ИначеЕсли ЭлементОформления.Параметр = НСтр("ru = 'Формат';
															|en = 'Format'") Тогда
	...
	Если СтрДлина(Формула) > ОграничениеДлиныФормулы Тогда
		ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Превышена максимальная длина формулы, введено %1 символов, доступно %2 символов.';
				|en = 'Maximum formula length exceeded: %1 characters entered, %2 characters available.'"),СтрДлина(Формула),ОграничениеДлиныФормулы);
