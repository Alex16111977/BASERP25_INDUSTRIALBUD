	...
	Функция ЗапроситьПараметрыАвторизации() Экспорт
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'МОТП';
					|en = 'МОТП'", ОбщегоНазначения.КодОсновногоЯзыка()),
				УровеньЖурналаРегистрации.Ошибка,,,
				НСтр("ru = 'Ошибка получения параметров авторизации сервера ИС МОТП';
					|en = 'Ошибка получения параметров авторизации сервера ИС МОТП'") + Символы.ПС +
				...
				Если ДанныеОтвета = Неопределено Тогда
					...
					ВозвращаемоеЗначение.ТекстОшибки = ИнтерфейсМОТПСлужебный.ТекстОшибкиПоРезультатуОтправкиЗапроса(
						НСтр("ru = 'Параметры авторизации не получены из ИС МОТП';
							|en = 'Параметры авторизации не получены из ИС МОТП'"),
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'МОТП';
					|en = 'МОТП'", ОбщегоНазначения.КодОсновногоЯзыка()),
				УровеньЖурналаРегистрации.Ошибка,,,
				НСтр("ru = 'Ошибка получения ключа сессии обмена с ИС МОТП';
					|en = 'Ошибка получения ключа сессии обмена с ИС МОТП'") + Символы.ПС +
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
				...
				Если ДанныеОтвета = Неопределено Тогда
					...
					ВозвращаемоеЗначение.ТекстОшибки = ИнтерфейсМОТПСлужебный.ТекстОшибкиПоРезультатуОтправкиЗапроса(
						НСтр("ru = 'Ключ сессии не получен из ИС МОТП.';
							|en = 'Ключ сессии не получен из ИС МОТП.'"),
						РезультатОтправкиЗапроса);
