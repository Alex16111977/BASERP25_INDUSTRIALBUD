...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Реструктуризация дополнительных реквизитов и сведений.
		...
		|Filters by additional attributes and information in the list may work incorrectly.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет уникальное имя дополнительных реквизитов и сведений.
		...
		|en = 'Fills in the unique name of additional attributes and information.
		|Editing additional attributes and information will not be available until the update is complete.'");
	Обработчик.РежимВыполнения = "Отложенно";
	...
	Обработчик.Комментарий = НСтр("ru = 'Реструктуризация дополнительных реквизитов и сведений.
		...
		|en = 'Restructuring additional attributes and information.
		|Additional attributes and information of some documents
		|and catalogs will be not available until the processing is complete.'");
