...
Функция ТекстВозвратСебестоимостиПретензии()
	...
	|
	|	ВЫБОР КОГДА Операция.ВозвратПринятойМногооборотнойТары И АналитикаУчетаНоменклатуры.Номенклатура.ТипНоменклатуры = ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.МногооборотнаяТара) ТОГДА
