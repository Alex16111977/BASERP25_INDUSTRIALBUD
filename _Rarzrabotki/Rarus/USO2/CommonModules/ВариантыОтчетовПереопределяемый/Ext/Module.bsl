...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	УПН_РиэлторПереопределяемый.ОпределитьРазделыСВариантамиОтчетов(Разделы);
	//<{УСО 2.0}:{Управление строительным предприятием}{Последов Д.В.}
	...
	// {УСО 2.4}:{Управление строительной организацией}{Горский М.Е.} {{
	УСОERP_МодификацияКонфигурации.ОпределитьРазделыСВариантамиОтчетов(Разделы);
	// {УСО 2.4}:{Управление строительной организацией}{Горский М.Е.} }} 
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	// {УСО 2.4}:{Управление строительной организацией}{Горский М.Е.} {{
	УСОERP_МодификацияКонфигурации.НастроитьВариантыОтчетов(Настройки);
	// {УСО 2.4}:{Управление строительной организацией}{Горский М.Е.} }}
...
Процедура ОпределитьОбъектыСКомандамиОтчетов(Объекты) Экспорт
	...
	// {УСО 2.4}:{Управление строительной организацией}{Горский М.Е.} {{
	УСОERP_МодификацияКонфигурации.ОпределитьОбъектыСКомандамиОтчетов(Объекты);
	// {УСО 2.4}:{Управление строительной организацией}{Горский М.Е.} }}
...
Процедура ПередДобавлениемКомандОтчетов(КомандыОтчетов, Параметры, СтандартнаяОбработка) Экспорт
	...
	// {УСО 2.4}:{Управление строительной организацией}{Горский М.Е.} {{
	УСОERP_МодификацияКонфигурации.ПередДобавлениемКомандОтчетов(КомандыОтчетов, Параметры, СтандартнаяОбработка);
	// {УСО 2.4}:{Управление строительной организацией}{Горский М.Е.} }}
