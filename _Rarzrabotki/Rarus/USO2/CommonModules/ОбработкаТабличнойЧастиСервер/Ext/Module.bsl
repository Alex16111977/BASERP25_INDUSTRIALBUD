...
Процедура ЗаполнитьСлужебныеРеквизитыПоНоменклатуреВСтрокеТЧ(ТекущаяСтрока, СтруктураДействий, КэшированныеЗначения)
	...
	Если СтруктураДействий.Свойство("ЗаполнитьПризнакМаркируемаяПродукцияТабачная", СтруктураПараметровДействия)
		...
		СтруктураДействийЗаполнения.Вставить("ЗаполнитьПризнакМаркируемаяПродукцияТабачная", СтруктураПараметровДействия);
	КонецЕсли;
...
Функция ПоддерживаемыеДействияЗаполненияТЧ() Экспорт
	...
	Действия.Добавить("ЗаполнитьПризнакМаркируемаяПродукцияТабачная");
