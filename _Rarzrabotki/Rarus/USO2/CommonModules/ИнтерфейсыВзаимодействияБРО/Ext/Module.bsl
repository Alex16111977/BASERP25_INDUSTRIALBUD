	...
	Если ОпрашиватьСервис Тогда
		...
		Исключение
			...
			НСтр("ru = 'Электронный документооброт с контролирующими органами.Получение изменений кодов органов ФСГС на ЦЕМПОС';
				|en = 'Электронный документооброт с контролирующими органами.Получение изменений кодов органов ФСГС на ЦЕМПОС'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
