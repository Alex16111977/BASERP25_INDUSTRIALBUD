...
Функция ДанныеПечатнойФормыОС6_2003(МассивОбъектов, ДатаСведений)
	...
	Если ВнеоборотныеАктивы.ИспользуетсяУправлениеВНА_2_4(ДатаСведений) Тогда
		...
		|ИЗ
		|	РегистрСведений.МестонахождениеОС.СрезПоследних(&ДатаСведений, ОсновноеСредство В (&МассивОбъектов)) КАК МестонахождениеОС
		|
		|ИНДЕКСИРОВАТЬ ПО
		|	ОсновноеСредство,
		|	Организация
	...
	Иначе
		...
		|	NULL КАК ДатаВводаВЭксплуатациюБУ
		|ПОМЕСТИТЬ ДатыПринятияКУчету
		|
		|ИНДЕКСИРОВАТЬ ПО
		|	ОсновноеСредство";
