...
//
// Параметры
// - ДополнительныеПоказатели - таблица значений с данными для заполнения значений с полями
//  * Сотрудник
//  * Начисление
//  * Организация
//  * Подразделение
//  * Показатель
//  * УчитватьДокументОснование
//  * ДатаНачала
//  * ИдентификаторСтроки
//  * Значение
//  * ВремяВЧасах
// - ЗначенияПоказателей - таблица значений для заполнения значений с полями
//	* ИдентификаторСтроки
//	* Показатель
//	* Значение
// - МенеджерРасчета - обработка менеджера расчета зарплаты
//
