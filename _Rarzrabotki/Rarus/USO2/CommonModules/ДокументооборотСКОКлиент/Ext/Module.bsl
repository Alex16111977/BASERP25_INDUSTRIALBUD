...
Процедура ПроверитьЧтоЭДОПодключенПослеДобавленияКонтекстаВПараметры_ПослеНастройкиЗаявления(Результат, ВходящийКонтекст) Экспорт
	...
	ОписаниеОповещения = Новый ОписаниеОповещения(
		"ПроверитьЧтоЭДОПодключенПослеДобавленияКонтекстаВПараметры_ПослеПроверкиСертификатаИЛицензии", 
		ЭтотОбъект, 
		ВходящийКонтекст);
	
	ПроверитьСертификатИЛицензию(ОписаниеОповещения, ВходящийКонтекст.СсылкаНаОтчет, ВходящийКонтекст.ОрганизацияОтчета)
	
КонецПроцедуры

Процедура ПроверитьЧтоЭДОПодключенПослеДобавленияКонтекстаВПараметры_ПослеПроверкиСертификатаИЛицензии(Результат, ВходящийКонтекст) Экспорт
...
Процедура ПроверитьСертификатИЛицензию(ОповещениеЗавершения, ОбъектСсылка, Организация) Экспорт
	...
	ОписаниеОповещения = Новый ОписаниеОповещения(
		"ПроверитьСертификатИЛицензию_ПослеПолученияКонтекста", 
		ЭтотОбъект, 
		ДополнительныеПараметры);
...
Процедура ПроверитьСертификатИЛицензию_ПослеПолученияКонтекста(Результат, ДополнительныеПараметры) Экспорт
	...
	Иначе
		...
		КонтекстЭДОКлиент.ПроверитьСертификатИЛицензию(
			...
			ДополнительныеПараметры.ОбъектСсылка, 
