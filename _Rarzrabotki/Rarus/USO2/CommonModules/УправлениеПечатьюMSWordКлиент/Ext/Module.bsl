...
#КонецЕсли
	...
	Исключение
		...
		ВызватьИсключение(НСтр("ru = 'Ошибка при открытии файла шаблона.';
								|en = 'An error occurred when opening a template file.'") + Символы.ПС 
...
#Иначе		
	ТекстУточнения = НСтр("ru = 'Для вывода печатных форм в формате Microsoft Word требуется, чтобы на компьютере был установлен пакет Microsoft Office.';
							|en = 'To display print forms in the Microsoft Word format, install the Microsoft Office package on the computer.'");
#КонецЕсли
