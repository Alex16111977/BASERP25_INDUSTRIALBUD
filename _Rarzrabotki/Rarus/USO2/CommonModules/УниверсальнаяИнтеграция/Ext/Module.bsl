...
//
// Параметры:
//  ИдентификатрПравила - Строка - идентификатор правила трансляции с типом "Чтение". 
//  КлючОбъекта - Строка, Число - ключ объекта, определенный в правиле.
// 
// Возвращаемое значение:
//  Структура - данные объкта или Неопределено, если данные не получены.
//
...
//
// Параметры:
//  ИдентификатрПравила - Строка - идентификатор правила трансляции с типом "Загрузка". 
...
//  КлючОбъекта - ключ объекта, по которому отписываемся от оповещений об обновлениях.
//
Процедура ОтписатьсяОтОповещенийНаИзменения(ИдентификаторПравила, КлючОбъекта) Экспорт
    ...
    Если Ответ.КодСостояния = 404 Тогда
        ВызватьИсключение НСтр("ru = 'Подписка на уведомления не найдена.';
								|en = 'Subscription to notifications is not found.'") 
...
// 
// Возвращаемое значение:
//   - Структура - прочитанные полученные данные обекта.
//
...
// 
// Возвращаемое значение:
//   Строка - ключ полученных данных обекта, по которому можно прочитать 
