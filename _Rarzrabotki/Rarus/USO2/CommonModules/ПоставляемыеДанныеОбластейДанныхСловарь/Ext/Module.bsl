...
Функция УдалениеФайла() Экспорт
    ...
    Возврат НСтр("ru = 'Удаление файла';
...
Функция ЗаданиеНеНайдено() Экспорт
    ...
    Возврат НСтр("ru = 'Не найдено задание по идентификатору обрабатываемого файла.';
				|en = 'Job by processed file ID is not found.'");
