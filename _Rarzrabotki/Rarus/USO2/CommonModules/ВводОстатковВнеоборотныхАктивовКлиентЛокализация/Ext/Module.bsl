...
Процедура ФормаРедактированияСтрокиОС_ПриИзмененииРеквизита(Элемент, Форма) Экспорт
	...
	ИначеЕсли Элемент.Имя = Элементы.АдресМестонахожденияАрендатора.Имя Тогда
		
		ФормаРедактированияСтрокиОС_АдресМестонахожденияАрендатораПриИзменении(Форма);
...
Процедура ФормаРедактированияСтрокиОС_НачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка, Форма) Экспорт
	...
	Если Элемент.Имя = Элементы.АдресМестонахожденияАрендатора.Имя Тогда
		ФормаРедактированияСтрокиОС_АдресМестонахожденияАрендатораНачалоВыбора(Форма, СтандартнаяОбработка);
	КонецЕсли;
...
Процедура ФормаРедактированияСтрокиОС_Очистка(Элемент, СтандартнаяОбработка, Форма) Экспорт
	...
	Если Элемент.Имя = Элементы.АдресМестонахожденияАрендатора.Имя Тогда
		Форма.АдресМестонахожденияАрендатораЗначенияПолей = "";
	КонецЕсли;
...
Процедура ФормаРедактированияСтрокиОС_АдресМестонахожденияАрендатораПриИзменении(Форма)
	
	Форма.АдресМестонахожденияАрендатораЗначенияПолей = ВнеоборотныеАктивыВызовСервера.ЗначенияПолейКонтактнойИнформацииСервер(
															Форма.АдресМестонахожденияАрендатора,
															ПредопределенноеЗначение("Перечисление.ТипыКонтактнойИнформации.Адрес"));
	
КонецПроцедуры

Процедура ФормаРедактированияСтрокиОС_АдресМестонахожденияАрендатораНачалоВыбора(Форма, СтандартнаяОбработка)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ФормаРедактированияСтрокиОС_АдресМестонахожденияАрендатораНачалоВыбораЗавершение", ЭтотОбъект, Форма);
...
Процедура ФормаРедактированияСтрокиОС_АдресМестонахожденияАрендатораНачалоВыбораЗавершение(РезультатОткрытияФормы, Форма) Экспорт
	...
	Форма.АдресМестонахожденияАрендатораЗначенияПолей = РезультатОткрытияФормы.КонтактнаяИнформация;
	Форма.АдресМестонахожденияАрендатора = РезультатОткрытияФормы.Представление;
