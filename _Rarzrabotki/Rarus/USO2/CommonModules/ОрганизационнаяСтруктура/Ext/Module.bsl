...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение регистра сведений ""ПодчиненностьСтруктурныхЕдиниц"".';
									|en = 'Fill in the ""ПодчиненностьСтруктурныхЕдиниц"" information register.'");	
	...
	Обработчик.Комментарий = НСтр("ru = 'Пометка удаления для ошибочно созданного управленческого элемента.';
									|en = 'Deletion mark for incorrectly created management item.'");	
	...
	Обработчик.Комментарий = НСтр("ru = 'Установка параметров для набора свойств справочника ""Структура предприятия"".';
									|en = 'Set parameters for set of the ""Enterprise structure"" catalog properties.'");
