...
Процедура РассчитатьЗачетАвансовПолученных(ПараметрыРасчета)
	...
	|			ТОГДА РасчетыСКлиентами.ПредоплатаРегл
	|		ИНАЧЕ 0
	|	КОНЕЦ) КАК ВидЦенностиЗнак,
	|	СУММА(РасчетыСКлиентами.ПредоплатаРегл * ВЫБОР
	|			КОГДА РасчетыСКлиентами.ВидДвижения = ЗНАЧЕНИЕ(ВидДвиженияНакопления.Приход)
	|				ТОГДА 1
	|			ИНАЧЕ -1
	|		КОНЕЦ) КАК СуммаЗачета,
	|	СУММА(РасчетыСКлиентами.ПредоплатаУпр * ВЫБОР
	|			КОГДА РасчетыСКлиентами.ВидДвижения = ЗНАЧЕНИЕ(ВидДвиженияНакопления.Приход)
	|				ТОГДА 1
	|			ИНАЧЕ -1
	|		КОНЕЦ) КАК СуммаЗачетаУпр
	|ПОМЕСТИТЬ вт_РасчетСКлиентамиДляЗачетаАванса
	|ИЗ
	...
	|	ПО
	|		РасчетыСКлиентами.АналитикаУчетаПоПартнерам.Контрагент = АвансыПолученные.Покупатель
	|		И РасчетыСКлиентами.РасчетныйДокумент = АвансыПолученные.ДокументОплаты
	|ГДЕ
	|	НЕ &НоваяАрхитектураВзаиморасчетов
	|
	|СГРУППИРОВАТЬ ПО
	...
	|			ТОГДА РасчетыСКлиентами.ПредоплатаРегл
	|		ИНАЧЕ
	|			-РасчетыСКлиентами.ПредоплатаРегл
	|	КОНЕЦ) КАК ВидЦенностиЗнак,
	|	СУММА(РасчетыСКлиентами.ПредоплатаРегл * ВЫБОР
	|			КОГДА РасчетыСКлиентами.ВидДвижения = ЗНАЧЕНИЕ(ВидДвиженияНакопления.Приход)
	|				ТОГДА -1
	...
	|	РасчетыСКлиентами.Контрагент                                            КАК Поставщик,
	|	РасчетыСКлиентами.ДокументОплаты                                        КАК СчетФактура,
	|	ВЫБОР
	|		КОГДА РасчетыСКлиентами.ВидЦенностиЗнак >= 0
	...
	|	КОНЕЦ                                                                   КАК ВидЦенности,
	|	РасчетыСКлиентами.ДокументОплаты                                        КАК ДокументОплаты,
	|	РасчетыСКлиентами.Период                                                КАК ДатаОплаты,
	|	ЗНАЧЕНИЕ(Перечисление.СобытияПоНДСПокупки.ПредъявленНДСКВычету)         КАК Событие,
	|	РасчетыСКлиентами.Период                                                КАК ДатаСобытия,
	|	РасчетыСКлиентами.СуммаЗачета * ВЫБОР
	|		КОГДА РасчетыСКлиентами.СуммаЗачета > 0
	|			ТОГДА 1
	|		ИНАЧЕ -1
	|	КОНЕЦ                                                                   КАК СуммаЗачета,
	|	РасчетыСКлиентами.СуммаЗачетаУпр * ВЫБОР
	|		КОГДА РасчетыСКлиентами.СуммаЗачетаУпр > 0
	|			ТОГДА 1
	|		ИНАЧЕ -1
	|	КОНЕЦ                                                                   КАК СуммаЗачетаУпр,
	...
	|ИЗ
	|	вт_РасчетСКлиентамиДляЗачетаАванса КАК РасчетыСКлиентами
	|	
	|	ЛЕВОЕ СОЕДИНЕНИЕ
	|		РегистрСведений.ДанныеПервичныхДокументов КАК ДанныеПервичныхДокументов
	|	ПО
	|		РасчетыСКлиентами.Организация = ДанныеПервичныхДокументов.Организация
	...
	|		И РасчетыСКлиентами.АналитикаУчетаПоПартнерам.Контрагент = АвансыПолученные.Покупатель
	|		
	|ГДЕ
	|	НЕ &НоваяАрхитектураВзаиморасчетов
	...
	|
	|////////////////////////////////////////////////////////////////////////////////
	|УНИЧТОЖИТЬ вт_РасчетСКлиентамиДляЗачетаАванса
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
...
Процедура РассчитатьЗачетАвансовВыданных(ПараметрыРасчета)
	...
	|	РасчетыСПоставщиками.АналитикаУчетаПоПартнерам.НаправлениеДеятельности,
	|	АвансыВыданные.НалогообложениеНДС,
