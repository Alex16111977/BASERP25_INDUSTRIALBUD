...
Процедура ПолучитьСведенияОПоказателях(ИДРедакцииОтчета, ПоказателиОтчета, ПараметрыОтчета) Экспорт
	...
	ИначеЕсли ИДРедакцииОтчета = "ФормаОтчета2017Кв3" Тогда
		ЗаполнениеОтчетностиВБанкиПереопределяемый.ДобавитьПоказатели2017Кв3(ПоказателиОтчета);
...
Процедура ЗаполнитьОтчетБухгалтерскаяОтчетностьВБанкФормаОтчета2011Кв4_ДополнительныеПоказателиПоГрафе(КонтекстВыполнения) Экспорт
	...
	ПросроченнаяЗадолженность = ЗаполнениеОтчетностиВБанкиПереопределяемый.ПросроченнаяЗадолженностьПокупателей(Организация, КонецПериодаОтчета);
	
	ЗначениеПоказателя = ПросроченнаяЗадолженность.Итог("ПросроченнаяЗадолженность");
	
	УстановитьЗначениеПоказателя(РассчитанныеПоказатели, ИмяРаздела, ИмяОбластиПоказателя, ЗначениеПоказателя);
	
	ПараметрыРасшифровки = ЗаполнениеОтчетностиВБанкиПереопределяемый.НастройкиЗадолженностиПокупателей(ОбщиеПараметрыРасшифровки);
	...
	ПросроченнаяЗадолженность = ЗаполнениеОтчетностиВБанкиПереопределяемый.ПросроченнаяЗадолженностьПоставщикам(Организация, КонецПериодаОтчета);
	
	ЗначениеПоказателя = ПросроченнаяЗадолженность.Итог("ПросроченнаяЗадолженность");
	
	УстановитьЗначениеПоказателя(РассчитанныеПоказатели, ИмяРаздела, ИмяОбластиПоказателя, ЗначениеПоказателя);
	
	ПараметрыРасшифровки = ЗаполнениеОтчетностиВБанкиПереопределяемый.НастройкиЗадолженностиПоставщикам(ОбщиеПараметрыРасшифровки);
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, ЗаголовокРасшифровки, "+", НаименованиеСтроки, ЗначениеПоказателя, ИмяРаздела, ПараметрыРасшифровки);
