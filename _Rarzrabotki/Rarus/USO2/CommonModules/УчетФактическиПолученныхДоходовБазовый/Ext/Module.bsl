...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет реквизит ""Категория дохода"" в начислениях';
									|en = 'Fills in the ""Income category"" attribute in accruals'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет реквизит ""Категория дохода"" в документе ""Операция учета НДФЛ""';
									|en = 'Fills in the ""Income category"" attribute in the ""PIT accounting transaction"" document'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение «Категории Дохода» в движениях документа «Реестр ДСВ-3» по регистру «Учет доходов для исчисления НДФЛ».';
									|en = 'Fill in ""Income categories"" in records of the ""DSV-3 registry"" document by the ""Income accounting to calculate PIT"" register.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение «Категории Дохода» в движениях документа «Реестр ДСВ-3» по регистру «Расчеты налогоплательщиков с бюджетом по НДФЛ».';
									|en = 'Fill in ""Income categories"" in records of the ""DSV-3 registry"" document by the ""Taxpayer settlements with the budget on PIT"" register.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет реквизит ""Категория дохода"" в регистре ""Учет доходов для исчисления НДФЛ""';
									|en = 'Fills in the ""Income category"" attribute in the ""Income accounting to calculate PIT"" register'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Удаление излишних движений документов выплаты по прошлым годам';
									|en = 'Delete excess records of payment documents for previous years'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Исправить движения документов «Операция учета НДФЛ»';
									|en = 'Correct records of the ""PIT accounting transaction"" documents'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет категории доходов исчисленного и удержанного НДФЛ в документах «Операция учета НДФЛ»';
									|en = 'Populates income categories of calculated and overdeducted PIT in the PIT accounting transaction documents'");
	Обработчик.Процедура = "УчетФактическиПолученныхДоходов.ЗаполнитьКатегориюДоходаВОперацияНалоговогоУчетаПоНДФЛ";
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет категории доходов исчисленного и удержанного НДФЛ пропорционально доходам в документах «Операция учета НДФЛ»';
									|en = 'Populates income categories of estimated and deducted PIT in proportion to income in the PIT accounting transaction documents'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет категорию дохода в исчисленном НДФЛ межрасчетных документов';
									|en = 'Fills in income category in calculated PIT of documents outside the payroll period'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет категорию дохода в исчисленном НДФЛ расчета зарплаты';
									|en = 'Fills in income category in calculated PIT of payroll'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет реквизит ""Категория дохода"" в удержанном НДФЛ';
									|en = 'Fills in the ""Income category"" attribute in deducted PIT'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Проверяет распределение суммы выплаченного дохода в удержанном НДФЛ по категориям';
									|en = 'Checks allocation of paid income amount in deducted PIT by categories'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Проверяет категорию дохода в удержанном НДФЛ';
									|en = 'Checks income category in deducted PIT'");
