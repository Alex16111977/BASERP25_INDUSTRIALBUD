	...
	Если ПараметрыПриложения[ИмяПараметра] = Неопределено Тогда
		ВызватьИсключение
			НСтр("ru = 'Ошибка порядка запуска программы.
			           ...
			           |en = 'An error occurred while starting the application.
			           |The first procedure which is called from the ПередНачаломРаботыСистемы event handler 
			           |should be the СтандартныеПодсистемыКлиент.ПередНачаломРаботыСистемы SL procedure.'");
	КонецЕсли;
	...
	Если Не СтандартныеПодсистемыКлиент.ЗапускПрограммыЗавершен() Тогда
		ВызватьИсключение
			НСтр("ru = 'Ошибка порядка запуска программы.
			           ...
			           |en = 'An error occurred while starting the application.
			           |Before receiving client operation parameters, the application should be started.'");
	КонецЕсли;
