...
Процедура ПриЗаполненииРазрешенийНаДоступКВнешнимРесурсам(ЗапросыРазрешений) Экспорт
	...
	Разрешение = РаботаВБезопасномРежиме.РазрешениеНаИспользованиеИнтернетРесурса(
		...
		НСтр("ru = 'Сервис обмена данными с внешними системами (ru)';
			|en = 'The service for data exchange with external systems (ru)'"));
		...
		Для Каждого ИдентификаторСистемы Из ИдентификаторыСистем Цикл
			...
			Если НайденныеСтроки.Количество() = 0 Тогда
				...
				Результат.СообщениеОбОшибке  = НСтр("ru = 'Не удалось получить информацию о внешней системе.
					...
					|en = 'Cannot receive the information about the external system.
				...
				Результат.ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'Идентификатор внешней системы %1 не обнаружен в сервисе.';
						|en = 'An external system identifier %1 is not found in the service.'"),
...
Функция ИнформацияОВнешнихСистемах()
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Начало получения информации о доступных внешних системах.';
			|en = 'Start receiving the information about available external systems.'"),
		Ложь);
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		ЧастиСтрок.Добавить(НСтр("ru = 'Не удалось получить информацию о доступных внешних системах.';
								|en = 'Cannot receive the information about available external systems.'"));
		...
		ЧастиСтрок.Добавить(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Техническая информация об ошибке:
				...
				|%3';
				|en = 'Technical information about the error:
				|While receiving information about available external systems, the service returned an error.
				|URL: %1
				|Error code: %2
				|Details:
				|%3'"),
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершено получение информации о внешних системах';
			|en = 'Receipt of the information about external systems is completed'"),
		Ложь);
...
Процедура ПрочитатьДанные_sourcesgetAvailableList(
	...
	ТекстЖурналРегистрации = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Получен ответ сервиса обмена данными с внешними системами:
			|%1';
			|en = 'The response of the service for data exchange with external systems is received:
			|%1'"),
		ТелоJSON);
...
Функция ИдентификаторОбменДанными(ИдентификаторСистемы, ОписаниеНастройки) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Начало получения идентификатора загрузки данных.';
			|en = 'Start receiving a data upload identifier.'"),
		Ложь);
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		ЧастиСтрок.Добавить(НСтр("ru = 'Не удалось получить идентификатор обмена данными.';
								|en = 'Cannot receive the data exchange identifier.'"));
		ЧастиСтрок.Добавить(Символы.ПС);
		ЧастиСтрок.Добавить(РезультатОперации.СообщениеОбОшибке);
		ЧастиСтрок.Добавить(Символы.ПС);
		ЧастиСтрок.Добавить(Символы.ПС);
		ЧастиСтрок.Добавить(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Техническая информация об ошибке:
				...
				|%3';
				|en = 'Technical information about the error:
				|While receiving information about a data exchange identifier, the service returned an error.
				|URL:%1
				|Error code:%2
				|Details:
				|%3'"),
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершено получение идентификатора обмена данными.';
			|en = 'Receipt of a data exchange identifier is completed.'"),
		Ложь);
...
Функция ИнформацияОНастроенныхОбменахДанными() Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Начало получения информации о настроенных обменах данными.';
			|en = 'Start receiving the information about setup data exchanges.'"),
		Ложь);
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		ЧастиСтрок.Добавить(НСтр("ru = 'Не удалось получить информацию о настроенных обменах данными.';
								|en = 'Cannot receive the information about setup data exchanges.'"));
		ЧастиСтрок.Добавить(Символы.ПС);
		ЧастиСтрок.Добавить(РезультатОперации.СообщениеОбОшибке);
		ЧастиСтрок.Добавить(Символы.ПС);
		ЧастиСтрок.Добавить(Символы.ПС);
		ЧастиСтрок.Добавить(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Техническая информация об ошибке:
				...
				|%3';
				|en = 'Technical information about the error:
				|While receiving information about setup data exchanges, the service returned an error.
				|URL: %1
				|Error code: %2
				|Details:
				|%3'"),
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершено получение информации о настроенных обменах данными.';
			|en = 'Receipt of the information about setup data exchanges is completed.'"),
		Ложь);
...
Функция УдалитьИдентификаторОбменаДанными(ИдентификаторОбмена) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Начало удаления настройки обмена данными.';
			|en = 'Start removing a data exchange setting.'"),
		Ложь);
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		ЧастиСтрок.Добавить(НСтр("ru = 'Не удалось удалить настройку обмена данными.';
								|en = 'Cannot remove a data exchange setting.'"));
		ЧастиСтрок.Добавить(Символы.ПС);
		ЧастиСтрок.Добавить(РезультатОперации.СообщениеОбОшибке);
		ЧастиСтрок.Добавить(Символы.ПС);
		ЧастиСтрок.Добавить(Символы.ПС);
		ЧастиСтрок.Добавить(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Техническая информация об ошибке:
				...
				|%3';
				|en = 'Technical information about the error:
				|While removing the data exchange setting, the service returned an error.
				|URL:%1
				|Error code:%2
				|Details:
				|%3'"),
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершено удаление настройки обмена данными.';
			|en = 'Removing of the data exchange setting is completed.'"),
		Ложь);
...
Функция ОбновитьОписаниеНастройки(ИдентификаторОбмена, ОписаниеНастройки) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Начало обновления описания настройки обмена данными.';
			|en = 'Start updating description of the data exchange setting.'"),
		Ложь);
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		ЧастиСтрок.Добавить(НСтр("ru = 'Не удалось обновить описание настройки обмена данными.';
								|en = 'Cannot update description of the data exchange setting.'"));
		ЧастиСтрок.Добавить(Символы.ПС);
		ЧастиСтрок.Добавить(РезультатОперации.СообщениеОбОшибке);
		ЧастиСтрок.Добавить(Символы.ПС);
		ЧастиСтрок.Добавить(Символы.ПС);
		ЧастиСтрок.Добавить(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Техническая информация об ошибке:
				...
				|%3';
				|en = 'Technical information about the error:
				|While updating description of the data exchange setting, the service returned an error.
				|URL:%1
				|Error code:%2
				|Details:
				|%3'"),
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершено обновление описание настройки обмена данными.';
			|en = 'Update of description of the data exchange setting is completed.'"),
		Ложь);
...
Функция ОбновитьНастройкиОбмена(ИдентификаторОбмена, НастройкиОбмена) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Начало обновления настроек обмена данными.';
			|en = 'Start updating data exchange settings.'"),
		Ложь);
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		ЧастиСтрок.Добавить(НСтр("ru = 'Не удалось обновить настройки обмена данными.';
								|en = 'Cannot update data exchange settings.'"));
		ЧастиСтрок.Добавить(Символы.ПС);
		ЧастиСтрок.Добавить(РезультатОперации.СообщениеОбОшибке);
		ЧастиСтрок.Добавить(Символы.ПС);
		ЧастиСтрок.Добавить(Символы.ПС);
		ЧастиСтрок.Добавить(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Техническая информация об ошибке:
				...
				|%3';
				|en = 'Technical information about the error:
				|While updating data exchange settings, the service returned an error.
				|URL:%1
				|Error code:%2
				|Details:
				|%3'"),
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершено обновление настройки обмена данными.';
			|en = 'Update of the data exchange setting is completed.'"),
		Ложь);
...
Функция ОписаниеФайлаОбменаДанными(ИдентификаторОбмена) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Начало получения информации о файле обмена.';
			|en = 'Start receiving the exchange file information.'"),
		Ложь);
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		Иначе
			...
			ЧастиСтрок.Добавить(НСтр("ru = 'Не удалось получить описание файла обмена.';
									|en = 'Cannot receive the description of the exchange file.'"));
			ЧастиСтрок.Добавить(Символы.ПС);
			ЧастиСтрок.Добавить(РезультатОперации.СообщениеОбОшибке);
			ЧастиСтрок.Добавить(Символы.ПС);
			ЧастиСтрок.Добавить(Символы.ПС);
			ЧастиСтрок.Добавить(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Техническая информация об ошибке:
					...
					|%3';
					|en = 'Technical information about the error:
					|While receiving information about the exchange file, the service returned an error.
					|URL: %1
					|Error code: %2
					|Details:
					|%3'"),
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершено получение информации о файле обмена';
			|en = 'Receipt of the information about the exchange file is completed'"),
		Ложь);
...
Процедура ПрочитатьДанные_packagenext(
	...
	Если Прав(НРег(СокрЛП(СтруктураURI.Хост)), 6) <> Прав(НРег(СокрЛП(ХостСервиса)), 6) Тогда
		СообщениеОбОшибке = НСтр("ru = 'Неверный адрес файла обмена данными.';
								|en = 'Incorrect address of the data exchange file.'");
...
Функция ФайлОбменаДанными(ИдентификаторОбмена, ОписаниеФайлаОбмена) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Получение файла обмена данными: %1';
					|en = 'Receipt of the data exchange file: %1'"),
		...
		Иначе
			...
			РезультатОперации.СообщениеОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Ошибка при получении файла обмена %1: 
					|%2';
					|en = 'An error occurred when receiving the %1 exchange file: 
					|%2'"),
			...
			ЧастиСтрок.Добавить(НСтр("ru = 'Не удалось получить файла обмена.';
									|en = 'Cannot receive the exchange file.'"));
			ЧастиСтрок.Добавить(Символы.ПС);
			ЧастиСтрок.Добавить(РезультатОперации.СообщениеОбОшибке);
			ЧастиСтрок.Добавить(Символы.ПС);
			ЧастиСтрок.Добавить(Символы.ПС);
			ЧастиСтрок.Добавить(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Техническая информация об ошибке:
					...
					|%3';
					|en = 'Technical information about the error:
					|While receiving the exchange file, the service returned an error.
					|URL:%1
					|Error code:%2
					|Details:
					|%3'"),
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершено получение файла обмена данными.';
			|en = 'Receipt of a data exchange file is completed.'"),
		Ложь);
...
Функция ПодтвердитьОбработкуФайлаОбменаДанными(ИдентификаторОбмена, ИдентификаторФайла) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Начало отправки подтверждения загрузки файла.';
			|en = 'Start sending confirmation of the file import.'"),
		Ложь);
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		ЧастиСтрок.Добавить(НСтр("ru = 'Не удалось отправить подтверждение загрузки файла обмена.';
								|en = 'Cannot send confirmation of the exchange file import.'"));
		ЧастиСтрок.Добавить(Символы.ПС);
		ЧастиСтрок.Добавить(РезультатОперации.СообщениеОбОшибке);
		ЧастиСтрок.Добавить(Символы.ПС);
		ЧастиСтрок.Добавить(Символы.ПС);
		ЧастиСтрок.Добавить(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Техническая информация об ошибке:
				...
				|%3';
				|en = 'Technical information about the error:
				|While sending confirmation of a file import, the service returned an error.
				|URL:%1
				|Error code:%2
				|Details:
				|%3'"),
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершена отправка подтверждения о загрузке файла.';
			|en = 'Sending of confirmation of the file import is completed.'"),
		Ложь);
...
Функция ПереопределитьСообщениеПользователю(КодОшибки)
	...
	Если КодОшибки = "НеверныйФорматЗапроса" Тогда
		Возврат НСтр("ru = 'Неверный набор параметров или формат.';
					|en = 'Incorrect set of parameters or format.'");
	...
	ИначеЕсли КодОшибки = "НеверныйИдентификатор" Тогда
		Возврат НСтр("ru = 'Идентификатор обмена данными не найден на Портале 1С:ИТС.
			|Подробнее см. в журнале регистрации.';
			|en = 'The data exchange identifier is not found on 1C:ITS Portal.
			|For more information, see the event log.'");
	...
	ИначеЕсли КодОшибки = "СервисВременноНеДоступен" Тогда
		Возврат НСтр("ru = 'Не удалось подключиться к сервису обмена данными с внешними системами.
			...
			|en = 'Cannot connect to the service for the data exchange with external systems.
			|The service is temporary unavailable. Try connecting later.'");
	ИначеЕсли КодОшибки = "ОшибкаСервиса" Тогда
		Возврат НСтр("ru = 'Ошибка работы с сервисом обмена данными с внешними системами.';
					|en = 'The error occurred during operation of the service for the data exchange with external systems.'");
		...
		Если Результат.ДанныеАутентификации = Неопределено Тогда
			...
			Результат.ИнформацияОбОшибке =
				НСтр("ru = 'Для работы с сервисом обмена данными с внешними системами 
					...
					|en = 'You need
					| to connect the user online support to operate the service for the data exchange with external systems.'");
...
Функция ИмяСобытияЖурналаРегистрации()
	...
	Возврат НСтр("ru = 'Загрузка данных из внешней системы';
				|en = 'Import of the data from the external system'",
