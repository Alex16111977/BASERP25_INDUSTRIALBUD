# -*- coding: utf-8 -*-
"""
PILOT РКО "Выдача в другую кассу" Шаг 01 — Baseline РКО N0000052950 ДО доработки.

Документ: РасходныйКассовыйОрдер N0000052950 от 02.12.2025 9:04:40
  ХозОп = ВыдачаДенежныхСредствВДругуюКассу, Сумма 95 000 UAH
  Касса = "2 Касса Строительство", КассаПолучатель = "Касса Авансы бригадам"
  Подразделение шапки = "Строительство"

Ожидаем: РНДС.ДенежныеСредстваВПути — 1 строка Приход 95000, Подразделение = (пусто).
Артефакт: _artifacts/pilot_rko_vk_01_baseline.json
"""
...
out = os.path.join(ART, "pilot_rko_vk_01_baseline.json")
