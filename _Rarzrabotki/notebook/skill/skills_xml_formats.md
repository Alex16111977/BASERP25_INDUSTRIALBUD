# XML-форматы объектов метаданных 1С:Предприятие 8.3

> Сводный индекс и полные спецификации XML-структур для всех типов объектов конфигурации.
> Источник: cc-1c-skills (Nikolay-Shirokov/cc-1c-skills)

---

## Часть 1: Сводный индекс спецификаций
...
## Часть 2: Спецификация объектов метаданных конфигурации
