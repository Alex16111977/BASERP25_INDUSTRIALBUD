...
Процедура ПодключениеРасширенияРаботыСФайламиЗавершение(РасширениеПодключено, ДополнительныеПараметры) Экспорт
	...
	Если Не РасширениеПодключено Тогда
		ПоказатьПредупреждение(, НСтр("ru='Расширение работы с файлами не установлено. Работа с файлами с неустановленным расширением в веб клиенте невозможна.';uk='Розширення роботи з файлами не встановлено. Робота з файлами з невстановленим розширенням вебклієнта неможлива.'"));
		Возврат;
	КонецЕсли;
