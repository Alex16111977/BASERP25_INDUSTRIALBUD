...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Иначе
		...
		МассивНепроверяемыхРеквизитов.Добавить("МФОБанка");
...
Процедура УправлениеФормой(Форма)
	...
	Элементы.НомерСчета.АвтоотметкаНезаполненного = НЕ Объект.Валютный;
	Элементы.МФОБанка.АвтоотметкаНезаполненного   = НЕ Объект.Валютный;
