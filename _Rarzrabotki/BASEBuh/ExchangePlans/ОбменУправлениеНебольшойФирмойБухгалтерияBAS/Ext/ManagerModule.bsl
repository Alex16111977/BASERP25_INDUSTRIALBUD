...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	ОписаниеВарианта.ЗаголовокКомандыДляСозданияНовогоОбменаДанными = НСтр("ru='BAS Малый бизнес, ред. 2.0';uk='BAS Малий бізнес, ред. 2.0'");
	...
	ОписаниеВарианта.ЗаголовокКомандыДляСозданияНовогоОбменаДанными = НСтр("ru='BAS Малый бизнес, ред. 2.0';uk='BAS Малий бізнес, ред. 2.0'");
	ОписаниеВарианта.ЗаголовокПомощникаСозданияОбмена =               НСтр("ru='Настройка синхронизации с программой ""BAS Малый бизнес, ред. 2.0""';uk='Настройка синхронізації з програмою ""BAS Малий бізнес, ред. 2.0""'");
	ОписаниеВарианта.ЗаголовокУзлаПланаОбмена =                       НСтр("ru='Синхронизация с программой ""BAS Малый бизнес, ред. 2.0""';uk='Синхронізація з програмою ""BAS Малий бізнес, ред. 2.0""'");
	ОписаниеВарианта.НаименованиеКонфигурацииКорреспондента =         НСтр("ru='BAS Малый бизнес, ред. 2.0';uk='BAS Малий бізнес, ред. 2.0'");
...
Функция КраткаяИнформацияПоОбмену(ИдентификаторНастройки) Экспорт
	...
	ПоясняющийТекст = НСтр("ru='Позволяет синхронизировать данные между приложениями ""BAS Малый бизнес"", ред. 2.0 и ""BAS Бухгалтерия"", ред. 2.1.
                            |Из приложения ""BAS Малый бизнес"" в приложение ""BAS Бухгалтерия"" переносятся справочники и все необходимые документы, а 
                            |из приложения ""BAS Бухгалтерия"" в приложение ""BAS Малый бизнес"" - справочники и документы учета денежных средств.';uk= 'Дозволяє синхронізувати дані між додатками ""BAS Малий бізнес"", ред. 2.0 і ""BAS Бухгалтерія"", ред. 2.1.
