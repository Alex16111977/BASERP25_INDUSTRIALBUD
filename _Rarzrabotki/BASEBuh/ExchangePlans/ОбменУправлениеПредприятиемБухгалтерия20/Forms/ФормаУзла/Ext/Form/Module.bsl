...
Процедура ЗаполнитьНачальныеЗначения()
	...
	ОтборыПоУмолчанию = ПланыОбмена.ОбменУправлениеПредприятиемБухгалтерия20.НастройкаОтборовНаУзле();
	ЗначенияПоУмолчанию = ПланыОбмена.ОбменУправлениеПредприятиемБухгалтерия20.ЗначенияПоУмолчаниюНаУзле();
