...
Перем мОбъектОтчета;     
&НаСервере
Перем мТаблицаПериодовПрибыль;     
Перем флЗаполнятьКолонку3АМ, флЗаполнятьКолонку4АМ;
&НаСервере
Перем ФлПереходаЕН; 
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мСоставПоказателей = "СоставПоказателей2025Кв4УФ";
	...
	СтруктураРеквизитовФормы.мИдГруппыBD2 = "BDT2R";  
	СтруктураРеквизитовФормы.мИдГруппыBD3 = "BDT3R";  
	СтруктураРеквизитовФормы.мИдГруппыBD4 = "BDT4R";  
	СтруктураРеквизитовФормы.мИдГруппыBD5 = "BDT5R";  
	СтруктураРеквизитовФормы.мИдГруппыBD6 = "BDT6R";  
	СтруктураРеквизитовФормы.мИдГруппыBD7 = "BDT7R";  
	...
	СтруктураДанныхПриложениеЩАВ = Новый Структура;
	СтруктураДанныхПриложениеБД = Новый Структура;
	...
	мСтруктураМногострочныхРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппыBD2, СтруктураРеквизитовФормы.мИдГруппыBD2);
	мСтруктураМногострочныхРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппыBD3, СтруктураРеквизитовФормы.мИдГруппыBD3);
	мСтруктураМногострочныхРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппыBD4, СтруктураРеквизитовФормы.мИдГруппыBD4);
	мСтруктураМногострочныхРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппыBD5, СтруктураРеквизитовФормы.мИдГруппыBD5);
	мСтруктураМногострочныхРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппыBD6, СтруктураРеквизитовФормы.мИдГруппыBD6);
	мСтруктураМногострочныхРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппыBD7, СтруктураРеквизитовФормы.мИдГруппыBD7);
	...
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппыBD2, КолИсхСтрокИдГруппы1);
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппыBD3, КолИсхСтрокИдГруппы1);
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппыBD4, КолИсхСтрокИдГруппы1);
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппыBD5, КолИсхСтрокИдГруппы1);
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппыBD6, КолИсхСтрокИдГруппы1);
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппыBD7, КолИсхСтрокИдГруппы1);
...
Процедура СформироватьСтруктуруРеквизитовФормы()
	...
	СтруктураРеквизитовФормы.Вставить("мИдГруппыBD2");
	СтруктураРеквизитовФормы.Вставить("мИдГруппыBD3");
	СтруктураРеквизитовФормы.Вставить("мИдГруппыBD4");
	СтруктураРеквизитовФормы.Вставить("мИдГруппыBD5");
	СтруктураРеквизитовФормы.Вставить("мИдГруппыBD6");
	СтруктураРеквизитовФормы.Вставить("мИдГруппыBD7");
	...
	СтруктураРеквизитовФормы.Вставить("АдресВременногоХранилищаПериодов");
...
Процедура ФормироватьСтруктуруСтраницОтчета() 
	...
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы              = "ПриложениеЩАВ";
	СтрокаУровня1.Представление            = НСтр("ru='Приложение ЩАВ';uk='Додаток ЩАВ'");
	СтрокаУровня1.ИмяОбластиТабличногоПоля = "ОбластьПечатиПоВысоте|ОбластьПечатиПоШирине";
	СтрокаУровня1.ОриентацияСтраницы       = ОриентацияСтраницы.Портрет;
	СтрокаУровня1.ВыводНаПечать            = 1;
	СтрокаУровня1.ПоказатьСтраницу         = 1;
	...
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы              = "ПриложениеБД";
	СтрокаУровня1.Представление            = НСтр("ru='Приложение БД';uk='Додаток БД'");
	СтрокаУровня1.ИмяОбластиТабличногоПоля = "ОбластьПечатиПоВысоте|ОбластьПечатиПоШирине";
	СтрокаУровня1.ОриентацияСтраницы       = ОриентацияСтраницы.Портрет;
	СтрокаУровня1.ВыводНаПечать            = 1;
	СтрокаУровня1.ПоказатьСтраницу         = 1;
...
Процедура ФормироватьСтруктуруСвойствСтраниц() Экспорт
	...
	НовСтр = СтрокаУровня1.МногострочностьВРазделе.Добавить();
	НовСтр.ИдГруппы = СтруктураРеквизитовФормы.мИдГруппыBD2;
	НовСтр.Область = "МногострочнаяЧасть_1";
	НовСтр.ВысотаСтроки =1;

	НовСтр = СтрокаУровня1.МногострочностьВРазделе.Добавить();
	НовСтр.ИдГруппы = СтруктураРеквизитовФормы.мИдГруппыBD3;
	НовСтр.Область = "МногострочнаяЧасть_2";
	НовСтр.ВысотаСтроки =1;

	НовСтр = СтрокаУровня1.МногострочностьВРазделе.Добавить();
	НовСтр.ИдГруппы = СтруктураРеквизитовФормы.мИдГруппыBD4;
	НовСтр.Область = "МногострочнаяЧасть_3";
	НовСтр.ВысотаСтроки =1;

	НовСтр = СтрокаУровня1.МногострочностьВРазделе.Добавить();
	НовСтр.ИдГруппы = СтруктураРеквизитовФормы.мИдГруппыBD5;
	НовСтр.Область = "МногострочнаяЧасть_4";
	НовСтр.ВысотаСтроки =1;

	НовСтр = СтрокаУровня1.МногострочностьВРазделе.Добавить();
	НовСтр.ИдГруппы = СтруктураРеквизитовФормы.мИдГруппыBD6;
	НовСтр.Область = "МногострочнаяЧасть_5";
	НовСтр.ВысотаСтроки =1;

	НовСтр = СтрокаУровня1.МногострочностьВРазделе.Добавить();
	НовСтр.ИдГруппы = СтруктураРеквизитовФормы.мИдГруппыBD7;
	НовСтр.Область = "МногострочнаяЧасть_6";
	НовСтр.ВысотаСтроки =1;
...
Процедура РазделыОтчетаПриАктивизацииСтроки(Элемент) Экспорт
	...
	Если    Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Декларация"
		...
		ИЛИ Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "ПриложениеБД"   
...
Процедура ЗаполнитьПоказателиЗначениямиПоУмолчанию(НаимРаздела)
	...
	Если    НаимРаздела = "ПриложениеПН" или НаимРаздела = "ПриложениеКИК" или НаимРаздела = "ПриложениеАМ" Тогда
...
Функция ОпределитьТабличноеПолеПоИдМногострочногоРазделаНаКлиенте(ИдГруппы) Экспорт
	...
	ИдГрупп.Вставить("мИдГруппыBD2", СтруктураРеквизитовФормы.мИдГруппыBD2);
	ИдГрупп.Вставить("мИдГруппыBD3", СтруктураРеквизитовФормы.мИдГруппыBD3);
	ИдГрупп.Вставить("мИдГруппыBD4", СтруктураРеквизитовФормы.мИдГруппыBD4);
	ИдГрупп.Вставить("мИдГруппыBD5", СтруктураРеквизитовФормы.мИдГруппыBD5);
	ИдГрупп.Вставить("мИдГруппыBD6", СтруктураРеквизитовФормы.мИдГруппыBD6);
	ИдГрупп.Вставить("мИдГруппыBD7", СтруктураРеквизитовФормы.мИдГруппыBD7);
...
Функция ОпределитьТабличноеПолеПоИдМногострочногоРаздела(ИдГруппы, ИдГрупп) Экспорт
	...
	ИначеЕсли  ИдГруппы = ИдГрупп.мИдГруппыMZ1 Тогда
		
		ТекТабличноеПоле = "ПриложениеМЗЗ";
		
	ИначеЕсли  ИдГруппы = ИдГрупп.мИдГруппыBD2   
		   ИЛИ ИдГруппы = ИдГрупп.мИдГруппыBD3
		   ИЛИ ИдГруппы = ИдГрупп.мИдГруппыBD4
		   ИЛИ ИдГруппы = ИдГрупп.мИдГруппыBD5
		   ИЛИ ИдГруппы = ИдГрупп.мИдГруппыBD6
		   ИЛИ ИдГруппы = ИдГрупп.мИдГруппыBD7
		   Тогда
		
		ТекТабличноеПоле = "ПриложениеБД";
...
Процедура ЗаполнитьШапкуПодписиПриложенияПН(Форма, НаимРаздела)
	...
	Если НЕ НаимРаздела = "ПриложениеКИК" Тогда   
		HZY  = ПолучитьПоказательНаСервере("HZY",	Форма,"Декларация");
		ЗаполнитьПоказательНаСервере("HZY",  HZY, 	Форма, НаимРаздела);    
	КонецЕсли;
	
	Если НЕ НаимРаздела = "ПриложениеМПЗ" И  НЕ НаимРаздела = "ПриложениеМЗЗ"  
		И  НЕ НаимРаздела = "ПриложениеКИК" Тогда
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма)
	...
	ЗаполнитьПоказательНаВсехЗакладках("HZY",  ГодОтчета, Форма,  "|ПриложениеКИК|");	
	ЗаполнитьПоказательНаСервере("HZY1", ГодОтчета, Форма, "ПриложениеКИК"); 
	Для каждого ДанныеКИК Из Форма.ТаблицаСтраницыРаздела2 Цикл
		ДанныеКИК.Данные[0].Значение.Вставить("HZY1", ГодОтчета)
	КонецЦикла;
	Форма.СтруктураДанныхПриложениеКИК.Вставить("HZY1", ГодОтчета);
	
	Если МесяцОтчета = 3 Тогда
		ЗаполнитьПоказательНаВсехЗакладках("H1KV", "X", Форма, "|ПриложениеТЦ|ПриложениеМПЗ|ПриложениеМЗЗ|ПриложениеДИЯ|ПриложениеКИК|");
	ИначеЕсли МесяцОтчета = 6 Тогда
		ЗаполнитьПоказательНаВсехЗакладках("HHY",  "X", Форма, "|ПриложениеТЦ|ПриложениеМПЗ|ПриложениеМЗЗ|ПриложениеДИЯ|ПриложениеКИК|");
	ИначеЕсли МесяцОтчета = 9 Тогда
		ЗаполнитьПоказательНаВсехЗакладках("H3KV", "X", Форма, "|ПриложениеТЦ|ПриложениеМПЗ|ПриложениеМЗЗ|ПриложениеДИЯ|ПриложениеКИК|");
	ИначеЕсли МесяцОтчета = 12 Тогда
		ЗаполнитьПоказательНаВсехЗакладках("HY",   "X", Форма, "|ПриложениеТЦ|ПриложениеМПЗ|ПриложениеМЗЗ|ПриложениеДИЯ|ПриложениеКИК|");
	КонецЕсли;      
...
Процедура ЗаполнитьПоказательНаВсехЗакладках(ИмяПоказателя, Значение, Форма, СписокИсключений = "")
	...
	КонецЕсли;
 	Если Найти(СписокИсключений, "|ПриложениеЩАВ|") = 0 Тогда
		ЗаполнитьПоказательНаСервере(ИмяПоказателя, Значение, Форма, "ПриложениеЩАВ");
	КонецЕсли;
	Если Найти(СписокИсключений, "|ПриложениеБД|") = 0 Тогда
		ЗаполнитьПоказательНаСервере(ИмяПоказателя, Значение, Форма, "ПриложениеБД");
	КонецЕсли;
...
Функция ОпределитьИдМногострочногоРазделаПоАктивнойСтранице(ИмяЛиста = Неопределено, ТекущаяСтраница, ИдГрупп)
	...
	ИначеЕсли ИмяТекущейСтраницыПанели = "ПриложениеБД" Тогда
		ИмяГруппы.Добавить(ИдГрупп.мИдГруппыBD2);       
		ИмяГруппы.Добавить(ИдГрупп.мИдГруппыBD3);       
		ИмяГруппы.Добавить(ИдГрупп.мИдГруппыBD4);       
		ИмяГруппы.Добавить(ИдГрупп.мИдГруппыBD5);       
		ИмяГруппы.Добавить(ИдГрупп.мИдГруппыBD6);       
		ИмяГруппы.Добавить(ИдГрупп.мИдГруппыBD7);       
	КонецЕсли;
...
Процедура ВосстановитьСохраненныеДанные()
	...
	СписокСохранения.Свойство("ТаблицаПериодовПрибыль", мТаблицаПериодовПрибыль);
	Если ТипЗнч(мТаблицаПериодовПрибыль) = Тип("ТаблицаЗначений") Тогда
		СтруктураРеквизитовФормы.АдресВременногоХранилищаПериодов = ПоместитьВоВременноеХранилище(мТаблицаПериодовПрибыль, УникальныйИдентификатор);
	КонецЕсли;
...
Функция Сохранить(Автосохранение = Ложь, НаимТекРаздела) Экспорт	
	...
	Если СтруктураРеквизитовФормы.АдресВременногоХранилищаПериодов <> Неопределено Тогда
	
		мТаблицаПериодовПрибыль = ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы.АдресВременногоХранилищаПериодов);
		СписокСохранения.Вставить("ТаблицаПериодовПрибыль", мТаблицаПериодовПрибыль);
...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяСтраницыПанели Тогда
		...
		ИдГрупп.Вставить("мИдГруппыBD2", Форма.СтруктураРеквизитовФормы.мИдГруппыBD2);  
		ИдГрупп.Вставить("мИдГруппыBD3", Форма.СтруктураРеквизитовФормы.мИдГруппыBD3);  
		ИдГрупп.Вставить("мИдГруппыBD4", Форма.СтруктураРеквизитовФормы.мИдГруппыBD4);  
		ИдГрупп.Вставить("мИдГруппыBD5", Форма.СтруктураРеквизитовФормы.мИдГруппыBD5);  
		ИдГрупп.Вставить("мИдГруппыBD6", Форма.СтруктураРеквизитовФормы.мИдГруппыBD6);  
		ИдГрупп.Вставить("мИдГруппыBD7", Форма.СтруктураРеквизитовФормы.мИдГруппыBD7);  
	...
	R0117G3 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0102G3", Форма, "ПриложениеАМ"))
										   ...
										   + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R01032G3", Форма, "ПриложениеАМ"))
	...
	R0117G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0102G4", Форма, "ПриложениеАМ"))
										   ...
										   + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R01032G4", Форма, "ПриложениеАМ"))
	...
	R0117G5 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0102G5", Форма, "ПриложениеАМ"))
										   ...
										   + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R01032G5", Форма, "ПриложениеАМ"))
	...
	//БД  
	//Таблица 1 БД
	R011G3 = ПолучитьПоказательНаСервере("R011G3", Форма, "ПриложениеБД");
	R012G3 = 0;
	R013G3 = 0;
	Если  R011G3 > 0 Тогда 
	...
	КонецЕсли;   
	ЗаполнитьПоказательНаСервере("R012G3", R012G3, Форма, "ПриложениеБД");
	ЗаполнитьПоказательНаСервере("R013G3", R013G3, Форма, "ПриложениеБД"); 
	
	//Таблица 2 БД
	Форма.мСтруктураМногострочныхРазделов.Свойство(Форма.СтруктураРеквизитовФормы.мИдГруппыBD2, ТаблицаБлока);
	СтруктураБД2 = Форма[ТаблицаБлока];  
	R021G4 = 0;
	R021G5 = 0;
	R021G6 = 0;
	R022G4 = 0;
	...
	Для каждого СтрокаБД2 Из СтруктураБД2 Цикл   
		
		СтрокаБД2.BDT2RXXXXG7 = ОкруглитьЧислоПоФормату(Форма, СтрокаБД2.BDT2RXXXXG4)
							  +	ОкруглитьЧислоПоФормату(Форма, СтрокаБД2.BDT2RXXXXG5)
							  +	ОкруглитьЧислоПоФормату(Форма, СтрокаБД2.BDT2RXXXXG6);

		ЗаполнитьПоказательНаСервере("BDT2RXXXXG7_"+Формат(СтруктураБД2.Индекс(СтрокаБД2) + 1, "ЧГ=;"), СтрокаБД2.BDT2RXXXXG7, Форма, "ПриложениеБД");

		R021G4 = R021G4 + СтрокаБД2.BDT2RXXXXG4;
		R021G5 = R021G5 + СтрокаБД2.BDT2RXXXXG5;
		R021G6 = R021G6 + СтрокаБД2.BDT2RXXXXG6;
		Если СокрЛП(СтрокаБД2.BDT2RXXXXG3S) = "0036" Тогда
			R022G4 = R022G4 + СтрокаБД2.BDT2RXXXXG4;
			R022G5 = R022G5 + СтрокаБД2.BDT2RXXXXG5;
			R022G6 = R022G6 + СтрокаБД2.BDT2RXXXXG6;
		КонецЕсли;
		
	КонецЦикла;

	ЗаполнитьПоказательНаСервере("R021G4", R021G4, Форма, "ПриложениеБД");
	ЗаполнитьПоказательНаСервере("R021G5", R021G5, Форма, "ПриложениеБД");
	ЗаполнитьПоказательНаСервере("R021G6", R021G6, Форма, "ПриложениеБД");    
	R021G7 = R021G4 + R021G5 + R021G6;
	ЗаполнитьПоказательНаСервере("R021G7", R021G7, Форма, "ПриложениеБД"); 
	
	ЗаполнитьПоказательНаСервере("R022G4", R022G4, Форма, "ПриложениеБД");
	ЗаполнитьПоказательНаСервере("R022G5", R022G5, Форма, "ПриложениеБД");
	ЗаполнитьПоказательНаСервере("R022G6", R022G6, Форма, "ПриложениеБД");  
	R022G7 = R022G4 + R022G5 + R022G6;
	ЗаполнитьПоказательНаСервере("R022G7", R022G7, Форма, "ПриложениеБД"); 
	
	R0221G7 = 0;
	Если  R011G3 > 0 Тогда   
		R0221G7 = R022G7/R011G3*100;
	КонецЕсли;   
	ЗаполнитьПоказательНаСервере("R0221G7", R0221G7, Форма, "ПриложениеБД");  
	
	R023G7 = R021G7 - R012G3;
	R023G7 = ?(R023G7 > 0, R023G7, 0);
	ЗаполнитьПоказательНаСервере("R023G7", R023G7, Форма, "ПриложениеБД");       
	
	R024G7 = R021G7 - R013G3;
	R024G7 = ?(R024G7 > 0, R024G7, 0);
	ЗаполнитьПоказательНаСервере("R024G7", R024G7, Форма, "ПриложениеБД");   
	
	Если R0221G7 > 4 Тогда
		ЗаполнитьПоказательНаСервере("R04125G3", R024G7, Форма, "ПриложениеРИ");  
		ЗаполнитьПоказательНаСервере("R0319G3", 0, Форма, "ПриложениеРИ");   
	Иначе
		ЗаполнитьПоказательНаСервере("R0319G3", R023G7, Форма, "ПриложениеРИ");   
		ЗаполнитьПоказательНаСервере("R04125G3", 0, Форма, "ПриложениеРИ");  
	КонецЕсли;

	//Таблица 3 БД
	Форма.мСтруктураМногострочныхРазделов.Свойство(Форма.СтруктураРеквизитовФормы.мИдГруппыBD3, ТаблицаБлока);
	СтруктураБД3 = Форма[ТаблицаБлока];  
	R031G4 = 0;
	R031G5 = 0;
	R031G6 = 0;
	
	Для каждого СтрокаБД3 Из СтруктураБД3 Цикл   
		
		СтрокаБД3.BDT3RXXXXG7 = ОкруглитьЧислоПоФормату(Форма, СтрокаБД3.BDT3RXXXXG4)
							  +	ОкруглитьЧислоПоФормату(Форма, СтрокаБД3.BDT3RXXXXG5)
							  +	ОкруглитьЧислоПоФормату(Форма, СтрокаБД3.BDT3RXXXXG6);

		ЗаполнитьПоказательНаСервере("BDT3RXXXXG7_"+Формат(СтруктураБД3.Индекс(СтрокаБД3) + 1, "ЧГ=;"), СтрокаБД3.BDT3RXXXXG7, Форма, "ПриложениеБД");

		R031G4 = R031G4 + СтрокаБД3.BDT3RXXXXG4;
		R031G5 = R031G5 + СтрокаБД3.BDT3RXXXXG5;
		R031G6 = R031G6 + СтрокаБД3.BDT3RXXXXG6;
		
	КонецЦикла;

	ЗаполнитьПоказательНаСервере("R031G4", R031G4, Форма, "ПриложениеБД");
	ЗаполнитьПоказательНаСервере("R031G5", R031G5, Форма, "ПриложениеБД");
	ЗаполнитьПоказательНаСервере("R031G6", R031G6, Форма, "ПриложениеБД");    
	R031G7 = R031G4 + R031G5 + R031G6;
	ЗаполнитьПоказательНаСервере("R031G7", R031G7, Форма, "ПриложениеБД"); 

	R032G7 = R031G7 - R013G3;
	R032G7 = ?(R032G7 > 0, R032G7, 0);
	ЗаполнитьПоказательНаСервере("R032G7", R032G7, Форма, "ПриложениеБД");       
	ЗаполнитьПоказательНаСервере("R03113G3", R032G7, Форма, "ПриложениеРИ");       

	//Таблица 4 БД
	Форма.мСтруктураМногострочныхРазделов.Свойство(Форма.СтруктураРеквизитовФормы.мИдГруппыBD4, ТаблицаБлока);
	СтруктураБД4 = Форма[ТаблицаБлока];  
	R041G4 = 0;
	R041G5 = 0;
	R041G6 = 0;
	
	Для каждого СтрокаБД4 Из СтруктураБД4 Цикл   
		
		СтрокаБД4.BDT4RXXXXG7 = ОкруглитьЧислоПоФормату(Форма, СтрокаБД4.BDT4RXXXXG4)
							  +	ОкруглитьЧислоПоФормату(Форма, СтрокаБД4.BDT4RXXXXG5)
							  +	ОкруглитьЧислоПоФормату(Форма, СтрокаБД4.BDT4RXXXXG6);
                                                                             
		ЗаполнитьПоказательНаСервере("BDT4RXXXXG7_"+Формат(СтруктураБД4.Индекс(СтрокаБД4) + 1, "ЧГ=;"), СтрокаБД4.BDT4RXXXXG7, Форма, "ПриложениеБД");

		R041G4 = R041G4 + СтрокаБД4.BDT4RXXXXG4;
		R041G5 = R041G5 + СтрокаБД4.BDT4RXXXXG5;
		R041G6 = R041G6 + СтрокаБД4.BDT4RXXXXG6;
		
	КонецЦикла;

	ЗаполнитьПоказательНаСервере("R041G4", R041G4, Форма, "ПриложениеБД");
	ЗаполнитьПоказательНаСервере("R041G5", R041G5, Форма, "ПриложениеБД");
	ЗаполнитьПоказательНаСервере("R041G6", R041G6, Форма, "ПриложениеБД");    
	R041G7 = R041G4 + R041G5 + R041G6;
	ЗаполнитьПоказательНаСервере("R041G7", R041G7, Форма, "ПриложениеБД"); 

	R042G7 = ПолучитьПоказательНаСервере("R042G7", Форма, "ПриложениеБД");
	R043G7 = R041G7 - R042G7*0.5/100;
	R043G7 = ?(R043G7 > 0, R043G7, 0);
	ЗаполнитьПоказательНаСервере("R043G7", R043G7, Форма, "ПриложениеБД");       
	ЗаполнитьПоказательНаСервере("R020G3", R043G7, Форма, "ПриложениеДИЯ");       
	
	//Таблица 5 БД
	Форма.мСтруктураМногострочныхРазделов.Свойство(Форма.СтруктураРеквизитовФормы.мИдГруппыBD5, ТаблицаБлока);
	СтруктураБД5 = Форма[ТаблицаБлока];  
	R051G4 = 0;
	R051G5 = 0;
	R051G6 = 0;
	
	Для каждого СтрокаБД5 Из СтруктураБД5 Цикл   
		
		СтрокаБД5.BDT5RXXXXG7 = ОкруглитьЧислоПоФормату(Форма, СтрокаБД5.BDT5RXXXXG4)
							  +	ОкруглитьЧислоПоФормату(Форма, СтрокаБД5.BDT5RXXXXG5)
							  +	ОкруглитьЧислоПоФормату(Форма, СтрокаБД5.BDT5RXXXXG6);
                                                                             
		ЗаполнитьПоказательНаСервере("BDT5RXXXXG7_"+Формат(СтруктураБД5.Индекс(СтрокаБД5) + 1, "ЧГ=;"), СтрокаБД5.BDT5RXXXXG7, Форма, "ПриложениеБД");

		R051G4 = R051G4 + СтрокаБД5.BDT5RXXXXG4;
		R051G5 = R051G5 + СтрокаБД5.BDT5RXXXXG5;
		R051G6 = R051G6 + СтрокаБД5.BDT5RXXXXG6;
		
	КонецЦикла;

	ЗаполнитьПоказательНаСервере("R051G4", R051G4, Форма, "ПриложениеБД");
	ЗаполнитьПоказательНаСервере("R051G5", R051G5, Форма, "ПриложениеБД");
	ЗаполнитьПоказательНаСервере("R051G6", R051G6, Форма, "ПриложениеБД");    
	R051G7 = R051G4 + R051G5 + R051G6;
	ЗаполнитьПоказательНаСервере("R051G7", R051G7, Форма, "ПриложениеБД"); 

	R052G7 = ПолучитьПоказательНаСервере("R052G7", Форма, "ПриложениеБД");
	R053G7 = R051G7 - R052G7*1/100;
	R053G7 = ?(R053G7 > 0, R053G7, 0);
	ЗаполнитьПоказательНаСервере("R053G7", R053G7, Форма, "ПриложениеБД");       
	ЗаполнитьПоказательНаСервере("R021G3", R053G7, Форма, "ПриложениеДИЯ");       
	
	//Таблица 6 БД
	Форма.мСтруктураМногострочныхРазделов.Свойство(Форма.СтруктураРеквизитовФормы.мИдГруппыBD6, ТаблицаБлока);
	СтруктураБД6 = Форма[ТаблицаБлока];  
	R061G4 = 0;
	R061G5 = 0;
	R061G6 = 0;
	
	Для каждого СтрокаБД6 Из СтруктураБД6 Цикл   
		
		СтрокаБД6.BDT6RXXXXG7 = ОкруглитьЧислоПоФормату(Форма, СтрокаБД6.BDT6RXXXXG4)
							  +	ОкруглитьЧислоПоФормату(Форма, СтрокаБД6.BDT6RXXXXG5)
							  +	ОкруглитьЧислоПоФормату(Форма, СтрокаБД6.BDT6RXXXXG6);
                                                                             
		ЗаполнитьПоказательНаСервере("BDT6RXXXXG7_"+Формат(СтруктураБД6.Индекс(СтрокаБД6) + 1, "ЧГ=;"), СтрокаБД6.BDT6RXXXXG7, Форма, "ПриложениеБД");

		R061G4 = R061G4 + СтрокаБД6.BDT6RXXXXG4;
		R061G5 = R061G5 + СтрокаБД6.BDT6RXXXXG5;
		R061G6 = R061G6 + СтрокаБД6.BDT6RXXXXG6;
		
	КонецЦикла;

	ЗаполнитьПоказательНаСервере("R061G4", R061G4, Форма, "ПриложениеБД");
	ЗаполнитьПоказательНаСервере("R061G5", R061G5, Форма, "ПриложениеБД");
	ЗаполнитьПоказательНаСервере("R061G6", R061G6, Форма, "ПриложениеБД");    
	R061G7 = R061G4 + R061G5 + R061G6;
	ЗаполнитьПоказательНаСервере("R061G7", R061G7, Форма, "ПриложениеБД"); 

	//Таблица 7 БД
	Форма.мСтруктураМногострочныхРазделов.Свойство(Форма.СтруктураРеквизитовФормы.мИдГруппыBD7, ТаблицаБлока);
	СтруктураБД7 = Форма[ТаблицаБлока];  
	R071G4 = 0;
	R071G5 = 0;
	R071G6 = 0;
	
	Для каждого СтрокаБД7 Из СтруктураБД7 Цикл   
		
		СтрокаБД7.BDT7RXXXXG7 = ОкруглитьЧислоПоФормату(Форма, СтрокаБД7.BDT7RXXXXG4)
							  +	ОкруглитьЧислоПоФормату(Форма, СтрокаБД7.BDT7RXXXXG5)
							  +	ОкруглитьЧислоПоФормату(Форма, СтрокаБД7.BDT7RXXXXG6);
                                                                             
		ЗаполнитьПоказательНаСервере("BDT7RXXXXG7_"+Формат(СтруктураБД7.Индекс(СтрокаБД7) + 1, "ЧГ=;"), СтрокаБД7.BDT7RXXXXG7, Форма, "ПриложениеБД");

		R071G4 = R071G4 + СтрокаБД7.BDT7RXXXXG4;
		R071G5 = R071G5 + СтрокаБД7.BDT7RXXXXG5;
		R071G6 = R071G6 + СтрокаБД7.BDT7RXXXXG6;
		
	КонецЦикла;

	ЗаполнитьПоказательНаСервере("R071G4", R071G4, Форма, "ПриложениеБД");
	ЗаполнитьПоказательНаСервере("R071G5", R071G5, Форма, "ПриложениеБД");
	ЗаполнитьПоказательНаСервере("R071G6", R071G6, Форма, "ПриложениеБД");    
	R071G7 = R071G4 + R071G5 + R071G6;
	ЗаполнитьПоказательНаСервере("R071G7", R071G7, Форма, "ПриложениеБД"); 
	
	//////////////////////////////////////////////////////////////////////////////////////////
	// РИ
	R0121G3 = ПолучитьПоказательНаСервере("R00121G3", Форма, "ПриложениеАМ");
	R0313G3 = ПолучитьПоказательНаСервере("R01G17", Форма, "ПриложениеТЦ");
	R0314G3 = ПолучитьПоказательНаСервере("R01G19", Форма, "ПриложениеТЦ");
	Если R0121G3 <> 0 или R0313G3 <> 0 или R0314G3 <> 0 Тогда
		ЗаполнитьПоказательНаСервере("HD6", "+", Форма, "Декларация");									
	КонецЕсли;	
	ЗаполнитьПоказательНаСервере("R0121G3", R0121G3, Форма, "ПриложениеРИ");									
	
	ЗаполнитьПоказательНаСервере("R0313G3", R0313G3, Форма, "ПриложениеРИ");
	ЗаполнитьПоказательНаСервере("R0314G3", R0314G3, Форма, "ПриложениеРИ");
	...
	R001G3 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0111G3", Форма, "ПриложениеРИ"))
										  ...
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R03116G3", Форма, "ПриложениеРИ"))  
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R03117G3", Форма, "ПриложениеРИ"))  
										  ...
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R04152G3", Форма, "ПриложениеРИ"))  
										  ...
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R04125G3", Форма, "ПриложениеРИ")); 
	...
	R002G3 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0121G3", Форма, "ПриложениеРИ"))
										  ...
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R04251G3", Форма, "ПриложениеРИ")) 
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R04252G3", Форма, "ПриложениеРИ")) 
	...
	//////////////////////////////////////////////////////////////////////////////////////////
	// ЩАВ 
 	ГодПериода = Год(Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета);   
	...
	Для НомерМесяца = 1 по 12 Цикл
		...
		R11G5 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R10" + Формат(НомерМесяца, "ЧЦ=2;ЧВН=0;") + "1G3", Форма, "ПриложениеЩАВ")) 
				* (600 * ПолучитьПоказательНаСервере("R10" + Формат(НомерМесяца, "ЧЦ=2;ЧВН=0;") + "1G4", Форма, "ПриложениеЩАВ"));  
		
		R12G5 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R10" + Формат(НомерМесяца, "ЧЦ=2;ЧВН=0;") + "2G3", Форма, "ПриложениеЩАВ")) 
				* (700 * ПолучитьПоказательНаСервере("R10" + Формат(НомерМесяца, "ЧЦ=2;ЧВН=0;") + "2G4", Форма, "ПриложениеЩАВ"));  
		
		R13G5 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R10" + Формат(НомерМесяца, "ЧЦ=2;ЧВН=0;") + "3G3", Форма, "ПриложениеЩАВ")) 
				* (200 * ПолучитьПоказательНаСервере("R10" + Формат(НомерМесяца, "ЧЦ=2;ЧВН=0;") + "3G4", Форма, "ПриложениеЩАВ"));  
		
		ЗаполнитьПоказательНаСервере("R10" + Формат(НомерМесяца, "ЧЦ=2;ЧВН=0;") + "1G5", R11G5, Форма, "ПриложениеЩАВ");  
		ЗаполнитьПоказательНаСервере("R10" + Формат(НомерМесяца, "ЧЦ=2;ЧВН=0;") + "2G5", R12G5, Форма, "ПриложениеЩАВ");  
		ЗаполнитьПоказательНаСервере("R10" + Формат(НомерМесяца, "ЧЦ=2;ЧВН=0;") + "3G5", R13G5, Форма, "ПриложениеЩАВ"); 
		
		R1026G5 = R1026G5 + R11G5 + R12G5 + R13G5;
		
	КонецЦикла;

	ЗаполнитьПоказательНаСервере("R1026G5", R1026G5, Форма, "ПриложениеЩАВ");  
	...
	//таблица 2  
 	...
 	Для НомерМесяца = 1 по 12 Цикл
		...
		R21G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R20" + Формат(НомерМесяца, "ЧЦ=2;ЧВН=0;") + "1G3", Форма, "ПриложениеЩАВ")) * 30000; 
		R22G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R20" + Формат(НомерМесяца, "ЧЦ=2;ЧВН=0;") + "2G3", Форма, "ПриложениеЩАВ")) * 45000; 
		R23G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R20" + Формат(НомерМесяца, "ЧЦ=2;ЧВН=0;") + "3G3", Форма, "ПриложениеЩАВ")) * 60000;
		
		ЗаполнитьПоказательНаСервере("R20" + Формат(НомерМесяца, "ЧЦ=2;ЧВН=0;") + "1G4", R21G4, Форма, "ПриложениеЩАВ");  
		ЗаполнитьПоказательНаСервере("R20" + Формат(НомерМесяца, "ЧЦ=2;ЧВН=0;") + "2G4", R22G4, Форма, "ПриложениеЩАВ");  
		ЗаполнитьПоказательНаСервере("R20" + Формат(НомерМесяца, "ЧЦ=2;ЧВН=0;") + "3G4", R23G4, Форма, "ПриложениеЩАВ");  
		R2026G4 = R2026G4 + R21G4 + R22G4 + R23G4;   
	
	КонецЦикла;
		
	ЗаполнитьПоказательНаСервере("R2026G4", R2026G4, Форма, "ПриложениеЩАВ");  

	ЗаполнитьПоказательНаСервере("R026G3", R1026G5+R2026G4, Форма, "Декларация"); 
	R028G3 = R1026G5 + R2026G4 - ПолучитьПоказательНаСервере("R027G3",Форма,"Декларация");
	...
	Если ИмяСтраницыПанели = "ПриложениеПН" Тогда
		...
		Для КодСтроки = 1 По 32 Цикл    
			...
			ИначеЕсли КодСтроки = 22 Тогда
				ТекПроцент = 12;
			ИначеЕсли КодСтроки = 25 Тогда
				ТекПроцент = 5;	
			КонецЕсли;
			
			КодСтрокиСтр = Формат(КодСтроки, "ЧЦ=2; ЧДЦ=0; ЧВН=");       
			Если КодСтроки < 23 ИЛИ КодСтроки = 25 ИЛИ КодСтроки > 28 Тогда	    
				...
				R0133G3 = R0133G3 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R01" +КодСтрокиСтр+"G3", Форма, "ПриложениеПН"));
				R0133G6 = R0133G6 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R01" +КодСтрокиСтр+"G6", Форма, "ПриложениеПН"));
				R0133G7 = R0133G7 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R01" +КодСтрокиСтр+"G7", Форма, "ПриложениеПН"));
				R0133G8 = R0133G8 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R01" +КодСтрокиСтр+"G8", Форма, "ПриложениеПН"));
																	  
			Иначе										
				R0133G3 = R0133G3 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R01" +КодСтрокиСтр+"G3", Форма, "ПриложениеПН"));
			КонецЕсли;	
		КонецЦикла;
		ЗаполнитьПоказательНаСервере("R0133G3", R0133G3, Форма, "ПриложениеПН");
		ЗаполнитьПоказательНаСервере("R0133G6", R0133G6, Форма, "ПриложениеПН");
		ЗаполнитьПоказательНаСервере("R0133G7", R0133G7, Форма, "ПриложениеПН");
		ЗаполнитьПоказательНаСервере("R0133G8", R0133G8, Форма, "ПриложениеПН");
	КонецЕсли;
	//////////////////////////////////////////////////////////////////////////////////////////
	// АВ
	...
	//////////////////////////////////////////////////////////////////////////////////////////
	// МЗЗ
	ЗаполнитьПоказательНаСервере("MZR01G3", 0, Форма, "ПриложениеМЗЗ");  
	ЗаполнитьПоказательНаСервере("MZR01G4", 0, Форма, "ПриложениеМЗЗ");
	ЗаполнитьПоказательНаСервере("MZR01G5", 0, Форма, "ПриложениеМЗЗ");
	ЗаполнитьПоказательНаСервере("MZR01G6", 0, Форма, "ПриложениеМЗЗ");
	ЗаполнитьПоказательНаСервере("MZR01G7", 0, Форма, "ПриложениеМЗЗ");
	ЗаполнитьПоказательНаСервере("MZR01G18", 0, Форма, "ПриложениеМЗЗ");
	...
	Для каждого СтрокаМЗ1 Из СтруктураМЗ1 Цикл   
		...
		Если СтрокаМЗ1.MZT1RXXXXG3 <> 0 Тогда 
			
			СтрокаМЗ1.MZT1RXXXXG8 = (СтрокаМЗ1.MZT1RXXXXG4 + СтрокаМЗ1.MZT1RXXXXG6)
						 		    / СтрокаМЗ1.MZT1RXXXXG3 * 100;     
		Иначе
			
			СтрокаМЗ1.MZT1RXXXXG8 = 0;	
			
		КонецЕсли;
					  		
		СтрокаМЗ1.MZT1RXXXXG13 = ОкруглитьЧислоПоФормату(Форма, СтрокаМЗ1.MZT1RXXXXG9  
							   	 * СтрокаМЗ1.MZT1RXXXXG12
						 	   	 * СтрокаМЗ1.MZT1RXXXXG11/ 12);
						  
		СтрокаМЗ1.MZT1RXXXXG14 = ОкруглитьЧислоПоФормату(Форма, СтрокаМЗ1.MZT1RXXXXG10
							   	 * СтрокаМЗ1.MZT1RXXXXG12 * СтрокаМЗ1.MZT1RXXXXG3
						 	     * СтрокаМЗ1.MZT1RXXXXG11 / 12);

		Если СтрокаМЗ1.MZT1RXXXXG3 <> 0 Тогда  
								   
			СтрокаМЗ1.MZT1RXXXXG15 = ОкруглитьЧислоПоФормату(Форма,?(СтрокаМЗ1.MZT1RXXXXG13 = 0,
									 СтрокаМЗ1.MZT1RXXXXG14, СтрокаМЗ1.MZT1RXXXXG13)
									 / СтрокаМЗ1.MZT1RXXXXG3);
			
		Иначе 
								   
			СтрокаМЗ1.MZT1RXXXXG15 = 0;	
			
		КонецЕсли;     
		
		Если СтрокаМЗ1.MZT1RXXXXG8 >= 50 и СтрокаМЗ1.MZT1RXXXXG15 < 1400 Тогда   
			
			СтрокаМЗ1.MZT1RXXXXG16 = ОкруглитьЧислоПоФормату(Форма, 1400 * СтрокаМЗ1.MZT1RXXXXG3);  
			
		Иначе   
			
			СтрокаМЗ1.MZT1RXXXXG16 = 0;
			
		КонецЕсли;
		
		Если СтрокаМЗ1.MZT1RXXXXG8 < 50 и СтрокаМЗ1.MZT1RXXXXG15 < 700 Тогда   
			
			СтрокаМЗ1.MZT1RXXXXG17 = ОкруглитьЧислоПоФормату(Форма, 700 * СтрокаМЗ1.MZT1RXXXXG3);  
			
		Иначе   
			
			СтрокаМЗ1.MZT1RXXXXG17 = 0;
			
		КонецЕсли; 
		
		СтрокаМЗ1.MZT1RXXXXG18 = Макс(СтрокаМЗ1.MZT1RXXXXG13, СтрокаМЗ1.MZT1RXXXXG14, СтрокаМЗ1.MZT1RXXXXG16, СтрокаМЗ1.MZT1RXXXXG17);		

		ЗаполнитьПоказательНаСервере("MZT1RXXXXG8_"+Формат(СтруктураМЗ1.Индекс(СтрокаМЗ1) + 1, "ЧГ=;"), СтрокаМЗ1.MZT1RXXXXG8, Форма, "ПриложениеМЗЗ");
		ЗаполнитьПоказательНаСервере("MZT1RXXXXG11_"+Формат(СтруктураМЗ1.Индекс(СтрокаМЗ1) + 1, "ЧГ=;"), СтрокаМЗ1.MZT1RXXXXG11, Форма, "ПриложениеМЗЗ");
		ЗаполнитьПоказательНаСервере("MZT1RXXXXG13_"+Формат(СтруктураМЗ1.Индекс(СтрокаМЗ1) + 1, "ЧГ=;"), СтрокаМЗ1.MZT1RXXXXG13, Форма, "ПриложениеМЗЗ");
  		ЗаполнитьПоказательНаСервере("MZT1RXXXXG14_"+Формат(СтруктураМЗ1.Индекс(СтрокаМЗ1) + 1, "ЧГ=;"), СтрокаМЗ1.MZT1RXXXXG14, Форма, "ПриложениеМЗЗ");
  		ЗаполнитьПоказательНаСервере("MZT1RXXXXG15_"+Формат(СтруктураМЗ1.Индекс(СтрокаМЗ1) + 1, "ЧГ=;"), СтрокаМЗ1.MZT1RXXXXG15, Форма, "ПриложениеМЗЗ");
  		ЗаполнитьПоказательНаСервере("MZT1RXXXXG16_"+Формат(СтруктураМЗ1.Индекс(СтрокаМЗ1) + 1, "ЧГ=;"), СтрокаМЗ1.MZT1RXXXXG16, Форма, "ПриложениеМЗЗ");
  		ЗаполнитьПоказательНаСервере("MZT1RXXXXG17_"+Формат(СтруктураМЗ1.Индекс(СтрокаМЗ1) + 1, "ЧГ=;"), СтрокаМЗ1.MZT1RXXXXG17, Форма, "ПриложениеМЗЗ");
		ЗаполнитьПоказательНаСервере("MZT1RXXXXG18_"+Формат(СтруктураМЗ1.Индекс(СтрокаМЗ1) + 1, "ЧГ=;"), СтрокаМЗ1.MZT1RXXXXG18, Форма, "ПриложениеМЗЗ");

		R01G18 = R01G18 +  ПолучитьПоказательНаСервере("MZR01G18", Форма, "ПриложениеМЗЗ") + СтрокаМЗ1.MZT1RXXXXG18;
		
		R01G3 = R01G3 + ПолучитьПоказательНаСервере("MZR01G3", Форма, "ПриложениеМЗЗ") + СтрокаМЗ1.MZT1RXXXXG3;
		
		R01G4 = R01G4 + ПолучитьПоказательНаСервере("MZR01G4", Форма, "ПриложениеМЗЗ") + СтрокаМЗ1.MZT1RXXXXG4;
		
		R01G5 = R01G5 + ПолучитьПоказательНаСервере("MZR01G5", Форма, "ПриложениеМЗЗ") + СтрокаМЗ1.MZT1RXXXXG5;
		
		R01G6 = R01G6 + ПолучитьПоказательНаСервере("MZR01G6", Форма, "ПриложениеМЗЗ") + СтрокаМЗ1.MZT1RXXXXG6;
		
		R01G7 = R01G7 + ПолучитьПоказательНаСервере("MZR01G7", Форма, "ПриложениеМЗЗ") + СтрокаМЗ1.MZT1RXXXXG7;
		
	КонецЦикла;

	ЗаполнитьПоказательНаСервере("MZR01G18", R01G18, Форма, "ПриложениеМЗЗ");
	ЗаполнитьПоказательНаСервере("MZR01G3", R01G3, Форма, "ПриложениеМЗЗ"); 
	ЗаполнитьПоказательНаСервере("MZR01G4", R01G4, Форма, "ПриложениеМЗЗ");	
	...
	ЗаполнитьПоказательНаСервере("MZR01G7", R01G7, Форма, "ПриложениеМЗЗ");
	ЗаполнитьПоказательНаСервере("R02G3",   R01G18, Форма, "ПриложениеМПЗ");
	...
	ЗаполнитьПоказательНаСервере("R0062G3", ?(R04G3>0, R04G3, 0), Форма, "Декларация");
	...
	//позитивне значення(рядок 16 - рядок 16.1 - рядок 16.2 - рядок 16.3 - рядок 16.4 - рядок 16.5)  
	R017G3 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R016G3", Форма, "ПриложениеДИЯ")) 
		   ...
		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0165G3", Форма, "ПриложениеДИЯ"));
	...
	// (рядок 42 + рядок 43 + рядок 44 + рядок 45)
	R041G3 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R042G3", Форма, "ПриложениеДИЯ")) 
  		   + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R043G3", Форма, "ПриложениеДИЯ")) 
   		   + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R044G3", Форма, "ПриложениеДИЯ")) 
 		   + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R045G3", Форма, "ПриложениеДИЯ")); 
	ЗаполнитьПоказательНаСервере("R041G3", R041G3, Форма, "ПриложениеДИЯ");
	...
	R039G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R039G3", Форма, "ПриложениеДИЯ")) * 18 / 100;
	ЗаполнитьПоказательНаСервере("R039G6", R039G6, Форма, "ПриложениеДИЯ");
	R040G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R040G3", Форма, "ПриложениеДИЯ")) * 18 / 100;
	ЗаполнитьПоказательНаСервере("R040G6", R040G6, Форма, "ПриложениеДИЯ");
	R041G3 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R041G3", Форма, "ПриложениеДИЯ")) * 9 / 100;  
	ЗаполнитьПоказательНаСервере("R041G6", R041G3, Форма, "ПриложениеДИЯ");
	
	R046G6 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R002G6", Форма, "ПриложениеДИЯ"))     
										 ...
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R040G6", Форма, "ПриложениеДИЯ"))
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R041G6", Форма, "ПриложениеДИЯ"));
										 
	ЗаполнитьПоказательНаСервере("R046G6", R046G6, Форма, "ПриложениеДИЯ");  
	ЗаполнитьПоказательНаСервере("R0063G3", R046G6, Форма, "Декларация");
	...
	//ЗП       
	Если ИмяСтраницыПанели = "ПриложениеЩАВ" или ИмяСтраницыПанели = "ПриложениеКИК" или ИмяСтраницыПанели = "Декларация" Тогда   
		
		R026G4ЩАВ = ПолучитьПоказательНаСервере("R1026G5", Форма, "ПриложениеЩАВ") 
				  + ПолучитьПоказательНаСервере("R2026G4", Форма, "ПриложениеЩАВ");  
		...
		ЗаполнитьПоказательНаСервере("R0165G3", Мин(R026G4ЩАВ,R0165G3_предел), Форма, "ПриложениеЗП");   
	...
	R023G3 = 0;
	Если ИмяСтраницыПанели = "ПриложениеПН" Тогда
		R023G3 = R023G3 + ПолучитьПоказательНаСервере("R0133G8", Форма, "ПриложениеПН");  
	КонецЕсли;
	Для каждого ДанныеПН Из Форма.ТаблицаСтраницыРаздела1 Цикл
		...
		Если ДанныеПН.АктивнаяСтраница = Ложь Тогда
			...
			R0133G8 = 0;                                         
			Если ДанныеПН.Данные[0].Значение.Свойство("R0133G8", R0133G8) Тогда
	 			R023G3 = R023G3 + R0133G8;
			КонецЕсли;
		КонецЕсли; 
	КонецЦикла;
...
Процедура ДобавитьСтраницу(Команда)
	...
	РасчитатьКоличествоСтраницПриложений();  
...
Процедура ОбработкаВыбораВПолеТабличногоДокумента(Элемент, Область, СтандартнаяОбработка)
   ...
   ИначеЕсли ИмяЯчейки = "H1KVP"
		...
		Если НаименованиеТекЛиста <> "Декларация" Тогда
			ЗаполнитьПоказательНаСервере("H1KVP",	ТабличныйДокумент.Области["H1KVP"].Значение, ЭтаФорма, "Декларация");
			ЗаполнитьПоказательНаСервере("HHYP",	ТабличныйДокумент.Области["HHYP"].Значение,	 ЭтаФорма, "Декларация");
			ЗаполнитьПоказательНаСервере("H3KVP",	ТабличныйДокумент.Области["H3KVP"].Значение, ЭтаФорма, "Декларация");
			ЗаполнитьПоказательНаСервере("HYP",		ТабличныйДокумент.Области["HYP"].Значение,	 ЭтаФорма, "Декларация");
		КонецЕсли;                                                                                 

		Если НаименованиеТекЛиста <> "ПриложениеВП" Тогда
			ЗаполнитьПоказательНаСервере("H1KVP",	ТабличныйДокумент.Области["H1KVP"].Значение, ЭтаФорма, "ПриложениеВП");
			ЗаполнитьПоказательНаСервере("HHYP",	ТабличныйДокумент.Области["HHYP"].Значение,	 ЭтаФорма, "ПриложениеВП");
			ЗаполнитьПоказательНаСервере("H3KVP",	ТабличныйДокумент.Области["H3KVP"].Значение, ЭтаФорма, "ПриложениеВП");
			ЗаполнитьПоказательНаСервере("HYP",		ТабличныйДокумент.Области["HYP"].Значение,	 ЭтаФорма, "ПриложениеВП");
		КонецЕсли;

		Если НаименованиеТекЛиста <> "ПриложениеБД" Тогда
			ЗаполнитьПоказательНаСервере("H1KVP",	ТабличныйДокумент.Области["H1KVP"].Значение, ЭтаФорма, "ПриложениеБД");
			ЗаполнитьПоказательНаСервере("HHYP",	ТабличныйДокумент.Области["HHYP"].Значение,	 ЭтаФорма, "ПриложениеБД");
			ЗаполнитьПоказательНаСервере("H3KVP",	ТабличныйДокумент.Области["H3KVP"].Значение, ЭтаФорма, "ПриложениеБД");
			ЗаполнитьПоказательНаСервере("HYP",		ТабличныйДокумент.Области["HYP"].Значение,	 ЭтаФорма, "ПриложениеБД");
		КонецЕсли;
	...
	ИначеЕсли ИмяЯчейки = "HHY1"     //Приложение АМ 
   	...
   	ИначеЕсли ИмяЯчейки = "H01G3"    
			  ИЛИ ИмяЯчейки = "HLIQ" ИЛИ ИмяЯчейки = "H0110" ИЛИ ИмяЯчейки = "H0107" ИЛИ ИмяЯчейки = "H0108" ИЛИ ИмяЯчейки = "H0104"  
			  ...
			  ИЛИ (ИмяЯчейки = "R01G7" И НаименованиеТекЛиста = "ПриложениеПН") Тогда
	...
	ИначеЕсли ВРЕГ(Лев(ИмяЯчейки, 3)) = "H09"  
		...
		ТекЗначение = ?(ЗначениеЗаполнено(ТабличныйДокумент.Области[ИмяЯчейки].Значение), "", "X");
 	    ТабличныйДокумент.Области.H091.Значение = "";
 	    ТабличныйДокумент.Области.H092.Значение = "";
 	    ТабличныйДокумент.Области.H093.Значение = "";
 	    ТабличныйДокумент.Области.H094.Значение = "";
 	    ТабличныйДокумент.Области.H095.Значение = "";
 	    ТабличныйДокумент.Области.H096.Значение = "";
 	    ТабличныйДокумент.Области.H097.Значение = "";
 	    ТабличныйДокумент.Области.H098.Значение = "";
 	    ТабличныйДокумент.Области.H099.Значение = "";
 	    ТабличныйДокумент.Области.H100.Значение = "";
 	    ТабличныйДокумент.Области.H101.Значение = "";
 	    ТабличныйДокумент.Области.H102.Значение = "";
 	    ТабличныйДокумент.Области.H103.Значение = "";
 	    ТабличныйДокумент.Области.H105.Значение = "";
 	    ТабличныйДокумент.Области.H106.Значение = "";
 	    ТабличныйДокумент.Области.H0109.Значение = "";
        ТабличныйДокумент.Области[ИмяЯчейки].Значение = ТекЗначение;
		СтруктураРеквизитовФормы.H091 = ТабличныйДокумент.Области.H091.Значение;          
	...
	ИначеЕсли Лев(ИмяЯчейки,2) = "HD" Тогда 
		
		Если  ИмяЯчейки = "HD3" Или ИмяЯчейки = "HD13" Тогда
			
			Значение = ТабличныйДокумент.Области[ИмяЯчейки].Значение;
			ОписаниеОповещения = Новый ОписаниеОповещения("ВводПоказателяВПолеТабличногоДокументЗавершение",
													   ЭтаФорма, Новый Структура("ИмяЯчейки, ИмяСтраницы,
																				 |ИмяЯчейкиКвадратов, ИмяСтраницыКвадратов, 
																				 |Размерность, ДополнитьЗначение, НольКакНоль", 
																				 ИмяЯчейки,  "Декларация",
																				 ИмяЯчейки + "_", "Декларация",
																				 3, Ложь, Неопределено));
...
Процедура ВводПоказателяВПолеТабличногоДокументЗавершение(Значение, ДополнительныеПараметры) Экспорт
	...
	Если ИмяЯчейки = "HZYP" Тогда
		...
		ЗаполнитьПоказательНаСервере("HZYP", Значение, ЭтаФорма, "ПриложениеБД");	
	
	КонецЕсли; 
	
	Если Лев(ИмяЯчейки,2) = "HD" Тогда
...
Процедура ОбработкаИзмененияСодержимогоВПолеТабличногоДокумента(Элемент, Область)
	...
	Если ИмяРаздела = "Декларация" Тогда
		Если    ИмяОбласти = "HTIN" 
			...
			СтруктураДанныхПриложениеЩАВ[ИмяОбласти] = ТабличныйДокумент.Области[ИмяОбласти].Значение; 
			СтруктураДанныхПриложениеБД[ИмяОбласти] = ТабличныйДокумент.Области[ИмяОбласти].Значение;
...
Процедура ОчиститьНаСервере() Экспорт
	...
	СтруктураДанныхПриложениеЩАВ.Очистить();
	СтруктураДанныхПриложениеБД.Очистить();
...
Процедура ПриОткрытии(Отказ)
	...
	Если Найти(Заголовок, СтруктураРеквизитовФормы.СтрПериодОтчета) = 0 Тогда
		Заголовок = Заголовок + " за " + СтруктураРеквизитовФормы.СтрПериодОтчета + " (форма 4кв. 2025) ";
	КонецЕсли;
...
Процедура Заполнить(ПараметрыЗаполненияЗвит1С)
	...
	// строка 01 заполняется одинаково для всех случаев
	// строка 02 для варианта - нет перехода на ЕН 2%
	ЗаполнитьДанныеИзФинОтчетности(ПараметрыЗаполненияЗвит1С);
	Если ФлПереходаЕН Тогда
		//можем заполнить только из предприятия
		ТекстСообщения = НСтр("ru='Из-за перехода на Единый налог 2% строка 02 Декларации будет заполнена 
									|по данным бухучета, а не из сохраненного отчета о финансовом состоянии.';uk= 'Через перехід на Єдиний податок 2% рядок 02 Декларації буде заповнений 
		...
		КонецЕсли;
		ЗаполнитьДанныеФинОтчетностиВП(ДатаНачала1, ДатаОкончания1,1 );
		Если ФлДвухПериодов Тогда
			ЗаполнитьДанныеФинОтчетностиВП(ДатаНачала2, ДатаОкончания2, 2);
		КонецЕсли;	
	КонецЕсли;	
	...
	Если ЮрЛицо Тогда
		...
		мТаблицаПериодовПрибыль = Неопределено;
		Если СтруктураРеквизитовФормы.Свойство("АдресВременногоХранилищаПериодов") И ЗначениеЗаполнено(СтруктураРеквизитовФормы.АдресВременногоХранилищаПериодов) Тогда
			мТаблицаПериодовПрибыль = ПолучитьИзВременногоХранилища(СтруктураРеквизитовФормы.АдресВременногоХранилищаПериодов);
		КонецЕсли;
		ТаблицаПериодов = мТаблицаПериодовПрибыль;
		Если ЗначениеЗаполнено(ТаблицаПериодов) Тогда
			КоличествоПериодов = ТаблицаПериодов.Количество();
			флЗаполнятьКолонку3АМ = Истина;
			флЗаполнятьКолонку4АМ = Истина;
			Для Сч = 0 по КоличествоПериодов - 1 Цикл
				ДатаНач = ТаблицаПериодов[Сч].ДатаНачала;
				ДатаОк  = ТаблицаПериодов[Сч].ДатаОкончания;
				Если РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации() = "БП" 
					...
					НалогНаПрибыльБезКорректировокФинансовогоРезультата = УчетнаяПолитика.НалогНаПрибыльБезКорректировокФинансовогоРезультата(СтруктураРеквизитовФормы.Организация, ДатаОк);
				Иначе
					ПараметрыУчетнойПолитики = РегистрыСведений.УчетнаяПолитикаОрганизаций.ПараметрыУчетнойПолитики(СтруктураРеквизитовФормы.Организация, ДатаОк);
				...
				Если НалогНаПрибыльБезКорректировокФинансовогоРезультата = Ложь Тогда
					ЗаполнитьПриложениеРИ_АМ(ДатаНач, ДатаОк, КоличествоПериодов+Сч);
					ЗаполнитьПриложениеРИ_ТЦ(ДатаНач, ДатаОк, КоличествоПериодов+Сч); 
				Иначе
					...
					флЗаполнятьКолонку3АМ = Ложь;
					флЗаполнятьКолонку4АМ = Ложь;
				
				КонецЕсли;
				
			КонецЦикла;	
			ЗаполнитьПриложениеРИ_АМ(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета, СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета, 5);

		КонецЕсли;
				
		///////////////////////////////////////////////////////////////////////////  
		//4.2, 5.2 Приложение БД
		ЗаполнитьДанныеИзФинОтчетностиБД(ПараметрыЗаполненияЗвит1С);
		...
		///////////////////////////////////////////////////////////////////////////
		// 4.1.5.1 та 4.2.9 РИ - Переходные положения			
		ЗаполнитьСтатьиПереходногоПоложения();
...
Процедура ЗаполнитьДанныеИзФинОтчетности(ПараметрыЗаполненияЗвит1С, КварталПрошлГод = 0)
	...
	Если СтруктураРеквизитовФормы.ПолучениеДанныхДляЗвит1С = Ложь Тогда
		...
		// если был переход на ЕН 2% - не заполняем
		Если НЕ ФлПереходаЕН Тогда
...
&НаСервере
Процедура ЗаполнитьДанныеИзФинОтчетностиБД(ПараметрыЗаполненияЗвит1С)
	...
	Если СтруктураРеквизитовФормы.ПолучениеДанныхДляЗвит1С = Ложь Тогда
		...
		Если СтруктураРеквизитовФормы.ВидФинОтчетности = 0 Тогда
			...
			СписокСтрокДляРасшифровки = "2000";
		...
		ФинЗапрос.УстановитьПараметр ("ДатаОкончания", ДатаПрошлогоГода);
		ФинЗапрос.УстановитьПараметр ("Организация", СтруктураРеквизитовФормы.Организация);
		ФинЗапрос.УстановитьПараметр ("ИсточникОтчета", ИсточникОтчета);
		...
		Если  НЕ ТаблицаРезультатов.Количество() = 1 Тогда
			...
			Сообщить(НСтр("ru='Не удалось получить данных из отчета о финансовом состоянии. Строки 4.2 и 5.2 Приложения БД заполнены не будут!';uk= 'Не вдалося отримати дані зі звіту про фінансовий стан, рядки 4.2 та 5.2 Додатка БД заповнені не будуть!'"));
			Сообщить(НСтр("ru='	Обнаружено сохраненных отчетов без пометок удаления: ';uk= '	Виявлено збережених звітів без помітки про вилучення: '") + ТаблицаРезультатов.Количество() + Символы.ПС);
		...
		Иначе	
			...
			R042G7 =  ЗначенияПоказателей[ИмяДляБД];
		...
		СтруктураДанныхПриложениеБД.R042G7 = R042G7;       
		СтруктураДанныхПриложениеБД.R052G7 = R042G7;       
	...
	Иначе	
		...
		НазваниеФормыОтчетности = НазваниеФормыОтчетности + " за 4 квартал минулого року";
		ПараметрыЗаполненияИзФинОтчетностиПрошлБД = Новый Структура;
		ПараметрыЗаполненияИзФинОтчетностиПрошлБД.Вставить("ПараметрыЗапроса", Новый Структура("ИмяСхемы, ТипПериода, НомерПериода, ГодПериода", ИмяСхемы, ТипПериода, НомерПериода, ГодПериода));
		ПараметрыЗаполненияИзФинОтчетностиПрошлБД.Вставить("ИмяСхемы", ИмяСхемы);
		ПараметрыЗаполненияИзФинОтчетностиПрошлБД.Вставить("ИмяДляБД", ИмяДляБД);
		ПараметрыЗаполненияИзФинОтчетностиПрошлБД.Вставить("СписокСтрокДляРасшифровки", СписокСтрокДляРасшифровки);
		ПараметрыЗаполненияИзФинОтчетностиПрошлБД.Вставить("НазваниеФормыОтчетности", НазваниеФормыОтчетности);		
		ПараметрыЗаполненияЗвит1С.Вставить("ПараметрыЗаполненияИзФинОтчетностиПрошлБД", ПараметрыЗаполненияИзФинОтчетностиПрошлБД);
...
&НаСервере
Процедура ЗаполнитьДанныеФинОтчетностиВП(ДатаНачала, ДатаКонца, НомерПериода)
	...
	Если СтруктураРеквизитовФормы.ВидФинОтчетности = 0 Тогда
		...
		R002G3 = ДоходОперДеят3 - (ДО(Счет95) + ДО(Счет96) + ДО(Счет97));
		 ...
		 //001
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "Показник 02 Декларації",	"+", "!КО",КО(Счет70_1), Счет70_1,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"+", "!КО",КО(Счет70_2),Счет70_2,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"+", "!КО",КО(Счет70_3),Счет70_3,,ДатаНачала, ДатаКонца, "Декларация");
		
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"+", "!КО",КО(Счет70_9_1),Счет70_9_1,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ОБ",ОБ(Счет70_9_1,Счет70),Счет70_9_1, Счет70,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ОБ",ОБ(Счет70,Счет70_9_1),Счет70, Счет70_9_1,ДатаНачала, ДатаКонца, "Декларация");
		
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ОБ",ОБ(Счет70_1,Счет64),Счет70_1,Счет64,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ОБ",ОБ(Счет70_2,Счет64),Счет70_2,Счет64,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ОБ",ОБ(Счет70_3,Счет64),Счет70_3,Счет64,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ОБ",ОБ(Счет70_9_1,Счет64),Счет70_9_1,Счет64,ДатаНачала, ДатаКонца, "Декларация");
		
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ОБ",ОБ(Счет70,Счет36),Счет70,Счет36,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ОБ",ОБ(Счет70,Счет30),Счет70,Счет30,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ОБ",ОБ(Счет70,Счет68_5),Счет70,Счет68_5,ДатаНачала, ДатаКонца, "Декларация");
		
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ОБ",ОБ(Счет70_4,Счет37_7),Счет70_4,Счет37_7,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ОБ",ОБ(Счет70_4,Счет63),Счет70_4,Счет63,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ОБ",ОБ(Счет70_4,Счет64),Счет70_4,Счет64,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"+", "!ОБ",ОБ(Счет64,Счет70_4),Счет64,Счет70_4,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"+", "!ОБ",ОБ(Счет30,Счет70_4),Счет30,Счет70_4,ДатаНачала, ДатаКонца, "Декларация");
	...
	Иначе	//МПС и МП
		...
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"+", "!КО",КО(Счет70_3),Счет70_3,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"+", "!КО",КО(Счет70_9_1),Счет70_9_1,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ОБ",ОБ(Счет70_9_1,Счет70_1),Счет70_9_1, Счет70_1,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ОБ",ОБ(Счет70_9_1,Счет70_2),Счет70_9_1, Счет70_2,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ОБ",ОБ(Счет70_9_1,Счет70_3),Счет70_9_1, Счет70_3,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ОБ",ОБ(Счет70,Счет70_9_1),Счет70, Счет70_9_1,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ОБ",ОБ(Счет70, Счет64_1), Счет70_1, Счет64_1,ДатаНачала, ДатаКонца, "Декларация");	
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ОБ",ОБ(Счет70, Счет64_2),Счет70, Счет64_2,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ОБ",ОБ(Счет70, Счет64_3),Счет70, Счет64_3,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ОБ",ОБ(Счет70, Счет36),Счет70, Счет36,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ОБ",ОБ(Счет70, Счет30),Счет70, Счет30,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ОБ",ОБ(Счет70, Счет31),Счет70, Счет31,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ОБ",ОБ(Счет70, Счет68_5),Счет70, Счет68_5,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"+", "!ОБ",ОБ(Счет30, Счет70_4),Счет30, Счет70_4,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"+", "!ОБ",ОБ(Счет31, Счет70_4),Счет31, Счет70_4,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ОБ",ОБ(Счет70_4, Счет63),Счет70_4, Счет63,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"+", "!ОБ",ОБ(Счет64_3, Счет70_4),Счет64_3, Счет70_4,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"+", "!ОБ",ОБ(Счет64_4, Счет70_4),Счет64_4, Счет70_4,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"+", "!КО",КО(Счет71), Счет71,,ДатаНачала, ДатаКонца, "Декларация");	
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ОБ",ОБ(Счет71,Счет64_1),Счет71,Счет64_1,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ОБ",ОБ(Счет71,Счет64_3),Счет71,Счет64_3,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"+", "!КО",КО(Счет72),Счет72,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"+", "!КО",КО(Счет73),Счет73,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"+", "!КО",КО(Счет74),Счет74,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ОБ",ОБ(Счет74,Счет64_1),Счет74, Счет64_1,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ОБ",ОБ(Счет74,Счет64_3),Счет74,Счет64_3,ДатаНачала, ДатаКонца, "Декларация");
         //002
...
//заполнение РИ, АМ
// НомерПер: 1 - только один период, 2 - первый период из двух, 3 - второй период из двух
//			 5 - расчет балансовой стоимости на начало года и конец периода отчета
&НаСервере
Процедура ЗаполнитьПриложениеРИ_АМ(ДатаНачала, ДатаКонца, НомерПер)
	Перем СтруктураГруппы, ИсходноеКоличествоСтрокГруппы;
	
	//////////////////////////////////////////////////////////////////
	//	амортизация  и другие данные по ОС  
	Если НомерПер = 5 И НЕ флЗаполнятьКолонку3АМ И НЕ флЗаполнятьКолонку4АМ Тогда
		//уже заполнили
		Возврат;
	КонецЕсли;
   ...
   // Списание    = Кт оборот 10,11,12,286 - не в корр с 10,11,12,13,286 при условии, что на конец приода нет остатка по этим счетам учета (по Дт)
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |	ЕстьNULL(" + ?(ИДКонERP25 = "ERP25", " СведенияГруппаНачало."," СведенияНалНазначениеНачало.")+"НалоговоеНазначение, " + ?(ИДКонERP25 = "ERP25", " СведенияГруппа."," СведенияНалНазначение.")+"НалоговоеНазначение) КАК НалоговоеНазначениеНачало,
				   ...
				   |     " + ?(НЕ ИДКонERP25 = "ERP25", " ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.НалоговыеНазначенияОС.СрезПоследних(&ДатаНач, Организация = &Организация) КАК СведенияНалНазначениеНачало
				   |		ПО СведенияГруппа.ОсновноеСредство = СведенияНалНазначениеНачало.ОсновноеСредство", " ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ПорядокУчетаОСБУ.СрезПоследних(&ДатаНач, Организация = &Организация) КАК СведенияГруппаНачало
				   |		ПО СведенияГруппа.ОсновноеСредство = СведенияГруппаНачало.ОсновноеСредство")+"
	               |
	               |ОБЪЕДИНИТЬ ВСЕ
	               |
	               |ВЫБРАТЬ
	               ...
	               |	ЕстьNULL(СведенияНачало.НалоговоеНазначение, Сведения.НалоговоеНазначение),
	               ...
	               |	ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений." + ?(ИДКонERP25 = "ERP25", "ПорядокУчетаНМАБУ.","ПервоначальныеСведенияНМАНалоговыйУчет.")+"СрезПоследних(&ДатаНач, Организация = &Организация) КАК СведенияНачало 
				   |		ПО Сведения.НематериальныйАктив = СведенияНачало.НематериальныйАктив
	               |
	               |ОБЪЕДИНИТЬ ВСЕ
	               |
	               |ВЫБРАТЬ
				   ...
				   |	    ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений." + ?(ИДКонERP25 = "ERP25", "ПорядокУчетаОСБУ.СрезПоследних(&ДатаКон)","НалоговыеНазначенияОС")+" КАК НалоговыеНазначенияОС
	...
	Если ИДКонф = "ЕРП" Тогда 
		Запрос.Текст = Запрос.Текст + " ОБЪЕДИНИТЬ ВСЕ
					...
					|ВЫБРАТЬ
					|	ВЫБОР
					|		КОГДА ХозрасчетныйОбороты.Субконто1 ССЫЛКА Справочник.ОбъектыЭксплуатации
					|				ИЛИ ХозрасчетныйОбороты.Субконто1 ССЫЛКА Справочник.НематериальныеАктивы
					|				ИЛИ ХозрасчетныйОбороты.Субконто1 ССЫЛКА Справочник.Номенклатура
					|			ТОГДА ХозрасчетныйОбороты.Субконто1
					|		КОГДА ХозрасчетныйОбороты.Субконто2 ССЫЛКА Справочник.ОбъектыЭксплуатации
					|				ИЛИ ХозрасчетныйОбороты.Субконто2 ССЫЛКА Справочник.НематериальныеАктивы
					|				ИЛИ ХозрасчетныйОбороты.Субконто2 ССЫЛКА Справочник.Номенклатура
					|			ТОГДА ХозрасчетныйОбороты.Субконто2
					|		КОГДА ХозрасчетныйОбороты.Субконто3 ССЫЛКА Справочник.ОбъектыЭксплуатации
					|				ИЛИ ХозрасчетныйОбороты.Субконто3 ССЫЛКА Справочник.НематериальныеАктивы
					|				ИЛИ ХозрасчетныйОбороты.Субконто3 ССЫЛКА Справочник.Номенклатура
					|			ТОГДА ХозрасчетныйОбороты.Субконто3
					|	КОНЕЦ,
					...
					|			ИЛИ ЕСТЬNULL(Остатки.ОстатокНУ, 0) <> 0)
					|	И ХозрасчетныйОбороты.Регистратор ССЫЛКА Документ.СписаниеОС
					|	И ХозрасчетныйОбороты.Регистратор.ЧастичнаяЛиквидация
					|СГРУППИРОВАТЬ ПО
					|	ВЫБОР
					|		КОГДА ХозрасчетныйОбороты.Субконто1 ССЫЛКА Справочник.ОбъектыЭксплуатации
					|				ИЛИ ХозрасчетныйОбороты.Субконто1 ССЫЛКА Справочник.НематериальныеАктивы
	...
	Запрос.Текст = Запрос.Текст + " ОБЪЕДИНИТЬ ВСЕ
	               ...
	               |	СУММА(ВЫБОР
	               |			КОГДА Сведения.НалоговоеНазначениеНачало = &НеоблНеХозДеят
	               |				ТОГДА 0
	...
	R0111G3_ОС = 0; R0111G3_НМА = 0; R0111G3_Номенклатура = 0; 
	СписокОСДляR0111G3_ОС = Новый СписокЗначений;
	СписокОСДляR0111G3_НМА = Новый СписокЗначений;
	СписокОСДляR0111G3_Номенклатура = Новый СписокЗначений;
	...
	R042162G3 = 0; 
	ДатаНачалаПериода = СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета; 
 	ДатаКонцаПериода  = СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета; 
	флКол3 = флЗаполнятьКолонку3АМ; флКол4 = флЗаполнятьКолонку4АМ;
	...
	Пока Выборка.Следующий() Цикл
		...
		Если НЕ ПустаяСтрока(ИмяЯчейкиАМ) Тогда
			Если ДатаНачала = ДатаНачалаПериода и флКол3 Тогда 
				...
				флЗаполнятьКолонку3АМ = Ложь;
			КонецЕсли;
			Если ДатаКонца = ДатаКонцаПериода И флКол4 Тогда
		...
		Если ДатаКонца = ДатаКонцаПериода И флКол4 Тогда
			//считаем только в последнем периоде
...
// НомерПер: 1 - только один период, 2 - первый период из двух, 3 - второй период из двух
&НаСервере
Процедура ЗаполнитьПриложениеРИ_ТЦ(ДатаНачала, ДатаКонца, НомерПер)
	Перем СтруктураГруппы, ИсходноеКоличествоСтрокГруппы;
	
	ИДКонф = РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации();
	//	Приложение ТЦ, только для ЕРП    
	Если ИДКонф = "ЕРП" И Метаданные.РегистрыСведений.Найти("СвязанностьЛицКонтролируемыхОпераций") <> Неопределено и (КонецГода(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) Тогда
		...
		Попытка
			Запрос.Текст = "ВЫБРАТЬ
					   ...
					   |	Страны.Страна.Код,
					   |	КонтролируемыеОперации.ЕдиницаИзмерения КАК ЕдиницаИзмерения,
					   |	КонтролируемыеОперации.Количество,
		               |	КонтролируемыеОперации.ЦенаРегл КАК Цена
		               |ИЗ
		...
		Пока ВыборкаКонтрагент.Следующий() Цикл
			...
			Пока Выборка.Следующий() Цикл
				...
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G10S"] = СтрЗаменить(Выборка.КодУКТВЭД, " ", "");
				...
				Если Выборка.СуммаКорректировкиДоходов <> 0 Тогда
					...
					ДобавленнаяСтрока[ПрефиксИмениКолонки+"G171"] = Выборка.Цена;  
					ДобавленнаяСтрока[ПрефиксИмениКолонки+"G172"] = Выборка.Количество;  
					ДобавленнаяСтрока[ПрефиксИмениКолонки+"G173S"] = Выборка.ЕдиницаИзмерения;  
				КонецЕсли;
				...
				Если Выборка.СуммаКорректировкиРасходов <> 0 Тогда
					...
					ДобавленнаяСтрока[ПрефиксИмениКолонки+"G191"] = Выборка.Цена;  
					ДобавленнаяСтрока[ПрефиксИмениКолонки+"G192"] = Выборка.Количество;  
					ДобавленнаяСтрока[ПрефиксИмениКолонки+"G193S"] = Выборка.ЕдиницаИзмерения;  
				КонецЕсли;
	...
	ЗаполнитьРемонтНепроизводственныхОС(ДатаНачала, ДатаКонца);
	ЗаполнитьШтрафы(ДатаНачала, ДатаКонца);
	ЗаполнитьСписаниеНеБезнЗадолженности(ДатаНачала, ДатаКонца);
	ЗаполнитьПередачуНеприбыльным(ДатаНачала, ДатаКонца);
	ЗаполнитьПриобретениеУНеприбыльных(ДатаНачала, ДатаКонца, НомерПер);
	ЗаполнитьПриобретениеИзОффшоров(ДатаНачала, ДатаКонца, НомерПер);
	ЗаполнитьПриобретениеИзОффшоровОргформа(ДатаНачала, ДатаКонца, НомерПер);
	ЗаполнитьРеализациюИзОффшоров(ДатаНачала, ДатаКонца);
	ЗаполнитьРеализациюИзОффшоровОргформа(ДатаНачала, ДатаКонца);
	...
	Пока Выборка.Следующий() Цикл
		...
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_Задолженность		  			Тогда ЗаполнитьКорректировкуРИ("R04110G3","+",  Выборка.Сумма, Выборка.Статья)
		...
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_АмортизацияУскоренная_Начисленная_2020	Тогда ЗаполнитьКорректировкуРИ("R041171G3","+",  Выборка.Сумма, Выборка.Статья)			
		...
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Фин_БезвозврФинПомощьСвязЛиц			Тогда ЗаполнитьКорректировкуРИ("R031101G3", "+",  Выборка.Сумма, Выборка.Статья)	
		...
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_3_СебестоимостьБУОбСтр		Тогда ЗаполнитьКорректировкуРИ("R04142G3", "+",  Выборка.Сумма, Выборка.Статья)
		...
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Фин_ДИЯ_ЕН 						Тогда ЗаполнитьКорректировкуРИ("R03115G3", "+",  Выборка.Сумма, Выборка.Статья)
		Иначе			
			Попытка
				Если Выборка.Статья = СтНД.НП15_РИ_Фин_Хабар Тогда 
					ЗаполнитьКорректировкуРИ("R03116G3", "+",  Выборка.Сумма, Выборка.Статья)
				КонецЕсли;
			Исключение
			КонецПопытки;
			Попытка
				Если Выборка.Статья = СтНД.НП15_РИ_Фин_ХабарАморт Тогда 
					ЗаполнитьКорректировкуРИ("R03117G3", "+",  Выборка.Сумма, Выборка.Статья)
				КонецЕсли;
			Исключение
			КонецПопытки;
		КонецЕсли;
...
&НаСервере  
Процедура ЗаполнитьСписаниеНеБезнЗадолженности(ДатаНачала, ДатаКонца)
	
	ЗаполнитьПоСтатьямЗатрат("R0213G3", СтруктураРеквизитовФормы.СписаниеНеБезнадежнойЗадолженности_Статьи, ДатаНачала, ДатаКонца);
	
КонецПроцедуры

&НаСервере
Процедура ЗаполнитьШтрафы(ДатаНачала, ДатаКонца)
	
	ЗаполнитьПоСтатьямЗатрат("R03111G3", СтруктураРеквизитовФормы.Штрафы_Статьи, ДатаНачала, ДатаКонца);
		
КонецПроцедуры

&НаСервере
Процедура ЗаполнитьПередачуНеприбыльным(ДатаНачала, ДатаКонца)
    //2025
	ПередачаНеприбыльным = ЗаполнитьПриложениеБД("", СтруктураРеквизитовФормы.ПередачаНеприбыльным_СтатьиЗатрат, ДатаНачала, ДатаКонца);
															
КонецПроцедуры

&НаСервере
Функция ЗаполнитьПоСтатьямЗатрат(ИмяЯчейки, ФильтрСтатей, ДатаНачала, ДатаКонца)
...
//2025
&НаСервере
Функция ЗаполнитьПриложениеБД(ИмяЯчейки, ФильтрСтатей, ДатаНачала, ДатаКонца)
	Перем СтруктураГруппы, ИсходноеКоличествоСтрокГруппы;

	Разница = 0;
	
	ИмяГруппы = СтруктураРеквизитовФормы.мИдГруппыBD2;
	ДанныеФормы 	= ЭтаФорма[ИмяГруппы]; 
	СтруктураГруппы = ДанныеФормыВЗначение(ДанныеФормы, Тип("ТаблицаЗначений"));		
	мСтруктураИсхКолвоСтрокРазделов.Свойство(ИмяГруппы, ИсходноеКоличествоСтрокГруппы);
	
	ПрефиксИмениКолонки = "BDT2RXXXX";
	...
	Если РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации() = "БП" Тогда
		Запрос.УстановитьПараметр("СтатьиЗатратНеоперационные", ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.СтатьиНеоперационныхРасходов);
	    ТекстЗапр =	"РегистрБухгалтерии.Хозрасчетный.Обороты(&ДатаНач, &ДатаКон, Регистратор , , &СтатьиЗатратНеоперационные, Организация В (&Организация), , ) КАК ХозрасчетныйОбороты";
		УсловиеЕРП = ""; 
		
		ТипДокументаРС = "ДокументСсылка.СписаниеСРасчетногоСчета";
	Иначе	
	    ТекстЗапр =	"РегистрБухгалтерии.Хозрасчетный.Обороты(&ДатаНач, &ДатаКон, Регистратор , , , Организация В (&Организация), , ) КАК ХозрасчетныйОбороты";
		УсловиеЕРП = "И ЛОЖЬ"; 
		
		ТипДокументаРС = "ДокументСсылка.СписаниеБезналичныхДенежныхСредств";
	КонецЕсли;	
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |	ЕСТЬNULL(ХозрасчетныйОбороты.Регистратор.Контрагент, """") КАК Контрагент
	               |ИЗ
				   |	"+ТекстЗапр +"
	               |ГДЕ
	               |	(ХозрасчетныйОбороты.Субконто1 В (&ФильтрСтатей)
	               ...
	               |	ХозрасчетныйОбороты.Регистратор,
	               |	ХозрасчетныйОбороты.КорСчет,
	               |	ЕСТЬNULL(ХозрасчетныйОбороты.Регистратор.Контрагент, """")
	               |
	               |ОБЪЕДИНИТЬ ВСЕ
	               |
	               |ВЫБРАТЬ
	               ...
	               |				ИЛИ Счет В (&СчетаЗатрат),
	               |			&СтатьиЗатрат,
	               |			Организация В (&Организация)
	               |				И (Субконто1 В (&ФильтрСтатей)
	               |					ИЛИ Субконто1 В ИЕРАРХИИ (&ФильтрСтатей)),
	               |			НЕ КорСчет В ИЕРАРХИИ (&СчетаЗатрат)
	               |				И НЕ КорСчет В (&СчетаЗатрат),
	               |			) КАК ХозрасчетныйОбороты
	               |
	               |СГРУППИРОВАТЬ ПО
	               |	ХозрасчетныйОбороты.Регистратор,
	...
	Пока Выборка.Следующий() Цикл
		...
		Если ЗначениеЗаполнено(Выборка.Контрагент) Тогда
			ДобавленнаяСтрока[ПрефиксИмениКолонки+"G1S"] = Выборка.Контрагент;
			ДобавленнаяСтрока[ПрефиксИмениКолонки+"G2S"] = Выборка.Контрагент.КодПоЕДРПОУ;	
		КонецЕсли;
		//в предприятии заполним для подсказки
		ДобавленнаяСтрока[ПрефиксИмениКолонки+"Document"] = Выборка.Регистратор;
		
		ДобавленнаяСтрока[ПрефиксИмениКолонки+"G3S"] = "";
		Если ТипЗнч(Выборка.Регистратор) = Тип(ТипДокументаРС) Тогда
			ДобавленнаяСтрока[ПрефиксИмениКолонки+"G4"] = Выборка.Сумма;	
		Иначе
			ДобавленнаяСтрока[ПрефиксИмениКолонки+"G5"] = Выборка.Сумма;
		КонецЕсли;	
		
		ДобавленнаяСтрока[ПрефиксИмениКолонки+"G6"] = 0;	
		ТекНомСтр = ТекНомСтр + 1;
			
		СтруктураДанныхДекларация.HD17 = "+";
		СтруктураДанныхДекларация.HD6 = "+";
	КонецЦикла;
	ЗначениеВРеквизитФормы(СтруктураГруппы, ИмяГруппы);
...
&НаСервере
Процедура ЗаполнитьПриобретениеУНеприбыльных(ДатаНачала, ДатаКонца, НомерПер)

	ЗаполнитьПриобретения("R0316G3", СтруктураРеквизитовФормы.Контрагенты_Неприбыльные, "3.1.6", ДатаНачала, ДатаКонца, НомерПер);

КонецПроцедуры

&НаСервере 
Процедура ЗаполнитьПриобретениеИзОффшоров(ДатаНачала, ДатаКонца, НомерПер)
	ЗаполнитьПриобретения("R03161G3", СтруктураРеквизитовФормы.Контрагенты_Оффшоры, "3.1.6.1", ДатаНачала, ДатаКонца, НомерПер);
КонецПроцедуры

&НаСервере
Процедура ЗаполнитьПриобретениеИзОффшоровОргформа(ДатаНачала, ДатаКонца, НомерПер)

	ЗаполнитьПриобретения("R03162G3", СтруктураРеквизитовФормы.Контрагенты_ОффшорыОргформа, "3.1.6.2", ДатаНачала, ДатаКонца, НомерПер);

КонецПроцедуры

&НаСервере
Процедура ЗаполнитьПриобретения(ИмяЯчейки, ФильтрКонтрагентов, ПредставлениеПоказателя, ДатаНачала, ДатаКонца, НомерПер)
	...
	// исключаем расходы связанные с курсовыми разницами
	...
	Если ТекущиеДанные.Следующий() Тогда
		...
		Если ИмяЯчейки = "R0316G3" Тогда   
			Если НомерПер = 3 Тогда
				//второй период из двух
				...
				КонецЕсли;	
			ИначеЕсли НомерПер = 2 Тогда
				//первый период из двух
...
&НаСервере
Процедура ЗаполнитьРеализациюИзОффшоров(ДатаНачала, ДатаКонца)
	ЗаполнитьРеализацию("R0317G3", СтруктураРеквизитовФормы.Контрагенты_Оффшоры, "3.1.7", ДатаНачала, ДатаКонца);
КонецПроцедуры

&НаСервере
Процедура ЗаполнитьРеализациюИзОффшоровОргформа(ДатаНачала, ДатаКонца)

	ЗаполнитьРеализацию("R03171G3", СтруктураРеквизитовФормы.Контрагенты_ОффшорыОргформа, "3.1.7.1", ДатаНачала, ДатаКонца);

КонецПроцедуры

&НаСервере
Процедура ЗаполнитьРеализацию(ИмяЯчейки, ФильтрКонтрагентов, ПредставлениеПоказателя, ДатаНачала, ДатаКонца)
...
&НаСервере 
Процедура ЗаполнитьРемонтНепроизводственныхОС(ДатаНачала, ДатаКонца)
...
Процедура ЗаполнитьУбытокПрошлогоГода(ПараметрыЗаполненияЗвит1С)
	...
	Иначе
		...
		Если ГодПериода = 2024 Тогда
			ИмяСхемы1 = ИмяСхемы1 + "26";
			// сельхозники
			ИмяСхемы2 = "J0100526";  
		Иначе //2025
			ИмяСхемы1 = ИмяСхемы1 + "29";
			// сельхозники
			ИмяСхемы2 = "J0100529";  
		КонецЕсли;
...
&НаСервере
Процедура ЗаполнитьСтатьиПереходногоПоложения()
	...
	СтД = Справочники.СтатьиНалоговыхДеклараций;
	МассивСтатей = Новый Массив();
	МассивСтатей.Добавить(СтД.НП15_РИ_Фин_ОплатаТоваров_ЕН);
	МассивСтатей.Добавить(СтД.НП15_РИ_Др_Переходные_КассовыйЗатраты);  
	Попытка
		МассивСтатей.Добавить(СтД.НП15_РИ_Фин_СС_Товаров);  
		МассивСтатей.Добавить(СтД.НП15_РИ_Фин_СС_Товаров_ЕН);  
		МассивСтатей.Добавить(СтД.НП15_РИ_Фин_Аванс_ЕН);  
	Исключение
	КонецПопытки;
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |			&ДатаКон,
	               |			,
	               |			Счет = &СчетКорректировок,
	               |			&МассивСубконто,
	               |			Организация = &Организация
	               |				И Субконто1 В (&МассивСтатей),
	               |			,
	               |			) КАК ХозрасчетныйОбороты";
	...
	R0429G3 = 0;
	Пока Выборка.Следующий() Цикл
		Если Выборка.Статья = СтД.НП15_РИ_Фин_ОплатаТоваров_ЕН Тогда
			R04151G3 = Выборка.Сумма;
		КонецЕсли;	
		Если Выборка.Статья = СтД.НП15_РИ_Др_Переходные_КассовыйЗатраты Тогда
			R0429G3 = Выборка.Сумма;
		КонецЕсли;	
		Попытка
			Если Выборка.Статья = СтД.НП15_РИ_Фин_СС_Товаров Тогда
				R04152G3 = Выборка.Сумма;
			КонецЕсли;	
			Если Выборка.Статья = СтД.НП15_РИ_Фин_СС_Товаров_ЕН Тогда
				R04251G3 = Выборка.Сумма;
			КонецЕсли;	
			Если Выборка.Статья = СтД.НП15_РИ_Фин_Аванс_ЕН Тогда
				R04252G3 = Выборка.Сумма;
			КонецЕсли;	
		Исключение
		КонецПопытки;
	КонецЦикла;
	ЗаполнитьКорректировкуРИ("R04151G3", "+",  R04151G3, СтД.НП15_РИ_Фин_ОплатаТоваров_ЕН);
	Попытка
		ЗаполнитьКорректировкуРИ("R04152G3", "+",  R04152G3, СтД.НП15_РИ_Фин_СС_Товаров);
		ЗаполнитьКорректировкуРИ("R04251G3", "+",  R04251G3, СтД.НП15_РИ_Фин_СС_Товаров_ЕН);
		ЗаполнитьКорректировкуРИ("R04252G3", "+",  R04252G3, СтД.НП15_РИ_Фин_Аванс_ЕН);
	Исключение
	КонецПопытки;
	ЗаполнитьКорректировкуРИ("R0429G3",  "+",  R0429G3,  СтД.НП15_РИ_Др_Переходные_КассовыйЗатраты);
...
Процедура ЗаполнитьПоказателиПрошогоПериода(ПараметрыЗаполненияЗвит1С)
	...
	Если ПолучитьДанныеЗаПрошлыйКварталИз1С Тогда
		// обычное заполнение отчета из встроенной подсистемы
		ДанныеПрошлогоКвартала = ЗначениеПоПредыдущейДекларации(ДатаПрошлогоКвартала,"Декларация","ru = 'строк 18, 21, 24, 27 Декларации';uk= 'рядків 18, 21, 24, 27 Декларації'", ВыводитьПредупреждения);
		...
		Если ПолучитьДанныеЗаПрошлыйГодИз1С Тогда
			...
			Если ДанныеПрошлогоГода <> Неопределено Тогда
				...
				Если R0163G3 <> 0 тогда
					СтруктураДанныхДекларация.HD2 =  "+"; 
				КонецЕсли;
			КонецЕсли;   
			ДанныеПрошлогоГода = ЗначениеПоПредыдущейДекларации(ДатаПрошлогоГода,"Декларация","ru = '1.1 Приложения БД';uk= '1.1 Додатка БД'", ВыводитьПредупреждения);
			Если ДанныеПрошлогоГода <> Неопределено Тогда
				R004G3 = ДанныеПрошлогоГода.R004G3;
				R005G3 = ДанныеПрошлогоГода.R005G3;
				R011G3 =  R004G3 - R005G3; 
			КонецЕсли;   
		КонецЕсли;
		...
		СтруктураДанныхПриложениеБД.R011G3 = R011G3;  
	...
	Иначе
		...
		Если (Месяц(ДатаПрошлогоКвартала) = 6 и ГодПериода = 2025) Тогда	
			Если ЮрЛицо Тогда  
				ИмяСхемы = "J0100127";  // Декларация о прибыли 
			...
			Иначе
				ИмяСхемы = "F0100727";   
			КонецЕсли;	
		ИначеЕсли (Месяц(ДатаПрошлогоКвартала) = 9 и ГодПериода = 2025) Тогда	   
			Если ЮрЛицо Тогда  
				ИмяСхемы = "J0100128";  // Декларация о прибыли 
				Если ЗначениеЗаполнено(СтруктураДанныхДекларация.H091) Тогда
					// сельхозники
					ИмяСхемы = "J0100528"; 
				КонецЕсли;
		...
		Иначе
			Если ЮрЛицо Тогда  
				ИмяСхемы = "J0100129";  // Декларация о прибыли 
				Если ЗначениеЗаполнено(СтруктураДанныхДекларация.H091) Тогда
					// сельхозники
					ИмяСхемы = "J0100529"; 
				КонецЕсли;
		...
		Если ЮрЛицо Тогда
			...
			Если ПрошлыйГодПериода = 2024 Тогда   
				ИмяСхемы = ?(ЗначениеЗаполнено(СтруктураДанныхДекларация.H091), "J0151426","J0111426"); 
			Иначе
				ИмяСхемы = ?(ЗначениеЗаполнено(СтруктураДанныхДекларация.H091), "J0151429","J0111429"); 
			КонецЕсли; 
			
			// данные за прошлый год  из Декларации для БД
			Если ПрошлыйГодПериода = 2024 Тогда   
				ИмяСхемыДекл = ?(ЗначениеЗаполнено(СтруктураДанныхДекларация.H091), "J0100126","J0100126"); 
			Иначе
				ИмяСхемыДекл = ?(ЗначениеЗаполнено(СтруктураДанныхДекларация.H091), "J0100129","J0100129"); 
			КонецЕсли;
			...
			ПараметрыЗаполненияПоказателиПрошлогоГода.Вставить("ПараметрыЗапроса", Новый Структура("ИмяСхемы, ИмяСхемыДекл, ТипПериода, НомерПериода, ГодПериода", ИмяСхемы, ИмяСхемыДекл, ТипПериода, НомерПериода, ПрошлыйГодПериода));
...
Процедура ДозаполнитьНаКлиенте(ПараметрыЗаполненияЗвит1С)
	...
	Если ТипЗнч(ПараметрыЗаполненияЗвит1С) = Тип("Структура") Тогда
		...
		ПараметрыЗаполненияИзФинОтчетностиПрошлБД = Неопределено;
		Если ПараметрыЗаполненияЗвит1С.Свойство("ПараметрыЗаполненияИзФинОтчетностиПрошлБД", ПараметрыЗаполненияИзФинОтчетностиПрошлБД) Тогда

			// из финотчетности
			Попытка
				
				Данные = глКомпонентаЗвит1С.GetReport(ПараметрыЗаполненияИзФинОтчетностиПрошлБД.ПараметрыЗапроса.ИмяСхемы, 
													  ПараметрыЗаполненияИзФинОтчетностиПрошлБД.ПараметрыЗапроса.ТипПериода, 
													  ПараметрыЗаполненияИзФинОтчетностиПрошлБД.ПараметрыЗапроса.НомерПериода, 
													  ПараметрыЗаполненияИзФинОтчетностиПрошлБД.ПараметрыЗапроса.ГодПериода);
				Если Данные = Неопределено Тогда
					// Выводим только связанные с заполняемым отчетом сообщения
					ТекстСообщения = "Не вдалося отримати дані зі звіту про фінансовий стан, рядки 4.2 та 5.2 Додатка БД заповнені не будуть!";
					глМенеджерЗвит1С.ПредупреждениеЗвит1С(ТекстСообщения, "Завантаження даних з ""FREDO Звіт""");
				Иначе
					Точн = ?(ПараметрыЗаполненияИзФинОтчетностиПрошлБД.ПараметрыЗапроса.ГодПериода <2016 ,1000,1);
					R042G7 = 0;
					
					R042G7 = ПолучитьЗначениеПоказателяЗвит1С(Данные, ПараметрыЗаполненияИзФинОтчетностиПрошлБД.ИмяДляБД)/Точн;
					...
					ЗаполнитьПоказательНаСервере("R042G7", R042G7, ЭтаФорма, "ПриложениеБД");
					ЗаполнитьПоказательНаСервере("R052G7", R042G7, ЭтаФорма, "ПриложениеБД");
			...
			Исключение
				...
				Если глМенеджерЗвит1С.ФлагОтладки Тогда
					Сообщить("FREDO Звіт. Виняток при отриманні даних з ""FREDO Звіт"" ("+ПараметрыЗаполненияИзФинОтчетностиПрошлБД.ПараметрыЗапроса.ИмяСхемы+", "+ПараметрыЗаполненияИзФинОтчетностиПрошлБД.ПараметрыЗапроса.ТипПериода+", "+ПараметрыЗаполненияИзФинОтчетностиПрошлБД.ПараметрыЗапроса.НомерПериода+", " +ПараметрыЗаполненияИзФинОтчетностиПрошлБД.ПараметрыЗапроса.ГодПериода+")", СтатусСообщения.Важное);
					Сообщить(ОписаниеОшибки(), СтатусСообщения.Информация);
				КонецЕсли;
		...
		Если ПараметрыЗаполненияЗвит1С.Свойство("ПараметрыЗаполненияПоказателиПрошлогоГода", ПараметрыЗаполненияПоказателиПрошлогоГода) Тогда
			...
			Попытка
				Данные = глКомпонентаЗвит1С.GetReport(ПараметрыЗаполненияПоказателиПрошлогоГода.ПараметрыЗапроса.ИмяСхемы, 
					...
					Если Данные = Неопределено Тогда
						...
						// Выводим только связанные с заполняемым отчетом сообщения
						Если ВыводитьПредупреждения Тогда
							ТекстСообщения = "Збереженого звіту ""Податкова декларація з податку на прибуток підприємства"" ("+ПараметрыЗаполненияПоказателиПрошлогоГода.ПараметрыЗапроса.ИмяСхемы+") за "+ПараметрыЗаполненияПоказателиПрошлогоГода.ПредставлениеПериодаЗвит1С+" не виявлено!
			...
			Исключение
				ТекстОшибки = "Помилка алгоритму заповнення звіту!
							  |Виняткова ситуація при отриманні даних з ""FREDO Звіт"" ("+ПараметрыЗаполненияПоказателиПрошлогоГода.ПараметрыЗапроса.ИмяСхемы+", "+ПараметрыЗаполненияПоказателиПрошлогоГода.ПараметрыЗапроса.ТипПериода+", "+ПараметрыЗаполненияПоказателиПрошлогоГода.ПараметрыЗапроса.НомерПериода+", " +ПараметрыЗаполненияПоказателиПрошлогоГода.ПараметрыЗапроса.ГодПериода+")
							  |
							  |"+ОписаниеОшибки();
				глМенеджерЗвит1С.ПредупреждениеЗвит1С(ТекстОшибки, "Завантаження даних з ""FREDO Звіт""");
			КонецПопытки;
			...
			R011G3 = 0;
			Попытка
				Данные = глКомпонентаЗвит1С.GetReport(ПараметрыЗаполненияПоказателиПрошлогоГода.ПараметрыЗапроса.ИмяСхемыДекл, 
													  ПараметрыЗаполненияПоказателиПрошлогоГода.ПараметрыЗапроса.ТипПериода, 
													  ПараметрыЗаполненияПоказателиПрошлогоГода.ПараметрыЗапроса.НомерПериода, 
													  ПараметрыЗаполненияПоказателиПрошлогоГода.ПараметрыЗапроса.ГодПериода);
					
					Если Данные = Неопределено Тогда
						ВыводитьПредупреждения = (Лев(глМенеджерЗвит1С.ИмяСхемыЗвит1С, 6) = "J01001"); // Декларация
						
						// Выводим только связанные с заполняемым отчетом сообщения
						Если ВыводитьПредупреждения Тогда
							ТекстСообщения = "Збереженого звіту ""Податкова декларація з податку на прибуток підприємства"" ("+ПараметрыЗаполненияПоказателиПрошлогоГода.ПараметрыЗапроса.ИмяСхемыДекл+") за "+ПараметрыЗаполненияПоказателиПрошлогоГода.ПредставлениеПериодаЗвит1С+" не виявлено!
							|Автоматичне заповнення рядка 1.1 Додатка БД Декларації не можливе!";
							глМенеджерЗвит1С.ПредупреждениеЗвит1С(ТекстСообщения, "Завантаження даних з ""FREDO Звіт""");
						КонецЕсли;
					Иначе
						R004G3 = ПолучитьЗначениеПоказателяЗвит1С(Данные, "A04",Ложь);
						R005G3 = ПолучитьЗначениеПоказателяЗвит1С(Данные, "A05",Ложь);
						R011G3 = R004G3 - R005G3;
				КонецЕсли;

			Исключение
				ТекстОшибки = "Помилка алгоритму заповнення звіту!
							  |Виняткова ситуація при отриманні даних з ""FREDO Звіт"" ("+ПараметрыЗаполненияПоказателиПрошлогоГода.ПараметрыЗапроса.ИмяСхемыДекл+", "+ПараметрыЗаполненияПоказателиПрошлогоГода.ПараметрыЗапроса.ТипПериода+", "+ПараметрыЗаполненияПоказателиПрошлогоГода.ПараметрыЗапроса.НомерПериода+", " +ПараметрыЗаполненияПоказателиПрошлогоГода.ПараметрыЗапроса.ГодПериода+")
							  |
							  |"+ОписаниеОшибки();
				глМенеджерЗвит1С.ПредупреждениеЗвит1С(ТекстОшибки, "Завантаження даних з ""FREDO Звіт""");
			КонецПопытки;
		
			ЗаполнитьПоказательНаСервере("R011G3", R011G3, ЭтаФорма, "ПриложениеБД"); 
	...
	Для Каждого стр Из  тбСхемыXML Цикл
		...
		Если Лев(Стр.Префикс,3) = "OV"  Тогда
			Если НЕ ЗначениеЗаполнено(ПолучитьПоказательНаСервере("HD16", ЭтаФорма, "Декларация")) Тогда
				Сообщение.Текст = НСтр("ru='Приложение ЩАВ не выгружается, т.к. не установлена соответствующая пометка в разделе  ""Наявність додатків"" в Декларации';uk='Додаток ЩАВ не вивантажується, т.щ. не встановлена відповідна позначка в розділі  ""Наявність додатків"" в Декларації'");
				Сообщение.Сообщить();
				стр.фВыгрузка = 0;
			КонецЕсли;
		КонецЕсли;    
		
		Если Лев(Стр.Префикс,3) = "BD"  Тогда
			Если НЕ ЗначениеЗаполнено(ПолучитьПоказательНаСервере("HD17", ЭтаФорма, "Декларация")) Тогда
				Сообщение.Текст = НСтр("ru='Приложение БД не выгружается, т.к. не установлена соответствующая пометка в разделе  ""Наявність додатків"" в Декларации';uk='Додаток БД не вивантажується, т.щ. не встановлена відповідна позначка в розділі  ""Наявність додатків"" в Декларації'");
				Сообщение.Сообщить();
				стр.фВыгрузка = 0;
			КонецЕсли;
		КонецЕсли;    
...
Функция ЗаполнитьТаблицуСоСхемамиВыгрузки()
	...
	Если ЮрЛицо Тогда
		...
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0100529", "J0100129");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0151829", "J0111829");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0150329", "J0110329");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0152829", "J0112829");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0150629", "J0110629");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0151329", "J0111329");  
		...
		НовСтрока = тбСхемыXML.Добавить(); 
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0151429", "J0111429");  
		...
		Для  Инд = 1 ПО ТаблицаСтраницыРаздела1.Количество() Цикл
			...
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0151529", "J0111529");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0151629", "J0111629");  
		...
		Если НЕ ЗначениеЗаполнено(ПолучитьПоказательНаСервере("HZU", ЭтаФорма, "Декларация")) Тогда
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0151729", "J0111729");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0152029", "J0112029");  
		...
		Для  Инд = 1 ПО ТаблицаСтраницыРаздела2.Количество() Цикл
			...
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0154429", "J0114429");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0154829", "J0114829");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0154929", "J0114929");  
		...
		Если не ПроизводительСХ Тогда
			...
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = "J0115929";  
			НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение ЩАВ';uk='Додаток ЩАВ'");
			НовСтрока.НазваниеСтраницыПанели ="ПриложениеЩАВ";
			НовСтрока.Префикс = "OV";   
		КонецЕсли; 
		
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0156029", "J0116029");  
		НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение БД';uk='Додаток БД'");
		НовСтрока.НазваниеСтраницыПанели ="ПриложениеБД";
		НовСтрока.Префикс = "BD";
		
	Иначе
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = "F0100729";
		НовСтрока.ПредставлениеСхемы = НСтр("ru='Декларация о прибыли';uk='Декларація про прибуток'");
		НовСтрока.НазваниеСтраницыПанели ="Декларация";
...
Процедура ЗаполнитьНастраиваемыеПараметрыЗаполнения()
	...
	ДатаНачалаЕН = Неопределено; ДатаОкончанияЕН = Неопределено;
	...
	ИначеЕсли  РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации(Истина) = "ERP25" Тогда
		...
		Запрос = Новый Запрос();
			...
			|	НЕ СтатусыПлательщиковЕдиногоНалога.ПлательщикЕН КАК ПлательщикНалогаНаПрибыль,
	...
	Пока Выборка.Следующий() Цикл
		...
		КонецЕсли;
		Если Инд>0 Тогда
			//дополним предыдущую строку
			ТаблицаПериодов[Инд-1].ДатаОкончания  = КонецДня(Выборка.Период-86400);
			Если Выборка.ПлательщикЕдиногоНалога = ИСТИНА И 
				...
				Если ЗначениеЗаполнено(Выборка.ДатаИзмененияСхемыНалогообложенияВСерединеМесяца) Тогда
					ТаблицаПериодов[Инд-1].ДатаОкончания  = КонецДня(НачалоМесяца(Выборка.ДатаИзмененияСхемыНалогообложенияВСерединеМесяца)-86400);
				КонецЕсли;
			КонецЕсли;
		КонецЕсли;
		Инд = Инд + 1;
	...
	Если мТаблицаПериодовПрибыль = Неопределено Тогда
		мТаблицаПериодовПрибыль = Новый ТаблицаЗначений();
		мТаблицаПериодовПрибыль.Колонки.Добавить("ДатаНачала", Новый ОписаниеТипов("Дата"));
		мТаблицаПериодовПрибыль.Колонки.Добавить("ДатаОкончания", Новый ОписаниеТипов("Дата"));
	КонецЕсли;
	//оставим только записи по прибыли в текущем периоде
	Для Сч = 0 по ТаблицаПериодов.Количество() - 1 Цикл
		ДатаНач = ТаблицаПериодов[Сч].Период;
		ДатаОк = ТаблицаПериодов[Сч].ДатаОкончания;
		ДатаОк = ?(НЕ ЗначениеЗаполнено(ДатаОк), СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета, ДатаОк);
		//не в периоде отчета
		Если ДатаОк < СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета ИЛИ 
			ДатаНач > СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета Тогда
			Продолжить;
		КонецЕсли;	
		Если ТаблицаПериодов[Сч].ПлательщикНалогаНаПрибыль Тогда
			НоваяСтрока = мТаблицаПериодовПрибыль.Добавить();
			НоваяСтрока.ДатаНачала =  Макс(ДатаНач, СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета);
			НоваяСтрока.ДатаОкончания =  Мин(ДатаОк, СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета);
			
		ИначеЕсли ТаблицаПериодов[Сч].ГруппаПлательщикаЕдиногоНалога = Перечисления.ГруппыПлательщиковЕдиногоНалога.ТретьяГруппаОсобая Тогда
			//запомним период ЕН 2%
			ДатаИзмЕН2 = ТаблицаПериодов[Сч].ДатаИзмененияСхемыНалогообложенияВСерединеМесяца;
			Если ЗначениеЗаполнено(ДатаИзмЕН2) Тогда
				ДатаНачалаЕН = Макс(ДатаИзмЕН2,СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета);   
			Иначе
				//с начала месяца     
				ДатаНачалаЕН = Макс(ДатаНач,СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета);   
			КонецЕсли;
			ДатаОкончанияЕН = Мин(ДатаОк,СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета);
		КонецЕсли;	
	КонецЦикла;
...
&НаКлиенте
Процедура РасчитатьКоличествоСтраницПриложений()

	ВсегоСтр = 0;
	
	Для Сч = 1 По 15 Цикл    
		
		ЕстьПриложение =  ЗначениеЗаполнено(ПолучитьПоказательНаСервере("HD"+Сч, ЭтаФорма, "Декларация"));
		
		Если НЕ ЕстьПриложение Тогда
			Продолжить;
		КонецЕсли;
		Если Сч = 3 Тогда
			// это многостраница   ПН
			ВсегоСтр = ВсегоСтр + ЭтаФорма.ТаблицаСтраницыРаздела1.Количество() * 5;
		ИначеЕсли Сч = 4 или Сч = 8 Тогда   //ТЦ и АМ
			ВсегоСтр = ВсегоСтр + 2;
		ИначеЕсли Сч = 5 Тогда  //ВП
			ВсегоСтр = ВсегоСтр + 3;
		ИначеЕсли Сч = 6 Тогда   //РИ
			ВсегоСтр = ВсегоСтр + 13;
		ИначеЕсли Сч = 15 Тогда   //ДИЯ
			ВсегоСтр = ВсегоСтр + 9;    
		ИначеЕсли Сч = 17 Тогда   //БД 
			ВсегоСтр = ВсегоСтр + 5;    			
		ИначеЕсли Сч = 13 Тогда
			// это многостраница    КИК
			ВсегоСтр = ВсегоСтр + ЭтаФорма.ТаблицаСтраницыРаздела2.Количество();
		Иначе	
			ВсегоСтр = ВсегоСтр + 1;
		КонецЕсли;   
		//ЭтаФорма[мСтруктураМногостраничныхРазделов[ПриложениеПН]].Количество()
		
	КонецЦикла;	
	
	ЗаполнитьПоказательНаСервере("HPAGES", ВсегоСтр, ЭтаФорма, "Декларация");
