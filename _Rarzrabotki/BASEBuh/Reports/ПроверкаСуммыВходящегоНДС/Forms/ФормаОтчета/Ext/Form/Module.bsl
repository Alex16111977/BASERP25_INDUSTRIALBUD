...
Процедура ЗаполнитьГруппировкиПоУмолчанию()
	...
	НоваяСтрока.Представление = НСтр("ru='Сложн. нал. учет';uk='Складн. под. облік'");
	НоваяСтрока.Использование = Истина;
	НоваяСтрока.ТипГруппировки = 0;
	
	НоваяСтрока = Отчет.Группировка.Добавить();
	НоваяСтрока.Поле = "Контрагент";       
	НоваяСтрока.Представление = НСтр("ru='Контрагент';uk='Контрагент'");
	НоваяСтрока.Использование = Истина;
	НоваяСтрока.ТипГруппировки = 0;
	
	НоваяСтрока = Отчет.Группировка.Добавить();
	НоваяСтрока.Поле = "Схема";
	НоваяСтрока.Представление = НСтр("ru='Момент возникновения обязательств';uk='Момент виникнення зобов''язань'");
	НоваяСтрока.Использование = Истина;
	НоваяСтрока.ТипГруппировки = 0;

	НоваяСтрока = Отчет.Группировка.Добавить();
	НоваяСтрока.Поле = "ДоговорКонтрагента";
	НоваяСтрока.Представление = НСтр("ru='Договор контрагента';uk='Договір контрагента'");
	НоваяСтрока.Использование = Истина;
	НоваяСтрока.ТипГруппировки = 0;

	НоваяСтрока = Отчет.Группировка.Добавить();
	НоваяСтрока.Поле = "Сделка";           
	НоваяСтрока.Представление = НСтр("ru='Документ расчетов';uk='Документ розрахунків'");
	НоваяСтрока.Использование = Истина;
	НоваяСтрока.ТипГруппировки = 0;

	НоваяСтрока = Отчет.Группировка.Добавить();
	НоваяСтрока.Поле = "ЗаТару";
	НоваяСтрока.Представление = НСтр("ru='За тару';uk='За тару'");
	НоваяСтрока.Использование = Истина;
	НоваяСтрока.ТипГруппировки = 0;

	НоваяСтрока = Отчет.Группировка.Добавить();
	НоваяСтрока.Поле = "СтавкаНДС";
	НоваяСтрока.Представление = НСтр("ru='Ставка НДС';uk='Ставка ПДВ'");
	НоваяСтрока.Использование = Истина;
	НоваяСтрока.ТипГруппировки = 0;

	НоваяСтрока = Отчет.Группировка.Добавить();
	НоваяСтрока.Поле = "ДляХозяйственнойДеятельности";
	НоваяСтрока.Представление = НСтр("ru='Для хозяйственной деятельности';uk='Для господарської діяльності'");
	НоваяСтрока.Использование = Истина;
	НоваяСтрока.ТипГруппировки = 0;
	
	НоваяСтрока = Отчет.Группировка.Добавить();
	НоваяСтрока.Поле = "ВидДеятельностиНДС";
	НоваяСтрока.Представление = НСтр("ru='Вид деят. НДС';uk='Вид діял. ПДВ'");
	НоваяСтрока.Использование = Истина;
	НоваяСтрока.ТипГруппировки = 0;

	НоваяСтрока = Отчет.Группировка.Добавить();
	НоваяСтрока.Поле = "Амортизируется";  
	НоваяСтрока.Представление = НСтр("ru='Амортизируется';uk='Амортизується'");
	НоваяСтрока.Использование = Истина;
	НоваяСтрока.ТипГруппировки = 0;
	
	НоваяСтрока = Отчет.Группировка.Добавить();
	НоваяСтрока.Поле = "ПериодДень";
	НоваяСтрока.Представление = НСтр("ru='Дата возникновения обязательств';uk='Дата виникнення зобов''язань'");
	НоваяСтрока.Использование = Истина;
	НоваяСтрока.ТипГруппировки = 0;
	
	НоваяСтрока = Отчет.Группировка.Добавить();
	НоваяСтрока.Поле = "НалоговыйДокумент";
	НоваяСтрока.Представление = НСтр("ru='Документ';uk='Документ'");
	НоваяСтрока.Использование = Истина;
	НоваяСтрока.ТипГруппировки = 0;
