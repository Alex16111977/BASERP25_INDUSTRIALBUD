	...
	Для каждого Показатель Из ПоказателиИсточник Цикл
		...
		Иначе
			Если ПоказательИмя = "Поступление" Тогда
				НоваяСтрока.Представление = НСтр("ru='Поступление';uk='Надходження'");
			ИначеЕсли ПоказательИмя = "Списание" Тогда
				НоваяСтрока.Представление = НСтр("ru='Списание';uk='Списання'");
			ИначеЕсли ПоказательИмя = "Приход" Тогда
				НоваяСтрока.Представление = НСтр("ru='Приход';uk='Надходження'");
			ИначеЕсли ПоказательИмя = "Расход" Тогда
				НоваяСтрока.Представление = НСтр("ru='Расход';uk='Видаток'");
			Иначе				
				НоваяСтрока.Представление = ДоступноеПоле.Заголовок;
			КонецЕсли;	
		КонецЕсли;
