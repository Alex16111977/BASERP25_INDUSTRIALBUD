...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	ТекЗначениеФлага = ЗначениеЗаполнено(ПолучитьПоказательНаСервере("R011G4", Форма, "Приложение1"))
				   ...
				   ИЛИ ЗначениеЗаполнено(R012G4)
				   ИЛИ ЗначениеЗаполнено(R025G4);
		...
		Пока ВыборкаП7НН.Следующий() Цикл
			...
			Пока ВыборкаП7П2.Следующий() Цикл
				...
				Пока ВыборкаП7Детали.Следующий() Цикл
					...
					ТекНомерНН = "" + РегламентированнаяОтчетностьКлиентСервер.ПолучитьНомерНаПечать(ВыборкаП7Детали.НННомер, Истина, Истина)
					...
					ТекНомерП2 = "" + РегламентированнаяОтчетностьКлиентСервер.ПолучитьНомерНаПечать(ВыборкаП7Детали.П2Номер, Истина, Истина)
					...
					Если ВыборкаП7Детали.СтавкаНДС = НДС20 Тогда
