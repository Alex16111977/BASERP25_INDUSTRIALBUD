...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мСоставПоказателей = "СоставПоказателей2026Мес2УФ";
	...
	СтруктураРеквизитовФормы.мИдГруппы5 = "D5";
	СтруктураРеквизитовФормы.мИдГруппы7 = "D7";
	...
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "01/02/2026";
...
Функция СформироватьСтруктуруДанныхДопСтрокСтраницы(Форма, ИмяСтраницы) Экспорт
	...
	Если ИмяСтраницы = "ДекларацияАкциз" Тогда
		...
		РегламентированнаяОтчетностьКлиентСервер.ОбновитьСтруктуруМногострочногоРаздела(Форма, Форма.СтруктураРеквизитовФормы.мИдГруппы5);
		РегламентированнаяОтчетностьКлиентСервер.ОбновитьСтруктуруМногострочногоРаздела(Форма, Форма.СтруктураРеквизитовФормы.мИдГруппы7);
		...
		ПромТаблицаДопСтрокРаздела = Неопределено;
		Форма.мСтруктураМногострочныхРазделов.Свойство(Форма.СтруктураРеквизитовФормы.мИдГруппы5, ПромТаблицаДопСтрокРаздела);
		ПромТаблицаДопСтрокРаздела = Форма[ПромТаблицаДопСтрокРаздела];
		ТаблицаДопСтрокГруппы = Форма["Хранилище" + Форма.СтруктураРеквизитовФормы.мИдГруппы5].Добавить().Таблица;
		КопироватьДанныеФормы(ПромТаблицаДопСтрокРаздела, ТаблицаДопСтрокГруппы);
		СтруктураДанныхДопСтрокРаздела.Вставить(Форма.СтруктураРеквизитовФормы.мИдГруппы5, ТаблицаДопСтрокГруппы);

		ПромТаблицаДопСтрокРаздела = Неопределено;
		Форма.мСтруктураМногострочныхРазделов.Свойство(Форма.СтруктураРеквизитовФормы.мИдГруппы7, ПромТаблицаДопСтрокРаздела);
		ПромТаблицаДопСтрокРаздела = Форма[ПромТаблицаДопСтрокРаздела];
		ТаблицаДопСтрокГруппы = Форма["Хранилище" + Форма.СтруктураРеквизитовФормы.мИдГруппы7].Добавить().Таблица;
		КопироватьДанныеФормы(ПромТаблицаДопСтрокРаздела, ТаблицаДопСтрокГруппы);
		СтруктураДанныхДопСтрокРаздела.Вставить(Форма.СтруктураРеквизитовФормы.мИдГруппы7, ТаблицаДопСтрокГруппы);
...
Процедура ЗаполнитьДатуПодписи(Форма)
	...
	Для ТекНомПрил = 1 По Форма.D5.Количество() Цикл
		ЗаполнитьПоказательНаСервере("D5DATE1_" + ТекНомПрил, Форма.ДатаПодписи, Форма, "ДекларацияАкциз");
		ЗаполнитьПоказательНаСервере("D5DATE2_" + ТекНомПрил, Форма.ДатаПодписи, Форма, "ДекларацияАкциз");
	КонецЦикла;
	
	Для ТекНомПрил = 1 По Форма.D7.Количество() Цикл
		ЗаполнитьПоказательНаСервере("D7DATE1_" + ТекНомПрил, Форма.ДатаПодписи, Форма, "ДекларацияАкциз");
		ЗаполнитьПоказательНаСервере("D7DATE2_" + ТекНомПрил, Форма.ДатаПодписи, Форма, "ДекларацияАкциз");
		...
		ЗаполнитьПоказательНаСервере("D7ДД_" + ТекНомПрил, ТекЧисло, Форма, "ДекларацияАкциз");
		ЗаполнитьПоказательНаСервере("D7ДМ_" + ТекНомПрил, ТекМесяц, Форма, "ДекларацияАкциз");
		ЗаполнитьПоказательНаСервере("D7ДГ_" + ТекНомПрил, ТекГод,   Форма, "ДекларацияАкциз");
	КонецЦикла;
...
Функция ПоказательВходитВМногострочнуюЧасть(Форма, ИмяПоказателя) Экспорт
	...
	ИначеЕсли    Лев(ИмяПоказателя,2) = "D5"
		ИЛИ Лев(ИмяПоказателя,2) = "D7" Тогда
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма)
	...
	ЗаполнитьПоказательНаСервере("D1HBOS", ИмяФАМИЛИЯРук, Форма, "ДекларацияАкциз");
	...
	ЗаполнитьПоказательНаСервере("D1HBUH", ИмяФАМИЛИЯБух,  Форма, "ДекларацияАкциз");
	...
	//для приложения 5	
	ЗаполнитьПоказательНаСервере("HBOS5",  ИмяФАМИЛИЯРук, Форма, "ДекларацияАкциз");
	ЗаполнитьПоказательНаСервере("HBUH5",  ИмяФАМИЛИЯБух,  Форма, "ДекларацияАкциз");
	...
	ЗаполнитьСведенияОбОрганизацииПриложения5_7(Форма, 1, 1);
	...
	ЗаполнитьПоказательНаСервере("D9HBOS",  ИмяФАМИЛИЯРук, Форма, "ДекларацияАкциз");
	ЗаполнитьПоказательНаСервере("D9HBUH",  ИмяФАМИЛИЯБух,  Форма, "ДекларацияАкциз");
...
&НаКлиентеНаСервереБезКонтекста
Процедура ЗаполнитьСведенияОбОрганизацииПриложения5_7(Форма, НомПрил5 = Неопределено, НомПрил7 = Неопределено)
	...
	ИмяДиректора = ПолучитьПоказательНаСервере("HBOS5",  Форма, "ДекларацияАкциз");
	ИмяГлавБуха  = ПолучитьПоказательНаСервере("HBUH5",  Форма, "ДекларацияАкциз");
	...
	// приложение 5
	Если НомПрил5 = Неопределено Тогда
		НачНом = 1;
		СтруктураГруппы = Форма["D5"];
		КонКом = СтруктураГруппы.Количество();
	ИначеЕсли НомПрил5 = 0 Тогда	
		НачНом = 1;
		КонКом = 0;
	Иначе
		НачНом = НомПрил5;
	...
	Для НомПрил = НачНом По КонКом Цикл
		...
		ЗаполнитьПоказательНаСервере("D5H01G1S_" + ТекНомПрил,  "Д",  Форма, "ДекларацияАкциз");
		ЗаполнитьПоказательНаСервере("D5H02G2S_" + ТекНомПрил,  "Д1."+НомПрил,  Форма, "ДекларацияАкциз");
		
		ЗаполнитьПоказательНаСервере("D5HZM1_" + ТекНомПрил,  Сред(МесяцОтчета, 1, 1),  Форма, "ДекларацияАкциз");
		ЗаполнитьПоказательНаСервере("D5HZM2_" + ТекНомПрил,  Сред(МесяцОтчета, 2, 1),  Форма, "ДекларацияАкциз");
		
		ЗаполнитьПоказательНаСервере("D5HZY1_" + ТекНомПрил,  Сред(ГодОтчета, 1, 1),  Форма, "ДекларацияАкциз");
		ЗаполнитьПоказательНаСервере("D5HZY2_" + ТекНомПрил,  Сред(ГодОтчета, 2, 1),  Форма, "ДекларацияАкциз");
		ЗаполнитьПоказательНаСервере("D5HZY3_" + ТекНомПрил,  Сред(ГодОтчета, 3, 1),  Форма, "ДекларацияАкциз");
		ЗаполнитьПоказательНаСервере("D5HZY4_" + ТекНомПрил,  Сред(ГодОтчета, 4, 1),  Форма, "ДекларацияАкциз");
		
		ЗаполнитьПоказательНаСервере("D5HBOS_" + ТекНомПрил,  ИмяДиректора, Форма, "ДекларацияАкциз");
		ЗаполнитьПоказательНаСервере("D5HBUH_" + ТекНомПрил,  ИмяГлавБуха,  Форма, "ДекларацияАкциз");
		
		ЗаполнитьПоказательНаСервере("D5DATE1_" + ТекНомПрил,  Форма.ДатаПодписи, Форма, "ДекларацияАкциз");
		ЗаполнитьПоказательНаСервере("D5DATE2_" + ТекНомПрил,  Форма.ДатаПодписи,  Форма, "ДекларацияАкциз");
		
		Для Сч = 1 По 10 Цикл
			ЗаполнитьПоказательНаСервере("D5HKBOS" + Сч + "_" + ТекНомПрил,  Сред(ИННДиректора, Сч, 1),  Форма, "ДекларацияАкциз");
			ЗаполнитьПоказательНаСервере("D5HKBUH" + Сч + "_" + ТекНомПрил,  Сред(ИННГлавБуха,  Сч, 1),  Форма, "ДекларацияАкциз");
		КонецЦикла; 
	...
	// приложение 7
	Если НомПрил7 = Неопределено Тогда
		НачНом = 1;
		СтруктураГруппы = Форма["D7"];
		КонКом = СтруктураГруппы.Количество();
	ИначеЕсли НомПрил7 = 0 Тогда	
		НачНом = 1;
		КонКом = 0;
	Иначе
		НачНом = НомПрил7;
	...
	Для НомПрил = НачНом По КонКом Цикл
		...
		ЗаполнитьПоказательНаСервере("D7H01G1S_" + ТекНомПрил,  "Д",  Форма, "ДекларацияАкциз");

		ЗаполнитьПоказательНаСервере("D7H02G2S_" + ТекНомПрил,  "Д1."+НомПрил,  Форма, "ДекларацияАкциз");
		
		ЗаполнитьПоказательНаСервере("D7HZM1_" + ТекНомПрил,  Сред(МесяцОтчета, 1, 1),  Форма, "ДекларацияАкциз");
		ЗаполнитьПоказательНаСервере("D7HZM2_" + ТекНомПрил,  Сред(МесяцОтчета, 2, 1),  Форма, "ДекларацияАкциз");
		
		ЗаполнитьПоказательНаСервере("D7HZY1_" + ТекНомПрил,  Сред(ГодОтчета, 1, 1),  Форма, "ДекларацияАкциз");
		ЗаполнитьПоказательНаСервере("D7HZY2_" + ТекНомПрил,  Сред(ГодОтчета, 2, 1),  Форма, "ДекларацияАкциз");
		ЗаполнитьПоказательНаСервере("D7HZY3_" + ТекНомПрил,  Сред(ГодОтчета, 3, 1),  Форма, "ДекларацияАкциз");
		ЗаполнитьПоказательНаСервере("D7HZY4_" + ТекНомПрил,  Сред(ГодОтчета, 4, 1),  Форма, "ДекларацияАкциз");
		
		ЗаполнитьПоказательНаСервере("D7HNAME_" + ТекНомПрил,  НаимОрганизации, Форма, "ДекларацияАкциз");
		
		ЗаполнитьПоказательНаСервере("D7HTIN_" + ТекНомПрил,  КодОрганизации, Форма, "ДекларацияАкциз");
		
		ЗаполнитьПоказательНаСервере("D7HBOS_" + ТекНомПрил,  ИмяДиректора, Форма, "ДекларацияАкциз");
		ЗаполнитьПоказательНаСервере("D7HBUH_" + ТекНомПрил,  ИмяГлавБуха,  Форма, "ДекларацияАкциз");
		
		ЗаполнитьПоказательНаСервере("D7DATE1_" + ТекНомПрил,  Форма.ДатаПодписи,  Форма, "ДекларацияАкциз");
		ЗаполнитьПоказательНаСервере("D7DATE2_" + ТекНомПрил,  Форма.ДатаПодписи,  Форма, "ДекларацияАкциз");
		
		Для Сч = 1 По 10 Цикл
			ЗаполнитьПоказательНаСервере("D7HKBOS" + Сч + "_" + ТекНомПрил,  Сред(ИННДиректора, Сч, 1),  Форма, "ДекларацияАкциз");
			ЗаполнитьПоказательНаСервере("D7HKBUH" + Сч + "_" + ТекНомПрил,  Сред(ИННГлавБуха, Сч, 1),  Форма, "ДекларацияАкциз");
		КонецЦикла; 
...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяСтраницыПанели Тогда
		...
		ИдГрупп.Добавить(Форма.СтруктураРеквизитовФормы.мИдГруппы5);
		ИдГрупп.Добавить(Форма.СтруктураРеквизитовФормы.мИдГруппы7);
	...
	//////////////////////////
	НомСтрЧисло = 0;
	Для каждого Приложение6 Из Форма.D5 Цикл
		...
		Для НомКол = 1 По 5 Цикл
			...
			Приложение6["D5R01" + НомКол + "G5"] = Приложение6["D5R01" + НомКол + "G3"] * Приложение6["D5R01" + НомКол + "G4"] / 100;
			
			Итог = Итог + Приложение6["D5R01" + НомКол + "G5"];
			
            ЗаполнитьПоказательНаСервере("D5R01" + НомКол + "G5_" + НомСтр, Приложение6["D5R01" + НомКол + "G5"], Форма, "ДекларацияАкциз");
			
		КонецЦикла;
		
		Приложение6["D5R01G5"] = Итог;
		ЗаполнитьПоказательНаСервере("D5R01G5_" + НомСтр, Итог, Форма, "ДекларацияАкциз");
		
	КонецЦикла; 

	ЗаполнитьПоказательНаСервере("R010G1", ?(Форма.D5.Итог("D5R01G5")>0, "Х", ""), Форма, "ДекларацияАкциз");
	ЗаполнитьПоказательНаСервере("R010G2", ?(Форма.D5.Итог("D5R01G5")>0, Форма.D5.Количество(), ""), Форма, "ДекларацияАкциз");
	ЗаполнитьПоказательНаСервере("R010G3", ?(Форма.D5.Итог("D5R01G5")>0, Форма.D5.Количество(), ""), Форма, "ДекларацияАкциз");
	
	//////////////////////////
	// расчет тела декларации
	//////////////////////////
	
	ЗаполнитьПоказательНаСервере("R500100G4",  Форма.D5.Итог("D5R01G5"), Форма, "ДекларацияАкциз");
	...
	Для каждого Приложение6 Из Форма.D5 Цикл
		...
		Форма.DT1R[НомСтрЧисло - 1].DT1RXXXXG2S = Приложение6.D5HKATOTTG;
		Форма.DT1R[НомСтрЧисло - 1].DT1RXXXXG4  = Приложение6.D5R01G5;
		
		ЗаполнитьПоказательНаСервере("DT1RXXXXG2S_"+ НомСтр , Приложение6.D5HKATOTTG, Форма, "ДекларацияАкциз");
		ЗаполнитьПоказательНаСервере("DT1RXXXXG4_" + НомСтр , Приложение6.D5R01G5, Форма, "ДекларацияАкциз");
	...
	НомСтрЧисло = 0;
	HZMP7 = Ложь;
	Для каждого Приложение7 Из Форма.D7 Цикл
		...
		Для НомКол = 4 По 11 Цикл
			...
			Разница = Приложение7["D7R02G" + НомКол] - Приложение7["D7R01G" + НомКол];
			
			Приложение7["D7R03G" + НомКол] = ?(Разница>0,  Разница, 0);
			Приложение7["D7R04G" + НомКол] = ?(Разница<0, -Разница, 0);
			Приложение7["D7R05G" + НомКол] = ?(   ЭтоУточненка И Разница > 0, Разница * 0.03, 0);
			Приложение7["D7R06G" + НомКол] = ?(НЕ ЭтоУточненка И Разница > 0, Разница * 0.05, 0);
			
			ЗаполнитьПоказательНаСервере("D7R03G" + НомКол+ "_" + НомСтр, Приложение7["D7R03G" + НомКол], Форма, "ДекларацияАкциз");		
			ЗаполнитьПоказательНаСервере("D7R04G" + НомКол+ "_" + НомСтр, Приложение7["D7R04G" + НомКол], Форма, "ДекларацияАкциз");
			ЗаполнитьПоказательНаСервере("D7R05G" + НомКол+ "_" + НомСтр, Приложение7["D7R05G" + НомКол], Форма, "ДекларацияАкциз");
			ЗаполнитьПоказательНаСервере("D7R06G" + НомКол+ "_" + НомСтр, Приложение7["D7R06G" + НомКол], Форма, "ДекларацияАкциз");

		КонецЦикла;
		Если ЗначениеЗаполнено(ПолучитьПоказательНаСервере("D7HZMP_"+ НомСтр, Форма, "ДекларацияАкциз")) Тогда
			HZMP7=Истина;	
		КонецЕсли;
		
	КонецЦикла;
	Если ЭтоУточненка ИЛИ  HZMP7 Тогда 
		ЗаполнитьПоказательНаСервере("R013G1", "Х", Форма, "ДекларацияАкциз");
		ЗаполнитьПоказательНаСервере("R013G2", Форма.D7.Количество(), Форма, "ДекларацияАкциз");
		ЗаполнитьПоказательНаСервере("R013G3", Форма.D7.Количество(), Форма, "ДекларацияАкциз");
	Иначе
...
Процедура ВставитьДополнительнуюСтроку(Форма, ИмяГруппыБлока = Неопределено, СпециальноеДобавление = Ложь, ИмяКолонкиНомера = Неопределено, НомерПервойСтроки = 1) Экспорт
	...
	НомПрил5 = 0;
	НомПрил7 = 0;
	Если ИмяГруппы = "D5" Тогда
		НомПрил5 = СтруктураГруппы.Количество();		
	ИначеЕсли ИмяГруппы = "D7" Тогда
		НомПрил7 = СтруктураГруппы.Количество();	
	КонецЕсли;
	
	ЗаполнитьСведенияОбОрганизацииПриложения5_7(Форма, НомПрил5, НомПрил7);		
...
Процедура ОбработкаВыбораВПолеТабличногоДокумента(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Лев(ИмяЯчейки, 6) = "D7HZMP" Тогда
	...
	ИначеЕсли Лев(ИмяЯчейки, 6) = "D7HZYP" Тогда
	...
	ИначеЕсли Найти(ИмяЯчейки, "HBOS5") > 0 Тогда
			
		Значение = ТабличныйДокумент.Области.HBOS5.Значение;
		ОписаниеОповещения = Новый ОписаниеОповещения("ВводПоказателяВПолеТабличногоДокументЗавершение",
													   ЭтаФорма, Новый Структура("ИмяЯчейки, ИмяСтраницы,
																				 |ИмяЯчейкиКвадратов, ИмяСтраницыКвадратов, 
																				 |Размерность, ДополнитьЗначение, НольКакНоль", 
																				 "HBOS5",  "ДекларацияАкциз",
																				 "", "",
																				 0, Ложь, Неопределено));
	...
	ИначеЕсли Найти(ИмяЯчейки, "HBUH5") > 0 Тогда
			
		Значение = ТабличныйДокумент.Области.HBUH5.Значение;
		ОписаниеОповещения = Новый ОписаниеОповещения("ВводПоказателяВПолеТабличногоДокументЗавершение",
													   ЭтаФорма, Новый Структура("ИмяЯчейки, ИмяСтраницы,
																				 |ИмяЯчейкиКвадратов, ИмяСтраницыКвадратов, 
																				 |Размерность, ДополнитьЗначение, НольКакНоль", 
																				 "HBUH5",  "ДекларацияАкциз",
																				 "", "",
																				 0, Ложь, Неопределено));
...
Процедура ВводПоказателяВПолеТабличногоДокументЗавершение(Значение, ДополнительныеПараметры) Экспорт
	...
	// нормализуем КВЕД
	Если Лев(ИмяЯчейки, 4) = "D7HZ" Тогда
	...
	Если    Найти(ИмяЯчейки, "HKBOS") > 0 
		...
		Для Сч = 1 По D5.Количество() Цикл
			НомСтр = Формат(Сч, "ЧГ=0");
			Для НомЯчейки = 1 По 10 Цикл
				ТабличныйДокумент.Области["D5" + ИмяЯчейки + НомЯчейки + "_" + НомСтр].Значение = Сред(Значение, НомЯчейки, 1);
			КонецЦикла;
		КонецЦикла;
		Для Сч = 1 По D7.Количество() Цикл
			НомСтр = Формат(Сч, "ЧГ=0");
			Для НомЯчейки = 1 По  10 Цикл
				ТабличныйДокумент.Области["D7" + ИмяЯчейки + НомЯчейки + "_" + НомСтр].Значение = Сред(Значение, НомЯчейки, 1);
			КонецЦикла;
		КонецЦикла;
	...
	// заполнение ФИОв руководителей по всем приложениям
	Если    Найти(ИмяЯчейки, "HBOS5") > 0 
		ИЛИ Найти(ИмяЯчейки, "HBUH5") > 0 Тогда
		
		ЗаполнитьПоказательНаСервере("D1" + Лев(ИмяЯчейки,4), Значение, ЭтаФорма, ДополнительныеПараметры.ИмяСтраницы);
		ЗаполнитьПоказательНаСервере("D9" + Лев(ИмяЯчейки,4), Значение, ЭтаФорма, ДополнительныеПараметры.ИмяСтраницы);
		
		Для Сч = 1 По D5.Количество() Цикл
			НомСтр = Формат(Сч, "ЧГ=0");
			ЗаполнитьПоказательНаСервере("D5" + Лев(ИмяЯчейки,4)+ "_" + НомСтр, Значение, ЭтаФорма, ДополнительныеПараметры.ИмяСтраницы);
		КонецЦикла;
		Для Сч = 1 По D7.Количество() Цикл
			НомСтр = Формат(Сч, "ЧГ=0");
			ЗаполнитьПоказательНаСервере("D7" + Лев(ИмяЯчейки,4)+ "_" + НомСтр, Значение, ЭтаФорма, ДополнительныеПараметры.ИмяСтраницы);
		КонецЦикла;
...
Процедура АктивизироватьЯчейку(Ячейка) Экспорт
	...
	Если ЛЕВ(Ячейка.Раздел, 11) = "Приложение6" Тогда
		...
		Ячейка.ИмяЯчейки = "D5" + Ячейка.ИмяЯчейки + "_" + Сред(Ячейка.Раздел, 12);
		Ячейка.Раздел = "ДекларацияАкциз";
	
	ИначеЕсли ЛЕВ(Ячейка.Раздел, 11) = "Приложение7" Тогда
		
		Ячейка.ИмяЯчейки = "D7" + Ячейка.ИмяЯчейки + "_" + Сред(Ячейка.Раздел, 12);
		Ячейка.Раздел = "ДекларацияАкциз";
...
Процедура ЗаполнитьАвтоНаСервере(ПараметрыЗаполненияЗвит1С) Экспорт
	...
	ЗаполнитьСведенияОбОрганизацииПриложения5_7(ЭтаФорма);
...
Процедура ВнестиДанныеВДекларацию(ДеревоОтчетов)
	...
	Для каждого ДанныеВРазрезеНИ Из ДеревоОтчетов.Строки Цикл
		...
		// заполняем приложения 5 в разрезе КАТОТТГ
		НомерПриложения5 = 0;
		Для каждого ДанныеВРазрезеКОАТУУ Из ДанныеВРазрезеНИ.Строки Цикл
			
			НомерПриложения5 = НомерПриложения5 + 1;
			
			// добавляем Приложение 5 по данному КАТОТТГ
			Если НомерПриложения5 > 1 Тогда
				
				СтрокаПрил5 = СтрТаблицыСтраниц.ДанныеДопСтрок[0].Значение.D5.Добавить();
				СтрТаблицыСтраниц.ДанныеДопСтрок[0].Значение.DT1R.Добавить();
				
			Иначе
				
				СтрокаПрил5 = СтрТаблицыСтраниц.ДанныеДопСтрок[0].Значение.D5[0];
				ЭтоПервоеПриложение5 = Ложь;
			...
			СтрокаПрил5.D5HKATOTTG = ДанныеВРазрезеКОАТУУ.КАТОТТГ;
			...
			Для каждого СтрокаПродаж Из ДанныеПоПродажам Цикл
				...
				ВнестиДанныеВПриложение5(СтрокаПрил5, СтрокаПродаж.СтатьяДекларации, СтрокаПродаж.База);
...
&НаСервере
Процедура ВнестиДанныеВПриложение5(СтрокаПрил5, Статья, Сумма)
	...
	// ставка строго 5%
	СтрокаПрил5[ИмяСтроки + "4"] = 5.00;	
		
	СтрокаПрил5[ИмяСтроки + "3"]= СтрокаПрил5[ИмяСтроки + "3"] + Сумма;	
...
Функция ПолучитьДанныеФормыНаСервере();
	...
	Для каждого Страница Из ТаблицаСтраницыРаздела1 Цикл
		...
		// приложение 5
		Таблица = Страница.ДанныеДопСтрок[0].Значение.D5.Выгрузить();
		КолонкиТаблицы = Таблица.Колонки;
		...
		Для каждого Строка Из Таблица Цикл
			...
			ПоказателиОтчета.Вставить("Приложение5" + Индекс + "_" + НомСтрСтрока, СтруктураДанных);		
			
		КонецЦикла;
	
		// приложение 7
		Таблица = Страница.ДанныеДопСтрок[0].Значение.D7.Выгрузить();
		КолонкиТаблицы = Таблица.Колонки;
		СтруктураДанных = Новый Структура;
		...
		Для каждого Строка Из Таблица Цикл
			...
			ПоказателиОтчета.Вставить("Приложение7" + Индекс + "_" + НомСтрСтрока, СтруктураДанных);		
		...
		КонецЦикла;
		ПоказателиОтчета.Вставить("D9" + НомСтрСтрока + "T1R", СтруктураДанных);		
...
Процедура  ОпределитьСписокВыгружаемыхСхем(тбСхемыXML);
	...
	Для Каждого стр Из  тбСхемыXML Цикл
		...
		Если Лев(Стр.Префикс,3) = "D9"  Тогда
			стр.фВыгрузка = 0;
		ИначеЕсли Лев(Стр.НазваниеСтраницыПанели, 11) = "Приложение7" и НЕ ЗначениеЗаполнено(ПолучитьПоказательНаСервере("HZU", ЭтаФорма, "ДекларацияАкциз")) Тогда
			стр.фВыгрузка = 0;
		КонецЕсли;
...
Функция ЗаполнитьТаблицуСоСхемамиВыгрузки()
	...
	Для каждого Страница Из ТаблицаСтраницыРаздела1 Цикл
		...
		НовСтрока.ИмяСхемы = ?(ЮрЛицо, "J0209514", "F0209514");  
		...
		Для  Инд = 1 ПО Страница.ДанныеДопСтрок[0].Значение.D5.Количество() Цикл
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = ?(ЮрЛицо, "J0295614", "F0295614");  
			НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение 5';uk='Додаток 5'")+ НСтр("ru=' доп. стр. ';uk= ' дод. стор. '")  + Формат(Инд, "ЧГ=0");
			НовСтрока.НазваниеСтраницыПанели ="Приложение5" + Инд + "_"  + НомСтрСтрока; 
			НовСтрока.Префикс = "D5_" + НомСтрСтрока;
		КонецЦикла;
		
		Для  Инд = 1 ПО Страница.ДанныеДопСтрок[0].Значение.D7.Количество() Цикл
		
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = ?(ЮрЛицо, "J0295814", "F0295814");  
			НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение 7';uk='Додаток 7'")+ НСтр("ru=' доп. стр. ';uk= ' дод. стор. '")  + Формат(Инд, "ЧГ=0");
			НовСтрока.НазваниеСтраницыПанели ="Приложение7" + Инд + "_"  + НомСтрСтрока; 
			НовСтрока.Префикс = "D7_" + НомСтрСтрока;
		КонецЦикла;
		
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ЮрЛицо, "J0295914", "F0295914");  
