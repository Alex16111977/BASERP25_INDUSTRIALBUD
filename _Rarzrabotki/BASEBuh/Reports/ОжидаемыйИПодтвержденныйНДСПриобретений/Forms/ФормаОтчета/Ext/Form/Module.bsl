...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = НСтр("ru='Ожидаемый и подтвержденный НДС приобретений ';uk='Очікуваний і підтверджений ПДВ придбань '") + БухгалтерскиеОтчетыКлиентСервер.ПолучитьПредставлениеПериода(?(Отчет.СНачалаГода,НачалоГода(Отчет.НачалоПериода),Отчет.НачалоПериода), Отчет.КонецПериода);
...
Процедура ЗаполнитьГруппировкиПоУмолчанию()
	...
	НоваяСтрока.Представление = НСтр("ru='Сделка';uk='Угода'");
	НоваяСтрока.Использование = Истина;
	НоваяСтрока.ТипГруппировки = 0;

	НоваяСтрока = Отчет.Группировка.Добавить();
	НоваяСтрока.Поле = "ВозвратнаяТара";   
	НоваяСтрока.Представление = НСтр("ru='Возвратная тара';uk='Зворотна тара'");
	НоваяСтрока.Использование = Истина;
	НоваяСтрока.ТипГруппировки = 0;
	...
	НоваяСтрока.Представление = НСтр("ru='Для операций облагаемых НДС';uk='Для операцій оподатковуваних ПДВ'");
	НоваяСтрока.Использование = Истина;
	НоваяСтрока.ТипГруппировки = 0;
