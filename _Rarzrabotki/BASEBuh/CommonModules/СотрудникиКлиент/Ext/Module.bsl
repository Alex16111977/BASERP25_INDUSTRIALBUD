...
|Если у сотрудника изменился документ, удостоверяющий личность с %1, нажмите';uk='При редагуванні змінені відомості про документ, що посвідчує особу.
|Якщо виправлений колишній запис про документ (він був помилковим), натисніть ""Виправлена помилка"".
|Якщо у співробітника змінився документ, що посвідчує особу з %1, натисніть'") + " ""%2""",
				Формат(ДатаИзменения, "ДФ='д ММММ гггг ""г""'"),
				ТекстКнопкиДа);
