...
Функция ПолучитьСведенияОКомиссии(ДокументОбъект) Экспорт
	...
	Если ЗначениеЗаполнено(ДокументОбъект.ПредседательКомиссии) Тогда
		...
		СоставКомиссии.Вставить("ПредседательКомиссииИОФамилия", ФизическиеЛицаКлиентСервер.ИнициалыФамилия(ДанныеПредседательКомиссии));   
	...
	Если ЗначениеЗаполнено(ДокументОбъект.ПервыйЧленКомиссии) Тогда
		...
		СоставКомиссии.Вставить("ПервыйЧленКомиссииИОФамилия", ФизическиеЛицаКлиентСервер.ИнициалыФамилия(ДанныеПервыйЧленКомиссии));   
	...
	Если ЗначениеЗаполнено(ДокументОбъект.ВторойЧленКомиссии) Тогда
		...
		СоставКомиссии.Вставить("ВторойЧленКомиссииИОФамилия", ФизическиеЛицаКлиентСервер.ИнициалыФамилия(ДанныеВторойЧленКомиссии));   
	...
	Если ЗначениеЗаполнено(ДокументОбъект.ТретийЧленКомиссии) Тогда
		...
		СоставКомиссии.Вставить("ТретийЧленКомиссииИОФамилия", ФизическиеЛицаКлиентСервер.ИнициалыФамилия(ДанныеТретийЧленКомиссии));   
