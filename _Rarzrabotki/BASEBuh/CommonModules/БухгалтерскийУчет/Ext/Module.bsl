		...
		Для Каждого РеквизитДляПроверки Из ТаблицаРеквизитовДляПроверки Цикл
			...
			Иначе
				...
				Для сч = 1 По ВидыСубконто.Количество() Цикл
					...
					Если ВидыСубконто[сч-1].ВидСубконто = ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.НоменклатурныеГруппы 
							ИЛИ ВидыСубконто[сч-1].ВидСубконто = ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Номенклатура  Тогда
