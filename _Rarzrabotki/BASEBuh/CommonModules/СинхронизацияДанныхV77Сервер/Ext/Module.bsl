...
Процедура УстановитьПараметрСинхронизацииV77(ИмяПараметра, ЗначениеПараметра) Экспорт
	...
	Исключение
		ТекстСообщения = НСтр("ru='Не удалось записать элемент справочника ""Параметры синхронизации""!';uk='Не вдалося записати елемент довідника ""Параметри синхронізації""!'");
