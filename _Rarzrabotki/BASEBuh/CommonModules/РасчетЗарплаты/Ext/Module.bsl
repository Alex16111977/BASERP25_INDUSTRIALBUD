...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "РасчетЗарплаты.ИсправитьИндексыИнфляции21291"; 
...
Процедура ИсправитьИндексыИнфляции21291() Экспорт
