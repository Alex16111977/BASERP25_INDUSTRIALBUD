...
#Если ВебКлиент Тогда
	...
	ТекстСообщения = НСтр("ru='Обновление программы недоступно в веб-клиенте.';uk='Оновлення програми недоступно у вебклиєнті.'");
...
#Иначе
	...
	Если ОбщегоНазначенияКлиент.КлиентПодключенЧерезВебСервер() Тогда
		ВозможенЗапускОбновления = Ложь;
		ТекстСообщения = НСтр("ru='Обновление программы недоступно при подключении через веб-сервер.';uk='Оновлення програми недоступно при підключенні через вебсервер.'");
	КонецЕсли;
