...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "0.0.0.1";
	Обработчик.Процедура = "НСИССервер.ПервичнаяНастройкаРасписания";
	Обработчик.НачальноеЗаполнение = Истина;
...
//-- БУ ЗИК	
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия 		= "2.1.21.2";
	Обработчик.Процедура 	= "ОбновлениеИнформационнойБазыБП.ЗаполнитьНалоговуюИнспекциюВСкладах";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия 		= "2.1.21.3";
	Обработчик.Процедура 	= "ОбновлениеИнформационнойБазыБП.ЗаполнитьПредопределенные_2_1_21_3";
	Обработчик.НачальноеЗаполнение = Ложь;
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия 		= "2.1.25.3";
	Обработчик.Процедура 	= "ОбновлениеИнформационнойБазыБП.ОбновитьСтатьиВПроводкахПоРИ";
	Обработчик.НачальноеЗаполнение = Ложь;

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия 		= "2.1.25.5";
	Обработчик.Процедура 	= "ОбновлениеИнформационнойБазыБП.ЗаполнитьПредопределенные_2_1_25_5";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия 		= "2.1.26.3";
	Обработчик.Процедура 	= "ОбновлениеИнформационнойБазыБП.ЗаполнитьПредопределенные_2_1_26_3";
	Обработчик.НачальноеЗаполнение = Ложь;

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "2.1.26.5";
	Обработчик.Процедура           = "РегистрыСведений.КорреспонденцииСчетов.ЗаполнитьКорреспонденцииСчетов";
	Обработчик.НачальноеЗаполнение = Ложь;
	Обработчик.ОбщиеДанные         = Истина;	

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "2.1.27.3";
	Обработчик.Процедура           = "РегистрыСведений.КорреспонденцииСчетов.ЗаполнитьКорреспонденцииСчетов";
	Обработчик.НачальноеЗаполнение = Ложь;
	Обработчик.ОбщиеДанные         = Истина;	

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия 		= "2.1.28.2";
	Обработчик.Процедура 	= "ОбновлениеИнформационнойБазыБП.ЗаполнитьПредопределенныеСтатьиНаборыНалДекл";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия 		= "2.1.29.3";
	Обработчик.Процедура 	= "ОбновлениеИнформационнойБазыБП.ЗаполнитьПредопределенныеСтатьиНаборыНалДекл";
	Обработчик.НачальноеЗаполнение = Ложь;
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия 		= "2.1.30.3";
	Обработчик.Процедура 	= "ОбновлениеИнформационнойБазыБП.ЗаполнитьПредопределенные_2_1_30_3";
	Обработчик.НачальноеЗаполнение = Ложь;

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия 		= "2.1.31.1";
	Обработчик.Процедура 	= "ОбновлениеИнформационнойБазыБП.ЗаполнитьПредопределенные_2_1_31_1";
	Обработчик.НачальноеЗаполнение = Ложь;

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия 		= "2.1.32.1";
	Обработчик.Процедура 	= "ОбновлениеИнформационнойБазыБП.ЗаполнитьПредопределенные_2_1_32_1";
	Обработчик.НачальноеЗаполнение = Ложь;

//++ БУ ЗИК	
//~	Обработчик = Обработчики.Добавить();
//~	Обработчик.Версия 		= "2.1.5.4";
//~	Обработчик.Процедура 	= "ОбновлениеИнформационнойБазыБП.ИсправитьПрефиксы";
//~	Обработчик.НачальноеЗаполнение = Ложь;
//~	
//~	Обработчик = Обработчики.Добавить();
//~	Обработчик.Версия 		= "2.1.27.2";
//~	Обработчик.Процедура 	= "УправлениеСвойствамиСлужебный.УстановитьЗначениеПризнакаИспользуется";
//~	Обработчик.НачальноеЗаполнение = Ложь;
//-- БУ ЗИК	

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия 		= "2.1.33.4";
	Обработчик.Процедура 	= "ОбновлениеИнформационнойБазыБП.ЗаполнитьСчетаУчетаОкруленияНаличных";
	Обработчик.НачальноеЗаполнение = Ложь;
...
Процедура ЗаполнитьРСсАналитикойСтатьиЗатрат() Экспорт
	...
	НайденныеСтатьи.Вставить("СтатьиЗатрат_Округление", Справочники.СтатьиЗатрат.НайтиПоНаименованию(
		НСтр("ru='Затраты от округления при расчетах наличными';uk='Витрати від заокруглення при розрахунках готівкою'", Локализация.КодЯзыкаИнформационнойБазы()), Истина));
	НайденныеСтатьи.Вставить("СтатьиДоходов_Округление", Справочники.СтатьиДоходов.НайтиПоНаименованию(
		НСтр("ru='Доход от округления при расчетах наличными';uk='Дохід від заокруглення при розрахунках готівкою'", Локализация.КодЯзыкаИнформационнойБазы()), Истина)); 
...
Процедура ЗаполнитьРССчетаУчетаПрочие(НайденныеСтатьи, ПервыйЗапуск = Ложь)
	...
	Для каждого Организация Из МассивОрганизаций Цикл
		...
		Запись = РС.СоздатьМенеджерЗаписи();		
		Запись.Активность 			= Истина;		
		Запись.ВидПрочегоСчетаУчета = Перечисления.ВидыПрочихСчетовУчета.СчетДоходовОкруглениеНаличных;		
		Запись.СчетУчетаБУ   		= ПланыСчетов.Хозрасчетный.ДругиеДоходыОтОперационнойДеятельности;
		Запись.Субконто1     		= НайденныеСтатьи.СтатьиДоходов_Округление;
	    Запись.Записать(); 

		Запись = РС.СоздатьМенеджерЗаписи();		
		Запись.Активность 			= Истина;		
		Запись.ВидПрочегоСчетаУчета = Перечисления.ВидыПрочихСчетовУчета.СчетЗатратОкруглениеНаличных;		
		Запись.СчетУчетаБУ   		= ПланыСчетов.Хозрасчетный.ДругиеЗатратыОперационнойДеятельности;
		Запись.Субконто1     		= НайденныеСтатьи.СтатьиЗатрат_Округление;
	    Запись.Записать(); 
...
Процедура ЗаполнитьПредопределенные_2_1_21_3() Экспорт
...
Процедура ОбновитьСтатьиВПроводкахПоРИ() Экспорт
	...
	|ИЗ
	|	РегистрНакопления.ОжидаемыеНалоговыеРазницы КАК Т
	|ГДЕ
	...
	Пока Выборка.Следующий() Цикл
		...
		Период = КонецМесяца(Док.Дата);
		
		СуммыРИПоСтатьям = Новый Структура;
		СуммыРИПоСтатьям.Вставить("Оплата1", Новый Структура("Статья, Сумма", Справочники.СтатьиНалоговыхДеклараций.НП15_РИ_Фин_Аванс_ЕН, 0));
		СуммыРИПоСтатьям.Вставить("Оплата2", Новый Структура("Статья, Сумма", Справочники.СтатьиНалоговыхДеклараций.НП15_РИ_Фин_ОплатаТоваров_ЕН, 0));
		СуммыРИПоСтатьям.Вставить("Продажа1", Новый Структура("Статья, Сумма", Справочники.СтатьиНалоговыхДеклараций.НП15_РИ_Фин_СС_Товаров_ЕН, 0));
		СуммыРИПоСтатьям.Вставить("Продажа2", Новый Структура("Статья, Сумма", Справочники.СтатьиНалоговыхДеклараций.НП15_РИ_Фин_СС_Товаров, 0));
		
		//до 01.08.2023 налоговая разница существовала только по статье 4.1.5.1.
		РедакцияНКУ = 1;
		Если Период >= '20230801' Тогда
			РедакцияНКУ = 2;
		КонецЕсли;
		
		НаборЗаписей = РегистрыНакопления.ОжидаемыеНалоговыеРазницы.СоздатьНаборЗаписей();
		...
		Для каждого Запись Из НаборЗаписей Цикл
			...
			Если Запись.ВидДвижения = ВидДвиженияНакопления.Приход
				ИЛИ Запись.СуммаРИПлюс = 0 Тогда
				
				Продолжить;
				
			КонецЕсли;
			
			СуммаРИСтарая = Запись.СуммаРИПлюс;
			Запись.СуммаРИПлюс = 0;
			Запись.СуммаРИМинус = 0;
			
			Если Запись.Аванс Тогда
				
				КоэфРИ = ?(Запись.СуммаДоходовВтороеСобытие - Запись.СебестоимостьВтороеСобытие = СуммаРИСтарая, 1, 
					СуммаРИСтарая / (Запись.СуммаДоходовВтороеСобытие - Запись.СебестоимостьВтороеСобытие));  
				
				Если РедакцияНКУ > 1 Тогда
					Запись.СуммаРИПлюс = Запись.СебестоимостьВтороеСобытие * КоэфРИ;
					Запись.СуммаРИМинус = Запись.СуммаДоходовВтороеСобытие * КоэфРИ;
					СуммыРИПоСтатьям.Оплата1.Сумма = СуммыРИПоСтатьям.Оплата1.Сумма + Запись.СуммаРИМинус;
					СуммыРИПоСтатьям.Продажа2.Сумма = СуммыРИПоСтатьям.Продажа2.Сумма + Запись.СуммаРИПлюс;
				КонецЕсли;
				
			Иначе

				КоэфРИ = ?(Запись.СуммаДоходов - Запись.Себестоимость = СуммаРИСтарая, 1, 
					СуммаРИСтарая / (Запись.СуммаДоходов - Запись.Себестоимость));  
				
				Запись.СуммаРИПлюс = Запись.СуммаДоходов * КоэфРИ;
				СуммыРИПоСтатьям.Оплата2.Сумма = СуммыРИПоСтатьям.Оплата2.Сумма + Запись.СуммаРИПлюс;
				
				Если РедакцияНКУ > 1 Тогда
					Запись.СуммаРИМинус = Запись.Себестоимость * КоэфРИ;
					СуммыРИПоСтатьям.Продажа1.Сумма = СуммыРИПоСтатьям.Продажа1.Сумма + Запись.СуммаРИМинус;
				КонецЕсли;
		...
		Проводки.Отбор.Регистратор.Установить(Док);
		Проводки.Прочитать();
		
		ОбратныйИндекс = Проводки.Количество() - 1;
			
		Пока ОбратныйИндекс >= 0 Цикл
			
			Запись = Проводки.Получить(ОбратныйИндекс);
			Если Запись.СчетДт = СчетРИ Тогда
		...
		Для каждого КЗ ИЗ СуммыРИПоСтатьям Цикл
			...
			СуммаПоСтатье = КЗ.Значение;
			
			Если ЗначениеЗаполнено(СуммаПоСтатье.Сумма) Тогда	
				
				ПроводкаБУ                                 = Проводки.Добавить();
				ПроводкаБУ.Период                          = Период;
				ПроводкаБУ.Организация                     = Док.Организация;
				
				ПроводкаБУ.СчетДт                          = СчетРИ;
				ПроводкаБУ.СубконтоДт.СтатьиНалоговыхДеклараций = СуммаПоСтатье.Статья;
				
				ПроводкаБУ.Сумма                           = СуммаПоСтатье.Сумма;
...
Процедура ЗаполнитьПредопределенные_2_1_25_5() Экспорт
...
Процедура ЗаполнитьПредопределенные_2_1_26_3() Экспорт
	...
	МассивСчетовПоОперациямРРО = Новый Массив;
	МассивСчетовПоОперациямРРО.Добавить("РозничнаяВыручкаВКассахККМ");
	МассивСчетовПоОперациямРРО.Добавить("НаличныеДеньгиПоОперациямРРОВИностраннойВалюте");
	
	ВедетсяУчетКассОбособленныхПодразделений = БухгалтерскийУчетПереопределяемый.ВедетсяУчетКассОбособленныхПодразделений();
	...
	Для каждого ПерезаполняемыйСчет Из МассивСчетовПерезаполнения Цикл
		...
		Если СтрокаНачальногоЗаполнения <> Неопределено Тогда
			...
			Если НЕ МассивСчетовПоОперациямРРО.Найти(ПерезаполняемыйСчет) = Неопределено Тогда 
				...
				КонецЕсли;  
				Если ВедетсяУчетКассОбособленныхПодразделений Тогда
					СубконтоОбособленныеПодразделения = ОбъектСчет.ВидыСубконто.Найти(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.ОбособленныеПодразделенияБезОбразованияЮрЛица, "ВидСубконто");
					НетОбособленныеПодразделения = (СубконтоОбособленныеПодразделения = Неопределено);
					ВсегоСубконто = ОбъектСчет.ВидыСубконто.Количество();
					Если НетОбособленныеПодразделения И ВсегоСубконто < 3 Тогда

						НовыйВид = ОбъектСчет.ВидыСубконто.Добавить();

						НовыйВид.ВидСубконто    = ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.ОбособленныеПодразделенияБезОбразованияЮрЛица;
						НовыйВид.Суммовой       = Истина;
						НовыйВид.Валютный       = Истина;
						НовыйВид.Количественный = Истина;
						НовыйВид.ТолькоОбороты  = Ложь;
					...
					КонецЕсли;
					Если НЕ НетОбособленныеПодразделения И СубконтоОбособленныеПодразделения.ТолькоОбороты = Истина Тогда
						СубконтоОбособленныеПодразделения.ТолькоОбороты = Ложь;
					КонецЕсли;  
				КонецЕсли;
			КонецЕсли;
	...
	Если ПроверитьВозможностьДобавленияСубконто(ПланыСчетов.Хозрасчетный.РасчетыПоОперациямПредоставленияПлатежныхУслуг) Тогда
		УстановитьСубконтоНеавтоматизированныхСчетов(ПланыСчетов.Хозрасчетный.РасчетыПоОперациямПредоставленияПлатежныхУслуг, ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Контрагенты);
		УстановитьСубконтоНеавтоматизированныхСчетов(ПланыСчетов.Хозрасчетный.РасчетыПоОперациямПредоставленияПлатежныхУслуг, ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Договоры);
	КонецЕсли;

КонецПроцедуры

Процедура ЗаполнитьПредопределенные_2_1_30_3() Экспорт
...
Процедура ЗаполнитьПредопределенные_2_1_31_1() Экспорт
	Обработки.НачальноеЗаполнениеИОбновлениеОбъектов.ЗаполнитьОбъект("Справочник", 	   "СтатьиНалоговыхДеклараций");
	Обработки.НачальноеЗаполнениеИОбновлениеОбъектов.ЗаполнитьОбъект("Справочник", 	   "НаборыСтатейНалоговыхДеклараций");

КонецПроцедуры

Процедура ЗаполнитьПредопределенные_2_1_32_1() Экспорт
...
Процедура ЗаполнитьСчетаУчетаОкруленияНаличных() Экспорт
	
	Запись = РегистрыСведений.СчетаУчетаПрочие.СоздатьМенеджерЗаписи();		
	Запись.Активность 			= Истина;		
	Запись.ВидПрочегоСчетаУчета = Перечисления.ВидыПрочихСчетовУчета.СчетДоходовОкруглениеНаличных;		
	Запись.СчетУчетаБУ   		= ПланыСчетов.Хозрасчетный.ДругиеДоходыОтОперационнойДеятельности;
	Запись.Субконто1     		= Справочники.СтатьиДоходов.НайтиПоНаименованию(
		НСтр("ru='Доход от округления при расчетах наличными';uk='Дохід від заокруглення при розрахунках готівкою'", 
		Локализация.КодЯзыкаИнформационнойБазы()), Истина);
	Запись.Записать(); 
	...
	Запись.ВидПрочегоСчетаУчета = Перечисления.ВидыПрочихСчетовУчета.СчетЗатратОкруглениеНаличных;		
	Запись.СчетУчетаБУ   		= ПланыСчетов.Хозрасчетный.ДругиеЗатратыОперационнойДеятельности;
	Запись.Субконто1     		= Справочники.СтатьиЗатрат.НайтиПоНаименованию(
		НСтр("ru='Затраты от округления при расчетах наличными';uk='Витрати від заокруглення при розрахунках готівкою'", 
		Локализация.КодЯзыкаИнформационнойБазы()), Истина);
	Запись.Записать(); 
...
Процедура ЗаполнениеСубконтоНеавтоматизированныхСчетов(ЭтоНачальноеЗаполнение)
	...
	КонецЕсли;
	Если ЭтоНачальноеЗаполнение ИЛИ ПроверитьВозможностьДобавленияСубконто(ПланыСчетов.Хозрасчетный.РасчетыПоОперациямПредоставленияПлатежныхУслуг) Тогда
		УстановитьСубконтоНеавтоматизированныхСчетов(ПланыСчетов.Хозрасчетный.РасчетыПоОперациямПредоставленияПлатежныхУслуг, ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Контрагенты);
		УстановитьСубконтоНеавтоматизированныхСчетов(ПланыСчетов.Хозрасчетный.РасчетыПоОперациямПредоставленияПлатежныхУслуг, ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Договоры);
	КонецЕсли;
	//69
