...
Процедура Автозаполнение(ПараметрыЗаполнения, АдресХранилища) Экспорт
	...
	|	ВЫБОР
	|		КОГДА ЗарплатаКВыплатеОрганизаций.Ссылка.ФорматОбмена30
	|   		ТОГДА ЗарплатаКВыплатеОрганизаций.ГруппаУчетаНачислений.СчетУчета 
	|			ИНАЧЕ ЗарплатаКВыплатеОрганизаций.СчетУчета
	|   КОНЕЦ КАК СчетУчета,
	...
	|			И ((НЕ ЗарплатаКВыплатеОрганизаций.Ссылка.ФорматОбмена30 И ЗарплатаКВыплатеОрганизаций.СчетУчета = РасходныйКассовыйОрдер.СчетУчетаРасчетовПоЗП) ИЛИ (ЗарплатаКВыплатеОрганизаций.Ссылка.ФорматОбмена30 И ЗарплатаКВыплатеОрганизаций.ГруппаУчетаНачислений.СчетУчета = РасходныйКассовыйОрдер.СчетУчетаРасчетовПоЗП) )
