...
Процедура УстановитьСписокКолонокПоУмолчанию()
	...
	Если МассивСтрок.Количество() = 0 Тогда
		...
		НоваяСтрока.Представление = НСтр("ru='Артикул';uk= 'Артикул'");
	КонецЕсли;
	...
	Если МассивСтрок.Количество() = 0 Тогда
		...
		НоваяСтрока.Представление = НСтр("ru='Единица измерения';uk= 'Одиниця вимірювання'");
	КонецЕсли;
...
Процедура ЗаписатьДанныеВФайлИОткрыть()
	...
	ТекстСообщения = НСтр("ru='Для сохранения файлов рекомендуется установить расширение для веб-клиента BAS Бухгалтерия.';uk='Для збереження файлів рекомендується встановити розширення для вебклієнта BAS Бухгалтерія.'");
