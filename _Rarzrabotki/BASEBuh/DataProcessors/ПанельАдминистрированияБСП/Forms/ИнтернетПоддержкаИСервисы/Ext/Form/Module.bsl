...
Процедура ЦентрМониторингаАдресСервисаПриИзменении(Элемент)
	...
	Исключение
		...
		ОписаниеОшибки = НСтр("ru='Адрес сервиса';uk='Адреса сервісу'") + " "
			+ ЦентрМониторингаАдресСервиса + " "
			+ НСтр("ru='не является допустимым адресом веб-сервиса для отправки отчетов об использовании программы.';uk='не є допустимою адресою вебсервісу для відправки звітів про використання програми.'"); 
