...
Процедура УстановитьВидимостьДоступность()
	...
	Элементы.МестоХраненияАвтомобиля.Видимость = ЗначениеЗаполнено(Объект.Документ) И Объект.Документ.Дата >= РегистрыСведений.НастройкиЗаконодательныхИзменений.ЗначениеНастройки("ДатаНачалаИспользованияФормыТТН2026");
...
Процедура СохранитьПараметрыДоставкиНаСервере()
	...
	|	НастройкиЗаполненияТТН.МестоХраненияАвтомобиля}";
