...
Процедура ЗаполнитьТТН2024 (Шапка, ЗапросТовары, ТабДокумент, ПараметрыПечати)
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.ПечатьТТН.ПФ_MXL_UK_ТТН2024");
...
Процедура ЗаполнитьТТН2024_ПеремещениеТоваров (Шапка, ЗапросТовары, ТабДокумент, ПараметрыПечати)
