...
Процедура ДействиеОбновить(Команда)
	...
	ИначеЕсли Объект.РежимПоДатам 
		...
		ТекстПредупреждения = НСтр("ru='Не правильно задан период или не заполнены даты начала и конца периода! Заполнение невозможно.';uk='Не правильно вказаний період або не заповнені дати початку чи кінця періоду! Заповнення неможливо.'");
	КонецЕсли;
