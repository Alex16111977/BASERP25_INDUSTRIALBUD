...
Процедура КомандаВыполнить(Команда)
	...
	Если РезультатПроверки.ЕстьННДляПереформирования Тогда
		...
		ТекстВопроса = НСтр("ru='В выбранном периоде есть итоговые налоговые документы по рознице, они будут переформированы! Продолжить?';uk='В обраному періоді є підсумкові податкові документи у роздробі, вони будуть переформовані! Продовжити?'");
