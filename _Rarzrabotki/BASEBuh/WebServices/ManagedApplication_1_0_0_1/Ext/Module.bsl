	...
	Попытка
		...
		Если ОбщегоНазначенияПовтИсп.РазделениеВключено() Тогда
			...
			Если ОбщегоНазначенияПовтИсп.ДоступноИспользованиеРазделенныхДанных() Тогда
				...
				ВызватьИсключение НСтр("ru='Операция не может быть вызвана в сеансе, который запущен с указанием разделителей. Проверьте правильность публикации веб-сервиса!';uk='Операція не може бути викликана у сеансі, який запущений із зазначенням роздільників. Перевірте правильність публікації вебсервісу!'");
