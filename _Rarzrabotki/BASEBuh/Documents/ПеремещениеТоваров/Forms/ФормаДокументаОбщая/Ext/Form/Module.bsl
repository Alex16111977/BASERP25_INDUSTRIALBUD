...
Процедура ДобавитьРеквизиты()
 // Масив для нових реквізитів
	...
	Реквизит_Основание = Новый РеквизитФормы("Основание",Новый ОписаниеТипов("ДокументСсылка.СогласованиеПеремещения"),,НСтр("ru='Основание';uk='Підстава'"),Истина);
	...
	ГруппаШапкаПравая = Элементы.Найти("ГруппаШапкаПравая"); 
	// Поле для реквізиту "Направление"
    ПолеОснование = Элементы.Добавить("Основание", Тип("ПолеФормы"), ГруппаШапкаПравая);
    ПолеОснование.Вид = ВидПоляФормы.ПолеВвода;
    ПолеОснование.ПутьКДанным = "Основание";
    ПолеОснование.Заголовок = НСтр("ru='Основание';uk='Підстава'");
    ПолеОснование.Ширина = 30;
	...
	КонецЕсли;
	 ...
	 Если ЗначениеЗаполнено(Объект._ДокументОснование) Тогда
        ЭтаФорма.Основание = Объект._ДокументОснование;
    КонецЕсли;
КонецПроцедуры         
