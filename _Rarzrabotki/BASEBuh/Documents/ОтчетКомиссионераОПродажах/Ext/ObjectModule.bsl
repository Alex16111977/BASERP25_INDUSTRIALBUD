...
Процедура ДвиженияПоРеализацииТоваров(СтруктураШапкиДокумента, ТаблицаПоТоварам, ТаблицаПоУслугам, 
	...
	ТаблицаКопия.Свернуть("СчетДоходовБУ,СубконтоДоходовБУ1,СубконтоДоходовБУ2,СубконтоДоходовБУ3,НоменклатурнаяГруппа, Номенклатура"+?(СтруктураШапкиДокумента.ЕстьНалогНаПрибыльДо2015,",НалоговоеНазначениеДоходовИЗатрат",""),"ПроводкиСуммаСНДСРегл,ПроводкиСуммаСНДСВал,Количество");
	...
	// ТОВАРЫ
	ТаблицаКопия = ТаблицаПоТоварам.Скопировать();
	ТаблицаКопия.Свернуть("СтавкаНДС,СчетДоходовБУ,СубконтоДоходовБУ1,СубконтоДоходовБУ2,СубконтоДоходовБУ3,НоменклатурнаяГруппа, Номенклатура"+?(СтруктураШапкиДокумента.ЕстьНалогНаПрибыльДо2015,",НалоговоеНазначениеДоходовИЗатрат",""),"ПроводкиСуммаНДСРегл,ПроводкиСуммаНДСВал,СуммаНДСПередачи");
