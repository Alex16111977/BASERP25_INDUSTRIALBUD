...
Функция ДанныеВедомостей(Ведомости, СпособВыплаты, ФизическиеЛица = Неопределено, Регистратор = Неопределено) Экспорт
	...
	|	ВЫБОР
	|		КОГДА Основной.Ссылка.ФорматОбмена30
	|   		ТОГДА Основной.ГруппаУчетаНачислений.СчетУчета 
	|			ИНАЧЕ Основной.СчетУчета
	|   КОНЕЦ КАК СчетУчета, 
	|	Основной.Ссылка.ФорматОбмена30 КАК ФорматОбмена30,
	|	Работники.Банк
	|ИЗ
	...
	|			И ((НЕ Основной.Ссылка.ФорматОбмена30 И ОплатаВедомостейНаВыплатуЗарплаты.СчетУчета = Основной.СчетУчета) ИЛИ (Основной.Ссылка.ФорматОбмена30 И ОплатаВедомостейНаВыплатуЗарплаты.СчетУчета = Основной.ГруппаУчетаНачислений.СчетУчета))	
	...
	|			ИНАЧЕ Основной.СчетУчета
	|   КОНЕЦ,
	|	Основной.Ссылка.ФорматОбмена30,
	|	Работники.Банк";
