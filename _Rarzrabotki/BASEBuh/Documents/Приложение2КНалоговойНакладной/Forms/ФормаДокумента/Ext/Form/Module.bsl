...
Процедура ПриОткрытии(Отказ)
	...
	Для Сч = 1 По ЭтотОбъект["КоличествоОбъектовДляОткрытия"] Цикл
		...
		Если ФормаНовогоОбъекта.ИмяФормы = "Документ.Приложение2КНалоговойНакладной.Форма.ФормаДокумента" Тогда
			...
			ФормаНовогоОбъекта.СообщениеПользователю = СообщениеПользователю;
		КонецЕсли;
...
Процедура ВидОперацииОбработатьИзменение() Экспорт
	...
	УстановитьТипПричиныНевыдачиПокупателюПоУмолчаниюНаСервере();
...
Процедура ТоварыНоменклатураПриИзмененииНаСервере(СтрокаТабличнойЧасти, ДанныеОбъекта)
	...
	РассчитатьВес(СтрокаТабличнойЧасти);
	ЗаполнитьРежимЭкспортногоОбеспечения(СтрокаТабличнойЧасти);	
...
Процедура ТоварыСтавкаНДСПриИзменении(Элемент)
	...
	РассчитатьСуммыИзменений(СтрокаТабличнойЧасти, "Товары");
	РассчитатьСуммыРеглНаСервере(Объект.СуммаВключаетНДС, Истина);
...
Процедура ТоварыСуммаНДСПриИзменении(Элемент)
	...
	РассчитатьСуммыИзменений(Элементы.Товары.ТекущиеДанные, "Товары");
	РассчитатьСуммыРеглНаСервере(Объект.СуммаВключаетНДС);
...
Процедура ТоварыКодУКТВЭДПриИзменении(Элемент)
	...
	РассчитатьВес(ТекущиеДанные);
	ЗаполнитьРежимЭкспортногоОбеспечения(ТекущиеДанные);
	УстановитьВидимостьВеса(ЭтаФорма);	                                                                                                                        
...
&НаКлиенте
Процедура ТоварыИзменениеСуммыПриИзменении(Элемент)
	РассчитатьСуммыРеглНаСервере();
КонецПроцедуры

&НаКлиенте
Процедура ТоварыИзменениеСуммыНДСПриИзменении(Элемент)
	РассчитатьСуммыРеглНаСервере(Объект.СуммаВключаетНДС);	
КонецПроцедуры

&НаКлиенте
Процедура ТоварыИзменениеСуммыБезНДСРеглПриИзменении(Элемент)
	РассчитатьСуммыРеглНаСервере(Ложь, Истина);
КонецПроцедуры
...
&НаКлиенте
Процедура УслугиКодУКТВЭДПриИзменении(Элемент)
...
&НаКлиенте
Процедура УслугиИзменениеСуммыПриИзменении(Элемент)
	РассчитатьСуммыРеглНаСервере();
КонецПроцедуры

&НаКлиенте
Процедура УслугиИзменениеСуммыНДСПриИзменении(Элемент)
	РассчитатьСуммыРеглНаСервере(Объект.СуммаВключаетНДС);	
КонецПроцедуры

&НаКлиенте
Процедура УслугиИзменениеСуммыБезНДСРеглПриИзменении(Элемент)
	РассчитатьСуммыРеглНаСервере(Ложь, Истина);
КонецПроцедуры
...
&НаКлиенте
Процедура ОСКодУКТВЭДПриИзменении(Элемент)
...
&НаКлиенте
Процедура ОСИзменениеСуммыПриИзменении(Элемент)
	РассчитатьСуммыРеглНаСервере();
КонецПроцедуры

&НаКлиенте
Процедура ОСИзменениеСуммыНДСПриИзменении(Элемент)
	РассчитатьСуммыРеглНаСервере(Объект.СуммаВключаетНДС);	
КонецПроцедуры

&НаКлиенте
Процедура ОСИзменениеСуммыБезНДСРеглПриИзменении(Элемент)
	РассчитатьСуммыРеглНаСервере(Ложь, Истина);
КонецПроцедуры
...
&НаКлиенте
Процедура НМАКодУКТВЭДПриИзменении(Элемент)
...
&НаКлиенте
Процедура НМАИзменениеСуммыПриИзменении(Элемент)
	РассчитатьСуммыРеглНаСервере();
КонецПроцедуры

&НаКлиенте
Процедура НМАИзменениеСуммыНДСПриИзменении(Элемент)
	РассчитатьСуммыРеглНаСервере(Объект.СуммаВключаетНДС);	
КонецПроцедуры

&НаКлиенте
Процедура НМАИзменениеСуммыБезНДСРеглПриИзменении(Элемент)
	РассчитатьСуммыРеглНаСервере(Ложь, Истина);
КонецПроцедуры
...
Процедура ВыполнитьЗаполнениеНаОсновании(ПараметрыФормы)
	...
	Для каждого ОбъектДляОткрытия Из МассивОбъектовДляОткрытияФорм Цикл
		...
		Если ТипЗнч(ОбъектДляОткрытия) = Тип("ДокументОбъект.НалоговаяНакладная") Тогда
			Документы.НалоговаяНакладная.ЗаполнитьСуммыРегл(ОбъектДляОткрытия);
			Документы.НалоговаяНакладная.ЗаполнитьВесТоваров(ОбъектДляОткрытия);
		ИначеЕсли ТипЗнч(ОбъектДляОткрытия) = Тип("ДокументОбъект.Приложение2КНалоговойНакладной") Тогда
			Если НЕ ОбъектДляОткрытия.ДополнительныеСвойства.Свойство("СуммыРеглЗаполнены") Тогда
				Документы.Приложение2КНалоговойНакладной.ЗаполнитьСуммыРегл(ОбъектДляОткрытия);      
				Документы.Приложение2КНалоговойНакладной.ЗаполнитьВесТоваров(ОбъектДляОткрытия);
			КонецЕсли;
			Если ОбъектДляОткрытия.ДополнительныеСвойства.Свойство("СообщениеПользователю") Тогда
				СообщениеПользователю = ОбъектДляОткрытия.ДополнительныеСвойства.СообщениеПользователю;
			КонецЕсли;
		КонецЕсли;
...
Процедура ОбновитьИтоги(Форма)
	...
	ИзменениеВсегоРегл    = Объект.Товары.Итог("ИзменениеСуммыБезНДСРегл")   +Объект.Услуги.Итог("ИзменениеСуммыБезНДСРегл")   +Объект.ОС.Итог("ИзменениеСуммыБезНДСРегл")   +Объект.НМА.Итог("ИзменениеСуммыБезНДСРегл");
	ИзменениеВсегоНДСРегл = Объект.Товары.Итог("ИзменениеСуммыНДСРегл")+Объект.Услуги.Итог("ИзменениеСуммыНДСРегл")+Объект.ОС.Итог("ИзменениеСуммыНДСРегл")+Объект.НМА.Итог("ИзменениеСуммыНДСРегл");
	Форма.ИтогиВсегоРегл    = ИзменениеВсегоРегл + ИзменениеВсегоНДСРегл;
	Форма.ИтогиВсегоНДСРегл = ИзменениеВсегоНДСРегл;
...
Функция ДанныеСтрокиТабличнойЧасти(СтрокаТабличнойЧасти = Неопределено, ИмяТаблицы = "Товары")
	...
	Если ИмяТаблицы = "Товары" Тогда
		...
		|ИзменениеКоличества,ИзменениеЦены,ИзменениеСуммы,ИзменениеСуммыНДС,Причина,КодПричины,    
		|СтатьяДекларацииНДСНалоговыеОбязательства,ДатаКорректировки,ЕдиницаИзмерения,СуммаБезСкидки,СуммаСкидки,
		|КодУКТВЭД,НомерГТД, 
		|РежимЭкспортногоОбеспечения,Вес, 
		|Всего");
...
&НаСервере
Процедура УстановитьТипПричиныНевыдачиПокупателюПоУмолчаниюНаСервере()
	
	ТипПричиныНевыдачиСтарый = Объект.ТипПричиныНевыдачиПокупателю;
	Документы.Приложение2КНалоговойНакладной.УстановитьТипПричиныНевыдачиПокупателюПоУмолчанию(Объект);
	
	Если ТипПричиныНевыдачиСтарый <> Объект.ТипПричиныНевыдачиПокупателю Тогда
		
		СтруктураТЧ = Новый Структура("Товары, Услуги, ОС, НМА");
		Для каждого ТекТЧ Из СтруктураТЧ Цикл
			
			Документы.Приложение2КНалоговойНакладной.ЗаполнитьСчетаУчетаВТабЧасти(Объект, ТекТЧ.Ключ);		
...
Процедура УправлениеФормой(Форма)
	...
	Элементы.ГруппаИтогиФонРегл.Видимость = Форма.ВалютаРегламентированногоУчета <> Объект.ВалютаДокумента;

	УстановитьВидимостьВеса(Форма);	
	...
	Если Объект.ДатаПолученияПокупателемНеРавнаДатеДокумента Тогда    
		Элементы.ДатаПолученияПокупателемНеРавнаДатеДокумента.Заголовок = НСтр("ru='Дата получения покупателем не равна дате документа. Документ получен:';uk='Дата отримання покупцем не дорівнює даті документа. Документ отримано:'");
...
&НаСервере
Процедура РассчитатьСуммыРеглНаСервере(ИзмениласьСуммаБезНДС = Истина, ИзмениласьСтавкаНДС = Ложь, ЗаполнятьОтрицательныеСтроки = Ложь)
	
	Документы.Приложение2КНалоговойНакладной.ЗаполнитьСуммыРегл(Объект, ИзмениласьСуммаБезНДС, ИзмениласьСтавкаНДС, ЗаполнятьОтрицательныеСтроки);
	
КонецПроцедуры

&НаКлиентеНаСервереБезКонтекста
Процедура РассчитатьВес(ТекущаяСтрока)
	
	ТекущаяСтрока.Вес = ПолучитьВесНаСервере(ТекущаяСтрока.Номенклатура, ?(ТекущаяСтрока.ИзменениеКоличества = 0, ТекущаяСтрока.Количество, ТекущаяСтрока.ИзменениеКоличества), ТекущаяСтрока.Коэффициент, ТекущаяСтрока.КодУКТВЭД);

КонецПроцедуры

&НаСервереБезКонтекста
Функция ПолучитьВесНаСервере(Номенклатура, Количество, Коэффициент, КодУКТВЭД)
	
	Возврат Документы.НалоговаяНакладная.РассчитатьВес(Номенклатура, Количество, Коэффициент, КодУКТВЭД);
...
Процедура ЗаполнитьРежимЭкспортногоОбеспечения(СтрокаТаблицы)
	...
	СтрокаТаблицы.РежимЭкспортногоОбеспечения = ОбщегоНазначенияБПВызовСервера.ЗначениеРеквизитаОбъекта(СтрокаТаблицы.КодУКТВЭД, "РежимЭкспортногоОбеспечения");
...
Процедура ПреобразоватьНоменклатурныйСоставЗавершение(Ответ, ДополнительныеПараметры = Неопределено) Экспорт
	...
	ОткрытьФорму("Обработка.ПреобразованиеНоменклатурногоСоставаДокументаП2.Форма", ПараметрыФормы, ЭтотОбъект,,,,Новый ОписаниеОповещения("ПослеПреобразованияНоменклатурногоСостава", ЭтаФорма),РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
	
КонецПроцедуры

&НаКлиенте
Процедура ПослеПреобразованияНоменклатурногоСостава(РезультатЗакрытия, ДополнительныеПараметры) Экспорт
	
	РассчитатьСуммыРеглНаСервере(,, Истина);	
