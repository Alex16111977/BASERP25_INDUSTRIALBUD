...
Процедура ДвиженияПоРегистрам(РежимПроведения, СтруктураШапкиДокумента, ТаблицаПоТоварам, ТаблицаПоУслугам, Отказ, Заголовок)
	...
	ТаблицаКопия.Свернуть("СчетВычетовИзДоходов, СубконтоВычетовИзДоходов1, СубконтоВычетовИзДоходов2, СубконтоВычетовИзДоходов3, НоменклатурнаяГруппа, Номенклатура"+?(СтруктураШапкиДокумента.ЕстьНалогНаПрибыльДо2015,", НалоговоеНазначениеДоходовИЗатрат",""),"ПроводкиСуммаСНДСРегл,ПроводкиСуммаСНДСВал");
	...
	Если СтруктураШапкиДокумента.ЕстьНДС Тогда
		...
		// ТОВАРЫ
		ТаблицаКопия = ТаблицаПоТоварам.Скопировать();
		ТаблицаКопия.Свернуть("ДляХозяйственнойДеятельности,ВидДеятельностиНДС, СтавкаНДС, СчетВычетовИзДоходов, СубконтоВычетовИзДоходов1, СубконтоВычетовИзДоходов2, СубконтоВычетовИзДоходов3, НоменклатурнаяГруппа, Номенклатура"+?(СтруктураШапкиДокумента.ЕстьНалогНаПрибыльДо2015,", НалоговоеНазначениеДоходовИЗатрат",""),"ПроводкиСуммаНДСРегл,ПроводкиСуммаНДСВал,СуммаНДСПоступления");
	...
	Если СтруктураШапкиДокумента.ЕстьНДС Тогда
		...
		Для каждого СтрокаТаблицы Из ТаблицаКопия Цикл
			...
			БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетДт, Проводка.СубконтоДт, "Номенклатура", СтруктураШапкиДокумента.УслугаПоВознаграждению);
