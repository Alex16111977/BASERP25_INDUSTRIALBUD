	...
	Пока Шапка.Следующий() Цикл
		...
		Если (НазваниеМакета = "Доверенность") или (НазваниеМакета = "ДоверенностьСтраница") Тогда
			...
			Если ЗначениеЗаполнено(Руководители.РуководительФИО) Тогда
				...
				//Тютюн
				ОбластьМакета.Параметры.ФИОРуководителя = СтрЗаменить(ОбластьМакета.Параметры.ФИОРуководителя,"ОЛЕКСАНДР ВОРОНЦОВ","Манжула М.А."); 
				ОбластьМакета.Параметры.Руководитель = "Керівник підприємства";
				Если ОбластьМакета.Параметры.ФИОРуководителя = "Манжула М.А." Тогда 
					ОбластьМакета.Параметры.Руководитель = "Директор виконавчий";
				КонецЕсли; 
				//КонецИзменений
