...
WHITELIST = [
    ...
    "Перечисление.А_ТипСтатьиPL",  # 2026-05-21: ТипСтатьи у А_Статьи_PL (Доход/Расход) для знака суммы в Fact_PnL
    ...
    "Справочник.А_ВидыКонтрагентовДляБаланса",  # 2026-06-12: Dim_VidyKontragentov (ДоговорыКонтрагентов.А_ВидКонтрагента)
