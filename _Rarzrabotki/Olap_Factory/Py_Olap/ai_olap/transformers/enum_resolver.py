...
FROZEN_ENUMS: dict[str, list[str]] = {
    # OlapFactory (2026-08-01): Fact_PlanFactProizvodstvo.RowType.
    # Порядок ОБЯЗАН совпадать с _EnumOrder в 1С (_Enum56576, проверено: 0..3).
    # Строки используются в DAX Power BI буквально — переименование = регресс мер.
