...
// Функция отображения времени, передавайте миллисекунды
...
Процедура УстановитьПараметрыОтчета()
	...
	//НайденныйПараметр = КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("Начало"));
	//НайденныйПараметр.Использование = Истина;
	//НайденныйПараметр.Значение = НачалоДня(ЭтотОбъект.НачалоПериода);
	//НайденныйПараметр = КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("Окончание"));
	//НайденныйПараметр.Использование = Истина;
	//НайденныйПараметр.Значение = КонецДня(ЭтотОбъект.КонецПериода);
	//
	//НайденныйПараметр = КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("Счет691"));
	//НайденныйПараметр.Использование = Истина;
	//НайденныйПараметр.Значение = ПланыСчетов.Хозрасчетный.НайтиПоКоду("691");
	
	//НайденныйПараметр = КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("Организация"));
	//НайденныйПараметр.Использование = Истина;
	//НайденныйПараметр.Значение = ЭтотОбъект.Организация;
...
Функция ПолучитьТаблицуВнешнегоНабораДанных()
	//УТП = ВыполнитьПодключениеКИБПриемнику();
	//ТабЗнач = ВыбратьДанныеСервиса(УТП);
	//Возврат ТабЗнач
...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	//Если НЕ ЗначениеПараметра = Неопределено Тогда
	//	ЗначениеПараметра.Использование = Истина;
	//	ЗначениеПараметра.Значение = КонецМесяца(НачалоПериода);
	//	
	//КонецЕсли; 
	//
...
//
Функция ПолучитьТекстЗаголовкаОтчета()
	ЗаголовокОтчета = "";
...
//		
//		Сообщить(НСтр("ru='Подключение к информационной базе приемнику произошло успешно.';uk='Підключення до інформаційної бази приймачу відбулося успішно.'"));
//		
//	КонецЕсли;
...
Функция ВыполнитьПодключениеКИБПриемнику() Экспорт
	...
	//СтруктураПодключения.Вставить("КаталогИБ", ЭтотОбъект.КаталогИнформационнойБазыДляПодключения);
	СтруктураПодключения.Вставить("ИмяСервера", "127.0.0.1");
	СтруктураПодключения.Вставить("ИмяИБНаСервере", "Utp");
	СтруктураПодключения.Вставить("Пользователь", "Админ");
	СтруктураПодключения.Вставить("Пароль", "2018");
