// Внешняя печатная форма "Рахунок"
// Автономная — макет ПФ_MXL_СчетНаОплату берётся из Templates самой обработки (ПолучитьМакет).
...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование", "Рахунок");
	...
	НоваяКоманда.Представление    = "Рахунок";
...
Процедура Печать(МассивОбъектов, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "СчетНаОплатуБезПП") Тогда
		СтруктураТипов = ОбщегоНазначенияУТ.СоответствиеМассивовПоТипамОбъектов(МассивОбъектов);
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			КоллекцияПечатныхФорм,
			"СчетНаОплатуБезПП",
			НСтр("ru='Счет на оплату (без ПП)';uk='Рахунок'"),
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПредварительныйПросмотрПечатнойФормыСчетНаОплату") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			НСтр("ru='Счет на оплату (без ПП)';uk='Рахунок'"),
			ПечатьПредварительныйПросмотрСчетаНаОплату(МассивОбъектов[0], ОбъектыПечати, "СчетНаОплатуБезПП"),
			,
			,
			,
			Истина // ЭтоМногоязычнаяПечатнаяФорма 
...
Процедура ЗаполнитьРеквизитыШапкиСчетаНаОплату(ДанныеПечати, Макет, ТабличныйДокумент, ТаблицаЭтапыОплаты, ТаблицаТовары, ПараметрыВывода)
	...
	Макет = ЭтотОбъект.ПолучитьМакет("ПФ_MXL_СчетНаОплату");
...
Функция ПечатьПредварительныйПросмотрСчетаНаОплату(Организация, ОбъектыПечати, ИмяМакета)
	...
	ДанныеПечати.Вставить("УчитыватьНДС", Ложь);
	ДанныеПечати.Вставить("ЦенаВключаетНДС", Ложь);
