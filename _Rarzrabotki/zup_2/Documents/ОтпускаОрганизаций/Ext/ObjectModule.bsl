		...
		Пока ВыборкаВидОтпуска.Следующий() Цикл
			Если НЕ ЗначениеЗаполнено(ВыборкаВидОтпуска.Сотрудник) Тогда
				Если ЗначениеЗаполнено(ВыборкаВидОтпуска.НомерСтрокиРаботникиОрганизации) Тогда
					ТекстСообщения = "В строке номер " + Строка(ВыборкаВидОтпуска.НомерСтрокиРаботникиОрганизации) + НСтр("ru=' табличной части ""Работники организации"" не указан сотрудник!';uk=' табличної частини ""Працівники організації"" не вказаний співробітник!'") 
				Иначе
					ТекстСообщения = "В строке номер " + Строка(ВыборкаВидОтпуска.НомерСтрокиИспользованиеОтпуска) + НСтр("ru=' табличной части ""Использование ежегодного отпуска"" не указан сотрудник!';uk=' табличної частини ""Використання щорічної відпустки"" не вказаний співробітник!'") 
				КонецЕсли;
			...
			Если НЕ ЗначениеЗаполнено(ВыборкаВидОтпуска.ВидОтпуска) Тогда
				Если ЗначениеЗаполнено(ВыборкаВидОтпуска.НомерСтрокиРаботникиОрганизации) Тогда
					ТекстСообщения = "В строке номер " + Строка(ВыборкаВидОтпуска.НомерСтрокиРаботникиОрганизации) + НСтр("ru=' табличной части ""Работники организации"" не указан вид отпуска!';uk=' табличної частини ""Працівники організації"" не зазначений вид відпустки!'") 
				Иначе
					ТекстСообщения = "В строке номер " + Строка(ВыборкаВидОтпуска.НомерСтрокиИспользованиеОтпуска) + НСтр("ru=' табличной части ""Использование ежегодного отпуска"" не указан вид отпуска!';uk=' табличної частини ""Використання щорічної відпустки"" не зазначений вид відпустки!'") 
				КонецЕсли;
				ОбщегоНазначения.СообщитьОбОшибке(ТекстСообщения, Отказ, Заголовок);
			КонецЕсли;		
			Если НЕ ВыборкаВидОтпуска.ВидОтпуска.ВедетсяУчетОстатков Тогда
				Если ЗначениеЗаполнено(ВыборкаВидОтпуска.НомерСтрокиРаботникиОрганизации) Тогда
					ТекстСообщения = "В строке номер " + Строка(ВыборкаВидОтпуска.НомерСтрокиРаботникиОрганизации) + НСтр("ru=' табличной части ""Работники организации"" указан вид отпуска по которому не ведется учет остатков!';uk=' табличної частини ""Працівники організації"" зазначений вид відпустки по якому не ведеться облік залишків!'") 
				Иначе
					ТекстСообщения = "В строке номер " + Строка(ВыборкаВидОтпуска.НомерСтрокиИспользованиеОтпуска) + НСтр("ru=' табличной части ""Использование ежегодного отпуска"" указан вид отпуска по которому не ведется учет остатков!';uk=' табличної частини ""Використання щорічної відпустки"" зазначений вид відпустки по якому не ведеться облік залишків!'") 
				КонецЕсли;
				ОбщегоНазначения.СообщитьОбОшибке(ТекстСообщения, Отказ, Заголовок);
			КонецЕсли;			
	...
	ИначеЕсли Видоперации = Перечисления.ВидыОперацийОтпускаОрганизаций.КомпенсацияОтпуска Тогда
		Пока ВыборкаВидОтпуска.Следующий() Цикл
			...
			Если ВыборкаВидОтпуска.ВидОтпуска.ОтпускНеКомпенсируется Тогда
				ТекстСообщения = "В строке номер " + Строка(ВыборкаВидОтпуска.НомерСтрокиИспользованиеОтпуска) + НСтр("ru=' табличной части ""Использование ежегодного отпуска"" указан вид отпуска, который не компенсируется!';uk=' табличної частини ""Використання щорічної відпустки"" зазначений вид відпустки, який не компенсується!'");
