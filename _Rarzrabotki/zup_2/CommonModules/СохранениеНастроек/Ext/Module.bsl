...
Процедура СохранитьНастройкуОбъекта(СохраненнаяНастройка, СохраняемыеНастройки) Экспорт
	...
	Исключение
		Сообщить(НСтр("ru='Настройка формы не записана:';uk='Настройка форми не записана:'") + Символы.ПС + "- " + ОписаниеОшибки(), СтатусСообщения.Важное);
	КонецПопытки;
...
Функция ОткрытьФормуЗначения(ГуидИлиСсылка) 
