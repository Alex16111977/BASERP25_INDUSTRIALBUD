...
Функция СоответствиеКлассификаторовИМакетов() Экспорт
	...
	Результат.Вставить("КлассификаторПрофессий", Справочники.ДолжностиОрганизаций.ПолучитьМакет("КлассификаторПрофессийИДолжностей"));
	Результат.Вставить("ОснованияУвольненияПоКЗОТ", Справочники.ОснованияУвольненияИзОрганизации.ПолучитьМакет("СписокОснованийУвольнения"));
