...
Процедура СформироватьОтчет(ДокументРезультат, ПоказыватьЗаголовок = Ложь, ВысотаЗаголовка = 0) Экспорт
	...
	ТекстВыбранаСхемаМотивации = НСтр("ru='"" Действующая схема мотивации""';uk='"" Діюча схема мотивації""'",КодЯзыкаПечать);
	ТекстНеВыбранаСхемаМотивации = НСтр("ru='"" Схема мотивации не выбрана""';uk='"" Схема мотивації не обрана""'",КодЯзыкаПечать);
