...
Процедура РазбитьТабличныйДокументПоСтраницам(ТабличныйДокумент)
	...
	Состояние(НСТР("ru='Разбиение отчета по страницам ...  (Если Вы хотите прервать вывод отчета, нажмите Ctrl+Break)';uk='Розбиття звіту по сторінках ... (Якщо Ви хочете перервати виведення звіту, натисніть Ctrl+Break)'"));
