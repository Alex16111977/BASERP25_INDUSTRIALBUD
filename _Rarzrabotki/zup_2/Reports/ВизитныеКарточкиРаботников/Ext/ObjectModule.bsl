...
Функция ЗаголовокОтчета(Отчет) 
	...
	Для Сч = 1 По 3 Цикл
		...
		Если Префикс = "Верх" Тогда
			ОбластьШапка.Параметры.ЗаголовокОтчета = НСтр("ru='Визитные карточки работников: ';uk='Візитні картки працівників: '",ЛокализацияПовтИсп.ПолучитьЯзыкФормированияПечатныхФормОтчетов());			
		ИначеЕсли Префикс = "Середина" Тогда
			ОбластьШапка.Параметры.Фильтры = НСтр("ru='Отбор: ';uk='Відбір: '",ЛокализацияПовтИсп.ПолучитьЯзыкФормированияПечатныхФормОтчетов()) + СтрФильтры;
		ИначеЕсли Префикс = "Низ" Тогда
			ОбластьШапка.Параметры.Группировки = НСтр("ru='Группировки: ';uk='Групування: '",ЛокализацияПовтИсп.ПолучитьЯзыкФормированияПечатныхФормОтчетов()) + СтрГруппировки;
			ОбластьШапка.Параметры.Показатели = НСтр("ru='Показатели: ';uk='Показники: '",ЛокализацияПовтИсп.ПолучитьЯзыкФормированияПечатныхФормОтчетов()) + СтрПоказатели;
		КонецЕсли;
