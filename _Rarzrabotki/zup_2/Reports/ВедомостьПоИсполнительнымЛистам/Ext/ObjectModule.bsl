...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.ДобавитьПоказатель("Результат", НСтр("ru='Удержано по исполнительным листам';uk='Утримано за виконавчими листами'"), Истина, "ЧЦ=15; ЧДЦ=2");
	УниверсальныйОтчет.ДобавитьПоказатель("ПочтовыйСбор", НСтр("ru='Почтовый сбор';uk='Поштовий збір'"), Истина, "ЧЦ=15; ЧДЦ=2");
