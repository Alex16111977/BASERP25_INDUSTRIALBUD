...
Процедура ПередЗаписью(Отказ)
	...
	Если АвтоПолучениеОтправкаСообщений Тогда
		...
		Иначе
			...
			КонецЕсли; 
			Если Отказ Тогда
				ОбщегоНазначения.СообщитьОбОшибке(НСтр("ru='У ответственного за автополучение/отправку нет прав на запись электронных писем.';uk='У відповідального за автоотримання/відправлення немає прав на запис електронних листів.'"),, СтрокаОшибки);
			КонецЕсли; 
		КонецЕсли; 
	КонецЕсли; 
