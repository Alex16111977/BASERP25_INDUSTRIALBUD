# -*- coding: utf-8 -*-
"""
Генерация XML-файлов обработки СинхронизироватьДеньги из исходника СинхронизироватьТовары.
Создаёт: описатель, Forms/Форма.xml, Forms/Форма/Ext/Form.xml.
ObjectModule.bsl и Form/Module.bsl пишутся вручную (см. план 2026-06-10-sinhronizirovat-dengi.md).
Источник — основная директория (истина Designer), выход — в указанный корень репо.
"""
import re
import sys
import uuid
