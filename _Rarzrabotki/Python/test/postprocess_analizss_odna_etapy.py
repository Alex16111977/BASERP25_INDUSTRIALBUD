# -*- coding: utf-8 -*-
# Пост-обробка Templates/МакетПланФактЕтапи/Ext/Template.xml (Фаза 15):
# звіт «Аналіз залишків для списання за СС з етапами» — колонки як analizss_odna + групування Этап.
# Інжект uk-заголовків (одна колонка «Одиниця виміру» + «Етап») + ru->uk для calc. UTF-8 БЕЗ BOM.
import sys
if sys.stdout.encoding != 'utf-8':
    sys.stdout.reconfigure(encoding='utf-8')

TEMPLATE = r"C:\Configuration_downloads\BASERP25\_Rarzrabotki\Обработки\Создания комплектаций для бух учета\Templates\МакетПланФактЕтапи\Ext\Template.xml"
