...
for f in ["ДниР", "ЧасыР", "ДниМ", "ЧасыМ", "ДниОфициальные", "ДниО", "ДниБ", "ДниС", "ДниК", "ДниН", "ДниВ", "ДниОшибка", "ЧасыПлан",
          "ДниКомандировкаЗУП", "ДниНеявкиЗУП", "ДниПрочиеЗУП", "ОтработаноДнейЗУП", "НормаДнейЗУП"]:
    TOTALS.append((f, {EMP: "Сумма(%s)" % f, ORG: "0", TOT: "Сумма(%s)" % f}))
TOTALS.append(("РДниЧасы", {EMP: "Максимум(РДниЧасы)", ORG: '""', TOT: 'Формат(Сумма(ДниР), "ЧДЦ=0; ЧГ=0") + " / " + Формат(Сумма(ЧасыР), "ЧДЦ=0; ЧГ=0")'}))
TOTALS.append(("МДниЧасы", {EMP: "Максимум(МДниЧасы)", ORG: '""', TOT: 'Формат(Сумма(ДниМ), "ЧДЦ=0; ЧГ=0") + " / " + Формат(Сумма(ЧасыМ), "ЧДЦ=0; ЧГ=0")'}))
TOTALS += [
...
MAIN_SHOW = ["ФИО", "ИНН", "ДатаПриема", "ДатаУвольнения", "РасхождениеДней", "Контроль",
             "КазнаДниЧасы", "РДниЧасы", "МДниЧасы", "ДниО", "ДниБ", "ДниС", "ДниК", "ДниН", "ДниВ",
             "ЗУПДниЧасы", "ДниОтпуск", "ДниБольничный", "ДниБезОплаты", "Начислено"]
