...
# Берём данные из уже существующего документа 0Ц-00000001 — там организация точно есть
rows = query(
    "ВЫБРАТЬ ПЕРВЫЕ 1 "
    "д.Организация.Наименование КАК НазвОрг, "
    "ПРЕДСТАВЛЕНИЕ(д.Организация) КАК ОргПредст "
...
# Також читаем данные документа 0Ц-00000002 напрямую
rows2 = query(
    "ВЫБРАТЬ "
    "д.Организация.Наименование КАК НазвОрг, "
    "д.Подразделение.Наименование КАК НазвПодр, "
