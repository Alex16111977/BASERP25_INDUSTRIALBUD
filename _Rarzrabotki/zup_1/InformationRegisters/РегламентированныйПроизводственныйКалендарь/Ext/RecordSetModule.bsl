...
Функция ПервоначальноеЗаполнениеРегистра(КонтрольнаяДата,Сообщать = Истина) Экспорт
	...
	Если Сообщать и СписокПраздниковВВыходные.Количество() > 0 Тогда
		...
		Сообщить(НСтр("ru='При заполнении календаря на ';uk='При заповненні календаря на '") + Формат(ЗаКакойГод,"ЧЦ=4; ЧГ=0") + " год обнаружены государственные праздники, попадающие на выходные дни:"); 
		...
		Сообщить(НСтр("ru='Необходимо перенести эти выходные дни на следующий после праздничного рабочий день.';uk='Необхідно перенести ці вихідні дні на наступні після святкового робочі дні.'"), СтатусСообщения.Внимание)
