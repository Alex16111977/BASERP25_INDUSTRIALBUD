...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	|	Призывники.НомерЗаписиВРеестреВоеннообязанных КАК НомерЗаписиВРеестреВоеннообязанных,
	...
	|           ВоинскийУчетСрезПоследних.НомерЗаписиВРеестреВоеннообязанных КАК НомерЗаписиВРеестреВоеннообязанных,
	...
	|		Призывники.НомерЗаписиВРеестреВоеннообязанных,
...
Процедура СформироватьОтчет(ДокументРезультат, ПоказыватьЗаголовок = Ложь, ВысотаЗаголовка = 0, ТолькоЗаголовок = Ложь) Экспорт
	...
	МакетОтчета = ПолучитьМакет("Макет2022");
	...
	Если ЗначениеЗаполнено(ФизЛицоОтветственного) Тогда
		...
		Если Выборка.Следующий() Тогда
			...
			ОбластьИзвещение.Параметры.ФИООтветственного		= ОбщегоНазначения.ИмяФамилияВФорматеДСТУ(ФизЛицоОтветственного);
		КонецЕсли;
	КонецЕсли;
