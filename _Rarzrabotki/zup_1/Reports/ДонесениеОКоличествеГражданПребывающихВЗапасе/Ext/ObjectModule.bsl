...
Процедура СформироватьОтчет(ДокументРезультат, ЕстьОшибки) Экспорт
	...
	ВидыЗанятости = Новый СписокЗначений;
	...
	Запрос.УстановитьПараметр("ВидЗанятостиОсновноеМестоРаботы", ВидыЗанятости);
	...
	ТекстОсновногоЗапроса ="ВЫБРАТЬ
				  ...
				  |	ИЗ
	              |		РегистрСведений.РаботникиОрганизаций.СрезПоследних(&ДатаАктуальности,Сотрудник.ВидЗанятости В (&ВидЗанятостиОсновноеМестоРаботы)) КАК РаботникиОрганизацииСрезПоследних
	              |	
	              |	ГДЕ
