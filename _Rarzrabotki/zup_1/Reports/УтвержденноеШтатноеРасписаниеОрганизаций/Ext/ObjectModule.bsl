			...
			Пока ВыборкаСтрокШтРасписания.Следующий() Цикл 
				...
				Если ВыборкаСтрокШтРасписания.РазмерНадбавки <> NULL Тогда
					...
					Если ВыборкаСтрокШтРасписания.СпособРасчета  = Перечисления.СпособыРасчетаОплатыТруда.Процентом Тогда
						РазмерНадбавки = "" + ?(ВыборкаСтрокШтРасписания.РазмерНадбавки = 0,"",ВыборкаСтрокШтРасписания.РазмерНадбавки)+?(ВыборкаСтрокШтРасписания.РазмерНадбавки = 0,"","%");
...
Процедура СформироватьОтчет(ДокументРезультат, Дописать = Ложь) Экспорт
	...
	|			ГДЕ
	|				ВЫБОР КОГДА НадбавкиПоШтатномуРасписаниюОрганизацииСрезПоследних.ВидНадбавки.СпособРасчета = ЗНАЧЕНИЕ(Перечисление.СпособыРасчетаОплатыТруда.ДоплатаЗаВечерниеЧасы)
    |               ИЛИ НадбавкиПоШтатномуРасписаниюОрганизацииСрезПоследних.ВидНадбавки.СпособРасчета = ЗНАЧЕНИЕ(Перечисление.СпособыРасчетаОплатыТруда.ДоплатаЗаНочныеЧасы)
    |          			ТОГДА НадбавкиПоШтатномуРасписаниюОрганизацииСрезПоследних.Показатель2
	|				ИНАЧЕ НадбавкиПоШтатномуРасписаниюОрганизацииСрезПоследних.Показатель1 
	|				КОНЕЦ > 0
    ...
    |               ИЛИ НадбавкиПоШтатномуРасписанию.ВидНадбавки.СпособРасчета = ЗНАЧЕНИЕ(Перечисление.СпособыРасчетаОплатыТруда.ДоплатаЗаНочныеЧасы)
    |          			ТОГДА НадбавкиПоШтатномуРасписанию.Показатель2
	|				ИНАЧЕ НадбавкиПоШтатномуРасписанию.Показатель1 
	|				КОНЕЦ > 0
	...
	КурсВалютыОтчета = МодульВалютногоУчета.ПолучитьКурсВалюты(Константы.ВалютаРегламентированногоУчета.Получить(),ДатаАктуальности).Курс;
