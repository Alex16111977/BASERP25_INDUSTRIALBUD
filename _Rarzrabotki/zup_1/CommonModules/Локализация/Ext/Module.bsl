...
Процедура ПроверитьПереводСхемыКомпоновкиДанных(СхемаКомпоновкиДанных, ИмяОтчета, ПерезаписатьСхему = Ложь) Экспорт
	...
	Для Каждого НаборДанных ИЗ СхемаКомпоновкиДанных.НаборыДанных Цикл
		Для Каждого Поле Из НаборДанных.Поля Цикл
			...
			Если ПустаяСтрока(Заголовок) Тогда
				...
				КонецЕсли; 
			Иначе
				НовыйЗаголовок = ЛокализацияПовтИсп.ПолучитьПереводТекста(Заголовок);
...
Процедура ПеревестиМакетКомпоновкиДанных(МакетКомпоновкиДанных, СтрокаОтбор = "", ОбрабатыватьСтрокуОтбора = Истина) Экспорт
		...
		Для Каждого СтрокаТаблицыОбластиКомпоновкиДанных Из ОписаниеМакетаОбластиМакетаКомпоновкиДанных.Макет Цикл
			Для Каждого ЯчейкаТаблицыОбластиКомпоновкиДанных Из СтрокаТаблицыОбластиКомпоновкиДанных.Ячейки Цикл
				Для Каждого ПолеОбластиКомпоновкиДанных Из ЯчейкаТаблицыОбластиКомпоновкиДанных.Элементы Цикл
					...
					// обычный перевод
					НовоеЗначениеПоля = ЛокализацияПовтИсп.ПолучитьПереводДляОтчетовНаСКД(ЗначениеПоля, ЯзыкФормированияПечатныхФормОтчетов);
					ПолеОбластиКомпоновкиДанных.Значение = НовоеЗначениеПоля;
