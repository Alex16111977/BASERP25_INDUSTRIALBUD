...
Процедура ВыполнитьОбновление() Экспорт
	...
	Если ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) =  "2.1.54"
		ИЛИ (ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) = "2.1.55" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
	...
	ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
	НоваяВерсияИБ = "2.1.56.1";
	
	Если ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) =  "2.1.55"
		ИЛИ (ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) = "2.1.56" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
		...
		Если Константы.НомерВерсииКонфигурации.Получить() = НоваяВерсияИБ Тогда
			...
			#Если Клиент Тогда
			ВывестиОписаниеИзменений("2156", ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
			#КонецЕсли
		КонецЕсли;
	...
	ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
	НоваяВерсияИБ = "2.1.57.1";
	
	Если ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) =  "2.1.56"
		ИЛИ (ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) = "2.1.57" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
		...
		Если Константы.НомерВерсииКонфигурации.Получить() = НоваяВерсияИБ Тогда
			...
			#Если Клиент Тогда
			ВывестиОписаниеИзменений("2157", ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
			#КонецЕсли
		КонецЕсли;
	...
	ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
	НоваяВерсияИБ = "2.1.58.2";
	
	Если ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) =  "2.1.57"
		ИЛИ (ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) = "2.1.58" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
		...
		Если Константы.НомерВерсииКонфигурации.Получить() = НоваяВерсияИБ Тогда
			...
			#Если Клиент Тогда
			ВывестиОписаниеИзменений("2158", ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
			#КонецЕсли
		КонецЕсли;
	...
	ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
	НоваяВерсияИБ = "2.1.59.1";
	
	Если ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) =  "2.1.58"
		ИЛИ (ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) = "2.1.59" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
		...
		Если Константы.НомерВерсииКонфигурации.Получить() = НоваяВерсияИБ Тогда
			...
			#Если Клиент Тогда
			ВывестиОписаниеИзменений("2159", ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
			#КонецЕсли
		КонецЕсли;
	...
	ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
	НоваяВерсияИБ = "2.1.60.1";
	
	Если ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) =  "2.1.59"
		ИЛИ (ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) = "2.1.60" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
		...
		Если Константы.НомерВерсииКонфигурации.Получить() = НоваяВерсияИБ Тогда
			...
			#Если Клиент Тогда
			ВывестиОписаниеИзменений("2160", ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
			#КонецЕсли
		КонецЕсли;
	...
	ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
	НоваяВерсияИБ = "2.1.61.1";
	
	Если ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) =  "2.1.60"
		ИЛИ (ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) = "2.1.61" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
		...
		Если Константы.НомерВерсииКонфигурации.Получить() = НоваяВерсияИБ Тогда
			...
			#Если Клиент Тогда
			ВывестиОписаниеИзменений("2161", ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
			#КонецЕсли
		КонецЕсли;
	...
	ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
	НоваяВерсияИБ = "2.1.62.1";
	
	Если ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) =  "2.1.61"
		ИЛИ (ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) = "2.1.62" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
		...
		Если Константы.НомерВерсииКонфигурации.Получить() = НоваяВерсияИБ Тогда
			...
			#Если Клиент Тогда
			ВывестиОписаниеИзменений("2162", ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
			#КонецЕсли
		КонецЕсли;
	...
	ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
	НоваяВерсияИБ = "2.1.63.1";
	
	Если ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) =  "2.1.62"
		ИЛИ (ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) = "2.1.63" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
		...
		Если Константы.НомерВерсииКонфигурации.Получить() = НоваяВерсияИБ Тогда
			...
			#Если Клиент Тогда
			ВывестиОписаниеИзменений("2163", ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
			#КонецЕсли
		КонецЕсли;
	...
	ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
	НоваяВерсияИБ = "2.1.64.1";
	
	Если ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) =  "2.1.63"
		ИЛИ (ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) = "2.1.64" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
		...
		Если Константы.НомерВерсииКонфигурации.Получить() = НоваяВерсияИБ Тогда
			...
			#Если Клиент Тогда
			ВывестиОписаниеИзменений("2164", ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
			#КонецЕсли
		КонецЕсли;
	...
	ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
	НоваяВерсияИБ = "2.1.65.1";
	
	Если ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) =  "2.1.64"
		ИЛИ (ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) = "2.1.65" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
		...
		НачальноеЗаполнение.ЗаполнитьПланВидовРасчета("ОсновныеНачисленияОрганизаций", Истина);
		//Ежемесячные обновления
		НачальноеЗаполнение.ЗаполнитьОбъект("РегистрСведений",  "ИндексИнфляции");
		...
		Если Константы.НомерВерсииКонфигурации.Получить() = НоваяВерсияИБ Тогда
			...
			#Если Клиент Тогда
			ВывестиОписаниеИзменений("2165", ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
			#КонецЕсли
		КонецЕсли;
	...
	ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
	НоваяВерсияИБ = "2.1.66.1";
	
	Если ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) =  "2.1.65"
		ИЛИ (ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) = "2.1.66" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
		...
		//Отпуск на время военного положения 
		НачальноеЗаполнение.ЗаполнитьОбъект("Справочник",  "ВидыОтпусков");
		НачальноеЗаполнение.ЗаполнитьПланВидовРасчета("ОсновныеНачисленияОрганизаций", Истина);
		...
		Если Константы.НомерВерсииКонфигурации.Получить() = НоваяВерсияИБ Тогда
			...
			#Если Клиент Тогда
			ВывестиОписаниеИзменений("2166", ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
			#КонецЕсли
		КонецЕсли;
	...
	ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
	НоваяВерсияИБ = "2.1.67.1";
	
	Если ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) =  "2.1.66"
		ИЛИ (ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) = "2.1.67" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
		...
		Если Константы.НомерВерсииКонфигурации.Получить() = НоваяВерсияИБ Тогда
			...
			#Если Клиент Тогда
			ВывестиОписаниеИзменений("2167", ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
			#КонецЕсли
		КонецЕсли;
	...
	ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
	НоваяВерсияИБ = "2.1.68.1";
	
	Если ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) =  "2.1.67"
		ИЛИ (ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) = "2.1.68" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
		...
		Если Константы.НомерВерсииКонфигурации.Получить() = НоваяВерсияИБ Тогда
			...
			#Если Клиент Тогда
			ВывестиОписаниеИзменений("2168", ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
			#КонецЕсли
		КонецЕсли;
	...
	ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
	НоваяВерсияИБ = "2.1.69.1";
	
	Если ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) =  "2.1.68"
		ИЛИ (ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) = "2.1.69" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
		...
		Если Константы.НомерВерсииКонфигурации.Получить() = НоваяВерсияИБ Тогда
			...
			#Если Клиент Тогда
			ВывестиОписаниеИзменений("2169", ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
			#КонецЕсли
		КонецЕсли;
	...
	ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
	НоваяВерсияИБ = "2.1.70.1";
	
	Если ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) =  "2.1.69"
		ИЛИ (ОбщегоНазначения.ПолучитьНомерРелиза(ТекущаяВерсияИБ) = "2.1.70" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
		...
		НачальноеЗаполнение.ЗаполнитьОбъект("РегистрСведений", "ТаблицаНевыходовПоВидамОтпусков");
		...
		Если Константы.НомерВерсииКонфигурации.Получить() = НоваяВерсияИБ Тогда
			...
			#Если Клиент Тогда
			ВывестиОписаниеИзменений("2170", ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
			#КонецЕсли
		КонецЕсли;
