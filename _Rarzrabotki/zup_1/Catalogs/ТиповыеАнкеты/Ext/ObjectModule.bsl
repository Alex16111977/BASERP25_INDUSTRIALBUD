...
Функция ПолучитьОтветы(Выборка, Тип, ФлагКолонки = Ложь)
	...
	Иначе
		...
		Иначе
			...
			Иначе
				Сообщить(НСтр("ru='Справочник ""';uk='Довідник ""'")+Объект.Синоним+НСтр("ru='"" не имеет ни одного элемента. Рекомендуется заполнить его и сформировать анкету еще раз.';uk='"" не має жодного елемента. Рекомендується заповнити його і сформувати анкету ще раз.'"));
			КонецЕсли;
