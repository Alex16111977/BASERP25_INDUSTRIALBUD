...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ПорядокУчетаВНАВУпрУчетеПоСтандартамМУ.Заголовок = НСтр("ru='Учет необоротных активов в управленческом учете';uk='Облік необоротних активів в управлінському обліку'");
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "" Тогда
		...
		Если Константы.РегламентированныйУчетВНА.Получить() Тогда
			ЗаголовокЭлемента = НСтр("ru='Учет необоротных активов в управленческом учете';uk='Облік необоротних активів в управлінському обліку'");
		Иначе
			ЗаголовокЭлемента = НСтр("ru='Учет необоротных активов';uk='Облік необоротних активів'");
		КонецЕсли; 
