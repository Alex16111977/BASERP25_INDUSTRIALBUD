...
Функция МассивТабличныхЧастей()
	...
	//-- Локализация
	//++ НЕ УТКА
	Массив.Добавить("ПланСчетовМеждународногоУчета");
	//-- НЕ УТКА
...
Процедура Все(Команда)
	...
	Для Каждого ТабличнаяЧасть Из Массив Цикл
		...
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(ЭтаФорма[ТабличнаяЧасть], 
						...
						Ложь);
		ПолеФормы = Элементы["ТолькоСПравилами" + ТабличнаяЧасть]; // ПолеФормы - 
		ПолеФормы.Заголовок = НСтр("ru='Показывать';uk='Показувати'");
...
Процедура БезПравил(Команда)
	...
	Для Каждого ТабличнаяЧасть Из Массив Цикл
		...
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(ЭтаФорма[ТабличнаяЧасть], 
						...
						Истина);
		ПолеФормы = Элементы["ТолькоСПравилами" + ТабличнаяЧасть]; // ПолеФормы - 
		ПолеФормы.Заголовок = НСтр("ru='Только без правил';uk='Тільки без правил'");
...
Процедура ТолькоСПравилами(Команда)
	...
	Для Каждого ТабличнаяЧасть Из Массив Цикл
		...
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(ЭтаФорма[ТабличнаяЧасть], 
						...
						Истина);
		ПолеФормы = Элементы["ТолькоСПравилами" + ТабличнаяЧасть]; // ПолеФормы - 
		ПолеФормы.Заголовок = НСтр("ru='Только с правилами';uk='Тільки з правилами'");
