...
Процедура ЗаполнитьФункциюВыработкаСотрудников(ВидыРабочихЦентров)
	...
	ПараметрыФункции.ЗаголовокФункции = НСтр("ru='Выработка сотрудников';uk='Виробіток співробітників'");
	ПараметрыФункции.ОписаниеФункции = НСтр("ru='Позволяет оформить выработку сотрудников по выполненным работам.';uk='Дозволяє оформити виробіток співробітників по виконаних роботах.'");
	ПараметрыФункции.ШаблонПоказатель2 = НСтр("ru='- оформить %1';uk='- оформити %1'");
	ПараметрыФункции.ШаблонОписаниеПоказатель2 = НСтр("ru='- необходимо оформить выработку по %1 видам работ';uk='- необхідно оформити виробіток за %1 видами робіт'");
...
Процедура ЗаполнитьФункциюВыпускПродукции(ВидыРабочихЦентров)
	...
	ПараметрыФункции.ЗаголовокФункции = НСтр("ru='Выпуск продукции';uk='Випуск продукції'");
	ПараметрыФункции.ОписаниеФункции = НСтр("ru='Позволяет оформить выпуск продукции.';uk='Дозволяє оформити випуск продукції.'");
	ПараметрыФункции.ШаблонПоказатель2 = НСтр("ru='- оформить %1';uk='- оформити %1'");
	ПараметрыФункции.ШаблонОписаниеПоказатель2 = НСтр("ru='- необходимо оформить выпуск по %1 маршрутным листам';uk='- необхідно оформити випуск за %1 маршрутними листами'");
	ПараметрыФункции.Показатель2 = Оформить;
...
Процедура ЗаполнитьФункциюВыполнениеОпераций()
	...
	ПараметрыФункции.ЗаголовокФункции = НСтр("ru='Выполнение операций';uk='Виконання операцій'");
	ПараметрыФункции.ОписаниеФункции = НСтр("ru='Позволяет отразить выполнение операций, ввести фактический расход материалов, выпуск изделий и выполнение работ, сформировать сменно-суточные задания.';uk='Дозволяє відобразити виконання операцій, ввести фактичне витрачання матеріалів, випуск виробів і виконання робіт, сформувати змінно-добові завдання.'");
	ПараметрыФункции.ШаблонПоказатель1 = НСтр("ru='- на сегодня %1';uk='- на сьогодні %1'");
	ПараметрыФункции.ШаблонПоказатель2 = НСтр("ru='- предстоит %1';uk='- передбачається %1'");
	ПараметрыФункции.ШаблонОписаниеПоказатель1 = НСтр("ru='- на сегодня запланировано %1 операций';uk='- на сьогодні заплановано %1 операцій'");
	ПараметрыФункции.ШаблонОписаниеПоказатель2 = НСтр("ru='- в последующие дни предстоит выполнить %1 операций';uk='- у наступні дні належить виконати %1 операцій'");
	ПараметрыФункции.ШаблонПустойПоказатель = НСтр("ru='- на сегодня нет задач';uk='- на сьогодні немає задач'");
...
Процедура ЗаполнитьФункциюВводДанныхОВыполнении(ВидыРабочихЦентров)
	...
	ПараметрыФункции.ЗаголовокФункции = НСтр("ru='Ввод данных о выполнении';uk='Введення даних про виконання'");
	ПараметрыФункции.ОписаниеФункции = НСтр("ru='Позволяет отметить выполнение маршрутных листов.';uk='Дозволяє відзначити виконання маршрутних листів.'");
	ПараметрыФункции.ШаблонПоказатель2 = НСтр("ru='- выполняется %1';uk='- виконується %1'");
	ПараметрыФункции.ШаблонОписаниеПоказатель2 = НСтр("ru='- выполняется %1 маршрутных листов';uk='- виконується %1 маршрутних листів'");
