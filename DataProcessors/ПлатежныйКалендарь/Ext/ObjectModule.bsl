...
Функция ОбластиПланирования() Экспорт
	...
	//++ НЕ УТ
	ЛизингВключать = (Лизинг И ИспользоватьЛизинг
		Или Не Лизинг И Не ИспользоватьЛизинг);
	//-- НЕ УТ
	...
	Если ЕстьОтборОбластей Тогда
		...
		//++ НЕ УТ
		Если Лизинг Тогда
			ОбластиПланирования.Добавить(Перечисления.ОбластиПланированияПлатежей.Лизинг);
		КонецЕсли;
		//-- НЕ УТ
	КонецЕсли;
