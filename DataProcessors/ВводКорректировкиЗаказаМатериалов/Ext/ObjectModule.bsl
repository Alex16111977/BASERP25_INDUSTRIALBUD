...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ШаблонСообщенияСклад = НСтр("ru='Не заполнена колонка ""Склад"" в строке %1 списка ""Материалы и работы"".';uk='Не заповнена колонка ""Склад"" в рядку %1 списку ""Матеріали і роботи"".'");
