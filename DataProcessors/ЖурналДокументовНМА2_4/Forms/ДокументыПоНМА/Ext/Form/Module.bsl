...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ОтборыФормыСписка") Тогда
		...
		Если КлючНастроек = "ПомощникПерехода" Тогда
			...
			АвтоЗаголовок = Ложь;
			Заголовок = НСтр("ru='Документы по НМА, созданные для перехода на учет необоротных активов версии 2.5';uk='Документи по НМА, які створені для переходу на облік необоротних активів версії 2.5'");
	...
	ИначеЕсли Параметры.Свойство("НематериальныйАктив") Тогда
		...
		АвтоЗаголовок = Ложь;
		Заголовок = СтрШаблон(НСтр("ru='Документы по нематериальному активу %1';uk='Документи по нематеріальному активу %1'"), Строка(ОтборНематериальныйАктив));
...
Функция ИнициализироватьХозяйственныеОперацииИДокументы(ХозяйственныеОперацииИДокументы, ОтборХозяйственныеОперации, ОтборТипыДокументов, КлючНазначенияИспользования, ДокументыКОформлению = Ложь)
	...
	Строка.ЗаголовокРабочегоМеста       = НСтр("ru='Принятие к учету НМА';uk='Прийняття до обліку НМА'");
	...
	Строка.ЗаголовокРабочегоМеста       = НСтр("ru='Перемещение НМА';uk='Переміщення НМА'");
	Строка.ДобавитьКнопкуСоздать        = Истина;
	...
	Строка.ЗаголовокРабочегоМеста       = НСтр("ru='Списание НМА';uk='Списання НМА'");
	Строка.ДобавитьКнопкуСоздать        = Истина;
	...
	Строка.ЗаголовокРабочегоМеста       = НСтр("ru='Подготовка к передаче НМА';uk='Підготовка до передачі НМА'");
	Строка.ДобавитьКнопкуСоздать        = Истина;
	...
	Строка.ЗаголовокРабочегоМеста       = НСтр("ru='Изменение параметров НМА';uk='Зміна параметрів НМА'");
	Строка.ДобавитьКнопкуСоздать        = Истина;
	...
	Строка.ЗаголовокРабочегоМеста       = НСтр("ru='Переоценка НМА';uk='Переоцінка НМА'");
	Строка.ДобавитьКнопкуСоздать        = Истина;
	...
	Строка.ЗаголовокРабочегоМеста       = НСтр("ru='Выработка НМА';uk='Виробіток НМА'");
	Строка.ДобавитьКнопкуСоздать        = Истина;
