...
Процедура ЗаписатьИЗакрыть(Команда)
	...
	Если Не ЗаписатьДанные(ТребуетсяРучноеЗаполнение) Тогда
		...
		ТекстСообщения = НСтр("ru='Ошибка создания производственной операции!';uk='Помилка створення виробничої операції!'");
...
Функция ЗаписатьДанные(ТребуетсяРучноеЗаполнение = Ложь)
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Выполнение операции';uk='Опрацювання операції'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
Процедура УстановитьЗаголовкиЭлементовФормы()
	...
	Если РежимРаботы = РежимРаботыСоздать() Тогда
		ТекстЗаголовок = НСтр("ru='Создать операцию';uk='Створити операцію'");
	ИначеЕсли РежимРаботы = РежимРаботыПринятьВРаботу() Тогда
	...
	Если РежимРаботы = РежимРаботыСоздать() Тогда
		ТекстЗаголовок = НСтр("ru='Ожидает создания';uk='Очікує створення'");
	Иначе
		ТекстЗаголовок = НСтр("ru='Можно выполнять';uk='Можна виконувати'");
	КонецЕсли;
