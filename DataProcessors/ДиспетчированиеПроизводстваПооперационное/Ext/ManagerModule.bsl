...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "СменноСуточноеЗадание") Тогда
		...
		ТабличныйДокумент = СформироватьСменноСуточноеЗадание(ПараметрыПечати, ОбъектыПечати, ПараметрыВывода);
...
Функция СформироватьСменноСуточноеЗадание(ПараметрыПечати, ОбъектыПечати, ПараметрыВывода)
	
	КодЯзыкаПечать = ПараметрыВывода.КодЯзыкаДляМногоязычныхПечатныхФорм;
	
	Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.ДиспетчированиеПроизводстваПооперационное.ПФ_MXL_СменноСуточноеЗадание", КодЯзыкаПечать);
	...
	Пока ВыборкаБригады.Следующий() Цикл
		...
		Пока ВыборкаДатыЗаданий.Следующий() Цикл
			...
			ОбластьЗаголовок.Параметры.ТекстЗаголовка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
																		НСтр("ru='Сменно-суточное задание на %1';uk='Змінно-добове завдання на %1'",КодЯзыкаПечать),
			...
			// Вывод данных.
			ВывестиДанныеЗадания(ТабличныйДокумент, ВыборкаДатыЗаданий, ОбластьШапка, Макет, КодЯзыкаПечать);
...
Процедура ВывестиДанныеЗадания(ТабличныйДокумент, ДанныеЗадания, ОбластьШапка, Макет, КодЯзыкаПечать)
