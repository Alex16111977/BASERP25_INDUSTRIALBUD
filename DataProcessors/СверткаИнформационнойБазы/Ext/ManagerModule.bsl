...
Функция ПолучитьИсходныеДанныеОбОграниченияхСвертки(ДатаСверткиИБ, ДляОтчета = Истина) Экспорт
	...
	|ПОМЕСТИТЬ ВыбытиеОС
	|ИЗ                                                                                              
	|	РегистрБухгалтерии.Хозрасчетный.Остатки(&ГраницаОст, Счет В ИЕРАРХИИ (ЗНАЧЕНИЕ(ПланСчетов.Хозрасчетный.НеоборотныеАктивыИГруппыВыбытияУдерживаемыеДляПродажи))) КАК ХозрасчетныйОстатки
	|ГДЕ
	...
	ДобавитьВозможноеОграничение(ВозможныеОграничения,"ВА22",
							НСтр("ru='Учет необоротных активов версии 2.1';uk='Облік необоротних активів версії 2.1'"),
							НСтр("ru='Данные будут потеряны. Не рекомендуется выполнять свертку';uk='Дані будуть втрачені. Не рекомендується виконувати згортку'"));
	ДобавитьВозможноеОграничение(ВозможныеОграничения,"ВыбытиеОС",
							НСтр("ru='Выбывающие ОС (счет 286)';uk='ОЗ що вибувають (рахунок 286)'"),
							НСтр("ru='Данные будут потеряны. Не рекомендуется выполнять свертку';uk='Дані будуть втрачені. Не рекомендується виконувати згортку'"));


	ДобавитьВозможноеОграничение(ВозможныеОграничения,"ВзаиморасчетыСКонтрагентамиАкционерами",
							НСтр("ru='Взаиморасчеты с контрагентами акционерами';uk='Взаєморозрахунки з контрагентами акціонерами'"),
							НСтр("ru='Данные будут потеряны. Не рекомендуется выполнять свертку';uk='Дані будуть втрачені. Не рекомендується виконувати згортку'"));
	ДобавитьВозможноеОграничение(ВозможныеОграничения,"ПартииНЗП",
							НСтр("ru='Партии незавершенного производства';uk='Партії незавершеного виробництва'"),
							НСтр("ru='Данные будут потеряны. Не рекомендуется выполнять свертку';uk='Дані будуть втрачені. Не рекомендується виконувати згортку'"));

	ДобавитьВозможноеОграничение(ВозможныеОграничения,"РаспоряженияНормативы",
								НСтр("ru='Не оформлены списания по нормативам';uk='Не оформлено списання за нормативами'"),
								НСтр("ru='Перед сверткой оформить списание по нормативам';uk='Перед сверткой оформити списання за нормативами'"));
								
	//-- НЕ УТ
	//++ НЕ УТКА
	ДобавитьВозможноеОграничение(ВозможныеОграничения,"РаспоряженияИзПроизводства",
								НСтр("ru='Не оформлена передача из производства по распоряжениям';uk='Не оформлена передача з виробництва за розпорядженнями'"),
								НСтр("ru='Перед сверткой оформить передачу из производства';uk='Перед сверткой оформити передачу з виробництва'"));
	ДобавитьВозможноеОграничение(ВозможныеОграничения,"БракВПроизводстве",
							НСтр("ru='Брак в производстве';uk='Брак у виробництві'"),
							НСтр("ru='Данные будут потеряны. Не рекомендуется выполнять свертку';uk='Дані будуть втрачені. Не рекомендується виконувати згортку'"));

	ДобавитьВозможноеОграничение(ВозможныеОграничения,"РаспоряженияВыпуск",
								НСтр("ru='Не оформлен выпуск продукции по распоряжениям';uk='Не оформлений випуск продукції за розпорядженнями'"),
								НСтр("ru='Перед сверткой оформить выпуск продукции по распоряжениям';uk='Перед сверткой оформити випуск продукції за розпорядженнями'"));
	//-- НЕ УТКА
