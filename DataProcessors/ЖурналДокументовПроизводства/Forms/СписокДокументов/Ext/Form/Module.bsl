...
Процедура СписокДокументыПроизводстваПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	...
	Если Элементы.ГруппаСоздатьГенерируемая.ПодчиненныеЭлементы.Количество() <> 0 Тогда 
		Если Копирование Тогда
			...
			Иначе
				ТекстСообщения = НСтр("ru='Копирование документов ""Распределение материалов и работ"", ""Распределение расходов на себестоимость продукции"", ""Этап производства"" не допускается.';uk='Копіювання документів ""Розподіл матеріалів і робіт"", ""Розподіл витрат на собівартість продукції"", ""Етап виробництва"" не допускається.'");
...
Функция ОписаниеОперацийИТиповДокументов()
	...
	Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Акты выполненных внутренних работ';uk='Акти виконаних внутрішніх робіт'");
	...
	СвойстваПоУмолчанию.ЗаголовокРабочегоМеста                = НСтр("ru='Движение продукции и материалов';uk='Рух продукції і матеріалів'");
	...
	Строка.КлючНазначенияИспользования	= "ДокументыПроизводства";
	Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Производство без заказа';uk='Виробництво без замовлення'");
	...
	Строка.ХозяйственнаяОперация		= Перечисления.ХозяйственныеОперации.ВыпускПродукции;
	Строка.КлючНазначенияИспользования	= "ДокументыПроизводства";
	Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Распределение возвратных отходов';uk='Розподіл зворотних відходів'");
	...
	Строка.ХозяйственнаяОперация				= Перечисления.ХозяйственныеОперации.СписаниеРасходовНаПартииПроизводства;
	Строка.КлючНазначенияИспользования			= "ДокументыПроизводства";
	Строка.ЗаголовокРабочегоМеста				= НСтр("ru='Распределение материалов и работ';uk='Розподіл матеріалів і робіт'");
	...
	Строка.ХозяйственнаяОперация		= Перечисления.ХозяйственныеОперации.СписаниеРасходовНаПартииПроизводства;
	Строка.КлючНазначенияИспользования	= "ДокументыПроизводства";
	Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Распределение прочих расходов';uk='Розподіл інших витрат'");
	...
	Строка.ХозяйственнаяОперация		= Перечисления.ХозяйственныеОперации.ВыпускПродукции;
	Строка.КлючНазначенияИспользования	= "ДокументыПроизводства";
	Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Этапы производства';uk='Етапи виробництва'");
	...
	Строка.КлючНазначенияИспользования			= "ДокументыПроизводства";
	Строка.ЗаголовокРабочегоМеста				= НСтр("ru='Выработка сотрудников';uk='Виробіток співробітників'");
...
Процедура НастроитьФормуПоВыбраннымОперациямИДокументам(ТЗХозОперацииИТипыДокументов)
	...
	ДанныеРабочегоМеста = ОбщегоНазначенияУТ.ДанныеРабочегоМеста(ТЗХозОперацииИТипыДокументов,
		КлючНазначенияФормыПоУмолчанию(), НСтр("ru='Документы производства (все)';uk='Документи виробництва (всі)'"));
