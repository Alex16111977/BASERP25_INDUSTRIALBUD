...
Функция МассивДокументов(МассивВыделенныхСтрок)
	...
	Если ЕстьОшибкаПереотраженияДокументовОСНМА Тогда
		ПоказатьПредупреждение(,
			НСтр("ru='Документы учета необоротных активов отражаются в международном учете при проведении';uk='Документи обліку необоротних активів відображаються у міжнародному обліку під час проведення'"));
	КонецЕсли;
