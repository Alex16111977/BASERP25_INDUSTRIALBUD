...
Процедура НастроитьШаблоныПроводок(Команда)
	...
	ДействующаяУчетнаяПолитика = ДействующаяУчетнаяПолитика();
	МеждународныйУчетПоДаннымОперативногоУчетаКлиент.ОткрытьНастройкуШаблоновПроводок(ДействующаяУчетнаяПолитика.УчетнаяПолитика, Неопределено, ЭтаФорма);
...
Процедура НастроитьСоответствиеСчетовИОборотов(Команда)
	...
	ДействующаяУчетнаяПолитика = ДействующаяУчетнаяПолитика();
	МеждународныйУчетПоДаннымРеглУчетаКлиент.ОткрытьНастройкуСоответствияСчетовИОборотов(ДействующаяУчетнаяПолитика.УчетнаяПолитика, Неопределено, ЭтаФорма);
