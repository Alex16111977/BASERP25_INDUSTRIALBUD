...
// 
// Параметры:
// 	МассивСтрок - Массив из СправочникСсылка.НастройкиХозяйственныхОпераций - Описание
// 	УчетнаяПолитика - СправочникСсылка.УчетныеПолитики - Описание
// 	ОтражатьВМеждународномУчете - Булево - Описание
