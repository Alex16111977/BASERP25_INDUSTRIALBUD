...
Процедура ЗаписатьДокумент(ДокОбъект, СообщенияОбОшибках)
	...
	Если ДокОбъект.ПроверитьЗаполнение() Тогда
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(НСтр("ru='Создание заказов на передачу в производство';uk='Створення замовлень на передачу у виробництво'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
