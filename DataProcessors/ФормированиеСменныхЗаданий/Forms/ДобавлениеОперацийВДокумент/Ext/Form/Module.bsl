...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ Параметры.СменноеЗадание.Пустая() Тогда
		...
		Заголовок = СтрШаблон(
			?(РежимПодбора, НСтр("ru='Подбор операций в %1';uk='Підбір операцій в %1'"), НСтр("ru='Добавление операции в %1';uk='Додавання операції в %1'")),
	...
	Иначе
		...
		Заголовок = ?(РежимПодбора, НСтр("ru='Подбор операций';uk='Підбір операцій'"), НСтр("ru='Добавление операции';uk='Додавання операції'"));
...
Процедура КомандаПеренестиВДокумент(Команда)
	...
	Если НЕ РежимПодбора Тогда
		...
		Если ТекущаяСтрока = Неопределено Тогда
			...
			ПоказатьПредупреждение(, НСтр("ru='Не выбрана операция';uk='Не вибрана операція'"));
			Возврат;
...
Функция ПеренестиВДокументВФоне()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания =
		НСтр("ru='Подбор операций в сменное задание';uk='Підбір операцій в змінне завдання'");
