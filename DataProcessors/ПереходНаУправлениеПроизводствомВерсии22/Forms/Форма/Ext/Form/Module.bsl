...
Процедура ОбновитьКоманды(Форма, КоличествоОбъектов = Неопределено)
	...
	Количество = 0;
	ТекстЗаголовка = НСтр("ru='Выполняющиеся заказы на производство';uk='Виконуються замовлення на виробництво'");
	...
	Количество = 0;
	ТекстЗаголовка = НСтр("ru='Заказы материалов в производство ожидающие исполнения';uk='Замовлення матеріалів у виробництво очікують виконання'");
	Если ПредыдущиеШагиВыполненны
		И КоличествоОбъектов <> Неопределено
	...
	Количество = 0;
	ТекстЗаголовка = НСтр("ru='Распоряжения на оформление выпуска продукции';uk='Розпорядження на оформлення випуску продукції'");
	Если ПредыдущиеШагиВыполненны
		И КоличествоОбъектов <> Неопределено
	...
	Количество = 0;
	ТекстЗаголовка = НСтр("ru='Выпуски требующие списания затрат';uk='Випуски, що потребують списання витрат'");
	Если ПредыдущиеШагиВыполненны
		И КоличествоОбъектов <> Неопределено
