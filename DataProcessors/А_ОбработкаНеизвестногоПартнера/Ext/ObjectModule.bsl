...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование", "Поиск и замена ссылок на НеизвестныйПартнер в документах"); //имя под которым обработка будет зарегестрирована в справочнике внешних обработок
	...
	ТаблицаКоманд = ПолучитьТаблицуКоманд();
	 ...
	 ДобавитьКоманду(ТаблицаКоманд,
        НСтр("ru = 'Поиск и замена ссылок на НеизвестныйПартнер в документах'"),
        "Форма",
        "ОткрытиеФормы",
        Истина,
        "");
