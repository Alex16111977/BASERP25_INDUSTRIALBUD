...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	Если НЕ УчетДоступности Тогда
		...
		ТекстСообщения = СтрШаблон(
			НСтр("ru='Для вида рабочего центра ""%1"" не ведется учет доступности: не учитывается ограничение доступности в графике производства и не планируется работа рабочих центров.';uk='Для виду робочого центру ""%1"" не ведеться облік доступності: не враховується обмеження доступності в графіку виробництва і не планується робота робочих центрів.'"),
