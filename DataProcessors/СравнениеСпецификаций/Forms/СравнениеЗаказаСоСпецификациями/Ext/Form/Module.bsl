...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для каждого ЭлКоллекции Из Параметры.ДанныеЗаказа Цикл
		ЗначениеЭлемента = ЭлКоллекции.Значение; // см. АналогиМатериалов.СлужебнаяСтруктураСтруктуры
	...
	Для каждого ЭлКоллекции Из СписокСтрокЗаказа Цикл
		ДанныеЗаказа = Параметры.ДанныеЗаказа.Получить(ЭлКоллекции.Значение); // см. АналогиМатериалов.СлужебнаяСтруктураСтруктуры
