...
Процедура Планировать(Команда)
	...
	Иначе
		...
		ТекстСообщения = НСтр("ru='Необходимо выбрать хотя бы один из вариантов планирования (""Планировать график"" и/или ""Планировать модель"")';uk='Необхідно вибрати хоча б один з варіантів планування ( ""Планувати графік"" і / або ""Планувати модель"")'");
...
Процедура ЗаполнитьПодсказкуПланироватьГрафик(НастройкиПроизводства)
	...
	Если НастройкиПроизводства.ИспользуетсяПланированиеПоПроизводственнымРесурсам
		...
		Элементы.ПланироватьГрафик.Подсказка = 
			НСтр("ru='При планировании учитываются ограничения по материалам и оборудованию.';uk='При плануванні враховуються обмеження по матеріалах та устаткуванню.'");
		
	ИначеЕсли НастройкиПроизводства.ИспользуетсяПланированиеПоПроизводственнымРесурсам Тогда
		
		Элементы.ПланироватьГрафик.Подсказка = 
			НСтр("ru='При планировании учитываются ограничения по оборудованию.';uk='При плануванні враховуються обмеження по устаткуванню.'");
		
	ИначеЕсли НастройкиПроизводства.ИспользуетсяПланированиеПоМатериальнымРесурсам Тогда
		
		Элементы.ПланироватьГрафик.Подсказка = 
			НСтр("ru='При планировании учитываются ограничения по материалам.';uk='При плануванні враховуються обмеження по матеріалах.'");
