...
Процедура УстановитьСтатусВозвратыКВозврату(Команда)
	...
	УстановитьСтатусДокументовПроизводства("КВозврату", Тип("ДокументСсылка.ВозвратМатериаловИзПроизводства"), НСтр("ru='К возврату';uk='До повернення'"));
...
Процедура УстановитьСтатусВозвратыПринято(Команда)
	...
	УстановитьСтатусДокументовПроизводства("Принято", Тип("ДокументСсылка.ВозвратМатериаловИзПроизводства"), НСтр("ru='Принято';uk='Прийнято'"));
...
Процедура УстановитьСтатусПередачиОтгружено(Команда)
	...
	УстановитьСтатусДокументовПроизводства("Отгружено", Тип("ДокументСсылка.ПередачаМатериаловВПроизводство"), НСтр("ru='Отгружено';uk='Відвантажено'"));
...
Процедура УстановитьСтатусПередачиПринято(Команда)
	...
	УстановитьСтатусДокументовПроизводства("Принято", Тип("ДокументСсылка.ПередачаМатериаловВПроизводство"), НСтр("ru='Принято';uk='Прийнято'"));
...
Процедура УстановитьСтатусПеремещенияКОтгрузке(Команда)
	...
	УстановитьСтатусДокументовПроизводства("КОтгрузке", Тип("ДокументСсылка.ПеремещениеМатериаловВПроизводстве"), НСтр("ru='К отгрузке';uk='До відвантаження'"));
...
Процедура УстановитьСтатусПеремещенияОтгружено(Команда)
	...
	УстановитьСтатусДокументовПроизводства("Отгружено", Тип("ДокументСсылка.ПеремещениеМатериаловВПроизводстве"), НСтр("ru='Отгружено';uk='Відвантажено'"));
...
Процедура УстановитьСтатусПеремещенияПринято(Команда)
	...
	УстановитьСтатусДокументовПроизводства("Принято", Тип("ДокументСсылка.ПеремещениеМатериаловВПроизводстве"), НСтр("ru='Принято';uk='Прийнято'"));
