...
// 
// Параметры:
// 	Объект - ОбработкаОбъект.РедактированиеЭтаповПроизводства - объект
// 	Форма - ФормаКлиентскогоПриложения - форма
// 	Операция - Строка - операция
// 	ДанныеЗаполнения - Структура - данные заполнения
// 	ПараметрыРедактированияЭтапа - см. УправлениеПроизводством.ПараметрыРедактированияЭтапа, Неопределено
// 	ПараметрыУказанияСерий - см. НоменклатураСервер.ПараметрыУказанияСерий, Неопределено
// Возвращаемое значение:
// 	Структура - см. УправлениеПроизводством.ЗаполнитьВариантОбеспеченияЭтапа
//
Функция ЗаполнитьВариантОбеспечения(Объект, Форма, Операция, ДанныеЗаполнения, ПараметрыРедактированияЭтапа = Неопределено, ПараметрыУказанияСерий = Неопределено) Экспорт
	...
	Результат =
		УправлениеПроизводством.ЗаполнитьВариантОбеспеченияЭтапа(
		Объект,
		Форма,
		Операция,
		ДанныеЗаполнения,
