...
Процедура УстановитьСписокВыбораВариантаИспользованияЛимитов()
	...
	ПредставлениеЗначения = НСтр("ru='По данным бюджетирования';uk='За даними бюджетування'");
...
|;uk='При перевищенні ліміту або якщо заявка не змінює жодну зі статей бюджетів забороняється проведення 
|заявок на витрачання коштів в будь-яких статусах. Ліміти задаються документом ""Примірник бюджетів"" за статтями, 
|вказаними в правилах лімітів в моделі бюджетування.'");
	//-- НЕ УТ
	КонецЕсли;
