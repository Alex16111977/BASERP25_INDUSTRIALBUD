...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++ НЕ УТ
	НаборыПодсказка = НСтр("ru='Возможность объединения номенклатурных позиций в комплекты с целью удобного подбора комплектующих в ресурсные спецификации, документы продажи, назначения общей цены на комплект и вывода в печатных формах комплекта и комплектующих. Для настройки необходимо включить ""Множество видов номенклатуры"".';uk='Можливість об''єднання номенклатурних позицій в комплекти з метою зручного підбору комплектуючих в ресурсні специфікації, документи продажу, призначення загальною ціни на комплект і виведення в друкованих формах комплекту і комплектуючих. Для встановлення необхідно включити ""Кілька видів номенклатури"".'");
