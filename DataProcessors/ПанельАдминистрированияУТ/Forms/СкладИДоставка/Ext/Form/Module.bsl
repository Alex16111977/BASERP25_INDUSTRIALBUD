...
|;uk='Цей функціонал доступний, якщо використовується управління виробництвом (розділ ""НДІ і адміністрування"" - ""Виробництво"") 
|або дозволено використання хоча б однієї з таких видів документів: 
|- Замовлення постачальникам (розділ ""НДІ і адміністрування"" - ""Купівлі"") 
|- Замовлення на збирання (розділ ""НДІ і адміністрування"" - ""Склад і доставка"") 
