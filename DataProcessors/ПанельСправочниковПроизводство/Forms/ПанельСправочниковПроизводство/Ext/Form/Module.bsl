...
Процедура ОткрытьПричиныЗадержкиВыполненияЭтаповПроизводства(Команда)
	...
	//-- НЕ УТКА
	Возврат; // в BASКУП не используется
...
//++ НЕ УТКА
	...
	//
	ПравоПричиныОтменыПроизводства = ПравоДоступа("Просмотр", Метаданные.Справочники.ПричиныОтменыПроизводства);
	Элементы.ГруппаПричиныОтменыПроизводства.Видимость = ПравоПричиныОтменыПроизводства;
...
//++ НЕ УТКА
		И (ПравоПричиныЗадержкиВыполненияЭтаповПроизводства
			...
			ИЛИ ПравоПричиныОтменыПроизводства
			ИЛИ ПравоМоделиПооперационногоПланирования
			ИЛИ ПравоСценарииПооперационногоПланирования)
//-- НЕ УТКА
			;
