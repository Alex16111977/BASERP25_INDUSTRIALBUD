...
Функция СписокМетаданных(Аргументы)
	...
	Для Каждого Элемент Из КоллекцияМД Цикл
		...
		// Формируем структуру объекта для JSON
		СтруктураОбъекта = Новый Структура;
		СтруктураОбъекта.Вставить("name", Элемент.Имя);
		СтруктураОбъекта.Вставить("synonym", Элемент.Синоним);
		СтруктураОбъекта.Вставить("fullName", Элемент.ПолноеИмя());
	...
	РезультатСтруктура.Вставить("count", Счетчик);
	РезультатСтруктура.Вставить("objects", МассивОбъектов);
