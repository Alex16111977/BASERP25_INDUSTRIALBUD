...
Процедура РаспоряжениеПриИзменении(Элемент)
	...
	ОтображениеСостояния.Текст = НСтр("ru='Данные неактуальны. Нажмите ""Обновить"" для получения данных.';uk='Дані неактуальні. Натисніть ""Оновити"" для отримання даних.'");
...
Процедура ОбновитьДанныеНаСервере()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания =
		НСтр("ru='Заполнение списка этапов для переноса желаемых дат обеспечения этапов';uk='Заповнення списку етапів для перенесення бажаних дат забезпечення етапів'");
...
Процедура ПеренестиДатыОбеспеченияНаСервере()
	...
	ПараметрыВыполнения = ДлительныеОперации.ПараметрыВыполненияВФоне(УникальныйИдентификатор);
	ПараметрыВыполнения.НаименованиеФоновогоЗадания =
		НСтр("ru='Переноса желаемых дат обеспечения этапов';uk='Перенесення бажаних дат забезпечення етапів'");
		...
		Если ТипЗнч(ДанныеЗаполнения) = Тип("Структура") Тогда
			...
			Если КоличествоОбработанных > 0 Тогда
				...
				Форма.ТекстСообщения = СтрШаблон(
					НСтр("ru='Обработано %1 из %2 документов';uk='Опрацьовано %1 з %2 документів'"),
					ДанныеЗаполнения.КоличествоОбработанных,
					ДанныеЗаполнения.КоличествоВсего);
				
				Форма.ТекстЗаголовка = НСтр("ru='Даты обеспечения изменены';uk='Дати забезпечення змінені'");
				
			Иначе
				
				Форма.ТекстСообщения = НСтр("ru='Отсутствуют документы для обработки';uk='Відсутні документи для обробки'");
				Форма.ТекстЗаголовка = НСтр("ru='Даты обеспечения не изменены';uk='Дати забезпечення не змінені'");
