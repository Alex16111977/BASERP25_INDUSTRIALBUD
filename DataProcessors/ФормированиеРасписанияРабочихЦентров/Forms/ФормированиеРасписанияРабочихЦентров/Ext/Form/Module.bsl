...
Процедура СохранитьРасписаниеРабочегоЦентра(СписокСтрок)
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Не удалось сохранить расписание';uk='Неможливо зберегти розклад'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
			УровеньЖурналаРегистрации.Ошибка,
			,
			,
			ПодробноеПредставлениеОшибки(ИнформацияОбОшибке));
		
		ТекстСообщения = НСтр("ru='Не удалось сохранить расписание по причине: %1';uk='Не вдалося зберегти розклад з причини: %1'");
