...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
		...
		ПравоДоступа("Просмотр", Метаданные.Документы.ПоступлениеСырьяОтДавальца));
	//-- НЕ УТКА
...
Процедура УстановитьТекстЗапросаПринятаяТара()
	...
	//++ НЕ УТКА
	|			ИЛИ &ПоступлениеСырьяДоступно
	|				И ТИПЗНАЧЕНИЯ(ДокументПоступления) = ТИП(Документ.ПоступлениеСырьяОтДавальца)
	//-- НЕ УТКА
