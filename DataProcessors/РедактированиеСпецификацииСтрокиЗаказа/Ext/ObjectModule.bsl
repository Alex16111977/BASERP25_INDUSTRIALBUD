...
Процедура ПроверитьЗаполнениеМатериалыИУслуги(МассивНепроверяемыхРеквизитов, Отказ)
	...
	Если НЕ ПроверкаСтрокаМатериалыИУслуги.Пустой() Тогда
		...
		СписокШаблоновПолей.Вставить("Склад", НСтр("ru='Не указан склад получения материалов в строке %1 списка ""Материалы и работы""';uk='Не зазначений склад одержання матеріалів у рядку %1 списку ""Матеріали і роботи""'"));
		СписокШаблоновПолей.Вставить("СпецификацияПолуфабриката", НСтр("ru='Не указана спецификация полуфабриката в строке %1 списка ""Материалы и работы""';uk='Не зазначена специфікація напівфабрикату в рядку %1 списку ""Матеріали і роботи""'"));
		СписокШаблоновПолей.Вставить("ЭтапВыпускаПолуфабриката", НСтр("ru='Не указан этап выпуска полуфабриката в строке %1 списка ""Материалы и работы""';uk='Не зазначений етап випуску напівфабрикату в рядку %1 списку ""Матеріали і роботи""'"));
		СписокШаблоновПолей.Вставить("ДатаПотребности", НСтр("ru='Не указана дата потребности в строке %1 списка ""Материалы и работы""';uk='Не зазначена дата потреби в рядку %1 списку ""Матеріали і роботи""'"));
		СписокШаблоновПолей.Вставить("СтатьяКалькуляции", НСтр("ru='Не указана статья калькуляции в строке %1 списка ""Материалы и работы""';uk='Не вказана стаття калькуляції в рядку %1 списку ""Матеріали і роботи""'"));
