...
Функция ОписаниеОперацийИТиповДокументов(ТЗХозОперацииИТипыДокументов) Экспорт
	...
	Если ИспользоватьПроизводство Тогда
		...
		Строка.КлючНазначенияИспользования	= "";
		Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Внутренние документы (передачи материалов в производство)';uk='Внутрішні документи (передачі матеріалів у виробництво)'");
		...
		Строка.КлючНазначенияИспользования	= "";
		Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Внутренние документы (возвраты материалов из производства)';uk='Внутрішні документи (повернення матеріалів з виробництва)'");
		...
		Строка.КлючНазначенияИспользования	= "";
		Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Внутренние документы (выпуски продукции)';uk='Внутрішні документи (випуски продукції)'");
