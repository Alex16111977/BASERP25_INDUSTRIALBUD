...
//	#КонецОбласти
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='<Банк не указан>';uk='<Банк не вказано>'"));
	#КонецОбласти
...
Процедура ЗаполнитьНаСервере()
	...
	Запрос.УстановитьПараметр("НДФЛ", Перечисления.ТипыНалогов.НДФЛ);
...
Функция ПолучитьВедомости(ВидДокумента)
	...
	Если ГруппыВедомостей.Количество() > 1 Тогда
		ТекстСообщения = НСтр("ru='Для формирования документа укажите ведомости одной группы.';uk='Для формування документа вкажіть відомості однієї групи.'");
