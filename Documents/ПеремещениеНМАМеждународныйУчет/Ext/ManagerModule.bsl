...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка)
	...
	Если ОшибкиШаблоновПроводок <> Неопределено Тогда
		...
		ВызватьИсключение НСтр("ru='Требуется настроить счета расходов амортизации в шаблоне проводок для операции ""Амортизация необоротных активов""';uk='Потрібно настроїти рахунки витрат амортизації у шаблоні проводок для операції ""Амортизація необоротних активів""'");
	КонецЕсли;
