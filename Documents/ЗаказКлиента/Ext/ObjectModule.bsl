...
//***ERP
Процедура ОбновитьЗаказКлиентаНаПослеОбмена(Док) Экспорт
	...
	Док.Приоритет = Справочники.Приоритеты.НайтиПоНаименованию("Середній");
	...
	Для каждого СтрокаИсточник Из Док.А_Товары Цикл
		...
		СтрокаТовары.ДатаОтгрузки = Док.Дата;
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	//***ERP
	ОбновитьЗаказКлиентаНаПослеОбмена(ЭтотОбъект); 
	//***ERP
