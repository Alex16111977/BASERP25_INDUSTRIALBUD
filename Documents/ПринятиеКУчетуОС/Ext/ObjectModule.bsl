...
Процедура А_ОбновитьПринятиеКУчетуОСПослеОбмена() Экспорт
	...
	СтатьяРасходов = ПланыВидовХарактеристик.СтатьиРасходов.НайтиПоКоду("0Ц-000038"); //Амортизація ОЗ
	НачислятьАмортизациюБУ = Истина;
	НачислятьАмортизациюНУ = Истина;
	Подразделение   = А_Склад.Подразделение;
	Местонахождение = А_Склад.Подразделение;
	//Если СчетУчета = ПланыСчетов.Хозрасчетный.МалоценныеНеоборотныеМатериальныеАктивыИндивидуально Тогда
	//	МетодНачисленияАмортизацииБУ = Перечисления.СпособыНачисленияАмортизацииОС._100;
	//	СпособНачисленияАмортизацииНУ= Перечисления.СпособыНачисленияАмортизацииОС._100;
	//Иначе	
	...
	//	СрокИспользованияБУ = 1;
	//	СрокИспользованияНУ = 1;
	//КонецЕсли;
	МетодНачисленияАмортизацииБУ = Перечисления.СпособыНачисленияАмортизацииОС._100;
	СпособНачисленияАмортизацииНУ= Перечисления.СпособыНачисленияАмортизацииОС._100;
	А_Обработан = Истина;
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
		...
		//***ERP
	А_ОбновитьПринятиеКУчетуОСПослеОбмена(); 
	//***ERP
