...
Функция ДанныеДокументаДляПроведения(Документ, Регистры, ДопПараметры = Неопределено) Экспорт
	...
	СформироватьТаблицаЗначенияНефинансовыхПоказателей(ТаблицыДляДвижений, Документ, Регистры);
...
Функция ТипКолонки(Измерение)
	...
	Иначе
		ТекстИсключения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Неверный шаблон: неизвестное измерение ""%1""';uk='Невірний шаблон: невідомий вимір ""%1""'"),
	...
	Для НомерАналитики = 1 По МаксимальноеКоличествоАналитик Цикл
		...
		ТекстНомераАналитики = ТекстНомераАналитики + ?(ТекстНомераАналитики = "", "", Символы.ПС)
			+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				...
				НомерАналитики);
	КонецЦикла;
	ТекстНомераАналитики = "ВЫБОР" + Символы.ПС + ТекстНомераАналитики + "
	|				КОНЕЦ";
...
Процедура СформироватьТаблицаЗначенияНефинансовыхПоказателей(ТаблицыДляДвижений, Документ, Регистры)
	...
	ТаблицыДляДвижений.Вставить("Таблица" + ИмяРегистра, ТаблицаПроведения);
