...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ Параметры.Свойство("НефинансовыйПоказатель", НефинансовыйПоказатель) Тогда
		ТекстСообщения = НСтр("ru='Непосредственное открытие этой формы не предусмотрено. Для открытия формы можно воспользоваться командой ""История изменений"" в форме нефинансового показателя.';uk='Безпосереднє відкриття цієї форми не передбачено. Для відкриття форми можна скористатися командою ""Історія змін"" в формі нефінансового показника.'");
