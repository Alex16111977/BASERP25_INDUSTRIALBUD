...
Функция ТекстЗапросаВТКурсыВалютУпр(Запрос, ТекстыЗапроса)
	...
	// Виправлено: додано ОБЪЕДИНИТЬ ВСЕ з записом для валюти упр. обліку з коефіцієнтом = 1,
	// щоб забезпечити коректний перерахунок сум для національної валюти (грн),
	// яка може не мати запису в регістрі КурсыВалют
	ТекстЗапроса =
	"ВЫБРАТЬ
...
Функция ТекстЗапросаВТКурсыВалютРегл(Запрос, ТекстыЗапроса)
	...
	// Виправлено: додано ОБЪЕДИНИТЬ ВСЕ з записом для валюти регл. обліку з коефіцієнтом = 1,
	// щоб забезпечити коректний перерахунок сум для національної валюти (грн),
	// яка може не мати запису в регістрі КурсыВалют
	ТекстЗапроса =
	"ВЫБРАТЬ
