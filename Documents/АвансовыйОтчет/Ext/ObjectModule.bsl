...
Процедура ОбновитьАвансовыйОтчетПослеОбмена() Экспорт
	...
	Если ЗначениеЗаполнено(А_НаправлениеДеятельности) И ЗначениеЗаполнено(А_Подразделение) Тогда         
	...
	Если ЗначениеЗаполнено(Подразделение) Тогда
		...
		Для каждого СтрокаТабличнойЧасти Из ПрочиеРасходы Цикл
	...
	Для Каждого СтрокаРасшифровки Из ОплатаПоставщикам Цикл
	
		
		ПараметрыОР = ОбъектыРасчетовСервер.ПолучитьПараметрыОбъектаРасчетов();
		ПараметрыОР.Организация = Организация;
		ПараметрыОР.Партнер     = СтрокаРасшифровки.Поставщик;
		ПараметрыОР.Контрагент  = СтрокаРасшифровки.Контрагент;
		...
		Если ПорядокРасчетов = Перечисления.ПорядокРасчетов.ПоЗаказамНакладным Тогда 
			...
			Если  ТипРасчетов = Перечисления.ТипыРасчетовСПартнерами.РасчетыСПоставщиком 
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	//***
	ОбновитьАвансовыйОтчетПослеОбмена();
	//***
