...
// 		Таблица - ТабличнаяЧасть - Таблица документа для проверки с колонками:
// 		              * НомерСтроки - Число - 
...
Функция ЗначенияПараметровПроведения(Реквизиты = Неопределено)
	...
	ЗначенияПараметровПроведения.Вставить("НазваниеДокумента", НСтр("ru='Регистрация наработок';uk='Реєстрація напрацювань'"));
