...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	ПараметрыВзаиморасчеты = Документы.ВыбытиеДенежныхДокументов.ПараметрыВзаиморасчеты(ХозяйственнаяОперация, СпособКомпенсации);
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Параметры_Взаиморасчеты = Документы.ВыбытиеДенежныхДокументов.ПараметрыВзаиморасчеты(ХозяйственнаяОперация, СпособКомпенсации);
