...
Процедура Разделить(Команда)
	...
	Если КоличествоУпаковок = 0 Тогда
		ОбщегоНазначенияКлиент.СообщитьПользователю(
			НСтр("ru='Не заполнено количество в новом документе';uk='Не заповнена кількість в новому документі'"),,
			"КоличествоУпаковок");
		Возврат;
	КонецЕсли;
