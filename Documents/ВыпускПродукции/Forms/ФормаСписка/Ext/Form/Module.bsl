...
Процедура УстановитьСвойстваДинамическогоСпискаСписок()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Список, "ТекстПоРаспоряжению",           НСтр("ru='По заказу';uk='По замовленню'"));
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Список, "ТекстБезРаспоряжения",          НСтр("ru='Без заказа';uk='Без замовлення'"));
