...
#Область Назначение
	...
	Если ТаблицаСтрок.Количество() > 0 Тогда
		...
		ТекстОшибки = НСтр("ru='Не заполнено поле ""Назначение"" в строке %НомерСтроки% списка ""Товары""';uk='Не заповнене поле ""Призначення"" в рядку %НомерСтроки% списку ""Товари""'");
