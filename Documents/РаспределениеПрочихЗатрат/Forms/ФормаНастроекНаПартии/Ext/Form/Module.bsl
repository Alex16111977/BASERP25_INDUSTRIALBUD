...
Процедура ДекорацияСохранитьНастройкуРаспределенияНажатие(Элемент)
	...
	Если Не Объект.Проведен Тогда
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ru='Перед сохранением настройки документ требуется провести.';uk='Перед збереженням настройки документ потрібно провести.'"));
		Возврат;
...
Процедура НастроитьЗаголовкиПолей(Форма, ИмяРеквизита = Неопределено)
	...
	Если ИмяРеквизита = "ПартииУказаныВручную" Или ИмяРеквизита = Неопределено Тогда
		...
		Если Объект.ПартииУказаныВручную Тогда
			Элементы.БазаРаспределенияПоПартиям.Заголовок = НСтр("ru='Между выпуском и НЗП';uk='Між випуском і НЗВ'");
		Иначе
			Элементы.БазаРаспределенияПоПартиям.Заголовок = НСтр("ru='Между партиями по базе';uk='Між партіями за базою'");
		КонецЕсли;
...
Процедура УстановитьЗаголовокФормы()
	...
	УточнениеПредставленияОбъекта = НСтр("ru='между партиями производства';uk='між партіями виробництва'");
