...
Процедура НастроитьЗаголовкиПолей(Форма, ИмяРеквизита = Неопределено)
	...
	Если ИмяРеквизита = "ОтборПоМатериалам" Или ИмяРеквизита = "БазаРаспределенияПоПартиям" 
		...
		Если Форма.ОтборПоМатериалам.Количество() Тогда
			Элементы.ЗаголовокОтбораПоУказаннымПозициямФР.Заголовок = НСтр("ru='По указанным материалам';uk='За вказаними матеріалами'");
		ИначеЕсли ГруппаПоБазеРаспределения(Объект.БазаРаспределенияПоПартиям) = "Материалы" Тогда
			Элементы.ЗаголовокОтбораПоУказаннымПозициямФР.Заголовок = НСтр("ru='Без отбора по материалам';uk='Без відбору за матеріалами'");
		КонецЕсли;
	...
	Если ИмяРеквизита = "ОтборПоВидамРабот" Или ИмяРеквизита = "БазаРаспределенияПоПартиям" 
		...
		Если Форма.ОтборПоВидамРабот.Количество() Тогда
			Элементы.ЗаголовокОтбораПоУказаннымПозициямФР.Заголовок = НСтр("ru='По указанным видам работ';uk='За вказаними видами робіт'");
		ИначеЕсли ГруппаПоБазеРаспределения(Объект.БазаРаспределенияПоПартиям) = "Трудозатраты" Тогда
			Элементы.ЗаголовокОтбораПоУказаннымПозициямФР.Заголовок = НСтр("ru='Без отбора по видам работ';uk='Без відбору за видами робіт'");
		КонецЕсли;
	...
	Если Не ЗначениеЗаполнено(Объект.БазаРаспределенияПоПартиям)
		...
		Элементы.ЗаголовокОтбораПоУказаннымПозициямФР.Заголовок = НСтр("ru='Отбор недоступен.';uk='Відбір недоступний.'");
	КонецЕсли;
...
Процедура ОпределитьВидимостьИСуммуРасходовПоСтатье()
	...
	//++ НЕ УТ
	Элементы.ГруппаВР.Видимость = Ложь;
	//-- НЕ УТ
