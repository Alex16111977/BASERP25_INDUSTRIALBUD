...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПолучитьФункциональнуюОпцию("КомплекснаяАвтоматизация") Тогда
		Элементы.ПодразделенияЭтапыПравилоРаспределенияПоЭтапам.Заголовок = НСтр("ru='По выпускам продукции';uk='По випусках продукції'");
		Элементы.ЭтапыПравилоРаспределенияПоЭтапам.Заголовок = НСтр("ru='По выпускам продукции';uk='По випусках продукції'");
	КонецЕсли;
