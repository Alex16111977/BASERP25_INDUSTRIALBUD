...
Процедура АктуализироватьНалоговоеНазначение(Заполнить = Истина)
	...
	ПараметрыЗаполнения = Документы.ПередачаМатериаловВПроизводство.ПараметрыЗаполненияНалоговогоНазначения(Объект);
	...
	УчетНДСУП.ЗаполнитьСписокВыбораНалоговыхНазначений(
		...
		УчетНДСКэшированныеЗначенияПараметров
        ,Истина,
		НСтр("ru='По налоговому назначению материалов';uk='За податковим призначенням матеріалів'")
	);
