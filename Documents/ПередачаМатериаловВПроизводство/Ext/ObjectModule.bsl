...
//***ERP
Процедура ОбновитьПередачаМатериаловВПроизводствоПослеОбмена() Экспорт
	...
	Если ЗначениеЗаполнено(Склад.Подразделение) Тогда
	    Подразделение = Склад.Подразделение;
	КонецЕсли;    
	
	//Для каждого СтрокаТабличнойЧасти Из Товары Цикл
	//	СтрокаТабличнойЧасти.СтатьяРасходов =ПланыВидовХарактеристик.СтатьиРасходов.НайтиПоКоду("00-000029"); //Будівельні матеріали
	//КонецЦикла;
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	//***ERP
	ОбновитьПередачаМатериаловВПроизводствоПослеОбмена(); 
	//***ERP
