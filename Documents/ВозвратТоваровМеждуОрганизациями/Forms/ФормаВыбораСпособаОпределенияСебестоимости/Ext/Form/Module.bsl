...
Процедура ЗаполнитьСуммыПоВидуЦен()
	...
	СебестоимостьНДСРегл = ЦенообразованиеКлиентСервер.РассчитатьСуммуНДС(СебестоимостьРегл, СтавкаНДС, Ложь);
	СебестоимостьНДСУпр  = ЦенообразованиеКлиентСервер.РассчитатьСуммуНДС(СебестоимостьУпр, СтавкаНДС, Ложь);
	//-- НЕ УТ
...
Процедура НастроитьФормуПоПараметрам(Параметры)
	...
	СебестоимостьНДСРегл = Параметры.СебестоимостьНДСРегл;
	СебестоимостьНДСУпр = Параметры.СебестоимостьНДСУпр;
	//-- НЕ УТ
