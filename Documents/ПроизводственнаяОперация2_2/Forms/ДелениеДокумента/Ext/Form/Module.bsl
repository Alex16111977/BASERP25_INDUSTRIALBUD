...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = СтрШаблон(НСтр("ru='Деление операции %1';uk='Поділ операції %1'"), Выборка.Номер);
...
Процедура Разбить(Команда)
	...
	Если Количество = 0 ИЛИ КоличествоНов = 0 Тогда
		...
		ТекстСообщения = НСтр("ru='Введены некорректные данные';uk='Введено некоректні дані'");
...
Процедура РазбитьНаСервере(ИдентификаторФормы)
	...
	Исключение
		...
		ВызватьИсключение СтрШаблон(
			НСтр("ru='Не удалось выполнить действие по причине: %1';uk='Не вдалося виконати дію через: %1'"),
...
Процедура АдаптироватьПодМобильныйКлиент()
	...
	Заголовок = НСтр("ru='Новая операция';uk='Нова операція'");
	...
	Элементы.ВидРабочегоЦентраНов.Заголовок = НСтр("ru='Вид РЦ';uk='Вид РЦ'");
	Элементы.РабочийЦентрНов.Заголовок      = НСтр("ru='Рабочий центр';uk='Робочий центр'");
