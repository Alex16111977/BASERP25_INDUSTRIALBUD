	...
	Для каждого СтрокаЗаказ Из ТаблицаЗаказы Цикл
		...
		Если ЗаказОбъект.ПроверитьЗаполнение() Тогда
			...
			Исключение
				...
				СобытиеЖурналаРегистрации = НСтр("ru='Не удалось выполнить замену спецификаций';uk='Не вдалося виконати заміну специфікацій'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
