...
Функция СостояниеНеАктивен() 
	...
	Возврат НСтр("ru='Не активен';uk='Не активний'");
...
Функция СостояниеЗакрыт() 
	...
	Возврат НСтр("ru='Закрыт';uk='Закритий'");
...
Функция СостояниеВРаботе() 
	...
	Возврат НСтр("ru='В работе';uk='В роботі'");
...
Функция СостояниеВыполнен() 
	...
	Возврат НСтр("ru='Выполнен';uk='Виконаний'");
...
Функция СостояниеПостроение() 
	...
	Возврат НСтр("ru='Построение';uk='Побудова'");
