...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	// Заполнение флагов доступности субконто для условного оформления
	ЗаполнитьФлагиДоступностиСубконто();
	
КонецПроцедуры

// Заполняет флаги доступности субконто в табличной части ОтражениеВУчете
// на основании количества субконто у выбранных счетов
//
&НаСервере
Процедура ЗаполнитьФлагиДоступностиСубконто()
...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	// Обновление флагов доступности субконто после записи
	ЗаполнитьФлагиДоступностиСубконто();
КонецПроцедуры
