...
Функция НерекомендуемыеСчетаУчета() Экспорт
	...
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(НерекомендуемыеСчетаУчета, СчетаУчетаДенежныхСредств.СчетаВалютныхБезналичныхДенежныхСредств);
	...
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(НерекомендуемыеСчетаУчета, СчетаУчетаДенежныхСредств.СчетаВалютныхНаличныхДенежныхСредств);
