...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ГруппировкаЗатрат = Перечисления.ГруппировкиЗатратВЗаказеПереработчику.ПоЗаказамНаПроизводство Тогда
		Заголовок = НСтр("ru='Выбор заказов на производство';uk='Вибір замовлень на виробництво'");
	Иначе
	//-- Устарело_Производство21	
		Заголовок = НСтр("ru='Выбор этапов производства';uk='Вибір етапів виробництва'");
	//++ Устарело_Производство21	
	КонецЕсли;
	//-- Устарело_Производство21
...
Процедура ЗаполнитьГрафикПроизводства()
	...
	Если Параметры.ГруппировкаЗатрат = Перечисления.ГруппировкиЗатратВЗаказеПереработчику.ПоЗаказамНаПроизводство Тогда
		...
		ШаблонРаспоряжения = НСтр("ru='Заказ № %1 от %2 (%3)';uk='Замовлення № %1 від %2 (%3)'");
	...
	//-- Устарело_Производство21
		...
		ШаблонРаспоряжения = НСтр("ru='Этап № %1 от %2 (%3)';uk='Етап №%1 від %2(%3)'");
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Не ЗначениеЗаполнено(СпецификацияСтрока) Тогда
			СпецификацияСтрока = НСтр("ru='без спецификации';uk='без специфікації'");
		КонецЕсли;
