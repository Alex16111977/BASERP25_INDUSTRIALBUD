...
Процедура ОбновитьПоступлениеБезналичныхДенежныхСредствПослеОбмена1() Экспорт
	...
	РасшифровкаПлатежаСтрока.СтатьяДвиженияДенежныхСредств =  СтатьяДвиженияДенежныхСредствШапка;
		...
		Если БанковскийСчет.ВалютаДенежныхСредств = Константы.ВалютаРегламентированногоУчета.Получить() Тогда
			...
			ЗапросПокупкаПродажаВалюты.Текст =  "ВЫБРАТЬ
			                                    ...
			                                    |	И ПокупкаПродажаВалюты.СуммаГривневая = &СуммаГривневая
			                                    |
			                                    |"; 
			ПустойДокументПокупкаПродажаВалюты =  ЗапросПокупкаПродажаВалюты.Выполнить().Пустой();
			Если ПустойДокументПокупкаПродажаВалюты Тогда  // это остаток от покупки валюты
