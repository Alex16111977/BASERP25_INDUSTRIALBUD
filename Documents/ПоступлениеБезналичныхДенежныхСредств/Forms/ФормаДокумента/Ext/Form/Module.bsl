...
Процедура УправлениеЭлементамиФормы()
	...
	//*** 
	Если РольДоступна("А_Гермес") Тогда
	 Элементы.ГруппаСтраницы.ОтображениеСтраниц = ОтображениеСтраницФормы.ЗакладкиСверху;
	КонецЕсли;
	 //*** 
...
Процедура ПодтверждениеЗачисленияЗарплатыПриИзмененииНаСервере()
	...
	ИнтеграцияБЗК.ЗаполнитьСуммуНезачисленныхПлатежейПоПодтверждениюБанка(
		Объект.ПодтверждениеЗачисленияЗарплаты, Объект.СуммаДокумента);
