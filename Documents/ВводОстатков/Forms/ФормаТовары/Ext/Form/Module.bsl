...
Процедура ЗаполнитьПоОстаткам(Команда)
	...
	Если Объект.Товары.Количество() Тогда
		...
		ПоказатьВопрос(ОповещениеВопросЗаполнитьПоОстаткам, ТекстВопроса, РежимДиалогаВопрос.ДаНет,,,  НСтр("ru='Ввод остатков регл. учета по данным оперативного';uk='Введення залишків регл. обліку за даними оперативного'"));
	Иначе
