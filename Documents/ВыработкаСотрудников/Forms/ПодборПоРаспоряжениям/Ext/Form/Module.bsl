...
Процедура ЗаполнитьТаблицу()
	...
	|	ДД.КоличествоКОформлению - ЕСТЬNULL(Подобранные.КоличествоКОформлению, 0) КАК КоличествоКОплате,
	|	ДД.Расценка КАК Расценка,
	|	(ДД.КоличествоКОформлению - ЕСТЬNULL(Подобранные.КоличествоКОформлению, 0)) * ДД.Расценка КАК Сумма,
	...
	|ГДЕ
	|	ДД.КоличествоКОплате - ЕСТЬNULL(Подобранные.КоличествоКОформлению, 0) > 0";
	
	ПодобранныеВидыРабот =  ПолучитьИзВременногоХранилища(АдресВХранилище); // ТаблицаЗначений
	ПодобранныеВидыРабот.Свернуть("Распоряжение,КодСтрокиРаспоряжения","КоличествоКОформлению");
