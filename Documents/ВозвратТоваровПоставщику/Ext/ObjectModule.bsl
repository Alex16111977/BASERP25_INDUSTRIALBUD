...
//***ERP
Процедура ОбновитьВозвратТоваровПоставщикуПослеОбмена(Док) Экспорт
	...
	Для каждого СтрокаТовары Из Док.Товары Цикл
		...
		Попытка
			...
			ИначеЕсли ТипЗнч(СтрокаТовары.УдалитьСтавкаНДС) = Тип("СправочникСсылка.СтавкиНДС") Тогда
				// Уже справочник - просто присваиваем
				СтрокаТовары.СтавкаНДС = СтрокаТовары.УдалитьСтавкаНДС;
			Иначе
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
		...
		//***ERP
	ОбновитьВозвратТоваровПоставщикуПослеОбмена(ЭтотОбъект); 
	//***ERP
