...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ИначеЕсли НЕ КроссТаблица
		...
		Для Каждого СтрокаОшибки Из ТаблицаОшибок Цикл
			...
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%Спецификация%", ?(ЗначениеЗаполнено(СтрокаОшибки.Спецификация), " " + НСтр("ru='и спецификацией';uk='і специфікацією'") + " " + СтрокаОшибки.Спецификация, ""));
