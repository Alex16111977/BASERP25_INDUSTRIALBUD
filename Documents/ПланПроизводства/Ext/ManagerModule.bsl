...
#Область ПланыПроизводства
	...
	ДопПараметр.Вставить("Заголовок", 			?(ДоступноОписаниеТипаПроизводственногоПроцесса, 
												НСтр("ru='План производства (сборка)';uk='План виробництва (збирання)'"),
...
#Область ПланыПроизводстваРазборка
	...
	ДопПараметр.Вставить("Тип", 				Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 				ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 			НСтр("ru='План производства (разборка)';uk='План виробництва (розбирання)'"));
	...
	ДопПараметр.Вставить("ЗаголовокОперанда", 	НСтр("ru='План производства (разборка)';uk='План виробництва (розбирання)'"));
	ДопПараметр.Вставить("Расшифровка", 		"Документ.ПланПроизводства");
	ДопПараметр.Вставить("ВходитВОперанд",		"ДополнительныеОперандыПланы");
...
#Область ПланыПроизводстваРемонт
	...
	ДопПараметр.Вставить("Тип", 				Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 				ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 			НСтр("ru='План производства (ремонт)';uk='План виробництва (ремонт)'"));
	ДопПараметр.Вставить("СоздаватьРеквизит", 	ИспользоватьПланированиеПроизводства И ДоступноОписаниеТипаПроизводственногоПроцесса);
	ДопПараметр.Вставить("УдалятьРеквизитыТаблицы", Истина);
	
	// Общие свойства
	ДопПараметр.Вставить("СоздаватьОперанд", 	ИспользоватьПланированиеПроизводства И ДоступноОписаниеТипаПроизводственногоПроцесса);
	ДопПараметр.Вставить("ЗаголовокОперанда", 	НСтр("ru='План производства (ремонт)';uk='План виробництва (ремонт)'"));
	ДопПараметр.Вставить("Расшифровка", 		"Документ.ПланПроизводства");
	ДопПараметр.Вставить("ВходитВОперанд",		"ДополнительныеОперандыПланы");
...
#Область ПланыПроизводстваМатериалы
	...
	ДопПараметр.Вставить("Тип", 				Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 				ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 			НСтр("ru='План производства (потреьность в материалах)';uk='План виробництва (потреьность в матеріалах)'"));
	...
	ДопПараметр.Вставить("ЗаголовокОперанда", 	НСтр("ru='План производства (потребность в материалах)';uk='План виробництва (потреба в матеріалах)'"));
	ДопПараметр.Вставить("Расшифровка", 		"Документ.ПланПроизводства");
	ДопПараметр.Вставить("ВходитВОперанд",		"ДополнительныеОперандыПланы");
...
#Область ПланыПроизводстваМатериалыСОтбором
	...
	ДопПараметр.Вставить("Тип", 				Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 				ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 			НСтр("ru='План производства (потребность в материалах)*';uk='План виробництва (потреба в матеріалах)*'"));
...
#Область ПланыПроизводстваПолуфабрикаты
	...
	ДопПараметр.Вставить("Тип", 				Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 				ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 			НСтр("ru='План производства (полуфабрикаты)';uk='План виробництва (напівфабрикати)'"));
	ДопПараметр.Вставить("СоздаватьРеквизит", 	ИспользоватьПланированиеПроизводства);
	ДопПараметр.Вставить("УдалятьРеквизитыТаблицы", Истина);
	
	// Общие свойства
	ДопПараметр.Вставить("СоздаватьОперанд", 	ИспользоватьПланированиеПроизводства);
	ДопПараметр.Вставить("ЗаголовокОперанда", 	НСтр("ru='План производства (полуфабрикаты)';uk='План виробництва (напівфабрикати)'"));
	ДопПараметр.Вставить("Расшифровка", 		"Документ.ПланПроизводства");
	ДопПараметр.Вставить("ВходитВОперанд",		"ДополнительныеОперандыПланы");
...
#Область ПланыПроизводстваПотребностьВПолуфабрикатах
	...
	ДопПараметр.Вставить("Тип", 				Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 				ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 			НСтр("ru='План производства (потребность в полуфабрикатах)';uk='План виробництва (потреба в напівфабрикатах)'"));
	ДопПараметр.Вставить("СоздаватьРеквизит", 	ИспользоватьДляПланированияМатериалов);
	ДопПараметр.Вставить("УдалятьРеквизитыТаблицы", Истина);
	
	// Общие свойства
	ДопПараметр.Вставить("СоздаватьОперанд", 	ИспользоватьДляПланированияМатериалов);
	ДопПараметр.Вставить("ЗаголовокОперанда", 	НСтр("ru='План производства (потребность в полуфабрикатах)';uk='План виробництва (потреба в напівфабрикатах)'"));
	ДопПараметр.Вставить("Расшифровка", 		"Документ.ПланПроизводства");
	ДопПараметр.Вставить("ВходитВОперанд",		"ДополнительныеОперандыПланы");
...
#Область ФактыПроизводства
	...
	ДопПараметр.Вставить("Тип", 				Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 				ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 			?(СоздаватьРеквизитСОтбором, НСтр("ru='Факт производства*';uk='Факт виробництва*'"), 
		НСтр("ru='Факт производства';uk='Факт виробництва'")));
	...
	ДопПараметр.Вставить("ЗаголовокОперанда", ?(СоздаватьРеквизитСОтбором, НСтр("ru='Факт производства*';uk='Факт виробництва*'"), 
		НСтр("ru='Факт производства';uk='Факт виробництва'")));
...
#Область ФактыПроизводстваМатериалы
	...
	ДопПараметр.Вставить("Тип", 			Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 			ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 		?(СоздаватьРеквизитСОтбором, НСтр("ru='Факт производства (материалы)*';uk='Факт виробництва (матеріали)*'"), 
		НСтр("ru='Факт производства (материалы)';uk='Факт виробництва (матеріали)'")));
	...
	ДопПараметр.Вставить("ЗаголовокОперанда", ?(СоздаватьРеквизитСОтбором, НСтр("ru='Факт производства (материалы)*';uk='Факт виробництва (матеріали)*'"), 
		НСтр("ru='Факт производства (материалы)';uk='Факт виробництва (матеріали)'")));
	ДопПараметр.Вставить("ВходитВОперанд",		"ДополнительныеОперандыФакты");
...
#Область ПланыВыпуска
	...
	ДопПараметр.Вставить("Тип", 				Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 				ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 			НСтр("ru='План производства (весь выпуск)';uk='План виробництва (весь випуск)'"));
	ДопПараметр.Вставить("СоздаватьРеквизит", 	ИспользоватьПланированиеПроизводства);
	ДопПараметр.Вставить("УдалятьРеквизитыТаблицы", Истина);
	
	// Общие свойства
	ДопПараметр.Вставить("СоздаватьОперанд", 	ИспользоватьПланированиеПроизводства);
	ДопПараметр.Вставить("ЗаголовокОперанда", 	НСтр("ru='План производства (весь выпуск)';uk='План виробництва (весь випуск)'"));
	ДопПараметр.Вставить("Расшифровка", 		"Документ.ПланПроизводства");
	ДопПараметр.Вставить("ВходитВОперанд",		"ДополнительныеОперандыПланы");
...
Процедура ЗаполнитьДокументПолуфабрикатами(Знач Параметры, Знач АдресХранилища) Экспорт
	...
	ПараметрыВыбораСпецификаций = Параметры.ПараметрыВыбораСпецификаций;
	ЗаполнятьСпецификациюПоПериодам = Параметры.ЗаполнятьСпецификациюПоПериодам;
	ЭтоРазборка = ( Параметры.ТипПроизводственногоПроцесса = Перечисления.ТипыПроизводственныхПроцессов.Разборка );
	...
	Для каждого СтрокаТЧ Из ЗаполняемаяТЧ Цикл
		...
		Если НЕ ЗначениеЗаполнено(СтрокаТЧ.Спецификация) Тогда
			...
			ПараметрыЗаполнения.ДанныеОбИзделии.НачалоПроизводства = ?(ЗаполнятьСпецификациюПоПериодам,
				СтрокаТЧ[?(ЭтоРазборка, "ДатаЗапуска", "ДатаВыпуска")], Параметры.НачалоПериода);
	...
	Для каждого СтрокаТЧ Из ЗаполняемаяТЧ Цикл
		...
		Для каждого ЭлементМатериал Из ДанныеСпецификации.МатериалыИУслуги Цикл
			...
			ПараметрыЗаполнения.ДанныеОбИзделии.НачалоПроизводства = ?(ЗаполнятьСпецификациюПоПериодам,
				НоваяСтрока.ДатаВыпуска, Параметры.НачалоПериода);
...
//
// Возвращаемое значение:
// 	  ДоступныеТипыАналитик - Соответствие - Ключ: Тип, Значение: Источник заполнения.
//
...
Функция ПараметрыВыбораСпецификаций(Объект) Экспорт
	...
	Если НЕ ЭтоРазборка И НЕ Объект.КроссТаблица И ЗаполнятьСпецификациюПоПериодам Тогда
		
		ПараметрыВыбораСпецификаций.ПараметрыСмещенияПериода = ПараметрыСмещенияПериодаВыбораСпецификаций(Объект.Сценарий);
...
Процедура ПересчитатьПланПроизводства(Ссылка, ЗапуститьЗадание = Ложь) Экспорт
	...
	Исключение
		...
		ТекстСообщения = СтрШаблон(НСтр("ru='Не удалось установить новую границу расчета в документе: %Ссылка% по причине: %Причина%';uk='Не вдалося встановити нову межу розрахунку в документі: %Ссылка% з прични: %Причина%'"), Ссылка, ТекстОшибки);
...
Функция ТекстЗапросаТаблицаОборотыБюджетов(Запрос, ТекстыЗапроса, Регистры)
	...
	БюджетированиеСервер.УстановитьВЗапросеВыраженияЗаполненияАналитики(Запрос.Параметры.Ссылка, ТекстЗапроса, Запрос.Параметры.СтатьяБюджетов, Документы.ПланПроизводства);
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		Иначе
			Если ДанныеПечати.ТипПроизводственногоПроцесса = Перечисления.ТипыПроизводственныхПроцессов.Разборка Тогда
				ОбластьДатаПериод.Параметры.Заголовок = НСтр("ru='Дата запуска';uk='Дата запуску'",КодЯзыкаПечать);
			Иначе
				ОбластьДатаПериод.Параметры.Заголовок = НСтр("ru='Дата выпуска';uk='Дата випуску'",КодЯзыкаПечать);
			КонецЕсли;
...
//  расчета (см. функцию КодыСостоянийРасчетаПланаПроизводства).
//
...
Функция ПараметрыСмещенияПериодаВыбораСпецификаций(Сценарий) Экспорт
	
	ЗначенияРеквизитов = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Сценарий, "Календарь,СпособРасчетаПотребностейВМатериалах");
	
	ПараметрыСмещенияПериода = Новый Структура;
	
	Если НЕ ЗначениеЗаполнено(ЗначенияРеквизитов.Календарь) Тогда
		ПараметрыСмещенияПериода.Вставить("Календарь", Константы.ОсновнойКалендарьПредприятия.Получить());
	Иначе
		ПараметрыСмещенияПериода.Вставить("Календарь", ЗначенияРеквизитов.Календарь);
	КонецЕсли;
	
	ПолеДлительность = ?(ЗначенияРеквизитов.СпособРасчетаПотребностейВМатериалах = Перечисления.СпособыРасчетаМатериалов.МинимальноеПотребление,
		"ПлановаяДлительность",
		"МаксимальнаяДлительность");
	
	ПараметрыСмещенияПериода.Вставить("ПолеДлительность", ПолеДлительность);
	
	Возврат ПараметрыСмещенияПериода;
...
Процедура ОписаниеОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("853f99ff-ffd3-44e0-bc56-98446834f448");
	...
	Обработчик.ПроцедураПроверки = "Документы.ПланПроизводства.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.Комментарий = НСтр("ru='Выполняет замещение планов производства.
                                   ...
                                   |Создает документы ""Регистратор плана производства"" для планов с расчетом потребностей в материалах (видах РЦ, трудозатратах).
                                   |Заполняет реквизит ""Направление деятельности"" в табличной части ""Продукция"".'
                                   |;uk='Виконує заміщення планів виробництва.
                                   |Заповнює реквізити ""Тип виробничого процесу"" та ""Спосіб розрахунку потреб у матеріалах"".
                                   |Заповнює дату запуску продукції.
                                   |Очищає реквізит ""Підрозділ диспетчер"" у КУП.
                                   |Створює документи ""Реєстратор плану виробництва"" для планів з розрахунком потреб у матеріалах (видах РЦ, трудовитратах).
                                   |Заповнює реквізит ""Напрямок діяльності"" у табличній частині ""Продукція"".'");
	...
	Читаемые.Добавить(Метаданные.Справочники.СценарииТоварногоПланирования.ПолноеИмя());
	Читаемые.Добавить(Метаданные.РегистрыСведений.ЗамещениеПланов.ПолноеИмя());
	Читаемые.Добавить(Метаданные.РегистрыСведений.КалендарныеГрафики.ПолноеИмя());
	Читаемые.Добавить(Метаданные.РегистрыСведений.НормативнаяДлительностьПроизводства.ПолноеИмя());
	Обработчик.ЧитаемыеОбъекты = СтрСоединить(Читаемые, ",");
	
	Изменяемые = Новый Массив;
	Изменяемые.Добавить(Метаданные.Документы.ПланПроизводства.ПолноеИмя());
	Изменяемые.Добавить(Метаданные.Документы.РегистраторПланаПроизводства.ПолноеИмя());
	Изменяемые.Добавить(Метаданные.РегистрыСведений.ЗамещениеПланов.ПолноеИмя());
	Обработчик.ИзменяемыеОбъекты = СтрСоединить(Изменяемые, ",");
	
	Блокируемые = Новый Массив;
	Блокируемые.Добавить(Метаданные.Документы.ПланПроизводства.ПолноеИмя());
	Блокируемые.Добавить(Метаданные.Документы.РегистраторПланаПроизводства.ПолноеИмя());
	...
	НоваяСтрока = Обработчик.ПриоритетыВыполнения.Добавить();
	НоваяСтрока.Процедура = "РегистрыСведений.КалендарныеГрафики.ОбработатьДанныеДляПереходаНаНовуюВерсию";
	НоваяСтрока.Порядок = "После";
	
	НоваяСтрока = Обработчик.ПриоритетыВыполнения.Добавить();
	НоваяСтрока.Процедура = "КалендарныеГрафики.ОбновитьДанныеЗависимыеОтПроизводственныхКалендарей";
	НоваяСтрока.Порядок = "После";
...
Функция ТекстЗапросаДанныеКОбработке(ВыбратьТолькоДляДвижений = Истина) Экспорт
	...
	|	ПланПроизводства.Назначение КАК Назначение,
	...
	|	ПланыПроизводства.Статус КАК СтатусЗамещения
	|ПОМЕСТИТЬ ЗамещающиеИЗамещенныеПланыПроизводства
	|ИЗ
	|	ПланыПроизводства КАК ПланыПроизводства
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ПланыПроизводства КАК ПланыПроизводства1
	|		ПО ПланыПроизводства.ОкончаниеПериода >= ПланыПроизводства1.НачалоПериодаЗамещения
	|			И ПланыПроизводства.НачалоПериодаЗамещения <= ПланыПроизводства1.ОкончаниеПериода
	|			И ПланыПроизводства.Ссылка <> ПланыПроизводства1.Ссылка
	|			И ПланыПроизводства.ВидПлана = ПланыПроизводства1.ВидПлана
	|			И (ПланыПроизводства.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыПланов.НаУтверждении)
	|					И ПланыПроизводства1.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыПланов.Утвержден)
	|				ИЛИ ПланыПроизводства.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыПланов.Утвержден)
	|					И ПланыПроизводства1.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыПланов.Утвержден))
	|			И ПланыПроизводства.Дата > ПланыПроизводства1.Дата
	|			И ПланыПроизводства.Подразделение = ПланыПроизводства1.Подразделение
	|			И ПланыПроизводства.Назначение = ПланыПроизводства1.Назначение
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ЗамещающиеИЗамещенныеПланыПроизводства.ЗамещенныйПлан КАК Ссылка
	|ПОМЕСТИТЬ ПланыПроизводстваКОбработке
	|ИЗ
	|	ЗамещающиеИЗамещенныеПланыПроизводства КАК ЗамещающиеИЗамещенныеПланыПроизводства
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ЗамещениеПланов КАК ЗамещениеПланов
	|		ПО ЗамещающиеИЗамещенныеПланыПроизводства.ЗамещающийПлан = ЗамещениеПланов.ЗамещающийПлан
	|			И ЗамещающиеИЗамещенныеПланыПроизводства.ЗамещенныйПлан = ЗамещениеПланов.ЗамещенныйПлан
	|			И ЗамещающиеИЗамещенныеПланыПроизводства.СтатусЗамещения = ЗамещениеПланов.СтатусЗамещения
	|ГДЕ
	...
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ПланыПроизводства.Ссылка
	|ИЗ
	|	ПланыПроизводства КАК ПланыПроизводства
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.ЗамещениеПланов КАК ЗамещениеПланов
	|		ПО (ЗамещениеПланов.ЗамещенныйПлан = ПланыПроизводства.Ссылка)
	|ГДЕ
	|	ПланыПроизводства.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыПланов.Отменен)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ПланыПроизводстваКОбработке.Ссылка КАК Ссылка
	|ИЗ
	|	ПланыПроизводстваКОбработке КАК ПланыПроизводстваКОбработке";
...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ТекстЗапроса = ТекстЗапроса +
		...
		|ГДЕ
		|	Документ.Проведен
		|	И Документ.Сценарий.ИспользоватьДляПланированияМатериалов
		|	И НЕ ИСТИНА В
		|				(ВЫБРАТЬ ПЕРВЫЕ 1
		|					ИСТИНА
		|				ИЗ
		|					Документ.РегистраторПланаПроизводства КАК Т
		|				ГДЕ
		|					Т.ПланПроизводства = Документ.Ссылка
		|					И Т.Проведен)
		|
		|ОБЪЕДИНИТЬ
		|
		...
		|		ПО ПланПроизводстваПродукция.Назначение = Назначения.Ссылка
		|ГДЕ
		|	ПланПроизводстваПродукция.НаправлениеДеятельности <> ЕСТЬNULL(Назначения.НаправлениеДеятельности, ЗНАЧЕНИЕ(Справочник.Назначения.ПустаяСсылка))
		|	И ПланПроизводстваПродукция.Назначение <> ЗНАЧЕНИЕ(Справочник.Назначения.ПустаяСсылка)";
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ПолноеИмяОбъекта = "Документ.ПланПроизводства";
	...
	|	Документ.Сценарий.ПланированиеПоНазначениям КАК ПланированиепоНазначениям,
	|	Документ.ВидПлана КАК ВидПлана,
	|	Документ.ВидПлана.ТипПроизводственногоПроцесса КАК ТипПроизводственногоПроцесса,
	|	Документ.Сценарий КАК Сценарий,
	|	Документ.Сценарий.СпособРасчетаПотребностейВМатериалах КАК СпособРасчетаПотребностейВМатериалах,
	|	Документ.НачалоПериодаЗамещения КАК НачалоПериодаЗамещения,
	|	Документ.ОкончаниеПериода КАК ОкончаниеПериода,
	|	Документ.Статус КАК Статус,
	|	Документ.Дата КАК Дата,
	|	Документ.Назначение КАК Назначение,
	...
	|ИЗ
	|	ПланыПроизводстваДляОбработки КАК КОбработке
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ПланыПроизводстваДляОбработки КАК КОбработке
	...
	|ВЫБРАТЬ
	|	Документ.Ссылка КАК Ссылка
	|ПОМЕСТИТЬ ПланыПроизводстваСоздатьРегистратор
	|ИЗ
	|	ПланыПроизводстваДляОбработки КАК Документ
	|ГДЕ
	|	Документ.Проведен
	|	И Документ.ИспользоватьДляПланированияМатериалов
	|	И НЕ ИСТИНА В
	|				(ВЫБРАТЬ ПЕРВЫЕ 1
	|					ИСТИНА
	|				ИЗ
	...
	|	ПланПроизводства.Ссылка КАК Ссылка,
	|	ПланПроизводства.ВидПлана КАК ВидПлана,
	|	ПланПроизводства.НачалоПериодаЗамещения КАК НачалоПериодаЗамещения,
	|	ПланПроизводства.ОкончаниеПериода КАК ОкончаниеПериода,
	|	ПланПроизводства.Статус КАК Статус,
	|	ПланПроизводства.Дата КАК Дата,
	|	ПланПроизводства.Назначение КАК Назначение,
	...
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ПланыПроизводства.Ссылка КАК ЗамещающийПлан,
	|	ПланыПроизводства.НачалоПериодаЗамещения КАК НачалоПериодаЗамещения,
	|	ПланыПроизводства.ОкончаниеПериода КАК ОкончаниеПериодаЗамещения,
	|	ПланыПроизводства1.Ссылка КАК ЗамещенныйПлан,
	|	ПланыПроизводства.Статус КАК СтатусЗамещения,
	|	ПланыПроизводства1.Статус КАК СтатусЗамещенногоПлана,
	...
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ЗамещающиеИЗамещенныеПланыПроизводства.ЗамещенныйПлан КАК Ссылка
	|ПОМЕСТИТЬ ПланыПроизводстваЗаместить
	|ИЗ
	|	ЗамещающиеИЗамещенныеПланыПроизводства КАК ЗамещающиеИЗамещенныеПланыПроизводства
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ЗамещениеПланов КАК ЗамещениеПланов
	|		ПО ЗамещающиеИЗамещенныеПланыПроизводства.ЗамещающийПлан = ЗамещениеПланов.ЗамещающийПлан
	|			И ЗамещающиеИЗамещенныеПланыПроизводства.ЗамещенныйПлан = ЗамещениеПланов.ЗамещенныйПлан
	|			И ЗамещающиеИЗамещенныеПланыПроизводства.СтатусЗамещения = ЗамещениеПланов.СтатусЗамещения
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ПланПроизводства.Продукция КАК ПланПроизводстваПродукция
	|		ПО ЗамещающиеИЗамещенныеПланыПроизводства.ЗамещенныйПлан = ПланПроизводстваПродукция.Ссылка
	|ГДЕ
	|	(ЗамещениеПланов.ЗамещенныйПлан ЕСТЬ NULL
	|			ИЛИ ЗамещающиеИЗамещенныеПланыПроизводства.СтатусЗамещенногоПлана = ЗНАЧЕНИЕ(Перечисление.СтатусыПланов.Утвержден)
	|				И ЗамещающиеИЗамещенныеПланыПроизводства.СтатусЗамещения = ЗНАЧЕНИЕ(Перечисление.СтатусыПланов.Утвержден)
	|				И ВЫБОР
	|					КОГДА ЗамещающиеИЗамещенныеПланыПроизводства.ТипПроизводственногоПроцесса = ЗНАЧЕНИЕ(Перечисление.ТипыПроизводственныхПроцессов.Разборка)
	|						ТОГДА ПланПроизводстваПродукция.ДатаЗапуска МЕЖДУ ЗамещающиеИЗамещенныеПланыПроизводства.НачалоПериодаЗамещения И ЗамещающиеИЗамещенныеПланыПроизводства.ОкончаниеПериодаЗамещения
	|					ИНАЧЕ ПланПроизводстваПродукция.ДатаВыпуска МЕЖДУ ЗамещающиеИЗамещенныеПланыПроизводства.НачалоПериодаЗамещения И ЗамещающиеИЗамещенныеПланыПроизводства.ОкончаниеПериодаЗамещения
	|				КОНЕЦ
	|				И НЕ ПланПроизводстваПродукция.ЗамещенКЗаказу
	...
	|	ПланыПроизводства.Ссылка
	|ИЗ
	|	ПланыПроизводстваДляОбработки КАК ПланыПроизводства
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.ЗамещениеПланов КАК ЗамещениеПланов
	|		ПО (ЗамещениеПланов.ЗамещенныйПлан = ПланыПроизводства.Ссылка)
	|ГДЕ
	|	ПланыПроизводства.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыПланов.Отменен)
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.Назначения КАК Назначения
	|		ПО ПланПроизводстваПродукция.Назначение = Назначения.Ссылка
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ПланыПроизводстваДляОбработки КАК ПланыПроизводстваДляОбработки
	|		ПО ПланПроизводстваПродукция.Ссылка = ПланыПроизводстваДляОбработки.Ссылка
	|ГДЕ
	|	ПланПроизводстваПродукция.НаправлениеДеятельности <> ЕСТЬNULL(Назначения.НаправлениеДеятельности, ЗНАЧЕНИЕ(Справочник.Назначения.ПустаяСсылка))
	|	И ПланПроизводстваПродукция.Назначение <> ЗНАЧЕНИЕ(Справочник.Назначения.ПустаяСсылка)
	|	И ПланыПроизводстваДляОбработки.ПланированиепоНазначениям
	|;
	|           
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ПланыПроизводстваДляОбработки.Ссылка КАК Ссылка,
	|	ПланыПроизводстваДляОбработки.ВерсияДанных КАК ВерсияДанных,
	|	ПланыПроизводстваДляОбработки.ВидПлана КАК ВидПлана,
	|	ПланыПроизводстваДляОбработки.ТипПроизводственногоПроцесса КАК ТипПроизводственногоПроцесса,
	|	ПланыПроизводстваДляОбработки.Сценарий КАК Сценарий,
	|	ПланыПроизводстваДляОбработки.ИспользоватьДляПланированияМатериалов КАК ИспользоватьДляПланированияМатериалов,
	|	ПланыПроизводстваДляОбработки.СпособРасчетаПотребностейВМатериалах КАК СпособРасчетаПотребностейВМатериалах,
	|	ПланыПроизводстваДляОбработки.ПланированиепоНазначениям КАК ПланированиепоНазначениям,
	|	ВЫБОР
	|		КОГДА ПланыПроизводстваСоздатьРегистратор.Ссылка ЕСТЬ NULL
	|			ТОГДА ЛОЖЬ
	|		ИНАЧЕ ИСТИНА
	|	КОНЕЦ КАК СоздатьРегистратор,
	|	ВЫБОР
	|		КОГДА ПланыПроизводстваЗаместить.Ссылка ЕСТЬ NULL
	|			ТОГДА ЛОЖЬ
	|		ИНАЧЕ ИСТИНА
	|	КОНЕЦ КАК Заместить
	|ИЗ
	|	ПланыПроизводстваДляОбработки КАК ПланыПроизводстваДляОбработки
	|		ЛЕВОЕ СОЕДИНЕНИЕ ПланыПроизводстваСоздатьРегистратор КАК ПланыПроизводстваСоздатьРегистратор
	|		ПО ПланыПроизводстваДляОбработки.Ссылка = ПланыПроизводстваСоздатьРегистратор.Ссылка
	|		ЛЕВОЕ СОЕДИНЕНИЕ ПланыПроизводстваЗаместить КАК ПланыПроизводстваЗаместить
	|		ПО ПланыПроизводстваДляОбработки.Ссылка = ПланыПроизводстваЗаместить.Ссылка
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТЗаблокированныеСсылки
	|		ПО ПланыПроизводстваДляОбработки.Ссылка = ВТЗаблокированныеСсылки.Ссылка
	|ГДЕ
	...
	НазначенияИНаправленияДеятельности = ЗапросПакет[7].Выгрузить();
	Выборка = ЗапросПакет[8].Выбрать();
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			Если ДокументОбъект <> Неопределено Тогда
				...
				Если Выборка.СоздатьРегистратор Тогда
					ДокументРегистратор = Документы.РегистраторПланаПроизводства.СоздатьДокумент();
					ДокументРегистратор.ПланПроизводства = Выборка.Ссылка;
					ДокументРегистратор.Проведен = Истина;
					ЗаполнитьЗначенияСвойств(ДокументРегистратор, ДокументОбъект, "Дата, Статус");
					ОбновлениеИнформационнойБазы.ЗаписатьОбъект(ДокументРегистратор,,, РежимЗаписиДокумента.Запись);
				КонецЕсли;
				
				Если Выборка.Заместить ИЛИ (ДокументОбъект.Проведен И ДокументОбъект.Замещающий) Тогда
				...
				Если Выборка.ПланированиеПоНазначениям Тогда
					
					ПланНазначенияИНаправленияДеятельности = НазначенияИНаправленияДеятельности.НайтиСтроки(Новый Структура("Ссылка", Выборка.Ссылка));
					
					Если ПланНазначенияИНаправленияДеятельности.Количество()>0 Тогда
						Для Каждого Строка Из ПланНазначенияИНаправленияДеятельности Цикл
							СоответсвиеНазначенияИНаправленияДеятельности = Новый Соответствие;
							СоответсвиеНазначенияИНаправленияДеятельности.Вставить(Строка.Назначение, Строка.НаправлениеДеятельности);
						КонецЦикла;
						
						Для Каждого Строка Из ДокументОбъект.Продукция Цикл
							
							Если ЗначениеЗаполнено(Строка.Назначение)
								И СоответсвиеНазначенияИНаправленияДеятельности.Получить(Строка.Назначение) <> Неопределено Тогда
								Строка.НаправлениеДеятельности = СоответсвиеНазначенияИНаправленияДеятельности.Получить(Строка.Назначение);
							КонецЕсли;
...
Функция ДанныеОбновленыНаНовуюВерсиюПрограммы(МетаданныеИОтбор) Экспорт
	...
	ДокументОбновлен = ОбновлениеИнформационнойБазы.ОбработкаДанныхЗавершена(
		Неопределено, "Документ.ПланПроизводства", МетаданныеИОтбор.Отбор);
	
	РегистрыОбновлены = Истина;
	Если ДокументОбновлен Тогда
		РегистрыОбновлены = 
			ОбновлениеИнформационнойБазы.ОбработкаДанныхЗавершена(
				Неопределено, "РегистрНакопления.ПланыПроизводства", МетаданныеИОтбор.Отбор)
			И ОбновлениеИнформационнойБазы.ОбработкаДанныхЗавершена(
				Неопределено, "РегистрНакопления.ПланыВыпускаИзделий", МетаданныеИОтбор.Отбор)
			И ОбновлениеИнформационнойБазы.ОбработкаДанныхЗавершена(
				Неопределено, "РегистрНакопления.ПланыПотребленияМатериалов", МетаданныеИОтбор.Отбор)
			//++ НЕ УТКА
			И ОбновлениеИнформационнойБазы.ОбработкаДанныхЗавершена(
				Неопределено, "РегистрНакопления.ПланыЗанятостиВидовРабочихЦентров", МетаданныеИОтбор.Отбор)
			//-- НЕ УТКА
			И ОбновлениеИнформационнойБазы.ОбработкаДанныхЗавершена(
				Неопределено, "РегистрНакопления.ПланыЗанятостиТрудовыхРесурсов", МетаданныеИОтбор.Отбор);
	КонецЕсли;
	
	Возврат ДокументОбновлен И РегистрыОбновлены;
