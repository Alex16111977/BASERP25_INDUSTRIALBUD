...
// Инициализация параметров заполнения налогового назначения
//  Параметры:
...
Функция ПараметрыЗаполненияНалоговогоНазначения(ДанныеОбъекта) Экспорт
...
Функция МакетФормыВыбораНазначений() Экспорт
	...
	//++ НЕ УТКА
	ШаблонНазначения.ТипыНазначений.Удалить(
		ШаблонНазначения.ТипыНазначений.Найти(Перечисления.ТипыНазначений.Давальческое21));
	ШаблонНазначения.ТипыНазначений.Удалить(
		ШаблонНазначения.ТипыНазначений.Найти(Перечисления.ТипыНазначений.ДавальческоеПродукция22));
	ШаблонНазначения.ТипыНазначений.Удалить(
		ШаблонНазначения.ТипыНазначений.Найти(Перечисления.ТипыНазначений.ДавальческоеМатериалы22));
	ШаблонНазначения.ТипыНазначений.Удалить(
		ШаблонНазначения.ТипыНазначений.Найти(Перечисления.ТипыНазначений.ДавальческоеМатериалыПодЭтап22));
	//-- НЕ УТКА
...
Функция ТекстЗапросаТаблицаПрочиеРасходыНезавершенногоПроизводства(Запрос, ТекстыЗапроса, Регистры)
	...
	|	СУММА(ПрочиеРасходы.СтоимостьРеглБезНДС) КАК СтоимостьРеглБезНДС,
	|	СУММА(ПрочиеРасходы.НДСРегл) КАК НДСРегл,
	|	СУММА(ПрочиеРасходы.СтоимостьУпрБезНДС) КАК СтоимостьУпрБезНДС,
...
Функция ТекстЗапросаТаблицаСебестоимостьТоваров(Запрос, ТекстыЗапроса, Регистры) Экспорт
	...
	|	ТаблицаТовары.СтоимостьРегл															КАК СтоимостьРеглБезНДС,
	|	ТаблицаТовары.НДСРегл																КАК НДСРегл,
	|	ТаблицаТовары.НДСРегл																КАК НДСРеглРеквизит,
	|	ТаблицаТовары.СтоимостьУпр															КАК СтоимостьУпр,
	|	ТаблицаТовары.СтоимостьУпр															КАК СтоимостьУпрБезНДС,
...
Процедура СопоставитьЗагружаемыеДанныеМатериалыИРаботы(АдресЗагружаемыхДанных, АдресТаблицыСопоставления, СписокНеоднозначностей)
	...
	Запрос.УстановитьПараметр("ТекстЗаказНаПроизводство",	НСтр("ru='Заказ на производство';uk='Замовлення на виробництво'"));
	Запрос.УстановитьПараметр("ТекстОтчетПереработчика",	НСтр("ru='Отчет переработчика';uk='Звіт переробника'"));
	Запрос.УстановитьПараметр("ТекстПроизводствоБезЗаказа",	НСтр("ru='Производство без заказа';uk='Виробництво без замовлення'"));
