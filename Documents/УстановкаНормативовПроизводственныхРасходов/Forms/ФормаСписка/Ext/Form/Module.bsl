...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='Просрочены';uk='Прострочені'"));
	...
	// Представление состояния "Установлены" (не бессрочно).
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='Установлены';uk='Встановлені'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='Не установлены';uk='Не встановлені'"));
