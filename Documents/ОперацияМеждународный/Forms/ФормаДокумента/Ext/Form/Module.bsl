...
Процедура ОрганизацияПриИзменении(Элемент)
	...
	Если ЕстьДвижения Тогда
		ТекстВопроса = НСтр("ru='Указанные в проводках расчетные счета, договоры, подразделения, документы будут очищены. Продолжить?';uk='Зазначені в проводках розрахункові рахунки, договори, підрозділи, документи будуть очищені. Продовжити?'");
