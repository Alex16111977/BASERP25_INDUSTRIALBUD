...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если РежимЗаписи = РежимЗаписиДокумента.Проведение Тогда
		...
		Если Выборка.Следующий() Тогда
			ТекстСообщения = НСтр("ru='По организации ""%1"" с видом резервов ""%2"" за ""%3"" месяц уже оформлен документ ""%4"".';uk='По організації ""%1"" з видом резервів ""%2"" за ""%3"" місяць вже оформлений документ ""%4"".'");
