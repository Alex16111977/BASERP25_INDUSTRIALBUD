...
Процедура СоздатьДокументОтражения(Команда)
	...
	Если ТекущаяСтрока = Неопределено Тогда
		ВызватьИсключение НСтр("ru='Не выбраны ""Организация"" и ""Вид резервов"" для создания документа';uk='Не вибрані ""Організація"" і ""Вид резервів"" для створення документа'");
	КонецЕсли;
