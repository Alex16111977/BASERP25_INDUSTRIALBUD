...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
 	...
 	Если Не ЗакрытьФормуПринудительно И Модифицированность Тогда
...
|інакше змінені дані будуть загублені.'");
		...
		Иначе
			...
			Если Не СохранениеПараметровФормы Тогда
				...
				ТекстВопроса       = НСтр("ru='Реквизиты печати были изменены. Закрыть без сохранения реквизитов?';uk='Реквізити друку були змінені. Закрити без збереження реквізитів?'");
