...
|;uk='План продажів відjбhf;ається в бюджетуванні. 
|Необхідно встановити прогнозні курси валют %1 в сценарії бюджетування ""%2"" для кожного періоду плану %3.'");
			ТекстСообщения = 
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					ТекстСообщения, 
					СтрСоединить(МассивВалют, ", "), 
					НаименованиеСценарияБюджетирования, ?(ПравоПросмотраСценариевБюджетирования, "", НСтр("ru=', обратитесь к администратору';uk=', зверніться до адміністратора'")));
