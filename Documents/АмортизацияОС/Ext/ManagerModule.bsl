...
|;uk='Не вдалося провести документ ""Амортизація ОЗ"" за %1.
|Щоб отримати більш докладний опис помилки необхідно провести документ вручну.'");
...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	Возврат УчетОСВызовСервера.ТекстОтраженияВРеглУчетеНачисленнойАмортизацииУКР();
