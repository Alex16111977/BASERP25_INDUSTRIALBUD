...
Процедура ПроверитьДепонируемыеСуммыПоВедомости(Отказ)
	...
	МассивСообщений.Добавить(НСтр("ru='Сумма не соответствует ведомости в строке %1 списка ""Депоненты""';uk='Сума не відповідає відомості в рядку %1 списку ""Депоненти""'"));
	МассивСообщений.Добавить(НСтр("ru='Сотрудник в строке %1 списка ""Депоненты"" отсутствует в ведомости';uk='Співробітник в рядку %1 списку ""Депоненти"" відсутній у відомості'"));
