...
Процедура ДлительностьПереналадкиТаблицаПриАктивизацииЯчейки(Элемент)
	...
	ИначеЕсли ПриоритетНастройки = 1 Тогда
		...
		ПояснениеПоНастройке = Новый ФорматированнаяСтрока(НСтр("ru='Длительность определяется по индивидуальной настройке.';uk='Тривалість визначається за індивідуальною настройкою.'"));
	...
	ИначеЕсли ПриоритетНастройки = 2 Тогда
		...
		ПояснениеПоНастройке = Новый ФорматированнаяСтрока(ПояснениеПоНастройкеТекст, " ", НСтр("ru='(в таблице выделена';uk='(в таблиці виділено'"), " ", ТекстВТаблицеВыделеноЦветом, ").");
