...
|Не заповнений обов''язковий реквізит ""Власник товару"".'");
	...
	//***ЕРП
	 Если Не ЗначениеЗаполнено(СтруктураВидЗапасов.НалоговоеНазначение) Тогда
        СтруктураВидЗапасов.НалоговоеНазначение = Справочники.Организации.НалоговоеНазначениеНДС(Организация, ТекущаяДатаСеанса());
	КонецЕсли;
	//***ЕРП
