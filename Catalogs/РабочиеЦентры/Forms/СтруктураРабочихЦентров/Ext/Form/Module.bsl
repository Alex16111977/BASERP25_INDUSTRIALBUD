	...
	Если СтруктураРеквизитов.Свойство("РежимРаботыПоУчасткам")
		...
		Если Форма.ЕстьУчастки Тогда
			...
			Если Форма.РежимРаботыПоУчасткам Тогда
				МассивСтрок.Добавить(Новый ФорматированнаяСтрока(НСтр("ru='Участки';uk='Ділянки'")));
			Иначе
				МассивСтрок.Добавить(Новый ФорматированнаяСтрока(НСтр("ru='Участки';uk='Ділянки'"),,,,"#Участки"));
			КонецЕсли;
		...
		Если Форма.РежимРаботыПоУчасткам Тогда
			МассивСтрок.Добавить(Новый ФорматированнаяСтрока(НСтр("ru='Виды рабочих центров';uk='Види робочих центрів'"),,,,"#ВидыРЦ"));
		Иначе
			МассивСтрок.Добавить(Новый ФорматированнаяСтрока(НСтр("ru='Виды рабочих центров';uk='Види робочих центрів'")));
		КонецЕсли;
