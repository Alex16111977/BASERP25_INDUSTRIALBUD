		...
		Попытка
			...
			Иначе
				...
				Если СправочникОбъект.ТипНазначения = Перечисления.ТипыНазначений.ПустаяСсылка() Тогда
					...
					//++ НЕ УТКА
					Если СправочникОбъект.Партнер.Пустая() И ТипЗнч(СправочникОбъект.Заказ) = Тип("ДокументСсылка.ЗаказДавальца") Тогда
						СправочникОбъект.ТипНазначения = Перечисления.ТипыНазначений.Давальческое21;
					ИначеЕсли НЕ СправочникОбъект.Партнер.Пустая() И ТипЗнч(СправочникОбъект.Заказ) = Тип("ДокументСсылка.ЗаказДавальца") Тогда
						СправочникОбъект.ТипНазначения = Перечисления.ТипыНазначений.ДавальческоеПродукция22;
					ИначеЕсли НЕ СправочникОбъект.Партнер.Пустая() И ТипЗнч(СправочникОбъект.Заказ) = Тип("ДокументСсылка.ЭтапПроизводства2_2") Тогда
						СправочникОбъект.ТипНазначения = Перечисления.ТипыНазначений.ДавальческоеМатериалыПодЭтап22;
					ИначеЕсли НЕ СправочникОбъект.Партнер.Пустая() И НЕ ЗначениеЗаполнено(СправочникОбъект.Заказ) Тогда
						СправочникОбъект.ТипНазначения = Перечисления.ТипыНазначений.ДавальческоеМатериалы22;
						СправочникОбъект.Наименование = Справочники.Назначения.ПредставлениеНазначенияДляЗаписиВИнформационнуюБазу(СправочникОбъект, Неопределено);
					КонецЕсли;
					//-- НЕ УТКА
				...
				Если СправочникОбъект.КонтролироватьТолькоНаличие <> 
						...
						//++ НЕ УТКА
						ИЛИ ЗначениеЗаполнено(СправочникОбъект.Заказ) И ТипЗнч(СправочникОбъект.Заказ) = Тип("ДокументСсылка.ЗаказДавальца")
						//-- НЕ УТКА
