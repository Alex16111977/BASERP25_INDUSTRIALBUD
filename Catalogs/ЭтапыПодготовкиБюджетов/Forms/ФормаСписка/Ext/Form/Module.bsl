...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Отбор") Тогда
		Если Параметры.Отбор.Свойство("Владелец") Тогда
			...
			ЧастиЗаголовка.Добавить(НСтр("ru='Модель бюджетирования';uk='Модель бюджетування'") + ":");
			...
			Если ПравоДоступа("Просмотр", Метаданные.Отчеты.МониторБюджетныхПроцессов)
			   И ПравоДоступа("Просмотр", Метаданные.Отчеты.ВыполнениеЗадачБюджетногоПроцесса) Тогда
				...
				ЧастиЗаголовка.Добавить("(");
				ЧастиЗаголовка.Добавить(Новый ФорматированнаяСтрока(НСтр("ru='Обзор бюджетного процесса';uk='Огляд бюджетного процесу'"), , , , "Обзор"));
				ЧастиЗаголовка.Добавить(")");
			КонецЕсли;
