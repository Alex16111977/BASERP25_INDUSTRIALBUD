...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПолучитьФункциональнуюОпцию("ОтображатьВнеоборотныеАктивы2_2")
		...
		Элементы.СписокСоздатьАмортизациюОС.Заголовок = НСтр("ru='Амортизация ОС (2.1)';uk='Амортизація ОЗ (2.1)'");
		Элементы.СписокСоздатьАмортизациюНМА.Заголовок = НСтр("ru='Амортизация НМА (2.1)';uk='Амортизація НМА (2.1)'");
	КонецЕсли; 
	//-- НЕ УТ
